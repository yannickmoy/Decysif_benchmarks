...
;; "temp___1160"
(define-fun temp___1160 () (Array Int us_rep6)
  (nb_blacks o10))
...
;; "o"
(define-fun o11 () us_rep6
  (select temp___1160 x))
...
(define-fun o12 () us_split_fields10
  (us_split_fields11 o11))

;; "__split_fields'result'unused"
(define-fun us_split_fieldsqtresultqtunused1 () us_split_fields10
  o12)

;; "o"
(define-fun o13 () extended_index_type
  (rec__red_black_trees__black_count__depth o12))
