                                                ...
                                                (and
                                                  ...
                                                  (and
                                                    ...
                                                    (and
                                                      ...
                                                      o55))))))))))))))))))))))))
        (and (= o55 (distinct 1 0)) (= of_intqtresultqtunused o55))))
    (= o55 false)))
...
;; "temp___compl_1652"
(define-fun temp___compl_1652 () Int
  i)

;; "Assert"
(assert (type_invariant temp___old_1650))

;; "temp___1657"
(define-fun temp___1657 () Int
  (peek1 temp___old_1650 temp___compl_1652 1))

;; "H"
(assert (in_range2 temp___1657))
...
;; "peek'result'unused"
(define-fun peekqtresultqtunused4 () Int
  temp___1657)

;; "Ensures"
(assert (in_range4 temp___1657))
...
;; "Assert"
(assert (type_invariant temp___old_1648))

;; "temp___1663"
(define-fun temp___1663 () Int
  (peek1 temp___old_1648 temp___1657 0))

;; "H"
(assert (in_range2 temp___1663))
...
;; "peek'result'unused"
(define-fun peekqtresultqtunused5 () Int
  temp___1663)

;; "infix ='result'unused"
(define-fun infix_eqqtresultqtunused10 () Bool
  (ite (= temp___1663 0) true false))

;; "H"
(assert (not (= temp___1663 0)))

;; "__split_fields__content'result'unused"
(define-fun us_split_fields__contentqtresultqtunused100 () us_split_fields4
  t__split_fields6)

;; "temp___compl_1604"
(define-fun temp___compl_1604 () us_rep2
  (us_repqtmk2 t__split_fields6))
...
;; "temp___compl_1609"
(define-fun temp___compl_1609 () Int
  i)

;; "Assert"
(assert (type_invariant temp___old_1607))

;; "temp___1614"
(define-fun temp___1614 () Int
  (peek1 temp___old_1607 temp___compl_1609 1))

;; "H"
(assert (in_range2 temp___1614))
...
;; "peek'result'unused"
(define-fun peekqtresultqtunused6 () Int
  temp___1614)

;; "Ensures"
(assert (in_range4 temp___1614))
...
;; "Assert"
(assert (type_invariant temp___old_1605))

;; "temp___1620"
(define-fun temp___1620 () Int
  (peek1 temp___old_1605 temp___1614 0))

;; "H"
(assert (in_range2 temp___1620))
...
;; "peek'result'unused"
(define-fun peekqtresultqtunused7 () Int
  temp___1620)

;; "Ensures"
(assert (in_range4 temp___1620))
...
;; "temp___1622"
(define-fun temp___1622 () us_rep2
  (us_repqtmk2 t__split_fields6))
...
;; "Assert"
(assert (type_invariant temp___1622))

;; "temp___1625"
(define-fun temp___1625 () Int
  (parent1 temp___compl_1604 temp___1620))

;; "H"
(assert (in_range2 temp___1625))
...
;; "H"
(assert (=> (= (size temp___compl_1604) 0) (= temp___1625 0)))

;; "parent'result'unused"
(define-fun parentqtresultqtunused4 () Int
  temp___1625)

;; "infix ='result'unused"
(define-fun infix_eqqtresultqtunused11 () Bool
  (ite (= temp___1625 i) true false))

;; "H"
(assert (= temp___1625 i))
...
;; "temp___compl_1626"
(define-fun temp___compl_1626 () us_rep2
  (us_repqtmk2 t__split_fields6))

;; "__rep'mk'result'unused"
(define-fun us_repqtmkqtresultqtunused109 () us_rep2
  temp___compl_1626)

;; "temp___compl_1631"
(define-fun temp___compl_1631 () Int
  i)

;; "Assert"
(assert (type_invariant temp___old_1629))

;; "temp___1636"
(define-fun temp___1636 () Int
  (peek1 temp___old_1629 temp___compl_1631 1))

;; "H"
(assert (in_range2 temp___1636))
...
;; "peek'result'unused"
(define-fun peekqtresultqtunused8 () Int
  temp___1636)

;; "Ensures"
(assert (in_range4 temp___1636))
...
;; "Assert"
(assert (type_invariant temp___old_1627))
...
(assert
  (not
  (= (rec__tree_model__path_type__k
       (us_split_fields7 (select (model2 temp___old_1627) temp___1636))) true)))
