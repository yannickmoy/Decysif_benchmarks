...
;; "H"
(assert (or (not (= j2 i)) (= d2 0)))

;; "H"
(assert
  (or
    (not (= j2 (parent1 (us_repqtmk2 t__split_fields) i)))
    (not (= d2 (position1 (us_repqtmk2 t__split_fields) i)))))

;; "H"
(assert (or (not (= j2 (peek1 (us_repqtmk2 t__split_fields) i 1))) (= d2 1)))

;; "H"
(assert
  (= (rec__tree_model__path_type__k
       (us_split_fields7 (select (model2 (us_repqtmk2 t__split_fields6)) j2))) true))

;; Goal "def'vc"
;; File "search_trees.ads", line 121, characters 0-0
(assert
  (not
  (= (peek1 (us_repqtmk2 t__split_fields6) j2 d2) (peek1
                                                    (us_repqtmk2
                                                      t__split_fields)
                                                    j2
                                                    d2))))
