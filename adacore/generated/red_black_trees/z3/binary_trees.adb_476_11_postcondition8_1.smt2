...
(declare-const temp___2822 Int)

;; "H"
(assert (= temp___2822 r225b))
...
;; "H"
(assert (= int__contentqtresultqtunused34 r))

(declare-const o82 Bool)

;; "H"
(assert (= o82 (ite (<= r temp___2822) true false)))
...
;; "H"
(assert (= int__contentqtresultqtunused35 r))

(declare-const o83 Bool)

;; "H"
(assert (= o83 (ite (<= 1 r) true false)))
...
;; "H"
(assert (= o84 (and o83 o82)))

(declare-const andbqtresultqtunused6 Bool)

;; "H"
(assert (= andbqtresultqtunused6 o84))
...
(declare-const o89 position_type)
        ...
        (and
          ...
          (and
            ...
            (and
              ...
              (and
                (= temp___2828 (rec__binary_trees__forest__c
                                 f_old__split_fields))
                (and
                  (= rec__binary_trees__forest__cqtresultqtunused6 temp___2828)
                  (and
                    (= int__contentqtresultqtunused38 r)
                    (and
                      (= o87 (select temp___2828 r))
                      (and
                        (= getqtresultqtunused21 o87)
                        (and
                          (= o88 (us_split_fields1 o87))
                          (and
                            (= us_split_fieldsqtresultqtunused29 o88)
                            (and
                              (= o89 (rec__binary_trees__cell__position o88))
                              (and
                                ...
                                (and
                                  (= (to_rep1 o89) o90)
                                  (and
                                    (= to_repqtresultqtunused7 o90)
                                    (and
                                      (= o91 (ite (= o90 2) true false))
                                      (and
        ...
        (and
          (and
            ...
            (and
              (= pqtunused usf3)
              (and
                (= int__contentqtresultqtunused37 r)
                (and
                  (= o85 (ite (<= usf3 r) true false))
                  (and
                    (= infix_lseqqtresultqtunused14 o85)
                    (and
                      (= o86 (ite (<= 1 usf3) true false))
                      (and
                        (= infix_lseqqtresultqtunused15 o86)
                        (= andbqtresultqtunused7 (and o86 o85)))))))))
          (and
              ...
              (and
                ...
                (and
                  ...
                  (and
                    (and (<= 1 r1) (<= r1 r225b))
                    (and
                      (= int__contentqtresultqtunused36 r1)
                      (and
                        (= infix_eqqtresultqtunused6 (ite (= r1 temp___2822)
                                                       true
                                                       false))
                        (= r1 temp___2822)))))))))))))
