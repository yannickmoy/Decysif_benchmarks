...
;; "LoopInvariant"
(assert
  (= (size (rec__red_black_trees__rbt__struct t__split_fields2)) temp___loop_entry_848))

;; "LoopInvariant"
(assert
  (= (root (rec__red_black_trees__rbt__struct t__split_fields2)) temp___loop_entry_846))
...
;; "LoopInvariant"
(assert (= (color (us_repqtmk3 t__split_fields2) x1) 1))
...
(assert
  ...
  (= (color
       (us_repqtmk3 t__split_fields2)
       (root (rec__red_black_trees__rbt__struct t__split_fields2))) 0)))
