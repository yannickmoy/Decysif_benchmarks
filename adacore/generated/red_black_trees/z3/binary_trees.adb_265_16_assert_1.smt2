...
;; "H"
(assert
  (= (rec__tree_model__path_type__k (us_split_fields5 (select r4 k))) true))
...
(assert
  ...
  (not
    (= (olt
         (rec__tree_model__path_type__a (us_split_fields5 (select r4 j3)))
         (rec__tree_model__path_type__a (us_split_fields5 (select r4 k)))) true))))
