...
(assert
  (= (get
       (rec__tree_model__path_type__a
         (us_split_fields7 (select (model1 o44 x1) (peek o44 x1 1))))
       (+ (last
            (rec__tree_model__path_type__a
              (us_split_fields7 (select (model1 o44 x1) x1)))) 1)) 1))
...
;; "temp___2118"
(define-fun temp___2118 () (Array Int us_rep4)
  (model1 o46 x1))

;; "H"
(assert (dynamic_invariant temp___2118 true false true true))

;; "H"
(assert
  (= (rec__tree_model__path_type__k
       (us_split_fields7 (select temp___2118 x1))) true))

;; "H"
(assert
  (= (last
       (rec__tree_model__path_type__a
         (us_split_fields7 (select temp___2118 x1)))) 0))
    ...
    (=>
      ...
      (=>
        ...
        (ite (and
               (not (= (parent o46 i1) 0))
               (= (rec__tree_model__path_type__k
                    (us_split_fields7 (select temp___2118 (parent o46 i1)))) true))
          (= (rec__tree_model__path_type__k
               (us_split_fields7 (select temp___2118 i1))) true)
          (not
            (= (rec__tree_model__path_type__k
                 (us_split_fields7 (select temp___2118 i1))) true)))))))
  ...
  (forall ((i1 Int))
    (=>
      ...
      (ite (and
        ...
        (= (is_add
             (rec__tree_model__path_type__a
               (us_split_fields7 (select temp___2118 (parent o46 i1))))
             (position o46 i1)
             (rec__tree_model__path_type__a
               (us_split_fields7 (select temp___2118 i1)))) true)
        (= (last
             (rec__tree_model__path_type__a
               (us_split_fields7 (select temp___2118 i1)))) 0)))))
        ...
        (forall ((j2 Int))
          (=>
            ...
            (=>
              (and
                (= (rec__tree_model__path_type__k
                     (us_split_fields7 (select temp___2118 j2))) true)
                (= (oeq
                     (rec__tree_model__path_type__a
                       (us_split_fields7 (select temp___2118 i1)))
                     (rec__tree_model__path_type__a
                       (us_split_fields7 (select temp___2118 j2)))) true))
              (= j2 i1))))))))
...
;; "__split_fields'result'unused"
(define-fun us_split_fieldsqtresultqtunused48 () us_split_fields6
  o48)
...
;; "H"
(assert (= (correct_place o50 o49 x1 y1 o45) true))
...
;; "__split_fields__content'result'unused"
(define-fun us_split_fields__contentqtresultqtunused89 () us_split_fields2
  dummy_4__split_fields1)

;; "o"
(define-fun o52 () us_rep1
  (us_repqtmk1 dummy_4__split_fields1))
...
;; "H"
(assert (= (ordered_leafs o53 x1 o51) true))
...
(declare-const o55 extended_index_type)
...
(declare-const us_split_fields__contentqtresultqtunused93 us_split_fields2)

(declare-const us_repqtmkqtresultqtunused98 us_rep1)
...
(declare-const rec__search_trees__search_tree__structqtresultqtunused20 us_rep1)
...
(assert
  (=>
    (= spark__branch1 true)
    (and
      (= us_split_fields__contentqtresultqtunused91 t__split_fields5)
      (and
        (= us_repqtmkqtresultqtunused96 (us_repqtmk2 t__split_fields5))
        (and
          (= us_split_fieldsqtresultqtunused51 t__split_fields5)
          (and
            (= o54 (rec__search_trees__search_tree__values t__split_fields5))
            (and
              (= rec__search_trees__search_tree__valuesqtresultqtunused7 
              o54)
              (and
                (= us_split_fields__contentqtresultqtunused92 t__split_fields5)
                (and
                  (= us_repqtmkqtresultqtunused97 (us_repqtmk2
                                                    t__split_fields5))
                  (and
                    (= us_split_fieldsqtresultqtunused52 t__split_fields5)
                    (and
                      (= o55 (rec__search_trees__search_tree__root
                               t__split_fields5))
                      (and
                        ...
                        (and
                          (= (to_rep1 o55) o56)
                          (and
                            (= to_repqtresultqtunused2 o56)
                            (and
                              (in_range4 o56)
                              (and
                                (= range_check_qtresultqtunused5 o56)
                                (and
                                  (= us_split_fields__contentqtresultqtunused93 
                                  dummy_4__split_fields1)
                                  (and
                                    (= us_repqtmkqtresultqtunused98 (us_repqtmk1
                                                                    dummy_4__split_fields1))
                                    (and
                                      ...
                                      (and
                                        ...
                                        (and
                                          ...
                                          t__split_fields5)
                                          (and
                                            (= o57 (rec__search_trees__search_tree__struct
                                                     t__split_fields5))
                                            (and
                                              (= rec__search_trees__search_tree__structqtresultqtunused20 
                                              o57)
                                              (= (ordered_leafs o57 o56 o54) true))))))))))))))))))))))))
...
(declare-const us_split_fieldsqtresultqtunused54 us_split_fields4)

(declare-const o60 (Array Int natural))
...
(declare-const rec__search_trees__search_tree__structqtresultqtunused21 us_rep1)

(declare-const ordered_leafsqtresultqtunused Bool)

;; "H"
(assert
  (ite (not (= is_root true))
    (and
      (= us_split_fields__contentqtresultqtunused95 t__split_fields5)
      (and
        (= us_repqtmkqtresultqtunused100 (us_repqtmk2 t__split_fields5))
        (and
          (= us_split_fieldsqtresultqtunused54 t__split_fields5)
          (and
            (= o60 (rec__search_trees__search_tree__values t__split_fields5))
            (and
              (= rec__search_trees__search_tree__valuesqtresultqtunused8 
              o60)
              (and
                (= us_split_fields__contentqtresultqtunused96 t__split_fields5)
                (and
                  (= us_repqtmkqtresultqtunused101 (us_repqtmk2
                                                     t__split_fields5))
                  (and
                    (= us_split_fieldsqtresultqtunused55 t__split_fields5)
                    (and
                      (= o61 (rec__search_trees__search_tree__root
                               t__split_fields5))
                      (and
                        ...
                        (and
                          (= (to_rep1 o61) o62)
                          (and
                            (= to_repqtresultqtunused3 o62)
                            (and
                              (in_range4 o62)
                              (and
                                (= range_check_qtresultqtunused6 o62)
                                (and
                                  ...
                                  (and
                                    ...
                                    (and
                                      ...
                                      t__split_fields5)
                                      (and
                                        (= o63 (rec__search_trees__search_tree__struct
                                                 t__split_fields5))
                                        (and
                                          (= rec__search_trees__search_tree__structqtresultqtunused21 
                                          o63)
                                          (and
                                            (= o59 (ordered_leafs
                                                     o63
                                                        ...
                                                        (=>
                                                          ...
                                                          (=>
                                                            ...
                                                            (= (ordered_prefix
                                                                 ...
                                                                 i1
                                                                 j2) true)))))))
                                                (in_range (ite o59 1 0)))
                                              (= ordered_leafsqtresultqtunused 
                                              o59))))))))))))))))))))))
    (and (= o59 (distinct 1 0)) (= of_intqtresultqtunused o59))))
...
(declare-const o64 (Array Int natural))

(declare-const rec__search_trees__search_tree__valuesqtresultqtunused9 (Array Int natural))
...
(declare-const rec__search_trees__search_tree__structqtresultqtunused22 us_rep1)

(declare-const ordered_leafsqtresultqtunused1 Bool)

;; "H"
(assert
  (ite (= o59 true)
    (and
      (= us_split_fields__contentqtresultqtunused98 t__split_fields5)
      (and
        (= us_repqtmkqtresultqtunused103 (us_repqtmk2 t__split_fields5))
        (and
          (= us_split_fieldsqtresultqtunused57 t__split_fields5)
          (and
            (= o64 (rec__search_trees__search_tree__values t__split_fields5))
            (and
              (= rec__search_trees__search_tree__valuesqtresultqtunused9 
              o64)
              (and
                (= int__contentqtresultqtunused25 x1)
                (and
                  (= us_split_fields__contentqtresultqtunused99 t__split_fields5)
                  (and
                    (= us_repqtmkqtresultqtunused104 (us_repqtmk2
                                                       t__split_fields5))
                    (and
                      (= us_split_fieldsqtresultqtunused58 t__split_fields5)
                      (and
                        (= o65 (rec__search_trees__search_tree__struct
                                 t__split_fields5))
                        (and
                          (= rec__search_trees__search_tree__structqtresultqtunused22 
                          o65)
                          (and
                            (= o58 (ordered_leafs o65 x1 o64))
                            (and
                              (and
                                (=
                                  (= o58 true)
                                        ...
                                        (=>
                                          ...
                                          (=>
                                            ...
                                            (= (ordered_prefix
                                                 ...
                                                 i1
                                                 j2) true)))))))
                                (in_range (ite o58 1 0)))
                              (= ordered_leafsqtresultqtunused1 o58))))))))))))))
    (= o58 false)))
...
;; "__rep'mk'result'unused"
(define-fun us_repqtmkqtresultqtunused105 () us_rep2
  (us_repqtmk2 t__split_fields5))
...
;; "o"
(define-fun o66 () extended_index_type
...
;; "__split_fields__content'result'unused"
(define-fun us_split_fields__contentqtresultqtunused101 () us_split_fields2
  dummy_1__split_fields1)

;; "o"
(define-fun o68 () us_rep1
  (us_repqtmk1 dummy_1__split_fields1))
...
;; "o"
(define-fun o69 () (Array Int us_rep4)
  (model1 o68 o67))

;; "H"
(assert (dynamic_invariant o69 true false true true))

;; "H"
(assert
  (= (rec__tree_model__path_type__k (us_split_fields7 (select o69 o67))) true))

;; "H"
(assert
  (= (last
       (rec__tree_model__path_type__a (us_split_fields7 (select o69 o67)))) 0))
    ...
    (=>
      ...
      (=>
        ...
        (ite (and
               (not (= (parent o68 i1) 0))
               (= (rec__tree_model__path_type__k
                    (us_split_fields7 (select o69 (parent o68 i1)))) true))
          (= (rec__tree_model__path_type__k
               (us_split_fields7 (select o69 i1))) true)
          (not
            (= (rec__tree_model__path_type__k
                 (us_split_fields7 (select o69 i1))) true)))))))
  ...
  (forall ((i1 Int))
    (=>
      ...
      (ite (and
        ...
        (= (is_add
             (rec__tree_model__path_type__a
               (us_split_fields7 (select o69 (parent o68 i1))))
             (position o68 i1)
             (rec__tree_model__path_type__a
               (us_split_fields7 (select o69 i1)))) true)
        (= (last
             (rec__tree_model__path_type__a
               (us_split_fields7 (select o69 i1)))) 0)))))
...
(assert
  (forall ((i1 Int))
    (=>
      (and (<= 1 i1) (<= i1 100))
      (=>
        (= (rec__tree_model__path_type__k (us_split_fields7 (select o69 i1))) true)
        (forall ((j2 Int))
          (=>
            (and (<= 1 j2) (<= j2 100))
            (=>
              (and
                (= (rec__tree_model__path_type__k
                     (us_split_fields7 (select o69 j2))) true)
                (= (oeq
                     (rec__tree_model__path_type__a
                       (us_split_fields7 (select o69 i1)))
                     (rec__tree_model__path_type__a
                       (us_split_fields7 (select o69 j2)))) true))
              (= j2 i1))))))))
...
;; "__split_fields__content'result'unused"
(define-fun us_split_fields__contentqtresultqtunused103 () us_split_fields4
  t__split_fields5)
...
;; "rec__search_trees__search_tree__struct'result'unused"
(define-fun rec__search_trees__search_tree__structqtresultqtunused23 
  () us_rep1
  o72)
