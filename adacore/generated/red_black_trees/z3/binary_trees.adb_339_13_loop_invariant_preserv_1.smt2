    ...
    (=>
      ...
      (=>
        (and
          ...
          (< (last
               (rec__tree_model__path_type__a
                 (us_split_fields5 (select (model1 f1 root) i)))) n1))
        (= (rec__tree_model__path_type__k
             (us_split_fields5 (select (model1 f2 root) i))) true)))))
    ...
    (=>
      ...
      (=>
        (and
          ...
          (< (last
               (rec__tree_model__path_type__a
                 (us_split_fields5 (select (model1 f2 root) i)))) n1))
        (= (rec__tree_model__path_type__k
             (us_split_fields5 (select (model1 f1 root) i))) true)))))
    ...
    (=>
      ...
      (=>
        (and
          ...
          (< (last
               (rec__tree_model__path_type__a
                 (us_split_fields5 (select (model1 f1 root) i)))) n2))
        (= (rec__tree_model__path_type__k
             (us_split_fields5 (select (model1 f2 root) i))) true)))))
...
(assert
  (< (last
       (rec__tree_model__path_type__a
         (us_split_fields5 (select (model1 f2 root) i)))) n2))
