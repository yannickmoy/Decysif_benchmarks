...
;; "H"
(assert (= temp___3020 (model1 o53 o52)))
...
(assert
  (= (rec__tree_model__path_type__k
       (us_split_fields5 (select temp___3020 o52))) true))

;; "H"
(assert
  (= (last
       (rec__tree_model__path_type__a
         (us_split_fields5 (select temp___3020 o52)))) 0))
    ...
    (=>
      ...
      (=>
        ...
        (ite (and
               (not (= (parent o53 i2) 0))
               (= (rec__tree_model__path_type__k
                    (us_split_fields5 (select temp___3020 (parent o53 i2)))) true))
          (= (rec__tree_model__path_type__k
  ...
  (forall ((i2 Int))
    (=>
      ...
      (ite (and
        ...
        (= (is_add
             (rec__tree_model__path_type__a
               (us_split_fields5 (select temp___3020 (parent o53 i2))))
             (position o53 i2)
             (rec__tree_model__path_type__a
               (us_split_fields5 (select temp___3020 i2)))) true)
        (= (last
...
;; "H"
(assert (= o54 (select temp___3020 i1)))

(declare-const getqtresultqtunused8 us_rep3)

;; "H"
(assert (= getqtresultqtunused8 o54))
...
;; "H"
(assert (= us_split_fieldsqtresultqtunused8 o55))
...
;; "H"
(assert (= rec__tree_model__path_type__kqtresultqtunused4 o56))
          ...
          (and
              ...
              (and
                (and
                  (and
                    (and
                      (= (rec__tree_model__path_type__k
                           (us_split_fields5 (select temp___3021 o58))) true)
                      (= (last
                           (rec__tree_model__path_type__a
                             (us_split_fields5 (select temp___3021 o58)))) 0))
                    (forall ((i2 Int))
                      (=>
                        (and (<= 1 i2) (<= i2 100))
                        (=>
                          ...
                          (ite (and
                                 ...
                                 (= (rec__tree_model__path_type__k
                                      (us_split_fields5
                                        (select temp___3021 (parent o59 i2)))) true))
                            (= (rec__tree_model__path_type__k
                    ...
                    (=>
                      ...
                      (ite (and
                        ...
                        (= (is_add
                             (rec__tree_model__path_type__a
                               (us_split_fields5
                                 (select temp___3021 (parent o59 i2))))
                             (position o59 i2)
                             (rec__tree_model__path_type__a
                               (us_split_fields5 (select temp___3021 i2)))) true)
                        (= (last
            ...
            (and
              ...
              (and
                ...
                (and
                  (= o60 (select temp___3021 j))
                  (and
                    (= getqtresultqtunused9 o60)
                    (and
                      (= o61 (us_split_fields5 o60))
                      (and
                        (= us_split_fieldsqtresultqtunused9 o61)
                        (and
                          (= o57 (rec__tree_model__path_type__k o61))
...
(assert
  (not (= (ordered_prefix (model1 f root) values i1 j) true)))
