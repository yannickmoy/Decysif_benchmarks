...
;; "temp___2100"
(define-fun temp___2100 () (Array Int us_rep4)
  (model1 o43 y1))

;; "H"
(assert (dynamic_invariant temp___2100 true false true true))

;; "H"
(assert
  (= (rec__tree_model__path_type__k
       (us_split_fields7 (select temp___2100 y1))) true))

;; "H"
(assert
  (= (last
       (rec__tree_model__path_type__a
         (us_split_fields7 (select temp___2100 y1)))) 0))
    ...
    (=>
      ...
      (=>
        ...
        (ite (and
               (not (= (parent o43 i1) 0))
               (= (rec__tree_model__path_type__k
                    (us_split_fields7 (select temp___2100 (parent o43 i1)))) true))
          (= (rec__tree_model__path_type__k
               (us_split_fields7 (select temp___2100 i1))) true)
          (not
            (= (rec__tree_model__path_type__k
                 (us_split_fields7 (select temp___2100 i1))) true)))))))
  ...
  (forall ((i1 Int))
    (=>
      ...
      (ite (and
        ...
        (= (is_add
             (rec__tree_model__path_type__a
               (us_split_fields7 (select temp___2100 (parent o43 i1))))
             (position o43 i1)
             (rec__tree_model__path_type__a
               (us_split_fields7 (select temp___2100 i1)))) true)
        (= (last
             (rec__tree_model__path_type__a
               (us_split_fields7 (select temp___2100 i1)))) 0)))))
        ...
        (forall ((j2 Int))
          (=>
            ...
            (=>
              (and
                (= (rec__tree_model__path_type__k
                     (us_split_fields7 (select temp___2100 j2))) true)
                (= (oeq
                     (rec__tree_model__path_type__a
                       (us_split_fields7 (select temp___2100 i1)))
                     (rec__tree_model__path_type__a
                       (us_split_fields7 (select temp___2100 j2)))) true))
              (= j2 i1))))))))
...
;; "__split_fields__content'result'unused"
(define-fun us_split_fields__contentqtresultqtunused85 () us_split_fields2
  dummy_3__split_fields1)
...
;; "__rep'mk'result'unused"
(define-fun us_repqtmkqtresultqtunused89 () us_rep1
  o47)

;; "H"
(assert (= (correct_place o47 o46 y1 xr1 o42) true))
...
(assert
  (= (rec__tree_model__path_type__k
       (us_split_fields7 (select (model1 o49 xr1) i1))) true))
...
(assert
  (<= (+ (last
           (rec__tree_model__path_type__a
             (us_split_fields7 (select (model1 o50 y1) xr1)))) 1) i2))
...
(assert
  ...
  (= (get
       (rec__tree_model__path_type__a
         (us_split_fields7 (select (model1 o49 xr1) i1)))
       (- i2 (last
               (rec__tree_model__path_type__a
                 (us_split_fields7 (select (model1 o50 y1) xr1)))))) 
  (get
    (rec__tree_model__path_type__a
      (us_split_fields7 (select (model1 o50 y1) i1)))
    i2))))
