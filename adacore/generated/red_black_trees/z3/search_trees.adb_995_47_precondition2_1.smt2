...
;; "any'result'unused"
(define-fun anyqtresultqtunused1 () Int
  usf1)

;; "c'unused"
(define-fun cqtunused () Int
  usf1)

;; "o"
(define-fun o58 () Bool
  (ite (<= usf1 1) true false))
...
(declare-const temp___compl_1499 us_rep2)

;; "H"
(assert (= temp___compl_1499 (us_repqtmk2 t__split_fields6)))

(declare-const us_repqtmkqtresultqtunused93 us_rep2)

;; "H"
(assert (= us_repqtmkqtresultqtunused93 temp___compl_1499))
...
;; "H"
(assert (= temp___1500 (us_repqtmk2 t__split_fields6)))

(declare-const us_repqtmkqtresultqtunused94 us_rep2)

;; "H"
(assert (= us_repqtmkqtresultqtunused94 temp___1500))

;; "Assert"
(assert (type_invariant temp___1500))

(declare-const temp___1503 Int)

;; "H"
(assert (= temp___1503 (size temp___compl_1499)))

;; "H"
(assert (in_range2 temp___1503))
...
;; "H"
(assert (= sizeqtresultqtunused1 temp___1503))

(declare-const infix_eqqtresultqtunused1 Bool)

;; "H"
(assert (= infix_eqqtresultqtunused1 (ite (= temp___1503 0) true false)))

(declare-const o62 Bool)

(declare-const us_split_fields__contentqtresultqtunused88 us_split_fields4)

(declare-const temp___compl_1504 us_rep2)
...
(declare-const temp___1505 us_rep2)

(declare-const us_repqtmkqtresultqtunused96 us_rep2)

(declare-const temp___1508 (Array Int us_rep4))

(declare-const modelqtresultqtunused (Array Int us_rep4))

(declare-const o63 us_rep4)

(declare-const getqtresultqtunused us_rep4)
...
;; "H"
(assert
  (ite (not (= temp___1503 0))
    (and
      (= us_split_fields__contentqtresultqtunused88 t__split_fields6)
      (and
        (= temp___compl_1504 (us_repqtmk2 t__split_fields6))
        (and
          (= us_repqtmkqtresultqtunused95 temp___compl_1504)
          (and
            (= us_split_fields__contentqtresultqtunused89 t__split_fields6)
            (and
              (= temp___1505 (us_repqtmk2 t__split_fields6))
              (and
                (= us_repqtmkqtresultqtunused96 temp___1505)
                (and
                  (type_invariant temp___1505)
                  (and
                    (= temp___1508 (model2 temp___compl_1504))
                    (and
                      (and
                        (dynamic_invariant temp___1508 true false true true)
                        (= temp___1508 (model1
                                         (rec__search_trees__search_tree__struct
                                           t__split_fields6)
                                         (to_rep1
                                           (rec__search_trees__search_tree__root
                                             t__split_fields6)))))
                      (and
                        (= modelqtresultqtunused temp___1508)
                        (and
                          (= o63 (select temp___1508 usf))
                          (and
                            (= getqtresultqtunused o63)
                            (and
                              (= o64 (us_split_fields7 o63))
                              (and
                                (= us_split_fieldsqtresultqtunused45 
                                o64)
                                (and
                                  (= o62 (rec__tree_model__path_type__k o64))
...
(assert
  (ite (= o62 true)
    (and
      (= int__contentqtresultqtunused21 j1)
      (and
        (= infix_eqqtresultqtunused2 (ite (= usf j1) true false))
        (ite (not (= usf j1))
          (= o65 true)
          (and
            (= int__contentqtresultqtunused22 d1)
            (and
              (= infix_eqqtresultqtunused3 (ite (= d1 usf1) true false))
              (= o65 (ite (= d1 usf1) false true)))))))
    (= o65 false)))
...
(assert
  (ite (= o65 true)
    (and
      (= int__contentqtresultqtunused23 x1)
      (and
        (= infix_eqqtresultqtunused4 (ite (= usf x1) true false))
        (ite (not (= usf x1))
          (= o66 true)
          (and
            (= infix_eqqtresultqtunused5 (ite (= usf1 1) true false))
            (= o66 (ite (= usf1 1) false true))))))
    (= o66 false)))
...
(assert
  (ite (= o66 true)
    (and
      (= int__contentqtresultqtunused24 y1)
      (and
        (= infix_eqqtresultqtunused6 (ite (= usf y1) true false))
        (ite (not (= usf y1))
          (= o61 true)
          (and
            (= infix_eqqtresultqtunused7 (ite (= usf1 0) true false))
            (= o61 (ite (= usf1 0) false true))))))
    (= o61 false)))
...
;; "temp___compl_1492"
(define-fun temp___compl_1492 () us_rep2
  (us_repqtmk2 t_old__split_fields))
...
;; "temp___1495"
(define-fun temp___1495 () us_rep2
  (us_repqtmk2 t_old__split_fields))
...
;; "Assert"
(assert (type_invariant temp___1495))
...
(assert
  (not
  (= (rec__tree_model__path_type__k
       (us_split_fields7 (select (model2 temp___compl_1492) usf))) true)))
