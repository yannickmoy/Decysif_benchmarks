                                                ...
                                                (and
                                                  ...
                                                  (and
                                                    ...
                                                    (and
                                                      ...
                                                      o58))))))))))))))))))))))))
        (and (= o58 (distinct 1 0)) (= of_intqtresultqtunused o58))))
    (= o58 false)))
...
;; "temp___compl_2343"
(define-fun temp___compl_2343 () Int
  i)

;; "Assert"
(assert (type_invariant temp___old_2341))

;; "temp___2348"
(define-fun temp___2348 () Int
  (peek1 temp___old_2341 temp___compl_2343 0))

;; "H"
(assert (in_range2 temp___2348))
...
;; "Assert"
(assert (type_invariant temp___old_2339))

;; "temp___2354"
(define-fun temp___2354 () Int
  (peek1 temp___old_2339 temp___2348 1))

;; "H"
(assert (in_range2 temp___2354))
...
(define-fun infix_eqqtresultqtunused10 () Bool
  (ite (= temp___2354 0) true false))

;; "H"
(assert (not (= temp___2354 0)))

;; "__split_fields__content'result'unused"
(define-fun us_split_fields__contentqtresultqtunused106 () us_split_fields4
  t__split_fields6)

;; "temp___compl_2295"
(define-fun temp___compl_2295 () us_rep2
  (us_repqtmk2 t__split_fields6))

;; "__rep'mk'result'unused"
(define-fun us_repqtmkqtresultqtunused113 () us_rep2
  temp___compl_2295)

;; "temp___compl_2300"
(define-fun temp___compl_2300 () Int
  i)

;; "Assert"
(assert (type_invariant temp___old_2298))

;; "temp___2305"
(define-fun temp___2305 () Int
  (peek1 temp___old_2298 temp___compl_2300 0))

;; "H"
(assert (in_range2 temp___2305))
...
;; "Assert"
(assert (type_invariant temp___old_2296))

;; "temp___2311"
(define-fun temp___2311 () Int
  (peek1 temp___old_2296 temp___2305 1))

;; "H"
(assert (in_range2 temp___2311))
...
;; "__split_fields__content'result'unused"
(define-fun us_split_fields__contentqtresultqtunused107 () us_split_fields4
  t__split_fields6)

;; "temp___2313"
(define-fun temp___2313 () us_rep2
  (us_repqtmk2 t__split_fields6))

;; "__rep'mk'result'unused"
(define-fun us_repqtmkqtresultqtunused114 () us_rep2
  temp___2313)

;; "Assert"
(assert (type_invariant temp___2313))

;; "temp___2316"
(define-fun temp___2316 () Int
  (parent1 temp___compl_2295 temp___2311))

;; "H"
(assert (in_range2 temp___2316))
...
;; "H"
(assert (=> (= (size temp___compl_2295) 0) (= temp___2316 0)))
...
(define-fun infix_eqqtresultqtunused11 () Bool
  (ite (= temp___2316 i) true false))

;; "H"
(assert (= temp___2316 i))

;; "__split_fields__content'result'unused"
(define-fun us_split_fields__contentqtresultqtunused108 () us_split_fields4
  t__split_fields6)

;; "temp___compl_2317"
(define-fun temp___compl_2317 () us_rep2
  (us_repqtmk2 t__split_fields6))

;; "__rep'mk'result'unused"
(define-fun us_repqtmkqtresultqtunused115 () us_rep2
  temp___compl_2317)

;; "temp___compl_2322"
(define-fun temp___compl_2322 () Int
  i)

;; "Assert"
(assert (type_invariant temp___old_2320))

;; "temp___2327"
(define-fun temp___2327 () Int
  (peek1 temp___old_2320 temp___compl_2322 0))

;; "H"
(assert (in_range2 temp___2327))
...
;; "Assert"
(assert (type_invariant temp___old_2318))
...
(assert
  (not
  (= (rec__tree_model__path_type__k
       (us_split_fields7 (select (model2 temp___old_2318) temp___2327))) true)))
