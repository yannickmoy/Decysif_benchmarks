...
;; "H"
(assert (= int__contentqtresultqtunused19 j2))

(declare-const o43 Bool)

;; "H"
(assert (= o43 (ite (<= j2 100) true false)))

(declare-const infix_lseqqtresultqtunused16 Bool)

;; "H"
(assert (= infix_lseqqtresultqtunused16 o43))
...
;; "H"
(assert (= o44 (ite (<= 1 j2) true false)))

(declare-const infix_lseqqtresultqtunused17 Bool)

;; "H"
(assert (= infix_lseqqtresultqtunused17 o44))

(declare-const o45 Bool)

;; "H"
(assert (= o45 (and o44 o43)))

(declare-const andbqtresultqtunused8 Bool)

;; "H"
(assert (= andbqtresultqtunused8 o45))
      ...
      (and
        (and
          (and
            (and
              ...
              (and
                (= o61 f)
                (and
                  (= temp___2874 (model1 o61 o60))
                  (and
                    (and
                      (dynamic_invariant temp___2874 true false true true)
                      (and
                        (and
                          (and
                            (and
                              (= (rec__tree_model__path_type__k
                                   (us_split_fields5
                                     (select temp___2874 o60))) true)
                              (= (last
                                   (rec__tree_model__path_type__a
                                     (us_split_fields5
                                       (select temp___2874 o60)))) 0))
                            (forall ((i6 Int))
                              (=>
                                (and (<= 1 i6) (<= i6 100))
                                (=>
                                  ...
                                  (ite (and
                                         ...
                                         (= (rec__tree_model__path_type__k
                                              (us_split_fields5
                                                (select temp___2874 (parent
                                                                    o61
                                                                    i6)))) true))
                                    (= (rec__tree_model__path_type__k
                                         (us_split_fields5
                                           (select temp___2874 i6))) true)
                                    (not
                                      (= (rec__tree_model__path_type__k
                                           (us_split_fields5
                                             (select temp___2874 i6))) true)))))))
                            ...
                            (=>
                              ...
                              (ite (and
                                ...
                                (= (is_add
                                     (rec__tree_model__path_type__a
                                       (us_split_fields5
                                         (select temp___2874 (parent o61 i6))))
                                     (position o61 i6)
                                     (rec__tree_model__path_type__a
                                       (us_split_fields5
                                         (select temp___2874 i6)))) true)
                                ...
                                (=>
                                  ...
                                  (=>
                                    (and
                                      (= (rec__tree_model__path_type__k
                                           (us_split_fields5
                                             (select temp___2874 j4))) true)
                                      (= (oeq
                                           (rec__tree_model__path_type__a
                                             (us_split_fields5
                                               (select temp___2874 i6)))
                                           (rec__tree_model__path_type__a
                                             (us_split_fields5
                                               (select temp___2874 j4)))) true))
                                    (= j4 i6)))))))))
                    (and
                      (= modelqtresultqtunused6 temp___2874)
                      (and
                        (= int__contentqtresultqtunused25 i5)
                        (and
                          (= o62 (select temp___2874 i5))
                          (and
                            (= getqtresultqtunused6 o62)
                            (and
                              (= o63 (us_split_fields5 o62))
                              (and
                                (= us_split_fieldsqtresultqtunused6 o63)
                                (and
                                  (= o64 (rec__tree_model__path_type__k o63))
                                  (and
                                            ...
                                            (and
                                              ...
                                              (and
                                                ...
                                                (and
                                                  ...
                                                  j2)
                                                  (and
                                                    (= o67 (select temp___2875 
                                                    j2))
                                                    (and
                                                      (= getqtresultqtunused7 
                                                      o67)
                                                      (and
                                                        (= o68 (us_split_fields5
                                                                 o67))
                                                        (and
                                                          (= us_split_fieldsqtresultqtunused7 
                                                          o68)
                                                          (and
                                                            (= o49 (rec__tree_model__path_type__k
                                                                    o68))
                          ...
                          (and
                            (and
                              (and
                                (= (rec__tree_model__path_type__k
                                     (us_split_fields5
                                       (select temp___2877 o50))) true)
                                (= (last
                                     (rec__tree_model__path_type__a
                                       (us_split_fields5
                                         (select temp___2877 o50)))) 0))
                              (forall ((i6 Int))
                                (=>
                                  (and (<= 1 i6) (<= i6 100))
                                  (=>
                                ...
                                (forall ((j4 Int))
                                  (=>
                                    ...
                                    (=>
                                      ...
                                      (= j4 i6)))))))))
                      (and
                        (= modelqtresultqtunused4 temp___2877)
                        (and
                          (= int__contentqtresultqtunused23 j2)
                          (and
                            (= o52 (select temp___2877 j2))
                            (and
                              (= getqtresultqtunused4 o52)
                              (and
                                (= o53 (us_split_fields5 o52))
                                (and
                                  (= us_split_fieldsqtresultqtunused4 
                                  o53)
                                  (and
                                    (= o54 (rec__tree_model__path_type__a
                                             o53))
                                    (and
                                            ...
                                            (and
                                              ...
                                              (and
                                                ...
                                                (and
                                                  ...
                                                  i5)
                                                  (and
                                                    (= o57 (select temp___2876 
                                                    i5))
                                                    (and
                                                      (= getqtresultqtunused5 
                                                      o57)
                                                      (and
                                                        (= o58 (us_split_fields5
                                                                 o57))
                                                        (and
                                                          (= us_split_fieldsqtresultqtunused5 
                                                          o58)
                                                          (and
                                                            (= o59 (rec__tree_model__path_type__a
                                                                    o58))
                                                            (and
          ...
          (and
            (= spark__branch4 o48)
            (and
              (= bool__contentqtresultqtunused1 spark__branch4)
              (=>
                (= spark__branch4 true)
                (and
                  (= (olt
        ...
        (and
          (and
            (= anyqtresultqtunused9 usf4)
            (and
              (= kqtunused4 usf4)
              (and
                (= int__contentqtresultqtunused22 j2)
                (and
                  (= o46 (ite (<= usf4 j2) true false))
                  (and
                    (= infix_lseqqtresultqtunused18 o46)
                    (and
                      (= o47 (ite (<= 1 usf4) true false))
                      (and
                        (= infix_lseqqtresultqtunused19 o47)
                        (= andbqtresultqtunused9 (and o47 o46)))))))))
          (and
            (= usfqtunused4 (ite (forall ((k Int))
                                   (=>
                                     (and (<= 1 k) (<= k j2))
                                     (=>
                                       (and
                              ...
                              false))
            (and
              (= anyqtresultqtunused8 (ite (forall ((k Int))
                                             (=>
                                               (and (<= 1 k) (<= k j2))
                                               (=>
                                                 (and
              ...
              (and
                ...
                (and
                  ...
                  (and
                    (and (<= 1 j3) (<= j3 100))
                    (and
                      (= int__contentqtresultqtunused21 j3)
                      (and
                        (= infix_eqqtresultqtunused3 (ite (= j3 100)
                                                       true
                                                       false))
                        (= j3 100)))))))))))))
...
;; "H"
(assert (= int__contentqtresultqtunused29 i6))
...
;; "H"
(assert (= infix_mnqtresultqtunused2 o70))

(declare-const o71 Bool)

;; "H"
(assert (= o71 (ite (<= usf5 o70) true false)))

(declare-const infix_lseqqtresultqtunused20 Bool)

;; "H"
(assert (= infix_lseqqtresultqtunused20 o71))

(declare-const o72 Bool)

;; "H"
(assert (= o72 (ite (<= 1 usf5) true false)))

(declare-const infix_lseqqtresultqtunused21 Bool)

;; "H"
(assert (= infix_lseqqtresultqtunused21 o72))

(declare-const andbqtresultqtunused10 Bool)

;; "H"
(assert (= andbqtresultqtunused10 (and o72 o71)))
                 ...
                 (and
                   (and
                     (= (rec__tree_model__path_type__k
                          (us_split_fields5 (select (model1 f v) k))) true)
                     (= (rec__tree_model__path_type__k
                          (us_split_fields5 (select (model1 f v) j4))) true))
                   (= (olt
                        (rec__tree_model__path_type__a
                          (us_split_fields5 (select (model1 f v) k)))
                        (rec__tree_model__path_type__a
                          (us_split_fields5 (select (model1 f v) j4)))) true))
                 (= (ordered_prefix (model1 f v) values k j4) true))))))
    true
    false))
...
(assert
  (not (= (ordered_prefix (model1 f v) values k j4) true)))
