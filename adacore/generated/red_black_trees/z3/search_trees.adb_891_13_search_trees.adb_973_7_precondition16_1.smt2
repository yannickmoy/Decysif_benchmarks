...
(assert
  (= (rec__tree_model__path_type__k
       (us_split_fields7 (select (model1 o49 x1) i1))) true))
...
(assert
  (<= (+ (last
           (rec__tree_model__path_type__a
             (us_split_fields7 (select (model1 o50 y1) x1)))) 1) i2))
...
(assert
  ...
  (= (get
       (rec__tree_model__path_type__a
         (us_split_fields7 (select (model1 o49 x1) i1)))
       (- i2 (last
               (rec__tree_model__path_type__a
                 (us_split_fields7 (select (model1 o50 y1) x1)))))) (get
                                                                    (rec__tree_model__path_type__a
                                                                    (us_split_fields7
                                                                    (select 
                                                                    (model1
