...
;; "H"
(assert
  (not (= (size (rec__red_black_trees__rbt__struct t__split_fields2)) 0)))
...
(assert
  ...
  (or
    (and
      (not
        (= (size (rec__red_black_trees__rbt__struct t_old__split_fields)) 0))
      (= (rec__tree_model__path_type__k
           (us_split_fields9
             (select (model1
                       (rec__red_black_trees__rbt__struct
    ...
    (and
      (= (rec__red_black_trees__black_count__status
           (us_split_fields11 (select (nb_blacks o10) i))) true)
      (= (to_rep
           (rec__red_black_trees__black_count__count
             (us_split_fields11 (select (nb_blacks o10) i)))) 0)))))
