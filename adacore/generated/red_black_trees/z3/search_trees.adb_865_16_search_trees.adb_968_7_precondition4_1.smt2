...
;; "rec__search_trees__search_tree__values'result'unused"
(define-fun rec__search_trees__search_tree__valuesqtresultqtunused10 
  () (Array Int natural)
  o52)
...
;; "o"
(define-fun o53 () extended_index_type
...
;; "__split_fields__content'result'unused"
(define-fun us_split_fields__contentqtresultqtunused91 () us_split_fields2
  dummy_3__split_fields1)
...
;; "__rep'mk'result'unused"
(define-fun us_repqtmkqtresultqtunused95 () us_rep1
  o55)
...
(assert
  ...
  (= (oeq
       (rec__tree_model__path_type__a
         (us_split_fields7 (select (model1 o55 o54) i1)))
       (rec__tree_model__path_type__a
         (us_split_fields7 (select (model1 o56 o54) i1)))) true)))
