  ...
  (and
    (and
                  ...
                  (=>
                    ...
                    (or
                      ...
                      (and
                        ...
                        (= (to_rep
                             (rec__red_black_trees__black_count__count
                               (us_split_fields11 (select (nb_blacks t) i)))) 0)))))))
            (<= (size
                  (rec__red_black_trees__rbt__struct
                    (us_split_fields7 t_old))) (size
                                                 (rec__red_black_trees__rbt__struct
                                                   (us_split_fields7 t)))))
          (forall ((i Int))
            (=>
            ...
            (=>
              ...
              (= (to_rep3
                   (select (rec__red_black_trees__rbt__color
                             (us_split_fields7 t_old)) i)) (to_rep3
                                                             (select 
      ...
      (=>
        (not
          (= (size
               (rec__red_black_trees__rbt__struct (us_split_fields7 t_old))) 0))
        (= (root (rec__red_black_trees__rbt__struct (us_split_fields7 t))) 
        (root
...
(declare-const o us_split_fields6)

;; "H"
(assert (= o (us_split_fields7 t_old)))
...
;; "H"
(assert (= o1 (rec__red_black_trees__rbt__struct o)))

(declare-const rec__red_black_trees__rbt__structqtresultqtunused us_rep2)

;; "H"
(assert (= rec__red_black_trees__rbt__structqtresultqtunused o1))
...
(assert
  (= o2 (size1
          (rec__search_trees__search_tree__struct (us_split_fields5 o1)))))

(declare-const sizeqtresultqtunused Int)

;; "H"
(assert (= sizeqtresultqtunused o2))

(declare-const o3 Bool)

;; "H"
(assert (= o3 (ite (< 0 o2) true false)))

(declare-const infix_gtqtresultqtunused Bool)

;; "H"
(assert (= infix_gtqtresultqtunused o3))
...
(assert
  (=>
    (= spark__branch true)
    (and
      (= nqtunused (int__refqtmk n))
      (and
        (= n 1)
        (and
          (= int__contentqtresultqtunused n)
          (and
            (= o4 (ite (<= n 100) true false))
            (and
              (= infix_lseqqtresultqtunused o4)
              (and
                (= int__contentqtresultqtunused1 n)
                (and
                  (= o5 (ite (<= 1 n) true false))
                  (and
                    (= infix_lseqqtresultqtunused1 o5)
                    (and
                      (= o6 (and o5 o4))
                      (and
                        (= andbqtresultqtunused o6)
                        (=>
                          (= o6 true)
                          (and
                            (forall ((i Int))
                            ...
                            (and
                              (and
                                ...
                                (and
                                  (= iqtunused usf)
                                  (and
                                    (= o7 (ite (<= usf 100) true false))
                                    (and
                                      (= infix_lseqqtresultqtunused2 
                                      o7)
                                      (and
                                        (= o8 (ite (<= 1 usf) true false))
                                        (and
...
;; Goal "def'vc"
;; File "red_black_trees.adb", line 205, characters 0-0
(assert
  (not (= (same_nb_blacks t) true)))
