...
;; "__rep'mk'result'unused"
(define-fun us_repqtmkqtresultqtunused84 () us_rep1
  o40)
...
(assert
  ...
  (= (oeq
       (rec__tree_model__path_type__a
         (us_split_fields7 (select (model1 o40 o39) i1)))
       (rec__tree_model__path_type__a
         (us_split_fields7 (select (model1 o41 o39) i1)))) true)))
