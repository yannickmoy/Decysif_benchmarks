...
;; "H"
(assert (= jqtunused3 usf))

(declare-const o41 Bool)

;; "H"
(assert (= o41 (ite (<= usf 100) true false)))

(declare-const infix_lseqqtresultqtunused Bool)

;; "H"
(assert (= infix_lseqqtresultqtunused o41))

(declare-const o42 Bool)

;; "H"
(assert (= o42 (ite (<= 1 usf) true false)))

(declare-const infix_lseqqtresultqtunused1 Bool)

;; "H"
(assert (= infix_lseqqtresultqtunused1 o42))

(declare-const andbqtresultqtunused Bool)

;; "H"
(assert (= andbqtresultqtunused (and o42 o41)))
...
;; "H"
(assert (= jqtunused4 usf1))

(declare-const o43 Bool)

;; "H"
(assert (= o43 (ite (<= usf1 100) true false)))

(declare-const infix_lseqqtresultqtunused2 Bool)

;; "H"
(assert (= infix_lseqqtresultqtunused2 o43))
...
;; "H"
(assert (= infix_lseqqtresultqtunused3 o44))

(declare-const andbqtresultqtunused1 Bool)

;; "H"
(assert (= andbqtresultqtunused1 (and o44 o43)))
...
;; "o"
(define-fun o45 () us_rep3
  (select r4 root))

;; "get'result'unused"
(define-fun getqtresultqtunused7 () us_rep3
  o45)

;; "o"
(define-fun o46 () us_split_fields4
  (us_split_fields5 o45))
...
(define-fun o47 () us_rep2
  (rec__tree_model__path_type__a o46))
...
;; "H"
(assert (dynamic_invariant o48 true false true true))

;; "H"
(assert (= o48 (- (+ (last o47) 1) 1)))
...
;; "o"
(define-fun o50 () Bool
  (ite (= temp___900 temp___905) true false))
...
;; "map__content'result'unused"
(define-fun map__contentqtresultqtunused16 () (Array Int us_rep3)
  r4)
...
;; "o"
(define-fun o53 () Bool
  (rec__tree_model__path_type__k o52))
...
;; "H"
(assert (= jqtunused5 usf2))

(declare-const o54 Bool)

;; "H"
(assert (= o54 (ite (<= usf2 100) true false)))
...
;; "H"
(assert (= o55 (ite (<= 1 usf2) true false)))

(declare-const infix_lseqqtresultqtunused5 Bool)

;; "H"
(assert (= infix_lseqqtresultqtunused5 o55))

(declare-const andbqtresultqtunused3 Bool)

;; "H"
(assert (= andbqtresultqtunused3 (and o55 o54)))
...
(declare-const jqtunused6 Int)

;; "H"
(assert (= jqtunused6 usf3))

(declare-const o56 Bool)

;; "H"
(assert (= o56 (ite (<= usf3 100) true false)))

(declare-const infix_lseqqtresultqtunused6 Bool)

;; "H"
(assert (= infix_lseqqtresultqtunused6 o56))

(declare-const o57 Bool)

;; "H"
(assert (= o57 (ite (<= 1 usf3) true false)))

(declare-const infix_lseqqtresultqtunused7 Bool)

;; "H"
(assert (= infix_lseqqtresultqtunused7 o57))

(declare-const andbqtresultqtunused4 Bool)

;; "H"
(assert (= andbqtresultqtunused4 (and o57 o56)))
  ...
  (ite (forall ((j3 Int))
         (=>
           ...
           (ite (and
             ...
             (= (length
                  (rec__tree_model__path_type__a
                    (us_split_fields5 (select r4 j3)))) 0))))
    true
    false))
...
(declare-const jqtunused7 Int)

;; "H"
(assert (= jqtunused7 usf4))

(declare-const o58 Bool)

;; "H"
(assert (= o58 (ite (<= usf4 100) true false)))

(declare-const infix_lseqqtresultqtunused8 Bool)

;; "H"
(assert (= infix_lseqqtresultqtunused8 o58))

(declare-const o59 Bool)

;; "H"
(assert (= o59 (ite (<= 1 usf4) true false)))
...
;; "H"
(assert (= andbqtresultqtunused5 (and o59 o58)))
...
;; "j'unused"
(define-fun jqtunused8 () Int
  usf5)

;; "o"
(define-fun o60 () Bool
  (ite (<= usf5 100) true false))
...
(declare-const map__contentqtresultqtunused17 (Array Int us_rep3))

;; "H"
(assert (= map__contentqtresultqtunused17 r4))

(declare-const o64 us_rep3)

;; "H"
(assert (= o64 (select r4 usf5)))

(declare-const getqtresultqtunused9 us_rep3)

;; "H"
(assert (= getqtresultqtunused9 o64))
...
;; "H"
(assert (= us_split_fieldsqtresultqtunused9 o65))

(declare-const o66 Bool)

;; "H"
(assert (= o66 (rec__tree_model__path_type__k o65)))

(declare-const rec__tree_model__path_type__kqtresultqtunused1 Bool)

;; "H"
(assert (= rec__tree_model__path_type__kqtresultqtunused1 o66))
...
(assert
  (ite (= o66 true)
    (and
      (= infix_eqqtresultqtunused5 (ite (= usf5 root) true false))
      (= o63 (ite (= usf5 root) false true)))
    (= o63 false)))
...
;; "o"
(define-fun o67 () us_split_fields2
  (us_split_fields3 f))
...
;; "temp___856"
(define-fun temp___856 () (Array Int us_rep)
  (rec__binary_trees__forest__c o67))
...
;; "o"
(define-fun o68 () us_rep
  (select temp___856 usf5))
...
(define-fun o70 () extended_index_type
  (rec__binary_trees__cell__parent o69))
