...
;; "H"
(assert (= o9 (rec__search_trees__search_tree__root o8)))

(declare-const rec__search_trees__search_tree__rootqtresultqtunused extended_index_type)

;; "H"
(assert (= rec__search_trees__search_tree__rootqtresultqtunused o9))
...
;; "H"
(assert (= to_repqtresultqtunused o10))
...
;; "H"
(assert (= o12 (rec__search_trees__search_tree__struct o11)))

(declare-const rec__search_trees__search_tree__structqtresultqtunused us_rep1)

;; "H"
(assert (= rec__search_trees__search_tree__structqtresultqtunused o12))

(declare-const temp___3309 (Array Int us_rep4))

;; "H"
(assert (= temp___3309 (model1 o12 o10)))
...
(assert
  (= (rec__tree_model__path_type__k
       (us_split_fields7 (select temp___3309 o10))) true))

;; "H"
(assert
  (= (last
       (rec__tree_model__path_type__a
         (us_split_fields7 (select temp___3309 o10)))) 0))
    ...
    (=>
      ...
      (=>
        ...
        (ite (and
               (not (= (parent o12 i1) 0))
               (= (rec__tree_model__path_type__k
                    (us_split_fields7 (select temp___3309 (parent o12 i1)))) true))
          (= (rec__tree_model__path_type__k
  ...
  (forall ((i1 Int))
    (=>
      ...
      (ite (and
        ...
        (= (is_add
             (rec__tree_model__path_type__a
               (us_split_fields7 (select temp___3309 (parent o12 i1))))
             (position o12 i1)
             (rec__tree_model__path_type__a
               (us_split_fields7 (select temp___3309 i1)))) true)
        (= (last
...
;; "H"
(assert (= o13 (select temp___3309 ki)))
...
;; "H"
(assert (= us_split_fieldsqtresultqtunused2 o14))
...
(assert
  (ite (= o15 true)
    (and
      (= o17 (us_split_fields5 t))
      (and
        (= us_split_fieldsqtresultqtunused3 o17)
        (and
          (= o18 (rec__search_trees__search_tree__root o17))
          (and
            ...
            (and
              ...
              (and
                ...
                (and
                  (in_range6 o19)
                  (and
                    (= range_check_qtresultqtunused1 o19)
                    (and
                      (= o20 (us_split_fields5 t))
                      (and
                        (= us_split_fieldsqtresultqtunused4 o20)
                        (and
                          (= o21 (rec__search_trees__search_tree__struct o20))
                          (and
                            (= rec__search_trees__search_tree__structqtresultqtunused1 
                            o21)
                            (and
                              (= temp___3310 (model1 o21 o19))
                              (and
                                (and
                                  (dynamic_invariant
                                    temp___3310
                                ...
                                (and
                                  ...
                                  (and
                                    (= o22 (select temp___3310 usf))
                                    (and
                                      (= getqtresultqtunused1 o22)
                                      (and
                                        (= o23 (us_split_fields7 o22))
                                        (and
                                          (= us_split_fieldsqtresultqtunused5 
                                          o23)
                                          (and
                                            (= o16 (rec__tree_model__path_type__k
                                                     o23))
...
(assert
  (ite (= o16 true)
    (and
      ...
      (and
        (= infix_eqqtresultqtunused1 (ite (= usf i) true false))
        (= o24 (ite (= usf i) false true))))
    (= o24 false)))
...
(declare-const o31 us_split_fields6)
...
(assert
  (ite (= o24 true)
    (and
      (= o25 (us_split_fields5 t))
      (and
        (= us_split_fieldsqtresultqtunused6 o25)
        (and
          (= o26 (rec__search_trees__search_tree__root o25))
          (and
            ...
            (and
              (= (to_rep1 o26) o27)
              (and
                (= to_repqtresultqtunused2 o27)
                (and
                  (in_range6 o27)
                  (and
                    (= range_check_qtresultqtunused2 o27)
                    (and
                      (= o28 (us_split_fields5 t))
                      (and
                        (= us_split_fieldsqtresultqtunused7 o28)
                        (and
                          (= o29 (rec__search_trees__search_tree__struct o28))
                          (and
                            (= rec__search_trees__search_tree__structqtresultqtunused2 
                            o29)
                            (and
                              (= temp___3312 (model1 o29 o27))
                              (and
                                (and
                                  (dynamic_invariant
                                    temp___3312
                                ...
                                (and
                                  ...
                                  (and
                                    (= o30 (select temp___3312 usf))
                                    (and
                                      (= getqtresultqtunused2 o30)
                                      (and
                                        (= o31 (us_split_fields7 o30))
                                        (and
                                          (= us_split_fieldsqtresultqtunused8 
                                          o31)
                                          (and
                                            (= o32 (rec__tree_model__path_type__a
                                                     o31))
                                            (and
                                              (= rec__tree_model__path_type__aqtresultqtunused 
                                              o32)
                                              (and
                                                (= o33 (us_split_fields5 t))
                                                (and
                                                  (= us_split_fieldsqtresultqtunused9 
                                                  o33)
                                                  (and
                                                    (= o34 (rec__search_trees__search_tree__root
                                                             o33))
                                                    (and
...
;; "o"
(define-fun o41 () (Array Int natural)
...
;; "o"
(define-fun o45 () (Array Int us_rep4)
  (model1 o44 o43))

;; "H"
(assert (dynamic_invariant o45 true false true true))

;; "H"
(assert
  (= (rec__tree_model__path_type__k (us_split_fields7 (select o45 o43))) true))

;; "H"
(assert
  (= (last
       (rec__tree_model__path_type__a (us_split_fields7 (select o45 o43)))) 0))
    ...
    (=>
      ...
      (=>
        ...
        (ite (and
               (not (= (parent o44 i1) 0))
               (= (rec__tree_model__path_type__k
                    (us_split_fields7 (select o45 (parent o44 i1)))) true))
          (= (rec__tree_model__path_type__k
               (us_split_fields7 (select o45 i1))) true)
          (not
            (= (rec__tree_model__path_type__k
                 (us_split_fields7 (select o45 i1))) true)))))))
  ...
  (forall ((i1 Int))
    (=>
      ...
      (ite (and
        ...
        (= (is_add
             (rec__tree_model__path_type__a
               (us_split_fields7 (select o45 (parent o44 i1))))
             (position o44 i1)
             (rec__tree_model__path_type__a
               (us_split_fields7 (select o45 i1)))) true)
        (= (last
             (rec__tree_model__path_type__a
               (us_split_fields7 (select o45 i1)))) 0)))))
...
(assert
  (forall ((i1 Int))
    (=>
      (and (<= 1 i1) (<= i1 100))
      (=>
        (= (rec__tree_model__path_type__k (us_split_fields7 (select o45 i1))) true)
        (forall ((j Int))
          (=>
            (and (<= 1 j) (<= j 100))
            (=>
              (and
                (= (rec__tree_model__path_type__k
                     (us_split_fields7 (select o45 j))) true)
                (= (oeq
                     (rec__tree_model__path_type__a
                       (us_split_fields7 (select o45 i1)))
                     (rec__tree_model__path_type__a
                       (us_split_fields7 (select o45 j)))) true))
              (= j i1))))))))
...
(assert
  (not
  (= (olt
       (rec__tree_model__path_type__a (us_split_fields7 (select o45 ki)))
       (rec__tree_model__path_type__a (us_split_fields7 (select o45 usf)))) true)))
