...
;; "H"
(assert (= o15 (ite (<= i 100) true false)))

(declare-const infix_lseqqtresultqtunused2 Bool)

;; "H"
(assert (= infix_lseqqtresultqtunused2 o15))
...
;; "H"
(assert (= infix_lseqqtresultqtunused3 o16))
...
(assert
  (ite (= o17 true)
    (and
      (= temp___loop_entry_936qtunused res1)
      (and
        (= map__contentqtresultqtunused2 res1)
        (and
          (= o18 (distinct 1 0))
          (and
            (= of_intqtresultqtunused3 o18)
            (and
              (= o19 (us_split_fieldsqtmk5 o18 rliteral1 rliteral1))
              (and
                (= us_split_fieldsqtmkqtresultqtunused3 o19)
                (and
                  (= o20 (us_repqtmk5 o19))
                  (and
                    (= us_repqtmkqtresultqtunused3 o20)
                    (and
                      (= map__contentqtresultqtunused3 res1)
                      (and
                        (= o21 (select res1 0))
                        (and
                          (= getqtresultqtunused1 o21)
                          (and
                            (= bool_eqqtresultqtunused1 (bool_eq o21 o20))
                            (and
                              (= iqtunused1 (int__refqtmk i1))
                              (and
                                (= resqtunused3 (map__refqtmk res3))
                                (and
                                  (and
                                    (= (bool_eq
                                         (select res3 0)
                                      ...
                                      (and
                                        ...
                                        (and
                                          ...
                                          (and
                                            ...
                                            (and
                                              (= o23 (us_split_fields9 o22))
                                              (and
                                                (= us_split_fieldsqtresultqtunused1 
                                                o23)
                                                (and
                                                  (= o24 (rec__tree_model__path_type__k
                                                           o23))
                                                  (and
...
(assert
  (forall ((i2 Int))
    (=>
      ...
      (ite (and
             (= (rec__tree_model__path_type__k
                  (us_split_fields9 (select m i2))) true)
             (< n2 (to_rep
                     (rec__red_black_trees__black_count__depth
                       (us_split_fields11 (select res2 i2))))))
        (< (last
             (rec__tree_model__path_type__a (us_split_fields9 (select m i2)))) (- 100 
        n2))
        (=>
          (= (rec__tree_model__path_type__k (us_split_fields9 (select m i2))) true)
          (and
            (and
              (and
                (<= (to_rep
              ...
              (= (to_rep
                   (rec__red_black_trees__black_count__depth
                     (us_split_fields11 (select res2 i2)))) (+ 1 (max
                                                                   (to_rep
                                                                    (rec__red_black_trees__black_count__depth
                                                                    (us_split_fields11
                                                                    (select 
            ...
            (= (to_rep
                 (rec__red_black_trees__black_count__count
                   (us_split_fields11 (select res2 i2)))) (+ (ite (= 
                                                               (to_rep3
                                                                 (select 
                                                                 (rec__red_black_trees__rbt__color
                                                                   (us_split_fields7
