...
(assert
  (and
    (and
      (and (= (valid_root f1 root) true) (= (valid_root f2 root) true))
            ...
            (and
              (and
                (and
                  ...
                  (= (rec__tree_model__path_type__k
                       (us_split_fields5 (select (model1 f2 root) j))) true))
                (= (olt
                     (rec__tree_model__path_type__a
              ...
              (= (get
                   ...
                   (+ (last
                        (rec__tree_model__path_type__a
                          (us_split_fields5 (select (model1 f1 root) i)))) 1)) 
              (get
                (rec__tree_model__path_type__a
                  (us_split_fields5 (select (model1 f2 root) j)))
                (+ (last
                     (rec__tree_model__path_type__a
                       (us_split_fields5 (select (model1 f2 root) i)))) 1))))))))))
