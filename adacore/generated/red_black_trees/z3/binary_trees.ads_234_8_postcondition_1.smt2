...
(assert
  ...
  (and
    (and
      (and
        (and
          (= (size (us_repqtmk1 f__split_fields1)) (size
                                                     (us_repqtmk1
                                                       f__split_fields)))
          (= v (peek (us_repqtmk1 f__split_fields1) i d)))
        (forall ((j Int))
          (=>
            (and (<= 1 j) (<= j 100))
            (=>
              (and
                (= (valid_root (us_repqtmk1 f__split_fields) j) true)
                (not (= j v)))
              (= (valid_root (us_repqtmk1 f__split_fields1) j) true)))))
      (forall ((j Int))
        (=>
          (and (<= 1 j) (<= j 100))
          (=>
    ...
    (forall ((j Int))
      (=>
        ...
        (=>
          (not (= j v))
          (= (parent (us_repqtmk1 f__split_fields1) j) (parent
                                                         (us_repqtmk1
                                                           f__split_fields)
                                                         j))))))))
