...
;; "H"
(assert (= temp___28741 (model1 o72 o71)))
...
(assert
  (= (rec__tree_model__path_type__k
       (us_split_fields5 (select temp___28741 o71))) true))

;; "H"
(assert
  (= (last
       (rec__tree_model__path_type__a
         (us_split_fields5 (select temp___28741 o71)))) 0))
    ...
    (=>
      ...
      (=>
        ...
        (ite (and
               (not (= (parent o72 i6) 0))
               (= (rec__tree_model__path_type__k
                    (us_split_fields5 (select temp___28741 (parent o72 i6)))) true))
          (= (rec__tree_model__path_type__k
  ...
  (forall ((i6 Int))
    (=>
      ...
      (ite (and
        ...
        (= (is_add
             (rec__tree_model__path_type__a
               (us_split_fields5 (select temp___28741 (parent o72 i6))))
             (position o72 i6)
             (rec__tree_model__path_type__a
               (us_split_fields5 (select temp___28741 i6)))) true)
        (= (last
...
;; "H"
(assert (= o73 (select temp___28741 i5)))

(declare-const getqtresultqtunused8 us_rep3)

;; "H"
(assert (= getqtresultqtunused8 o73))
...
;; "H"
(assert (= us_split_fieldsqtresultqtunused8 o74))

(declare-const o75 Bool)

;; "H"
(assert (= o75 (rec__tree_model__path_type__k o74)))

(declare-const rec__tree_model__path_type__kqtresultqtunused4 Bool)

;; "H"
(assert (= rec__tree_model__path_type__kqtresultqtunused4 o75))
          ...
          (and
              ...
              (and
                (and
                  (and
                    (and
                      (= (rec__tree_model__path_type__k
                           (us_split_fields5 (select temp___28751 o77))) true)
                      (= (last
                           (rec__tree_model__path_type__a
                             (us_split_fields5 (select temp___28751 o77)))) 0))
                    (forall ((i6 Int))
                      (=>
                        (and (<= 1 i6) (<= i6 100))
                        (=>
                          ...
                          (ite (and
                                 ...
                                 (= (rec__tree_model__path_type__k
                                      (us_split_fields5
                                        (select temp___28751 (parent o78 i6)))) true))
                            (= (rec__tree_model__path_type__k
                    ...
                    (=>
                      ...
                      (ite (and
                        ...
                        (= (is_add
                             (rec__tree_model__path_type__a
                               (us_split_fields5
                                 (select temp___28751 (parent o78 i6))))
                             (position o78 i6)
                             (rec__tree_model__path_type__a
                               (us_split_fields5 (select temp___28751 i6)))) true)
                        (= (last
            ...
            (and
              ...
              (and
                ...
                (and
                  (= o79 (select temp___28751 j4))
                  (and
                    (= getqtresultqtunused9 o79)
                    (and
                      (= o80 (us_split_fields5 o79))
                      (and
                        (= us_split_fieldsqtresultqtunused9 o80)
                        (and
                          (= o76 (rec__tree_model__path_type__k o80))
