...
(assert
  (= (get
       (rec__tree_model__path_type__a
         (us_split_fields7 (select (model1 o41 y1) (peek o41 y1 0))))
       (+ (last
            (rec__tree_model__path_type__a
              (us_split_fields7 (select (model1 o41 y1) y1)))) 1)) 0))
...
;; "o"
(define-fun o42 () (Array Int natural)
...
;; "temp___1427"
(define-fun temp___1427 () (Array Int us_rep4)
  (model1 o43 y1))

;; "H"
(assert (dynamic_invariant temp___1427 true false true true))

;; "H"
(assert
  (= (rec__tree_model__path_type__k
       (us_split_fields7 (select temp___1427 y1))) true))

;; "H"
(assert
  (= (last
       (rec__tree_model__path_type__a
         (us_split_fields7 (select temp___1427 y1)))) 0))
    ...
    (=>
      ...
      (=>
        ...
        (ite (and
               (not (= (parent o43 i1) 0))
               (= (rec__tree_model__path_type__k
                    (us_split_fields7 (select temp___1427 (parent o43 i1)))) true))
          (= (rec__tree_model__path_type__k
               (us_split_fields7 (select temp___1427 i1))) true)
          (not
            (= (rec__tree_model__path_type__k
                 (us_split_fields7 (select temp___1427 i1))) true)))))))
  ...
  (forall ((i1 Int))
    (=>
      ...
      (ite (and
        ...
        (= (is_add
             (rec__tree_model__path_type__a
               (us_split_fields7 (select temp___1427 (parent o43 i1))))
             (position o43 i1)
             (rec__tree_model__path_type__a
               (us_split_fields7 (select temp___1427 i1)))) true)
        (= (last
             (rec__tree_model__path_type__a
               (us_split_fields7 (select temp___1427 i1)))) 0)))))
        ...
        (forall ((j2 Int))
          (=>
            ...
            (=>
              (and
                (= (rec__tree_model__path_type__k
                     (us_split_fields7 (select temp___1427 j2))) true)
                (= (oeq
                     (rec__tree_model__path_type__a
                       (us_split_fields7 (select temp___1427 i1)))
                     (rec__tree_model__path_type__a
                       (us_split_fields7 (select temp___1427 j2)))) true))
              (= j2 i1))))))))
...
;; "o"
(define-fun o44 () us_rep4
  (select temp___1427 x1))
...
;; "o"
(define-fun o45 () us_split_fields6
  (us_split_fields7 o44))
...
;; "__split_fields__content'result'unused"
(define-fun us_split_fields__contentqtresultqtunused81 () us_split_fields2
  dummy_4__split_fields1)

;; "o"
(define-fun o47 () us_rep1
  (us_repqtmk1 dummy_4__split_fields1))

;; "__rep'mk'result'unused"
(define-fun us_repqtmkqtresultqtunused86 () us_rep1
  o47)

;; "H"
(assert (= (correct_place o47 o46 y1 x1 o42) true))
...
;; "__rep'mk'result'unused"
(define-fun us_repqtmkqtresultqtunused87 () us_rep2
  (us_repqtmk2 t__split_fields5))
...
;; "__rep'mk'result'unused"
(define-fun us_repqtmkqtresultqtunused88 () us_rep1
  o49)
...
;; "H"
(assert (= (ordered_leafs o50 y1 o48) true))
...
;; "H"
(assert (= spark__branch1 (ite (= is_root true) false true)))
...
(declare-const us_split_fields__contentqtresultqtunused87 us_split_fields2)

(declare-const us_repqtmkqtresultqtunused92 us_rep1)
...
(declare-const rec__search_trees__search_tree__structqtresultqtunused15 us_rep1)
  ...
  (=>
    ...
    (and
      ...
      (and
        ...
        (and
          (= us_split_fieldsqtresultqtunused42 t__split_fields5)
          (and
            (= o51 (rec__search_trees__search_tree__values t__split_fields5))
            (and
              (= rec__search_trees__search_tree__valuesqtresultqtunused7 
              o51)
              (and
                (= us_split_fields__contentqtresultqtunused86 t__split_fields5)
                (and
                  ...
                  (and
                    ...
                    (and
                      (= o52 (rec__search_trees__search_tree__root
                               t__split_fields5))
                      (and
                            ...
                            (and
                              ...
                              (and
                                ...
                                (and
                                  ...
                                  dummy_4__split_fields1)
                                  (and
                                    (= us_repqtmkqtresultqtunused92 (us_repqtmk1
                                                                    dummy_4__split_fields1))
                                    (and
                                      ...
                                      (and
                                        ...
                                        (and
                                          ...
                                          t__split_fields5)
                                          (and
                                            (= o54 (rec__search_trees__search_tree__struct
                                                     t__split_fields5))
                                            (and
                                              (= rec__search_trees__search_tree__structqtresultqtunused15 
                                              o54)
                                              (= (ordered_leafs o54 o53 o51) true))))))))))))))))))))))))
