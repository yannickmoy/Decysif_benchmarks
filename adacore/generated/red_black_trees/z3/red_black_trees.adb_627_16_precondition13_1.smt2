...
;; "temp___772"
(define-fun temp___772 () (Array Int color_type)
...
;; "temp___778"
(define-fun temp___778 () (Array Int color_type)
...
;; "temp___780"
(define-fun temp___780 () Int
  (parent o41 x2))

;; "H"
(assert (in_range2 temp___780))
...
;; "H"
(assert (=> (= (size o41) 0) (= temp___780 0)))
...
;; "Assert"
(assert (and (<= 1 temp___780) (<= temp___780 100)))

;; "o"
(define-fun o42 () (Array Int color_type)
  (store temp___778 temp___780 o40))
...
;; "temp___785"
(define-fun temp___785 () (Array Int color_type)
...
;; "H"
(assert (=> (= (size o46) 0) (= temp___787 0)))
...
;; "Assert"
(assert (and (<= 1 temp___787) (<= temp___787 100)))

;; "o"
(define-fun o47 () (Array Int color_type)
  (store temp___785 temp___787 o45))
