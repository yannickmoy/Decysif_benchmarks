    ...
    (and
      (and
        ...
        (and
          (= iqtunused usf)
          (and
            (= o9 (ite (<= usf 100) true false))
            (and
              (= infix_lseqqtresultqtunused2 o9)
              (and
                (= o10 (ite (<= 1 usf) true false))
                (and
                  (= infix_lseqqtresultqtunused3 o10)
                  (= andbqtresultqtunused1 (and o10 o9))))))))
      (and
                                ...
                                (=>
                                  (= (rec__tree_model__path_type__k
                                       (us_split_fields9
                                         (select (model1
                                                   (rec__red_black_trees__rbt__struct
                                                     (us_split_fields7 o3))) i))) true)
                                  (and
                                    (and
                                      (=
                                        (= (rec__red_black_trees__black_count__status
                                             (us_split_fields11
                                               (select temp___1076 i))) true)
                                        (= (to_rep
                                             (rec__red_black_trees__black_count__count
                                               (us_split_fields11
                                                 (select temp___1076 
                                    ...
                                    (= (to_rep
                                         (rec__red_black_trees__black_count__count
                                           (us_split_fields11
                                             (select temp___1076 i)))) (+ 
                                    (ite (= (to_rep3
                                              (select (rec__red_black_trees__rbt__color
                                                        (us_split_fields7 o3)) i)) 0)
                                      1
                                      0) (to_rep
                                           (rec__red_black_trees__black_count__count
                                             (us_split_fields11
                                               (select temp___1076 (peek
                                                                    ...
                                                                    0))))))))))))
                          (and
                            (= nb_blacksqtresultqtunused temp___1076)
                            (and
                              (= o4 (select temp___1076 except))
                              (and
                                (= getqtresultqtunused o4)
                                (and
                                  (= o5 (us_split_fields11 o4))
                                  (and
                                    (= us_split_fieldsqtresultqtunused 
                                    o5)
                                    (and
                                      (= o6 (rec__red_black_trees__black_count__depth
                                              o5))
                                      (and
