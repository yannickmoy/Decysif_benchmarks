...
;; "o"
(define-fun o29 () (Array Int natural)
...
;; "o"
(define-fun o30 () us_rep1
  (us_repqtmk1 dummy_2__split_fields1))

;; "__rep'mk'result'unused"
(define-fun us_repqtmkqtresultqtunused74 () us_rep1
  o30)
...
(assert
  ...
  (= (oeq
       (rec__tree_model__path_type__a
         (us_split_fields7 (select (model1 o30 y1) i1)))
       (rec__tree_model__path_type__a
         (us_split_fields7 (select (model1 o31 y1) i1)))) true)))
