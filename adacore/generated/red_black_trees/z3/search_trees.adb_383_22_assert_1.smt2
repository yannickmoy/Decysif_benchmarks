...
;; "H"
(assert (= iqtunused4 (int__refqtmk i4)))
...
;; "H"
(assert (= int__contentqtresultqtunused16 i4))

(declare-const o37 Bool)

;; "H"
(assert (= o37 (ite (<= i4 100) true false)))

(declare-const infix_lseqqtresultqtunused12 Bool)

;; "H"
(assert (= infix_lseqqtresultqtunused12 o37))
...
;; "H"
(assert (= o38 (ite (<= 1 i4) true false)))
...
;; "H"
(assert (= o39 (and o38 o37)))

(declare-const andbqtresultqtunused6 Bool)

;; "H"
(assert (= andbqtresultqtunused6 o39))
...
(declare-const iqtunused5 int__ref)
    ...
    (and
      (and
        ...
        (and
          (= kqtunused4 usf4)
          (and
            (= int__contentqtresultqtunused27 i4)
            (and
              (= o66 (- i4 1))
              (and
                (= infix_mnqtresultqtunused1 o66)
                (and
                  (= o67 (ite (<= usf4 o66) true false))
                  (and
                    (= infix_lseqqtresultqtunused18 o67)
                    (and
                      (= o68 (ite (<= 1 usf4) true false))
                      (and
                        (= infix_lseqqtresultqtunused19 o68)
                        (= andbqtresultqtunused9 (and o68 o67)))))))))))
      (and
                ...
                (and
                  (and
                    ...
                    (and
                      (= j2 1)
                      (and
                        (= int__contentqtresultqtunused19 j2)
                        (and
                          (= o40 (ite (<= j2 100) true false))
                          (and
                            (= infix_lseqqtresultqtunused14 o40)
                            (and
                              (= int__contentqtresultqtunused20 j2)
                              (and
                                (= o41 (ite (<= 1 j2) true false))
                                (and
                                  (= infix_lseqqtresultqtunused15 o41)
                                  (and
                                    (= o42 (and o41 o40))
                                    (and
                                      (= andbqtresultqtunused7 o42)
                                      (=>
                                        (= o42 true)
                                        (and
                                                      ...
                                                      (and
                                                        ...
                                                        (and
                                                          ...
                                                          (and
                                                            ...
                                                            (= j3 100))))))))))))))))))))))
                  (and
                    (= int__contentqtresultqtunused18 i5)
                    (and
                      (= infix_eqqtresultqtunused3 (ite (= i5 100)
                                                     true
                                                     false))
                      (= i5 100))))))))))))
