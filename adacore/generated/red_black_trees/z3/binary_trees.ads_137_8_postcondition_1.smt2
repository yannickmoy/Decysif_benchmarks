          ...
          (and
            (and
              (= (size (us_repqtmk1 f__split_fields1)) (size
                                                         (us_repqtmk1
                                                           f__split_fields)))
              (= (valid_root (us_repqtmk1 f__split_fields1) root) true))
            (= v1 (peek (us_repqtmk1 f__split_fields) i d)))
          (= (peek (us_repqtmk1 f__split_fields1) i d) 0))
        (forall ((j Int))
          (=>
            (and (<= 1 j) (<= j 100))
            (=>
      ...
      (forall ((j Int))
        (=>
          ...
          (=>
            (and
              (not (= j v1))
              (not (= (parent (us_repqtmk1 f__split_fields1) j) 0)))
            (= (position (us_repqtmk1 f__split_fields1) j) (position
                                                             (us_repqtmk1
                                                               f__split_fields)
                                                             j))))))
    (forall ((j Int))
      (=>
        ...
        (forall ((e Int))
          (=>
            ...
            (=>
              (or (not (= j i)) (not (= e d)))
              (= (peek (us_repqtmk1 f__split_fields1) j e) (peek
                                                             (us_repqtmk1
                                                               f__split_fields)
                                                             j
                                                             e))))))))))
