...
;; "__rep'mk'result'unused"
(define-fun us_repqtmkqtresultqtunused75 () us_rep1
  o27)
...
;; "H"
(assert (= (ordered_leafs o28 y1 o26) true))

;; "H"
(assert (= (ordered_leafs o28 x1 o26) true))
...
(assert
  (= (correct_place
       o28
       (rec__tree_model__path_type__a
         (us_split_fields7 (select (model1 o27 y1) x1)))
       y1
       x1
       o26) true))
...
(assert
  (= (get
       (rec__tree_model__path_type__a
         (us_split_fields7
           (select (model1 (us_repqtmk1 dummy_1__split_fields1) y1) x1)))
       1) 0))
...
;; "__rep'mk'result'unused"
(define-fun us_repqtmkqtresultqtunused79 () us_rep1
  o32)
...
(assert
  ...
  (= (oeq
       (rec__tree_model__path_type__a
         (us_split_fields7 (select (model1 o32 o31) i1)))
       (rec__tree_model__path_type__a
         (us_split_fields7 (select (model1 o33 o31) i1)))) true)))
