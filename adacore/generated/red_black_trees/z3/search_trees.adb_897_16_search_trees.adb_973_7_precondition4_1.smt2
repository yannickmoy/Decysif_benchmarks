...
;; "o"
(define-fun o51 () (Array Int natural)
  (rec__search_trees__search_tree__values t__split_fields5))
...
;; "__rep'mk'result'unused"
(define-fun us_repqtmkqtresultqtunused92 () us_rep1
  o54)
...
(assert
  ...
  (= (oeq
       (rec__tree_model__path_type__a
         (us_split_fields7 (select (model1 o54 o53) i1)))
       (rec__tree_model__path_type__a
         (us_split_fields7 (select (model1 o55 o53) i1)))) true)))
