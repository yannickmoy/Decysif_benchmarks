...
;; "H"
(assert (not (= (parent1 (us_repqtmk2 t__split_fields) j2) 0)))

;; "H"
(assert
  (or
    (not (= (parent1 (us_repqtmk2 t__split_fields) j2) i))
    (= (position1 (us_repqtmk2 t__split_fields) j2) 0)))
  ...
  (or
    (or
      (not
        (= (parent1
             (us_repqtmk2 t__split_fields)
             (parent1 (us_repqtmk2 t__split_fields) j2)) i))
      (= (position1
           (us_repqtmk2 t__split_fields)
           (parent1 (us_repqtmk2 t__split_fields) j2)) 0))
    (= (position1 (us_repqtmk2 t__split_fields) j2) 1)))
