...
(declare-const temp___3850 Int)

;; "H"
(assert (= temp___3850 r293b))
...
;; "H"
(assert (= int__contentqtresultqtunused15 r))

(declare-const o39 Bool)

;; "H"
(assert (= o39 (ite (<= r temp___3850) true false)))
...
;; "H"
(assert (= int__contentqtresultqtunused16 r))

(declare-const o40 Bool)

;; "H"
(assert (= o40 (ite (<= 1 r) true false)))
...
;; "H"
(assert (= o41 (and o40 o39)))

(declare-const andbqtresultqtunused4 Bool)

;; "H"
(assert (= andbqtresultqtunused4 o41))
...
(declare-const o46 position_type)
...
(assert
  (=>
    (= o41 true)
    (and
      (= spark__branchqtunused2 (bool__refqtmk spark__branch4))
      (and
        (and
          (= int__contentqtresultqtunused19 v)
          (and
            (= int__contentqtresultqtunused20 r)
            (and
              (= infix_eqqtresultqtunused4 (ite (= r v) true false))
              (and
                (= us_split_fields__contentqtresultqtunused16 f_old__split_fields)
                (and
                  (= us_repqtmkqtresultqtunused16 (us_repqtmk1
                                                    f_old__split_fields))
                  (and
                    (= us_split_fieldsqtresultqtunused13 f_old__split_fields)
                    (and
                      (= temp___3856 (rec__binary_trees__forest__c
                                       f_old__split_fields))
                      (and
                        ...
                        (and
                          ...
                          (and
                            (= o44 (select temp___3856 r))
                            (and
                              (= getqtresultqtunused9 o44)
                              (and
                                (= o45 (us_split_fields1 o44))
                                (and
                                  (= us_split_fieldsqtresultqtunused14 
                                  o45)
                                  (and
                                    (= o46 (rec__binary_trees__cell__position
                                             o45))
                                    (and
        ...
        (and
          (and
            ...
            (and
              (= pqtunused usf2)
              (and
                (= int__contentqtresultqtunused18 r)
                (and
                  (= o42 (ite (<= usf2 r) true false))
                  (and
                    (= infix_lseqqtresultqtunused10 o42)
                    (and
                      (= o43 (ite (<= 1 usf2) true false))
                      (and
                        (= infix_lseqqtresultqtunused11 o43)
                        (= andbqtresultqtunused5 (and o43 o42)))))))))
          (and
            (= usfqtunused2 (ite (forall ((p Int))
                                   (=>
                                     (and (<= 1 p) (<= p r))
                                     (=>
                                       (and
                              ...
                              false))
            (and
              (= anyqtresultqtunused4 (ite (forall ((p Int))
                                             (=>
                                               (and (<= 1 p) (<= p r))
                                               (=>
                                                 (and
              ...
              (and
                ...
                (and
                  ...
                  (and
                    (and (<= 1 r1) (<= r1 r293b))
                    (and
                      (= int__contentqtresultqtunused17 r1)
                      (and
                        (= infix_eqqtresultqtunused3 (ite (= r1 temp___3850)
                                                       true
                                                       false))
                        (= r1 temp___3850)))))))))))))
...
(assert
  ...
  (= (rec__tree_model__path_type__k
       (us_split_fields5
         (select (model1 (us_repqtmk1 f__split_fields) root) v))) true)))
