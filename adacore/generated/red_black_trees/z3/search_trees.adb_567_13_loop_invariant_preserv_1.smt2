...
;; "H"
(assert (= temp___31231 (model1 o28 o27)))
...
(assert
  (= (rec__tree_model__path_type__k
       (us_split_fields5 (select temp___31231 o27))) true))

;; "H"
(assert
  (= (last
       (rec__tree_model__path_type__a
         (us_split_fields5 (select temp___31231 o27)))) 0))
    ...
    (=>
      ...
      (=>
        ...
        (ite (and
               (not (= (parent o28 i3) 0))
               (= (rec__tree_model__path_type__k
                    (us_split_fields5 (select temp___31231 (parent o28 i3)))) true))
          (= (rec__tree_model__path_type__k
  ...
  (forall ((i3 Int))
    (=>
      ...
      (ite (and
        ...
        (= (is_add
             (rec__tree_model__path_type__a
               (us_split_fields5 (select temp___31231 (parent o28 i3))))
             (position o28 i3)
             (rec__tree_model__path_type__a
               (us_split_fields5 (select temp___31231 i3)))) true)
        (= (last
...
;; "H"
(assert (= o29 (select temp___31231 i2)))

(declare-const getqtresultqtunused4 us_rep3)

;; "H"
(assert (= getqtresultqtunused4 o29))
...
;; "H"
(assert (= us_split_fieldsqtresultqtunused3 o30))
...
;; "H"
(assert (= rec__tree_model__path_type__kqtresultqtunused1 o31))
...
(declare-const temp___31221 (Array Int us_rep3))
...
(declare-const getqtresultqtunused7 Int)
    ...
    (and
      ...
      (and
        ...
        (and
          (= o40 f2)
          (and
            (= temp___31221 (model1 o40 o39))
            (and
              (and
                (dynamic_invariant temp___31221 true false true true)
                (and
                  (and
                    (and
                      (and
                        ...
                        (=>
                          ...
                          (=>
                            ...
                            (ite (and
                                   ...
                                   (= (rec__tree_model__path_type__k
                                        (us_split_fields5
                                          (select temp___31221 (parent
                                                                 o40
                                                                 i3)))) true))
                              (= (rec__tree_model__path_type__k
                                   (us_split_fields5
                                     (select temp___31221 i3))) true)
                              (not
                                (= (rec__tree_model__path_type__k
                                     (us_split_fields5
                                       (select temp___31221 i3))) true)))))))
                      ...
                      (=>
                        ...
                        (ite (and
                          ...
                          (= (is_add
                               (rec__tree_model__path_type__a
                                 (us_split_fields5
                                   (select temp___31221 (parent o40 i3))))
                               (position o40 i3)
                               (rec__tree_model__path_type__a
                          ...
                          (=>
                            ...
                            (=>
                              (and
                                (= (rec__tree_model__path_type__k
                                     (us_split_fields5
                                       (select temp___31221 j))) true)
                                (= (oeq
                                     (rec__tree_model__path_type__a
                                       (us_split_fields5
                                         (select temp___31221 i3)))
                                     (rec__tree_model__path_type__a
                                       (us_split_fields5
                                         (select temp___31221 j)))) true))
                              (= j i3)))))))))
              (and
                (= modelqtresultqtunused5 temp___31221)
                (and
                  (= int__contentqtresultqtunused10 i2)
                  (and
                    (= o41 (select temp___31221 i2))
                    (and
                      (= getqtresultqtunused6 o41)
                      (and
                        (= o42 (us_split_fields5 o41))
                        (and
                          (= us_split_fieldsqtresultqtunused5 o42)
                          (and
                            (= o43 (rec__tree_model__path_type__a o42))
                            (and
...
;; "H"
(assert (= int__contentqtresultqtunused11 i2))

(declare-const o48 Bool)

;; "H"
(assert (= o48 (ite (<= usf1 i2) true false)))

(declare-const infix_lseqqtresultqtunused4 Bool)

;; "H"
(assert (= infix_lseqqtresultqtunused4 o48))

(declare-const o49 Bool)

;; "H"
(assert (= o49 (ite (<= 1 usf1) true false)))

(declare-const infix_lseqqtresultqtunused5 Bool)

;; "H"
(assert (= infix_lseqqtresultqtunused5 o49))

(declare-const andbqtresultqtunused2 Bool)

;; "H"
(assert (= andbqtresultqtunused2 (and o49 o48)))
...
(assert
  (= (rec__tree_model__path_type__k
       (us_split_fields5
         (let ((temp___529 (model1 f2 v2))) (select temp___529 j)))) true))
