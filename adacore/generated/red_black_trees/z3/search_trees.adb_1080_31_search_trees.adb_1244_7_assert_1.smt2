...
;; "o"
(define-fun o32 () (Array Int natural)
...
;; "H"
(assert (= (ordered_leafs o34 x1 o32) true))

;; "H"
(assert (= (ordered_leafs o34 xr1 o32) true))
...
(assert
  (= (correct_place
       o34
       (rec__tree_model__path_type__a
         (us_split_fields7 (select (model1 o33 x1) xr1)))
       x1
       xr1
       o32) true))
...
(assert
  ...
  (= (get
       (rec__tree_model__path_type__a
         (us_split_fields7
           (select (model1 (us_repqtmk1 dummy_2__split_fields1) x1) xr1)))
       1) 1)))
