...
(define-fun infix_eqqtresultqtunused5 () Bool
  (ite (= usf3 root) true false))

;; "map__content'result'unused"
(define-fun map__contentqtresultqtunused17 () (Array Int us_rep3)
  r4)

;; "o"
(define-fun o59 () us_rep3
  (select r4 usf3))
...
;; "o"
(define-fun o61 () Bool
  (rec__tree_model__path_type__k o60))
...
;; "o"
(define-fun o62 () Bool
  (and o61 (ite (= usf3 root) false true)))
...
;; "map__content'result'unused"
(define-fun map__contentqtresultqtunused18 () (Array Int us_rep3)
  r4)
...
;; "temp___875"
(define-fun temp___875 () (Array Int us_rep)
  (rec__binary_trees__forest__c o66))
...
;; "o"
(define-fun o69 () position_type
  (rec__binary_trees__cell__position o68))
...
;; "temp___873"
(define-fun temp___873 () (Array Int us_rep)
  (rec__binary_trees__forest__c o71))
...
(define-fun o72 () us_rep
  (select temp___873 usf3))

;; "get'result'unused"
(define-fun getqtresultqtunused12 () us_rep
  o72)

;; "o"
(define-fun o73 () us_split_fields
  (us_split_fields1 o72))
...
(define-fun o74 () extended_index_type
  (rec__binary_trees__cell__parent o73))
