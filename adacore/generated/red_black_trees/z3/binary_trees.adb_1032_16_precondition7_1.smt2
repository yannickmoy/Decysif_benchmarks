...
;; "temp___3856"
(define-fun temp___3856 () (Array Int us_rep)
...
(define-fun o42 () us_rep
  (select temp___3856 r))

;; "get'result'unused"
(define-fun getqtresultqtunused9 () us_rep
  o42)
...
;; "o"
(define-fun o44 () position_type
  (rec__binary_trees__cell__position o43))
...
(define-fun infix_eqqtresultqtunused5 () Bool
  (ite (= r root) true false))

;; "o"
(define-fun o47 () Bool
  (and (ite (= r root) false true) o46))
...
;; "temp___compl_3851"
(define-fun temp___compl_3851 () us_rep1
  (us_repqtmk1 f_old__split_fields))
...
;; "temp___3854"
(define-fun temp___3854 () us_rep1
  (us_repqtmk1 f_old__split_fields))
...
;; "Assert"
(assert (type_invariant temp___3854))
    ...
    (=>
      ...
      (or
        (not
          (= (rec__tree_model__path_type__k
               (us_split_fields5
                 (select (model1 temp___compl_3851 temp___compl_3852) i))) true))
        (not
          (= (rec__tree_model__path_type__k
               (us_split_fields5 (select (model1 temp___compl_3851 r) i))) true))))))
...
(assert
  (= (rec__tree_model__path_type__k
       (us_split_fields5 (select (model1 o50 r) i))) true))
