...
(assert
  (= (rec__tree_model__path_type__k
       (us_split_fields7 (select (model1 o52 y1) i1))) true))
...
(assert
  (<= (+ (last
           (rec__tree_model__path_type__a
             (us_split_fields7 (select (model1 o53 x1) y1)))) 1) i2))
...
(assert
  ...
  (= (get
       (rec__tree_model__path_type__a
         (us_split_fields7 (select (model1 o52 y1) i1)))
       (- i2 (last
               (rec__tree_model__path_type__a
                 (us_split_fields7 (select (model1 o53 x1) y1)))))) (get
                                                                    (rec__tree_model__path_type__a
                                                                    (us_split_fields7
                                                                    (select 
                                                                    (model1
