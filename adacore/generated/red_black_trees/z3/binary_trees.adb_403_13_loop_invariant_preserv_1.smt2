...
(assert
  (<= (last
        (rec__tree_model__path_type__a
          (us_split_fields5 (select (model1 f root) j)))) (+ (last
                                                               (rec__tree_model__path_type__a
                                                                 (us_split_fields5
                                                                   (select 
                                                                   (model1
...
;; Goal "def'vc"
;; File "binary_trees.adb", line 385, characters 0-0
(assert
  (not
  (not
    (= (get
         ...
         (+ (last
              (rec__tree_model__path_type__a
                (us_split_fields5 (select (model1 f root) i)))) 1)) d))))
