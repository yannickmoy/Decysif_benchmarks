                            ...
                            (and
                              ...
                              (and
                                ...
                                (and
                                  ...
                                  t__split_fields3)
                                  (and
                                    (= temp___compl_793 (rec__red_black_trees__rbt__struct
                                                          t__split_fields3))
                                    (and
...
;; "temp___800"
(define-fun temp___800 () (Array Int color_type)
...
;; "temp___802"
(define-fun temp___802 () Int
  (parent o49 x3))

;; "H"
(assert (in_range2 temp___802))
...
;; "H"
(assert (=> (= (size o49) 0) (= temp___802 0)))
...
;; "Assert"
(assert (and (<= 1 temp___802) (<= temp___802 100)))

;; "o"
(define-fun o50 () (Array Int color_type)
  (store temp___800 temp___802 o48))
...
;; "temp___807"
(define-fun temp___807 () (Array Int color_type)
...
;; "temp___809"
(define-fun temp___809 () Int
  (parent o56 o55))

;; "H"
(assert (in_range2 temp___809))
...
;; "H"
(assert (=> (= (size o56) 0) (= temp___809 0)))
...
;; "Assert"
(assert (and (<= 1 temp___809) (<= temp___809 100)))

;; "o"
(define-fun o57 () (Array Int color_type)
  (store temp___807 temp___809 o53))
...
;; "temp___compl_813"
(define-fun temp___compl_813 () us_rep2
...
(define-fun o60 () us_split_fields4
  (us_split_fields5 temp___compl_813))
...
;; "H"
(assert (= (position1 (us_repqtmk2 param__t__split_fields5) o64) 0))

;; "H"
(assert
  (= (parent
       (us_repqtmk2 param__t__split_fields5)
       (peek (us_repqtmk2 o60) o64 1)) (parent (us_repqtmk2 o60) o64)))
...
(assert
  (=>
    ...
    (= (position1
         (us_repqtmk2 param__t__split_fields5)
         (peek (us_repqtmk2 o60) o64 1)) (position1 (us_repqtmk2 o60) o64))))

;; "H"
(assert
  (=>
    (not (= (peek (us_repqtmk2 o60) (peek (us_repqtmk2 o60) o64 1) 0) 0))
    (and
      (= (parent
           (us_repqtmk2 param__t__split_fields5)
           (peek (us_repqtmk2 o60) (peek (us_repqtmk2 o60) o64 1) 0)) 
      o64)
      (= (position1
           (us_repqtmk2 param__t__split_fields5)
           (peek (us_repqtmk2 o60) (peek (us_repqtmk2 o60) o64 1) 0)) 1))))
            ...
            (or
              (or
                ...
                (not
                  ...
                  o64)))
              (= (position1 (us_repqtmk2 o60) (parent (us_repqtmk2 o60) j)) 0))
...
;; "H"
(assert
  (= (peek (us_repqtmk2 param__t__split_fields5) o64 1) (peek
                                                          (us_repqtmk2 o60)
                                                          (peek
                                                            (us_repqtmk2 o60)
                                                            o64
...
(assert
  (=>
    ...
    (= (peek
         ...
         (position1 (us_repqtmk2 o60) o64)) (peek (us_repqtmk2 o60) o64 1))))

;; "H"
(assert
  (= (peek
       (us_repqtmk2 param__t__split_fields5)
       (peek (us_repqtmk2 o60) o64 1)
       0) o64))
          ...
          (=>
            (and
              (and
                ...
                (or (not (= j (peek (us_repqtmk2 o60) o64 1))) (= d 1)))
              (= (rec__tree_model__path_type__k
                   (us_split_fields9
                     (select (model1 (us_repqtmk2 param__t__split_fields5)) j))) true))
...
;; "H"
(assert
  (= (not (or (ite (= i o71) true false) (ite (= i (peek
                                                     (rec__red_black_trees__rbt__struct
                                                       t_old__split_fields3)
                                                     o71
                                                     1))
...
(assert
  (not
  (= (to_rep3 (select (rec__red_black_trees__rbt__color t__split_fields7) i)) 
  (to_rep3
    (select (rec__red_black_trees__rbt__color t_old__split_fields3) i)))))
