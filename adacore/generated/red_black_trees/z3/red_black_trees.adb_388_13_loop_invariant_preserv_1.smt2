  ...
  (and
    ...
    (forall ((i Int))
      (=>
        (and (<= 1 i) (<= i 100))
        (= (to_rep3
             (select (rec__red_black_trees__rbt__color (us_split_fields7 t)) i)) 
        (to_rep3
          (select (rec__red_black_trees__rbt__color (us_split_fields7 t_old)) i)))))))
...
;; "red_black_trees__prove_same_nb_blacks_rotate__y__assume'unused"
(define-fun red_black_trees__prove_same_nb_blacks_rotate__y__assumeqtunused 
  () Int
  o4)
...
(assert
  (= (to_rep
       (rec__red_black_trees__black_count__count
         (us_split_fields11 (select (nb_blacks t_old) x)))) (to_rep
                                                              (rec__red_black_trees__black_count__count
                                                                (us_split_fields11
                                                                  (select 
                                                                  (nb_blacks
    ...
    (=>
      ...
      (=>
        (and
          ...
          (< (to_rep
               (rec__red_black_trees__black_count__depth
                 (us_split_fields11 (select (nb_blacks t_old) i)))) n1))
        (= (to_rep
             (rec__red_black_trees__black_count__count
               (us_split_fields11 (select (nb_blacks t) i)))) (to_rep
                                                                (rec__red_black_trees__black_count__count
...
(declare-const temp___1160 (Array Int us_rep6))

;; "H"
(assert (= temp___1160 (nb_blacks o10)))
      ...
      (=>
        ...
        (and
          (and
            (=
              (= (rec__red_black_trees__black_count__status
                   (us_split_fields11 (select temp___1160 i))) true)
              (= (to_rep
                   (rec__red_black_trees__black_count__count
                     (us_split_fields11
                       (select temp___1160 (peek
                                             (rec__red_black_trees__rbt__struct
            ...
            (= (to_rep
                 (rec__red_black_trees__black_count__depth
                   (us_split_fields11 (select temp___1160 i)))) (+ 1 
            (max
              (to_rep
                (rec__red_black_trees__black_count__depth
                  (us_split_fields11
          ...
          (= (to_rep
               (rec__red_black_trees__black_count__count
                 (us_split_fields11 (select temp___1160 i)))) (+ (ite (= 
                                                                   (to_rep3
                                                                    (select 
...
;; "H"
(assert (= nb_blacksqtresultqtunused temp___1160))

(declare-const o11 us_rep6)

;; "H"
(assert (= o11 (select temp___1160 x)))
...
;; "H"
(assert (= int__contentqtresultqtunused3 n1))
...
(declare-const temp___1165 (Array Int us_rep6))

;; "H"
(assert (= temp___1165 (nb_blacks o16)))
      ...
      (=>
        (= (rec__tree_model__path_type__k
             (us_split_fields9
               (select (model1
                         (rec__red_black_trees__rbt__struct
                           (us_split_fields7 o16))) i))) true)
        (and
          (and
            (=
              (= (rec__red_black_trees__black_count__status
                   (us_split_fields11 (select temp___1165 i))) true)
              (= (to_rep
                   (rec__red_black_trees__black_count__count
                     (us_split_fields11
                       (select temp___1165 (peek
                                             (rec__red_black_trees__rbt__struct
                                               (us_split_fields7 o16))
                                             i
                                             0))))) (to_rep
                                                      (rec__red_black_trees__black_count__count
                                                        (us_split_fields11
            ...
            (= (to_rep
                 (rec__red_black_trees__black_count__depth
                   (us_split_fields11 (select temp___1165 i)))) (+ 1 
            (max
              (to_rep
                (rec__red_black_trees__black_count__depth
                  (us_split_fields11
          ...
          (= (to_rep
               (rec__red_black_trees__black_count__count
                 (us_split_fields11 (select temp___1165 i)))) (+ (ite (= 
                                                                   (to_rep3
                                                                    (select 
                                                                    (rec__red_black_trees__rbt__color
                                                                    (us_split_fields7
...
;; "H"
(assert (= nb_blacksqtresultqtunused1 temp___1165))
...
;; "H"
(assert (= o21 (select temp___1165 o20)))

(declare-const getqtresultqtunused1 us_rep6)

;; "H"
(assert (= getqtresultqtunused1 o21))

(declare-const o22 us_split_fields10)

;; "H"
(assert (= o22 (us_split_fields11 o21)))

(declare-const us_split_fieldsqtresultqtunused3 us_split_fields10)

;; "H"
(assert (= us_split_fieldsqtresultqtunused3 o22))

(declare-const o23 extended_index_type)

;; "H"
(assert (= o23 (rec__red_black_trees__black_count__depth o22)))

(declare-const rec__red_black_trees__black_count__depthqtresultqtunused1 extended_index_type)

;; "H"
(assert (= rec__red_black_trees__black_count__depthqtresultqtunused1 o23))
...
;; "H"
(assert (= to_repqtresultqtunused1 o24))

(declare-const o25 Bool)

;; "H"
(assert (= o25 (ite (= o24 n1) true false)))

(declare-const infix_eqqtresultqtunused1 Bool)

;; "H"
(assert (= infix_eqqtresultqtunused1 o25))
...
;; "H"
(assert (= o27 (ite (<= usf1 100) true false)))
...
;; "H"
(assert (= o28 (ite (<= 1 usf1) true false)))

(declare-const infix_lseqqtresultqtunused5 Bool)

;; "H"
(assert (= infix_lseqqtresultqtunused5 o28))

(declare-const andbqtresultqtunused2 Bool)

;; "H"
(assert (= andbqtresultqtunused2 (and o28 o27)))
    ...
    (=>
      ...
      (=>
        (and
          ...
          (< (to_rep
               (rec__red_black_trees__black_count__depth
                 (us_split_fields11 (select (nb_blacks t_old) i)))) n2))
        (= (to_rep
             (rec__red_black_trees__black_count__count
               (us_split_fields11 (select (nb_blacks t) i)))) (to_rep
                                                                (rec__red_black_trees__black_count__count
...
(assert
  (=>
    (< (to_rep
         (rec__red_black_trees__black_count__depth
           (us_split_fields11 (select (nb_blacks t_old) x)))) n2)
    (= (to_rep
         (rec__red_black_trees__black_count__count
           (us_split_fields11 (select (nb_blacks t) y)))) (to_rep
                                                            (rec__red_black_trees__black_count__count
...
;; Goal "def'vc"
;; File "red_black_trees.adb", line 331, characters 0-0
(assert
  (not
  (= (rec__red_black_trees__black_count__status
       (us_split_fields11 (select (nb_blacks t) i))) true)))
