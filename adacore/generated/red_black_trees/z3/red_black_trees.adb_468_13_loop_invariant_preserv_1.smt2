...
;; "H"
(assert (= o17 (us_split_fields7 t_old)))
...
;; "H"
(assert (= o18 (rec__red_black_trees__rbt__struct o17)))

(declare-const rec__red_black_trees__rbt__structqtresultqtunused1 us_rep2)

;; "H"
(assert (= rec__red_black_trees__rbt__structqtresultqtunused1 o18))

(declare-const o19 Int)

;; "H"
(assert (= o19 (parent o18 o16)))
...
(assert
  (= o19 (parent1
           (rec__search_trees__search_tree__struct (us_split_fields5 o18))
           o16)))

;; "H"
(assert (=> (= (size o18) 0) (= o19 0)))

(declare-const parentqtresultqtunused Int)

;; "H"
(assert (= parentqtresultqtunused o19))

(declare-const infix_eqqtresultqtunused1 Bool)

;; "H"
(assert (= infix_eqqtresultqtunused1 (ite (= o19 0) true false)))
...
;; "H"
(assert (= o31 (ite (<= usf1 100) true false)))

(declare-const infix_lseqqtresultqtunused4 Bool)

;; "H"
(assert (= infix_lseqqtresultqtunused4 o31))

(declare-const o32 Bool)

;; "H"
(assert (= o32 (ite (<= 1 usf1) true false)))

(declare-const infix_lseqqtresultqtunused5 Bool)

;; "H"
(assert (= infix_lseqqtresultqtunused5 o32))

(declare-const andbqtresultqtunused2 Bool)

;; "H"
(assert (= andbqtresultqtunused2 (and o32 o31)))
