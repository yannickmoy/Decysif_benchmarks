...
;; "H"
(assert (= temp___29921 (model1 o88 o87)))
...
(assert
  (= (rec__tree_model__path_type__k
       (us_split_fields5 (select temp___29921 o87))) true))

;; "H"
(assert
  (= (last
       (rec__tree_model__path_type__a
         (us_split_fields5 (select temp___29921 o87)))) 0))
    ...
    (=>
      ...
      (=>
        ...
        (ite (and
               (not (= (parent o88 i2) 0))
               (= (rec__tree_model__path_type__k
                    (us_split_fields5 (select temp___29921 (parent o88 i2)))) true))
          (= (rec__tree_model__path_type__k
  ...
  (forall ((i2 Int))
    (=>
      ...
      (ite (and
        ...
        (= (is_add
             (rec__tree_model__path_type__a
               (us_split_fields5 (select temp___29921 (parent o88 i2))))
             (position o88 i2)
             (rec__tree_model__path_type__a
               (us_split_fields5 (select temp___29921 i2)))) true)
        (= (last
...
;; "H"
(assert (= o89 (select temp___29921 i1)))

(declare-const getqtresultqtunused14 us_rep3)

;; "H"
(assert (= getqtresultqtunused14 o89))

(declare-const o90 us_split_fields4)

;; "H"
(assert (= o90 (us_split_fields5 o89)))

(declare-const us_split_fieldsqtresultqtunused14 us_split_fields4)

;; "H"
(assert (= us_split_fieldsqtresultqtunused14 o90))

(declare-const o91 Bool)

;; "H"
(assert (= o91 (rec__tree_model__path_type__k o90)))

(declare-const rec__tree_model__path_type__kqtresultqtunused8 Bool)

;; "H"
(assert (= rec__tree_model__path_type__kqtresultqtunused8 o91))
          ...
          (and
              ...
              (and
                (and
                  (and
                    (and
                      (= (rec__tree_model__path_type__k
                           (us_split_fields5 (select temp___29931 o93))) true)
                      (= (last
                           (rec__tree_model__path_type__a
                             (us_split_fields5 (select temp___29931 o93)))) 0))
                    (forall ((i2 Int))
                      (=>
                        (and (<= 1 i2) (<= i2 100))
                        (=>
                          ...
                          (ite (and
                                 ...
                                 (= (rec__tree_model__path_type__k
                                      (us_split_fields5
                                        (select temp___29931 (parent o94 i2)))) true))
                            (= (rec__tree_model__path_type__k
                    ...
                    (=>
                      ...
                      (ite (and
                        ...
                        (= (is_add
                             (rec__tree_model__path_type__a
                               (us_split_fields5
                                 (select temp___29931 (parent o94 i2))))
                             (position o94 i2)
                             (rec__tree_model__path_type__a
                               (us_split_fields5 (select temp___29931 i2)))) true)
                        (= (last
            ...
            (and
              ...
              (and
                ...
                (and
                  (= o95 (select temp___29931 j2))
                  (and
                    (= getqtresultqtunused15 o95)
                    (and
                      (= o96 (us_split_fields5 o95))
                      (and
                        (= us_split_fieldsqtresultqtunused15 o96)
                        (and
                          (= o92 (rec__tree_model__path_type__k o96))
...
(assert
  (= (oeq
       (rec__tree_model__path_type__a
         (us_split_fields5 (select (model1 f_old root) j2)))
       (rec__tree_model__path_type__a
...
;; "Assert"
(assert (= (ordered_prefix (model1 f_old root) values i1 j2) true))
