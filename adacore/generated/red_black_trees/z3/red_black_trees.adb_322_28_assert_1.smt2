...
;; "temp___1076"
(define-fun temp___1076 () (Array Int us_rep6)
  (nb_blacks o5))
...
(define-fun nb_blacksqtresultqtunused () (Array Int us_rep6)
  temp___1076)

;; "o"
(define-fun o6 () us_rep6
  (select temp___1076 except))
...
(define-fun o7 () us_split_fields10
  (us_split_fields11 o6))

;; "__split_fields'result'unused"
(define-fun us_split_fieldsqtresultqtunused () us_split_fields10
  o7)

;; "o"
(define-fun o8 () extended_index_type
  (rec__red_black_trees__black_count__depth o7))

;; "rec__red_black_trees__black_count__depth'result'unused"
(define-fun rec__red_black_trees__black_count__depthqtresultqtunused 
  () extended_index_type
  o8)
