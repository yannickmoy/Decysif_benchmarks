...
(assert
  (= (rec__tree_model__path_type__k
       (us_split_fields7
         (let ((temp___536 (model1 o92 o91))) (select temp___536 i1)))) true))
...
(assert
  (= (olt
       (rec__tree_model__path_type__a
         (us_split_fields7
           (let ((temp___537 (model1 o92 o91))) (select temp___537 i1))))
       (rec__tree_model__path_type__a
         (us_split_fields7 (select (model1 o93 o91) y1)))) true))
...
(assert
  (= (get
       ...
       (+ (last
            (rec__tree_model__path_type__a
              (us_split_fields7
                (let ((temp___535 (model1 o92 o91))) (select temp___535 i1))))) 1)) 0))

;; Goal "def'vc"
;; File "search_trees.ads", line 121, characters 0-0
(assert
  (not (= (all_less_than o92 y1 o89 (to_rep (select o89 i1))) true)))
