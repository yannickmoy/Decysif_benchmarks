...
;; "H"
(assert
  (not (= (size (rec__red_black_trees__rbt__struct t_old__split_fields)) 0)))
...
(assert
  (= (rec__tree_model__path_type__k
       (us_split_fields9
         (select (model1
                   (rec__red_black_trees__rbt__struct t_old__split_fields)) 
         i))) true))
...
(assert
  (not
  (or
    (= (peek (rec__red_black_trees__rbt__struct t_old__split_fields) i d) 
    (peek
      (rec__red_black_trees__rbt__struct t__split_fields2)
      i
      d))
    (and
      (= (peek (rec__red_black_trees__rbt__struct t_old__split_fields) i d) 0)
      (not
        (= (rec__tree_model__path_type__k
             (us_split_fields9
               (select (model1
                         (rec__red_black_trees__rbt__struct
                           t_old__split_fields)) (peek
                                                   (rec__red_black_trees__rbt__struct
                                                     t__split_fields2)
                                                   i
                                                   d)))) true))))))
