...
;; "o"
(define-fun o23 () (Array Int natural)
...
;; "H"
(assert (= (ordered_leafs o25 x1 o23) true))

;; "H"
(assert (= (ordered_leafs o25 y1 o23) true))
...
(assert
  (= (correct_place
       o25
       (rec__tree_model__path_type__a
         (us_split_fields7 (select (model1 o24 x1) y1)))
       x1
       y1
       o23) true))
...
(assert
  (= (get
       (rec__tree_model__path_type__a
         (us_split_fields7
           (select (model1 (us_repqtmk1 dummy_1__split_fields1) x1) y1)))
       1) 1))

;; "Assert"
(assert
  (< (to_rep
       (select (rec__search_trees__search_tree__values t__split_fields2) 
       x1)) (to_rep
...
;; "o"
(define-fun o26 () (Array Int natural)
  (rec__search_trees__search_tree__values t__split_fields2))
...
;; "__rep'mk'result'unused"
(define-fun us_repqtmkqtresultqtunused73 () us_rep1
  o29)
...
(assert
  ...
  (= (oeq
       (rec__tree_model__path_type__a
         (us_split_fields7 (select (model1 o29 o28) i1)))
       (rec__tree_model__path_type__a
         (us_split_fields7 (select (model1 o30 o28) i1)))) true)))
