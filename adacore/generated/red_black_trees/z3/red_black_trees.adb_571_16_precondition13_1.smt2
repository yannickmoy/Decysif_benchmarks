...
;; "__split_fields__content'result'unused"
(define-fun us_split_fields__contentqtresultqtunused28 () us_split_fields6
  t__split_fields3)
...
;; "__split_fields'result'unused"
(define-fun us_split_fieldsqtresultqtunused19 () us_split_fields6
  t__split_fields3)

;; "__split_fields__content'result'unused"
(define-fun us_split_fields__contentqtresultqtunused29 () us_split_fields6
  t__split_fields3)
...
;; "temp___718"
(define-fun temp___718 () (Array Int color_type)
  (rec__red_black_trees__rbt__color t__split_fields3))

;; "rec__red_black_trees__rbt__color'result'unused"
(define-fun rec__red_black_trees__rbt__colorqtresultqtunused2 () (Array Int color_type)
  temp___718)

(declare-const o36 color_type)

;; "Ensures"
(assert (= (to_rep3 o36) 0))
...
;; "o"
(define-fun o37 () (Array Int color_type)
  (store temp___718 y2 o36))
...
;; "o"
(define-fun o38 () us_rep2
  (rec__red_black_trees__rbt__struct t__split_fields3))

;; "rec__red_black_trees__rbt__struct'result'unused"
(define-fun rec__red_black_trees__rbt__structqtresultqtunused12 () us_rep2
  o38)

;; "o"
(define-fun o39 () us_split_fields6
  (us_split_fieldsqtmk3 o38 o37))

;; "__split_fields'mk'result'unused"
(define-fun us_split_fieldsqtmkqtresultqtunused2 () us_split_fields6
  o39)
...
;; "H"
(assert (= t__split_fields4 o39))

;; "__split_fields__content'result'unused"
(define-fun us_split_fields__contentqtresultqtunused30 () us_split_fields6
  t__split_fields4)
...
;; "__split_fields__content'result'unused"
(define-fun us_split_fields__contentqtresultqtunused31 () us_split_fields6
  t__split_fields4)
...
;; "temp___724"
(define-fun temp___724 () (Array Int color_type)
...
(declare-const o40 color_type)

;; "Ensures"
(assert (= (to_rep3 o40) 0))
...
;; "__split_fields__content'result'unused"
(define-fun us_split_fields__contentqtresultqtunused32 () us_split_fields6
  t__split_fields4)
...
;; "rec__red_black_trees__rbt__struct'result'unused"
(define-fun rec__red_black_trees__rbt__structqtresultqtunused13 () us_rep2
  o41)

;; "temp___726"
(define-fun temp___726 () Int
  (parent o41 x2))

;; "H"
(assert (in_range2 temp___726))
...
;; "H"
(assert (=> (= (size o41) 0) (= temp___726 0)))
...
;; "Assert"
(assert (and (<= 1 temp___726) (<= temp___726 100)))

;; "o"
(define-fun o42 () (Array Int color_type)
  (store temp___724 temp___726 o40))
...
;; "rec__red_black_trees__rbt__struct'result'unused"
(define-fun rec__red_black_trees__rbt__structqtresultqtunused14 () us_rep2
  o43)

;; "o"
(define-fun o44 () us_split_fields6
  (us_split_fieldsqtmk3 o43 o42))
...
;; "H"
(assert (= t__split_fields5 o44))

;; "__split_fields__content'result'unused"
(define-fun us_split_fields__contentqtresultqtunused33 () us_split_fields6
  t__split_fields5)
...
;; "__split_fields__content'result'unused"
(define-fun us_split_fields__contentqtresultqtunused34 () us_split_fields6
  t__split_fields5)
...
;; "temp___731"
(define-fun temp___731 () (Array Int color_type)
...
(declare-const o45 color_type)

;; "Ensures"
(assert (= (to_rep3 o45) 1))

;; "of_rep'result'unused"
(define-fun of_repqtresultqtunused3 () color_type
  o45)
...
;; "__split_fields__content'result'unused"
(define-fun us_split_fields__contentqtresultqtunused35 () us_split_fields6
  t__split_fields5)
...
;; "rec__red_black_trees__rbt__struct'result'unused"
(define-fun rec__red_black_trees__rbt__structqtresultqtunused15 () us_rep2
  o46)

;; "temp___733"
(define-fun temp___733 () Int
  (parent o46 y2))

;; "H"
(assert (in_range2 temp___733))

;; "H"
(assert
  (= temp___733 (parent1
                  (rec__search_trees__search_tree__struct
                    (us_split_fields5 o46))
                  y2)))

;; "H"
(assert (=> (= (size o46) 0) (= temp___733 0)))

;; "parent'result'unused"
(define-fun parentqtresultqtunused5 () Int
  temp___733)

;; "Assert"
(assert (and (<= 1 temp___733) (<= temp___733 100)))

;; "o"
(define-fun o47 () (Array Int color_type)
  (store temp___731 temp___733 o45))

;; "set'result'unused"
(define-fun setqtresultqtunused3 () (Array Int color_type)
  o47)

;; "o"
(define-fun o48 () us_rep2
  (rec__red_black_trees__rbt__struct t__split_fields5))
...
;; "o"
(define-fun o49 () us_split_fields6
  (us_split_fieldsqtmk3 o48 o47))
...
;; "__split_fields__content'result'unused"
(define-fun us_split_fields__contentqtresultqtunused36 () us_split_fields6
  t__split_fields6)
...
(assert
  (= o51 (parent1
           (rec__search_trees__search_tree__struct (us_split_fields5 o50))
           y2)))

;; "H"
(assert (=> (= (size o50) 0) (= o51 0)))
...
;; "o"
(define-fun o52 () us_rep3
  (us_repqtmk3 t_old__split_fields2))
...
;; "H"
(assert
  (= (not (or (ite (= i x3) true false) (or (ite (= i (peek
                                                        (rec__red_black_trees__rbt__struct
                                                          t__split_fields6)
                                                        x3
                                                        0))
...
(assert
  (not
  (= (to_rep3 (select (rec__red_black_trees__rbt__color t__split_fields6) i)) 
  (to_rep3
    (select (rec__red_black_trees__rbt__color t_old__split_fields2) i)))))
