...
(assert
  (= (rec__tree_model__path_type__k
       (us_split_fields7 (select (model1 o80 y1) i1))) true))
...
(assert
  (<= (+ (last
           (rec__tree_model__path_type__a
             (us_split_fields7 (select (model1 o79 o78) y1)))) 1) i2))

;; "H"
(assert
  (<= i2 (last
           (rec__tree_model__path_type__a
             (us_split_fields7 (select (model1 o79 o78) i1))))))
...
(assert
  ...
  (= (get
       (rec__tree_model__path_type__a
         (us_split_fields7 (select (model1 o80 y1) i1)))
       (- i2 (last
               (rec__tree_model__path_type__a
