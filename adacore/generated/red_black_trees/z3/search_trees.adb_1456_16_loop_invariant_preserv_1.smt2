...
;; "H"
(assert (= int__contentqtresultqtunused8 ki2))

(declare-const o12 Bool)

;; "H"
(assert (= o12 (ite (= ki2 i) true false)))
  ...
  (ite (= spark__branch1 true)
    (and
      ...
      (and
        ...
        (and
          (= us_split_fieldsqtresultqtunused2 o14)
          (and
            (= o15 (rec__search_trees__search_tree__root o14))
            (and
              ...
              (and
                (= (to_rep1 o15) o16)
                (and
                  (= to_repqtresultqtunused1 o16)
                  (and
                    (in_range6 o16)
                    (and
                      (= range_check_qtresultqtunused1 o16)
                      (and
                        ...
                        (and
                          (= us_repqtmkqtresultqtunused1 (us_repqtmk2
                                                           t_old__split_fields))
                          (and
                            (= us_split_fieldsqtresultqtunused3 t_old__split_fields)
                            (and
                              (= o17 (rec__search_trees__search_tree__struct
                                       t_old__split_fields))
                              (and
                                    ...
                                    (=>
                                      ...
                                      (=>
                                        (and
                                          (= (rec__tree_model__path_type__k
                                               (us_split_fields7
                                                 (select (model1 o17 o16) j))) true)
                                          (= (olt
                                               (rec__tree_model__path_type__a
                                                 (us_split_fields7
                                                   (select (model1 o17 o16) 
                                                   o13)))
                                               (rec__tree_model__path_type__a
                                                 (us_split_fields7
                                                   (select (model1 o17 o16) j)))) true))
...
;; "H"
(assert (= o18 (ite (<= usf1 ki2) true false)))

(declare-const infix_lseqqtresultqtunused4 Bool)

;; "H"
(assert (= infix_lseqqtresultqtunused4 o18))

(declare-const o19 Bool)

;; "H"
(assert (= o19 (ite (<= 1 usf1) true false)))

(declare-const infix_lseqqtresultqtunused5 Bool)

;; "H"
(assert (= infix_lseqqtresultqtunused5 o19))

(declare-const andbqtresultqtunused2 Bool)

;; "H"
(assert (= andbqtresultqtunused2 (and o19 o18)))
...
(assert
  ...
  (= (ordered_prefix
       (model1
         ...
         (to_rep1
           (rec__search_trees__search_tree__root (us_split_fields5 t))))
       (rec__search_trees__search_tree__values (us_split_fields5 t))
       i1
       j) true)))
