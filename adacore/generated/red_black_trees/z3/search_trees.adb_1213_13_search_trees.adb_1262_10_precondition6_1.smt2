...
;; "temp___2135"
(define-fun temp___2135 () (Array Int us_rep4)
  (model1 o72 o71))

;; "H"
(assert (dynamic_invariant temp___2135 true false true true))

;; "H"
(assert
  (= (rec__tree_model__path_type__k
       (us_split_fields7 (select temp___2135 o71))) true))

;; "H"
(assert
  (= (last
       (rec__tree_model__path_type__a
         (us_split_fields7 (select temp___2135 o71)))) 0))
    ...
    (=>
      ...
      (=>
        ...
        (ite (and
               (not (= (parent o72 i1) 0))
               (= (rec__tree_model__path_type__k
                    (us_split_fields7 (select temp___2135 (parent o72 i1)))) true))
          (= (rec__tree_model__path_type__k
               (us_split_fields7 (select temp___2135 i1))) true)
          (not
            (= (rec__tree_model__path_type__k
                 (us_split_fields7 (select temp___2135 i1))) true)))))))
  ...
  (forall ((i1 Int))
    (=>
      ...
      (ite (and
        ...
        (= (is_add
             (rec__tree_model__path_type__a
               (us_split_fields7 (select temp___2135 (parent o72 i1))))
             (position o72 i1)
             (rec__tree_model__path_type__a
               (us_split_fields7 (select temp___2135 i1)))) true)
        (= (last
             (rec__tree_model__path_type__a
               (us_split_fields7 (select temp___2135 i1)))) 0)))))
        ...
        (forall ((j2 Int))
          (=>
            ...
            (=>
              (and
                (= (rec__tree_model__path_type__k
                     (us_split_fields7 (select temp___2135 j2))) true)
                (= (oeq
                     (rec__tree_model__path_type__a
                       (us_split_fields7 (select temp___2135 i1)))
                     (rec__tree_model__path_type__a
                       (us_split_fields7 (select temp___2135 j2)))) true))
              (= j2 i1))))))))
...
;; "o"
(define-fun o73 () us_rep4
  (select temp___2135 j1))
...
;; "o"
(define-fun o74 () us_split_fields6
  (us_split_fields7 o73))

;; "__split_fields'result'unused"
(define-fun us_split_fieldsqtresultqtunused61 () us_split_fields6
  o74)

;; "o"
(define-fun o75 () us_rep3
  (rec__tree_model__path_type__a o74))
...
;; "o"
(define-fun o76 () (Array Int natural)
...
;; "__rep'mk'result'unused"
(define-fun us_repqtmkqtresultqtunused104 () us_rep2
  (us_repqtmk2 t__split_fields6))
...
;; "H"
(assert (= (ordered_leafs o80 o78 o76) true))

;; "H"
(assert (= (ordered_leafs o80 y1 o76) true))
...
(assert
  (= (correct_place
       o80
       (rec__tree_model__path_type__a
         (us_split_fields7 (select (model1 o79 o78) y1)))
       o78
       y1
       o76) true))
...
;; "o"
(define-fun o81 () (Array Int natural)
  (rec__search_trees__search_tree__values t__split_fields6))
...
;; "o"
(define-fun o82 () extended_index_type
  (rec__search_trees__search_tree__root t__split_fields6))
...
;; "__split_fields__content'result'unused"
(define-fun us_split_fields__contentqtresultqtunused104 () us_split_fields2
  f_old__split_fields)
...
;; "__rep'mk'result'unused"
(define-fun us_repqtmkqtresultqtunused110 () us_rep1
  o86)

;; "temp___2139"
(define-fun temp___2139 () (Array Int us_rep4)
  (model1 o86 o85))

;; "H"
(assert (dynamic_invariant temp___2139 true false true true))

;; "H"
(assert
  (= (rec__tree_model__path_type__k
       (us_split_fields7 (select temp___2139 o85))) true))

;; "H"
(assert
  (= (last
       (rec__tree_model__path_type__a
         (us_split_fields7 (select temp___2139 o85)))) 0))
    ...
    (=>
      ...
      (=>
        ...
        (ite (and
               (not (= (parent o86 i1) 0))
               (= (rec__tree_model__path_type__k
                    (us_split_fields7 (select temp___2139 (parent o86 i1)))) true))
          (= (rec__tree_model__path_type__k
               (us_split_fields7 (select temp___2139 i1))) true)
          (not
            (= (rec__tree_model__path_type__k
                 (us_split_fields7 (select temp___2139 i1))) true)))))))
  ...
  (forall ((i1 Int))
    (=>
      ...
      (ite (and
        ...
        (= (is_add
             (rec__tree_model__path_type__a
               (us_split_fields7 (select temp___2139 (parent o86 i1))))
             (position o86 i1)
             (rec__tree_model__path_type__a
               (us_split_fields7 (select temp___2139 i1)))) true)
        (= (last
             (rec__tree_model__path_type__a
               (us_split_fields7 (select temp___2139 i1)))) 0)))))
        ...
        (forall ((j2 Int))
          (=>
            ...
            (=>
              (and
                (= (rec__tree_model__path_type__k
                     (us_split_fields7 (select temp___2139 j2))) true)
                (= (oeq
                     (rec__tree_model__path_type__a
                       (us_split_fields7 (select temp___2139 i1)))
                     (rec__tree_model__path_type__a
                       (us_split_fields7 (select temp___2139 j2)))) true))
              (= j2 i1))))))))
...
;; "o"
(define-fun o87 () us_rep4
  (select temp___2139 y1))
...
;; "o"
(define-fun o88 () us_split_fields6
  (us_split_fields7 o87))

;; "__split_fields'result'unused"
(define-fun us_split_fieldsqtresultqtunused67 () us_split_fields6
  o88)

;; "o"
(define-fun o89 () us_rep3
  (rec__tree_model__path_type__a o88))
...
;; "__split_fields__content'result'unused"
(define-fun us_split_fields__contentqtresultqtunused105 () us_split_fields2
  dummy_5__split_fields1)

;; "o"
(define-fun o90 () us_rep1
  (us_repqtmk1 dummy_5__split_fields1))

;; "__rep'mk'result'unused"
(define-fun us_repqtmkqtresultqtunused111 () us_rep1
  o90)

;; "__split_fields__content'result'unused"
(define-fun us_split_fields__contentqtresultqtunused106 () us_split_fields2
  dummy_1__split_fields1)

;; "o"
(define-fun o91 () us_rep1
  (us_repqtmk1 dummy_1__split_fields1))

;; "__rep'mk'result'unused"
(define-fun us_repqtmkqtresultqtunused112 () us_rep1
  o91)

;; "H"
(assert (= (correct_place o90 o89 o83 x1 o81) true))
...
;; "o"
(define-fun o92 () (Array Int natural)
  (rec__search_trees__search_tree__values t__split_fields6))
...
;; "__split_fields'result'unused"
(define-fun us_split_fieldsqtresultqtunused69 () us_split_fields4
  t__split_fields6)

;; "o"
(define-fun o93 () extended_index_type
  (rec__search_trees__search_tree__root t__split_fields6))
...
;; "__split_fields__content'result'unused"
(define-fun us_split_fields__contentqtresultqtunused109 () us_split_fields2
  dummy_5__split_fields1)

;; "o"
(define-fun o95 () us_rep1
  (us_repqtmk1 dummy_5__split_fields1))

;; "__rep'mk'result'unused"
(define-fun us_repqtmkqtresultqtunused115 () us_rep1
  o95)
...
;; "__rep'mk'result'unused"
(define-fun us_repqtmkqtresultqtunused116 () us_rep2
  (us_repqtmk2 t__split_fields6))
...
;; "o"
(define-fun o96 () us_rep1
  (rec__search_trees__search_tree__struct t__split_fields6))

;; "rec__search_trees__search_tree__struct'result'unused"
(define-fun rec__search_trees__search_tree__structqtresultqtunused21 
  () us_rep1
  o96)
...
(assert
  (= (rec__tree_model__path_type__k
       (us_split_fields7
         (let ((temp___536 (model1 o95 o94))) (select temp___536 i1)))) true))
...
(assert
  (= (olt
       (rec__tree_model__path_type__a
         (us_split_fields7
           (let ((temp___537 (model1 o95 o94))) (select temp___537 i1))))
       (rec__tree_model__path_type__a
         (us_split_fields7 (select (model1 o96 o94) x1)))) true))

;; "H"
(assert
  (= (get
       (rec__tree_model__path_type__a
         (us_split_fields7 (select (model1 o96 o94) x1)))
       (+ (last
            (rec__tree_model__path_type__a
              (us_split_fields7
                (let ((temp___535 (model1 o95 o94))) (select temp___535 i1))))) 1)) 0))

;; Goal "def'vc"
;; File "search_trees.ads", line 215, characters 0-0
(assert
  (not (= (all_less_than o95 x1 o92 (to_rep (select o92 i1))) true)))
