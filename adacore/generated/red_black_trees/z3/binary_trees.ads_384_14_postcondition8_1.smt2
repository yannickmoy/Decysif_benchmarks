...
;; "Assume"
(assert (< (size (us_repqtmk1 f__split_fields)) 100))
...
;; "temp___old_1952"
(define-fun temp___old_1952 () us_rep1
...
;; "temp___old_1958"
(define-fun temp___old_1958 () us_rep1
  (us_repqtmk1 f__split_fields))
...
;; "temp___old_1936"
(define-fun temp___old_1936 () us_rep1
  (us_repqtmk1 f__split_fields))
...
;; "temp___old_1930"
(define-fun temp___old_1930 () us_rep1
  (us_repqtmk1 f__split_fields))
...
;; "temp___old_1914"
(define-fun temp___old_1914 () us_rep1
  (us_repqtmk1 f__split_fields))
...
;; "temp___old_1903"
(define-fun temp___old_1903 () us_rep1
  (us_repqtmk1 f__split_fields))
...
;; "temp___old_1887"
(define-fun temp___old_1887 () us_rep1
  (us_repqtmk1 f__split_fields))
...
;; "temp___compl_1971"
(define-fun temp___compl_1971 () us_rep1
  (us_repqtmk1 f__split_fields))
...
;; "temp___1972"
(define-fun temp___1972 () us_rep1
  (us_repqtmk1 f__split_fields))
...
;; "Assert"
(assert (type_invariant temp___1972))

;; "temp___1974"
(define-fun temp___1974 () Int
  (size temp___compl_1971))

;; "H"
(assert (in_range temp___1974))

;; "H"
(assert
  (= temp___1974 (to_rep (rec__binary_trees__forest__s f__split_fields))))
...
;; "binary_trees__init__f_old__assume'unused"
(define-fun binary_trees__init__f_old__assumeqtunused () us_rep1
  (us_repqtmk1 f__split_fields))
...
(define-fun of_repqtresultqtunused () extended_index_type
  o4)

;; "o"
(define-fun o5 () us_split_fields2
  (us_split_fieldsqtmk1 o4 o))
    ...
    (=>
      ...
      (=>
        (= (to_rep1
             (rec__binary_trees__cell__position
               (us_split_fields1
                 (select (rec__binary_trees__forest__c f_old__split_fields) r)))) 2)
        (= (oeq1
    ...
    (=>
      ...
      (=>
        ...
        (not
          (= (rec__tree_model__path_type__k
               (us_split_fields5
                 (select (model1 (us_repqtmk1 f__split_fields1) root1) i))) true))))))
...
;; "H"
(assert (= (valid_root (us_repqtmk1 f__split_fields) i) true))
...
;; Goal "def'vc"
;; File "binary_trees.ads", line 380, characters 0-0
(assert
  (not
  (= (oeq
       (rec__tree_model__path_type__a
         (us_split_fields5
           (select (model1 (us_repqtmk1 f__split_fields1) i) i1)))
       (rec__tree_model__path_type__a
         (us_split_fields5
           (select (model1 (us_repqtmk1 f__split_fields) i) i1)))) true)))
