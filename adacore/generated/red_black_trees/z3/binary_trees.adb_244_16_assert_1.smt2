...
;; "H"
(assert
  (= (rec__tree_model__path_type__k (us_split_fields5 (select r3 k))) true))
...
(assert
  ...
  (not
    (= (olt
         (rec__tree_model__path_type__a (us_split_fields5 (select r3 j2)))
         (rec__tree_model__path_type__a (us_split_fields5 (select r3 k)))) true))))
