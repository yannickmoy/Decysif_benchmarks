...
;; "H"
(assert (= temp___30001 (model1 o109 o108)))
...
(assert
  (= (rec__tree_model__path_type__k
       (us_split_fields5 (select temp___30001 o108))) true))

;; "H"
(assert
  (= (last
       (rec__tree_model__path_type__a
         (us_split_fields5 (select temp___30001 o108)))) 0))
  ...
  (forall ((i2 Int))
    (=>
      ...
      (=>
        (not (= i2 o108))
        (ite (and
               (not (= (parent o109 i2) 0))
               (= (rec__tree_model__path_type__k
                    (us_split_fields5 (select temp___30001 (parent o109 i2)))) true))
          (= (rec__tree_model__path_type__k
  ...
  (forall ((i2 Int))
    (=>
      ...
      (ite (and
        ...
        (= (is_add
             (rec__tree_model__path_type__a
               (us_split_fields5 (select temp___30001 (parent o109 i2))))
             (position o109 i2)
             (rec__tree_model__path_type__a
               (us_split_fields5 (select temp___30001 i2)))) true)
        (= (last
...
(declare-const o110 us_rep3)

;; "H"
(assert (= o110 (select temp___30001 i1)))

(declare-const getqtresultqtunused18 us_rep3)

;; "H"
(assert (= getqtresultqtunused18 o110))

(declare-const o111 us_split_fields4)

;; "H"
(assert (= o111 (us_split_fields5 o110)))

(declare-const us_split_fieldsqtresultqtunused18 us_split_fields4)

;; "H"
(assert (= us_split_fieldsqtresultqtunused18 o111))
...
;; "H"
(assert (= rec__tree_model__path_type__kqtresultqtunused10 o112))
          ...
          (and
              ...
              (and
                (and
                  (and
                    (and
                      (= (rec__tree_model__path_type__k
                           (us_split_fields5 (select temp___30011 o114))) true)
                      (= (last
                           (rec__tree_model__path_type__a
                             (us_split_fields5 (select temp___30011 o114)))) 0))
                    (forall ((i2 Int))
                      (=>
                        (and (<= 1 i2) (<= i2 100))
                        (=>
                          (not (= i2 o114))
                          (ite (and
                                 (not (= (parent o115 i2) 0))
                                 (= (rec__tree_model__path_type__k
                                      (us_split_fields5
                                        (select temp___30011 (parent o115 i2)))) true))
                            (= (rec__tree_model__path_type__k
                    ...
                    (=>
                      ...
                      (ite (and
                        ...
                        (= (is_add
                             (rec__tree_model__path_type__a
                               (us_split_fields5
                                 (select temp___30011 (parent o115 i2))))
                             (position o115 i2)
                             (rec__tree_model__path_type__a
                               (us_split_fields5 (select temp___30011 i2)))) true)
                        (= (last
            ...
            (and
              ...
              (and
                ...
                (and
                  (= o116 (select temp___30011 j2))
                  (and
                    (= getqtresultqtunused19 o116)
                    (and
                      (= o117 (us_split_fields5 o116))
                      (and
                        (= us_split_fieldsqtresultqtunused19 o117)
                        (and
                          (= o113 (rec__tree_model__path_type__k o117))
...
(assert
  (= (olt
       ...
       (rec__tree_model__path_type__a
         (us_split_fields5 (select (model1 f_old v) j2)))) true))

;; "Assert"
(assert (= (ordered_prefix (model1 f_old v) values i1 j2) true))
