...
;; "H"
(assert (= andbqtresultqtunused o10))

(declare-const temp___loop_entry_954qtunused (Array Int us_rep6))

(declare-const map__contentqtresultqtunused (Array Int us_rep6))
...
(declare-const us_split_fieldsqtmkqtresultqtunused2 us_split_fields10)

(declare-const o13 us_rep6)

(declare-const us_repqtmkqtresultqtunused2 us_rep6)

(declare-const map__contentqtresultqtunused1 (Array Int us_rep6))

(declare-const o14 us_rep6)
...
(declare-const temp___loop_entry_936qtunused (Array Int us_rep6))

(declare-const map__contentqtresultqtunused2 (Array Int us_rep6))
...
(declare-const us_split_fieldsqtmkqtresultqtunused3 us_split_fields10)

(declare-const o20 us_rep6)

(declare-const us_repqtmkqtresultqtunused3 us_rep6)

(declare-const map__contentqtresultqtunused3 (Array Int us_rep6))
...
(assert
  (ite (= o10 true)
    (and
      (= temp___loop_entry_954qtunused res)
      (and
        (= map__contentqtresultqtunused res)
        (and
          (= o11 (distinct 1 0))
          (and
            (= of_intqtresultqtunused2 o11)
            (and
              (= o12 (us_split_fieldsqtmk5 o11 rliteral1 rliteral1))
              (and
                (= us_split_fieldsqtmkqtresultqtunused2 o12)
                (and
                  (= o13 (us_repqtmk5 o12))
                  (and
                    (= us_repqtmkqtresultqtunused2 o13)
                    (and
                      (= map__contentqtresultqtunused1 res)
                      (and
                        (= o14 (select res 0))
                        (and
                          (= getqtresultqtunused o14)
                          (and
                            (= bool_eqqtresultqtunused (bool_eq o14 o13))
                            (and
...
;; "red_black_trees__nb_blacks__result'unused"
(define-fun red_black_trees__nb_blacks__resultqtunused () map__ref
  (map__refqtmk red_black_trees__nb_blacks__result))

;; "H"
(assert (= red_black_trees__nb_blacks__result res1))

;; "result'unused"
(define-fun resultqtunused () (Array Int us_rep6)
  red_black_trees__nb_blacks__result)

;; "map__content'result'unused"
(define-fun map__contentqtresultqtunused15 () (Array Int us_rep6)
  red_black_trees__nb_blacks__result)
...
(assert
  (= (rec__red_black_trees__black_count__status
       (us_split_fields11 (select red_black_trees__nb_blacks__result i2))) true))
...
(assert
  ...
  (= (to_rep
       (rec__red_black_trees__black_count__count
         (us_split_fields11
           (select red_black_trees__nb_blacks__result (peek
                                                        (rec__red_black_trees__rbt__struct
                                                          (us_split_fields7
                                                            t))
                                                        i2
