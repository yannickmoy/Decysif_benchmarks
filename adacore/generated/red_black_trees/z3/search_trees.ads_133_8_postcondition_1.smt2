...
(assert
  ...
  (and
    (and
      (and
        (= (size (us_repqtmk2 t__split_fields6)) (size
                                                   (us_repqtmk2
                                                     t__split_fields)))
        (ite (not (= (root (us_repqtmk2 t__split_fields)) i))
          (= (root (us_repqtmk2 t__split_fields6)) (root
                                                     (us_repqtmk2
                                                       t__split_fields)))
          (= (root (us_repqtmk2 t__split_fields6)) (peek1
                                                     (us_repqtmk2
                                                       t__split_fields)
                                                     i
                                                     1))))
      (= (parent1 (us_repqtmk2 t__split_fields6) i) (peek1
                                                      (us_repqtmk2
                                                        t__split_fields)
                                                      i
                                                      1)))
    (= (position1 (us_repqtmk2 t__split_fields6) i) 0))))
