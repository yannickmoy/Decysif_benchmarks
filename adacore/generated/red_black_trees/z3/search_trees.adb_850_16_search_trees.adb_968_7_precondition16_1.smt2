...
;; "o"
(define-fun o39 () (Array Int natural)
  (rec__search_trees__search_tree__values t__split_fields4))
...
;; "temp___1409"
(define-fun temp___1409 () (Array Int us_rep4)
  (model1 o40 x1))

;; "H"
(assert (dynamic_invariant temp___1409 true false true true))

;; "H"
(assert
  (= (rec__tree_model__path_type__k
       (us_split_fields7 (select temp___1409 x1))) true))

;; "H"
(assert
  (= (last
       (rec__tree_model__path_type__a
         (us_split_fields7 (select temp___1409 x1)))) 0))
    ...
    (=>
      ...
      (=>
        ...
        (ite (and
               (not (= (parent o40 i1) 0))
               (= (rec__tree_model__path_type__k
                    (us_split_fields7 (select temp___1409 (parent o40 i1)))) true))
          (= (rec__tree_model__path_type__k
               (us_split_fields7 (select temp___1409 i1))) true)
          (not
            (= (rec__tree_model__path_type__k
                 (us_split_fields7 (select temp___1409 i1))) true)))))))
  ...
  (forall ((i1 Int))
    (=>
      ...
      (ite (and
        ...
        (= (is_add
             (rec__tree_model__path_type__a
               (us_split_fields7 (select temp___1409 (parent o40 i1))))
             (position o40 i1)
             (rec__tree_model__path_type__a
               (us_split_fields7 (select temp___1409 i1)))) true)
        (= (last
             (rec__tree_model__path_type__a
               (us_split_fields7 (select temp___1409 i1)))) 0)))))
        ...
        (forall ((j2 Int))
          (=>
            ...
            (=>
              (and
                (= (rec__tree_model__path_type__k
                     (us_split_fields7 (select temp___1409 j2))) true)
                (= (oeq
                     (rec__tree_model__path_type__a
                       (us_split_fields7 (select temp___1409 i1)))
                     (rec__tree_model__path_type__a
                       (us_split_fields7 (select temp___1409 j2)))) true))
              (= j2 i1))))))))
...
;; "o"
(define-fun o41 () us_rep4
  (select temp___1409 yl1))
...
;; "o"
(define-fun o42 () us_split_fields6
  (us_split_fields7 o41))
...
;; "o"
(define-fun o44 () us_rep1
  (us_repqtmk1 dummy_3__split_fields1))

;; "__rep'mk'result'unused"
(define-fun us_repqtmkqtresultqtunused83 () us_rep1
  o44)

;; "H"
(assert (= (correct_place o44 o43 x1 yl1 o39) true))
...
;; "__rep'mk'result'unused"
(define-fun us_repqtmkqtresultqtunused85 () us_rep1
  o46)
...
(assert
  (= (rec__tree_model__path_type__k
       (us_split_fields7 (select (model1 o46 yl1) i1))) true))
...
(assert
  (<= (+ (last
           (rec__tree_model__path_type__a
             (us_split_fields7 (select (model1 o47 x1) yl1)))) 1) i2))

;; "H"
(assert
  (<= i2 (last
           (rec__tree_model__path_type__a
             (us_split_fields7 (select (model1 o47 x1) i1))))))
...
(assert
  ...
  (= (get
       (rec__tree_model__path_type__a
         (us_split_fields7 (select (model1 o46 yl1) i1)))
       (- i2 (last
               (rec__tree_model__path_type__a
                 (us_split_fields7 (select (model1 o47 x1) yl1)))))) 
  (get
    (rec__tree_model__path_type__a
      (us_split_fields7 (select (model1 o47 x1) i1)))
    i2))))
