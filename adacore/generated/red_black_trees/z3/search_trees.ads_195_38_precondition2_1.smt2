                          ...
                          (and
                            ...
                            (and
                              ...
                              (and
                                ...
                                (and
                                  (= o55 (oeq1 temp___1836 temp___1842))
                                  (and
                                    (=
                                      (= o55 true)
                                      (and
...
;; "temp___compl_1854"
(define-fun temp___compl_1854 () Int
  i)

;; "Assert"
(assert (type_invariant temp___old_1852))

;; "temp___1859"
(define-fun temp___1859 () Int
  (peek1 temp___old_1852 temp___compl_1854 1))

;; "H"
(assert (in_range2 temp___1859))
...
;; "peek'result'unused"
(define-fun peekqtresultqtunused10 () Int
  temp___1859)

;; "Ensures"
(assert (in_range4 temp___1859))
...
;; "Assert"
(assert (type_invariant temp___old_1850))
...
(assert
  (not
  (= (rec__tree_model__path_type__k
       (us_split_fields7 (select (model2 temp___old_1850) temp___1859))) true)))
