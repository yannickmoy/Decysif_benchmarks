...
;; "H"
(assert (not (= (size (us_repqtmk2 t__split_fields6)) 0)))

;; "H"
(assert
  (= (rec__tree_model__path_type__k
       (us_split_fields7 (select (model2 (us_repqtmk2 t__split_fields6)) i1))) true))

;; "H"
(assert (or (not (= i1 j1)) (not (= d1 c))))

;; "H"
(assert (or (not (= i1 x1)) (not (= c 1))))

;; "H"
(assert (or (not (= i1 y1)) (not (= c 0))))
