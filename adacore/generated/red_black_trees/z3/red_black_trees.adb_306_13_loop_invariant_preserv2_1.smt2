  ...
  (and
    ...
    (forall ((i Int))
      (=>
        (and (<= 1 i) (<= i 100))
        (=>
          (= (not (or (ite (= i except) true false) (or (ite (= i (peek
                                                                    (rec__red_black_trees__rbt__struct
                                                                    (us_split_fields7
                                                                    t))
                                                                    except
         ...
         (=>
           ...
           (=>
             ...
             (ite (or
               ...
               (to_rep
                 (rec__red_black_trees__black_count__count
                   (us_split_fields11 (select (nb_blacks t_old) i)))) 1))
               (= (to_rep
                    (rec__red_black_trees__black_count__count
                      (us_split_fields11 (select (nb_blacks t) i)))) 
               (to_rep
...
(declare-const temp___1076 (Array Int us_rep6))

;; "H"
(assert (= temp___1076 (nb_blacks o5)))
      ...
      (=>
        (= (rec__tree_model__path_type__k
             (us_split_fields9
               (select (model1
                         (rec__red_black_trees__rbt__struct
                           (us_split_fields7 o5))) i))) true)
        (and
          (and
            (=
              (= (rec__red_black_trees__black_count__status
                   (us_split_fields11 (select temp___1076 i))) true)
              (= (to_rep
                   (rec__red_black_trees__black_count__count
                     (us_split_fields11
                       (select temp___1076 (peek
                                             (rec__red_black_trees__rbt__struct
                                               (us_split_fields7 o5))
                                             i
                                             0))))) (to_rep
            ...
            (= (to_rep
                 (rec__red_black_trees__black_count__depth
                   (us_split_fields11 (select temp___1076 i)))) (+ 1 
            (max
              (to_rep
                (rec__red_black_trees__black_count__depth
                  (us_split_fields11
          ...
          (= (to_rep
               (rec__red_black_trees__black_count__count
                 (us_split_fields11 (select temp___1076 i)))) (+ (ite (= 
                                                                   (to_rep3
                                                                    (select 
...
;; "H"
(assert (= nb_blacksqtresultqtunused temp___1076))

(declare-const o6 us_rep6)

;; "H"
(assert (= o6 (select temp___1076 except)))
...
(declare-const us_split_fieldsqtresultqtunused us_split_fields10)
...
;; "H"
(assert (= rec__red_black_trees__black_count__depthqtresultqtunused o8))
...
;; "H"
(assert (= to_repqtresultqtunused o9))

(declare-const o10 Bool)

;; "H"
(assert (= o10 (ite (= o9 n1) true false)))

(declare-const infix_eqqtresultqtunused Bool)

;; "H"
(assert (= infix_eqqtresultqtunused o10))
...
(assert
  (=>
    ...
    (and
      (= (rec__red_black_trees__black_count__status
           (us_split_fields11 (select (nb_blacks t) except))) true)
      (= (to_rep
           (rec__red_black_trees__black_count__count
             (us_split_fields11 (select (nb_blacks t) except)))) (to_rep
                                                                   (rec__red_black_trees__black_count__count
                                                                    (us_split_fields11
                                                                    (select 
                                                                    (nb_blacks
...
;; "H"
(assert (= o12 (ite (<= usf1 100) true false)))

(declare-const infix_lseqqtresultqtunused4 Bool)

;; "H"
(assert (= infix_lseqqtresultqtunused4 o12))

(declare-const o13 Bool)

;; "H"
(assert (= o13 (ite (<= 1 usf1) true false)))

(declare-const infix_lseqqtresultqtunused5 Bool)

;; "H"
(assert (= infix_lseqqtresultqtunused5 o13))

(declare-const andbqtresultqtunused2 Bool)

;; "H"
(assert (= andbqtresultqtunused2 (and o13 o12)))
