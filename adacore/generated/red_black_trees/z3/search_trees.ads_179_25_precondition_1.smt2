    ...
    (and
      (and
        ...
        (and
          (= jqtunused2 usf1)
          (and
            (= o62 (ite (<= usf1 100) true false))
            (and
              (= infix_lseqqtresultqtunused o62)
              (and
                (= o63 (ite (<= 1 usf1) true false))
                (and
                  (= infix_lseqqtresultqtunused1 o63)
                  (= andbqtresultqtunused (and o63 o62))))))))
      (and
        (= usf (ite (forall ((j2 Int))
                 ...
                 true
                 false))
        (and (= anyqtresultqtunused usf) (= o55 usf))))
    (= o55 false)))
...
;; "j'unused"
(define-fun jqtunused3 () Int
  usf2)

;; "o"
(define-fun o64 () Bool
  (ite (<= usf2 100) true false))
...
;; "H"
(assert (= infix_eqqtresultqtunused13 (ite (= usf2 i) true false)))
...
(assert
  (ite (not (= usf2 i))
    (and
      (type_invariant temp___old_1746)
      (and
        (= temp___1752 (parent1 temp___old_1746 usf2))
        (and
          (and
            (in_range2 temp___1752)
            (and
              (= temp___1752 (parent
                               (rec__search_trees__search_tree__struct
                                 t__split_fields)
                               usf2))
              (=> (= (size temp___old_1746) 0) (= temp___1752 0))))
          (and
            (= parentqtresultqtunused5 temp___1752)
            (and
              (= infix_eqqtresultqtunused14 (ite (= temp___1752 0)
                                              true
                                              false))
              (= o68 (ite (= temp___1752 0) false true)))))))
    (= o68 false)))
...
(assert
  (ite (= o68 true)
    (and
      (type_invariant temp___old_1753)
      (and
        (= temp___1759 (parent1 temp___old_1753 usf2))
        (and
          (and
            (in_range2 temp___1759)
            (and
              (= temp___1759 (parent
                               (rec__search_trees__search_tree__struct
                                 t__split_fields)
                               usf2))
              (=> (= (size temp___old_1753) 0) (= temp___1759 0))))
          (and
            (= parentqtresultqtunused6 temp___1759)
            (and
              (= infix_eqqtresultqtunused15 (ite (= temp___1759 i)
                                              true
                                              false))
              (ite (not (= temp___1759 i))
                (= o69 true)
                (and
                  (type_invariant temp___old_1760)
                  (and
                    (= temp___1766 (position1 temp___old_1760 usf2))
                    (and
                      (and
                        (in_range5 temp___1766)
                        (= temp___1766 (position
                                         (rec__search_trees__search_tree__struct
                                           t__split_fields)
                                         usf2)))
                      (and
                        (= positionqtresultqtunused5 temp___1766)
                        (and
                          (= o69 (ite (= temp___1766 0) true false))
                          (= infix_eqqtresultqtunused16 o69))))))))))))
    (= o69 false)))
...
(declare-const positionqtresultqtunused7 Int)
...
(assert
  (ite (= o69 true)
    (and
      (and
        (type_invariant temp___old_1769)
        (and
          (= temp___1775 (parent1 temp___old_1769 usf2))
          (and
            (and
              (in_range2 temp___1775)
              (and
                (= temp___1775 (parent
                                 (rec__search_trees__search_tree__struct
                                   t__split_fields)
                                 usf2))
                (=> (= (size temp___old_1769) 0) (= temp___1775 0))))
            (and
              (= parentqtresultqtunused7 temp___1775)
              (and
                (in_range4 temp___1775)
                (and
                  (= range_check_qtresultqtunused13 temp___1775)
                  (and
                    (type_invariant temp___old_1767)
                    (and
                      (= temp___1780 (parent1 temp___old_1767 temp___1775))
                      (and
                        (and
                          (in_range2 temp___1780)
                          (and
                            (= temp___1780 (parent
                                             (rec__search_trees__search_tree__struct
                                               t__split_fields)
                                             temp___1775))
                            (=>
                              (= (size temp___old_1767) 0)
                              (= temp___1780 0))))
                        (and
                          (= parentqtresultqtunused8 temp___1780)
                          (and
                            (= infix_eqqtresultqtunused18 (ite (= temp___1780 
                                                            i)
                                                            true
                                                            false))
                            (ite (not (= temp___1780 i))
                              (= o70 true)
                              (and
                                (type_invariant temp___old_1783)
                                (and
                                  (= temp___1789 (parent1
                                                   temp___old_1783
                                                   usf2))
                                    ...
                                    (and
                                      ...
                                      (and
                                        (= temp___1789 (parent
                                                         ...
                                                         usf2))
                                        (=>
                                          (= (size temp___old_1783) 0)
                                          (= temp___1789 0))))
                                    (and
                                      (= parentqtresultqtunused9 temp___1789)
                                      (and
                                        (in_range4 temp___1789)
                                        (and
                                          (= range_check_qtresultqtunused14 
                                          temp___1789)
                                          (and
                                            (type_invariant temp___old_1781)
                                            (and
                                              (= temp___1794 (position1
                                                               temp___old_1781
                                                               temp___1789))
                                              (and
                                                (and
                                                  (in_range5 temp___1794)
                                                  (= temp___1794 (position
                                                                   (rec__search_trees__search_tree__struct
                                                                    t__split_fields)
                                                                   temp___1789)))
                                                (and
                                                  (= positionqtresultqtunused7 
                                                  temp___1794)
                                                  (and
                                                    (= o70 (ite (= temp___1794 0)
                                                             true
                                                             false))
                                                    (= infix_eqqtresultqtunused19 
                                                    o70))))))))))))))))))))))))
      (ite (= o70 true)
        (= o67 true)
        (and
          (type_invariant temp___old_1795)
          (and
            (= temp___1801 (position1 temp___old_1795 usf2))
            (and
              (and
                (in_range5 temp___1801)
                (= temp___1801 (position
                                 (rec__search_trees__search_tree__struct
                                   t__split_fields)
                                 usf2)))
              (and
                (= positionqtresultqtunused6 temp___1801)
                (and
                  (= o67 (ite (= temp___1801 1) true false))
                  (= infix_eqqtresultqtunused17 o67))))))))
    (= o67 false)))
...
;; "Assert"
(assert (type_invariant temp___old_1739))

;; "temp___1745"
(define-fun temp___1745 () Int
  (position1 temp___old_1739 usf2))

;; "H"
(assert (in_range5 temp___1745))

;; "H"
(assert
  (= temp___1745 (position
                   (rec__search_trees__search_tree__struct t__split_fields)
                   usf2)))

;; "position'result'unused"
(define-fun positionqtresultqtunused8 () Int
  temp___1745)
...
;; "temp___compl_1733"
(define-fun temp___compl_1733 () us_rep2
  (us_repqtmk2 t__split_fields6))

;; "__rep'mk'result'unused"
(define-fun us_repqtmkqtresultqtunused111 () us_rep2
  temp___compl_1733)

;; "__split_fields__content'result'unused"
(define-fun us_split_fields__contentqtresultqtunused105 () us_split_fields4
  t__split_fields6)

;; "temp___1735"
(define-fun temp___1735 () us_rep2
  (us_repqtmk2 t__split_fields6))

;; "__rep'mk'result'unused"
(define-fun us_repqtmkqtresultqtunused112 () us_rep2
  temp___1735)

;; "Assert"
(assert (type_invariant temp___1735))

;; Goal "def'vc"
;; File "search_trees.ads", line 121, characters 0-0
(assert
  (not (not (= (parent1 temp___compl_1733 usf2) 0))))
