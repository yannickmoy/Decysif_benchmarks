...
;; "temp___3856"
(define-fun temp___38561 () (Array Int us_rep)
  (rec__binary_trees__forest__c f_old__split_fields))
...
;; "o"
(define-fun o54 () us_rep
  (select temp___38561 r2))

;; "get'result'unused"
(define-fun getqtresultqtunused10 () us_rep
  o54)

;; "o"
(define-fun o55 () us_split_fields
  (us_split_fields1 o54))
...
;; "o"
(define-fun o56 () position_type
  (rec__binary_trees__cell__position o55))
...
(define-fun infix_eqqtresultqtunused9 () Bool
  (ite (= r2 root) true false))

;; "o"
(define-fun o59 () Bool
  (and (ite (= r2 root) false true) o58))
...
;; "temp___compl_3851"
(define-fun temp___compl_38511 () us_rep1
  (us_repqtmk1 f_old__split_fields))
...
;; "temp___compl_3852"
(define-fun temp___compl_3852 () Int
  root)
...
;; "temp___3854"
(define-fun temp___38541 () us_rep1
  (us_repqtmk1 f_old__split_fields))
...
;; "Assert"
(assert (type_invariant temp___38541))
    ...
    (=>
      ...
      (or
        (not
          (= (rec__tree_model__path_type__k
               (us_split_fields5
                 (select (model1 temp___compl_38511 temp___compl_3852) i))) true))
        (not
          (= (rec__tree_model__path_type__k
               (us_split_fields5 (select (model1 temp___compl_38511 r2) i))) true))))))
...
(assert
  (= (rec__tree_model__path_type__k
       (us_split_fields5 (select (model1 o62 r2) i))) true))
...
(assert
  ...
  (= (bool_eq
       ...
       (select (rec__binary_trees__forest__c f__split_fields) i)) true)))
