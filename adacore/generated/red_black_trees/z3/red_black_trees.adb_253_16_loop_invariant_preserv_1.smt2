...
(define-fun o1 () us_rep2
  (rec__red_black_trees__rbt__struct o))
...
;; "H"
(assert (= o7 (ite (<= usf 100) true false)))
...
;; "H"
(assert (= o8 (ite (<= 1 usf) true false)))
...
;; "H"
(assert (= o10 (ite (<= usf1 100) true false)))
...
;; "H"
(assert (= o11 (ite (<= 1 usf1) true false)))
...
;; "H"
(assert
  (not (= i (root (rec__red_black_trees__rbt__struct (us_split_fields7 t))))))
