...
(declare-const rqtunused2 Int)

;; "H"
(assert (= rqtunused2 usf2))

(declare-const us_split_fields__contentqtresultqtunused4 us_split_fields2)

;; "H"
(assert (= us_split_fields__contentqtresultqtunused4 f_old__split_fields))

(declare-const us_repqtmkqtresultqtunused4 us_rep1)

;; "H"
(assert (= us_repqtmkqtresultqtunused4 (us_repqtmk1 f_old__split_fields)))

(declare-const us_split_fieldsqtresultqtunused3 us_split_fields2)

;; "H"
(assert (= us_split_fieldsqtresultqtunused3 f_old__split_fields))

(declare-const o18 extended_index_type)

;; "H"
(assert (= o18 (rec__binary_trees__forest__s f_old__split_fields)))

(declare-const rec__binary_trees__forest__sqtresultqtunused1 extended_index_type)

;; "H"
(assert (= rec__binary_trees__forest__sqtresultqtunused1 o18))
...
;; "H"
(assert (= to_repqtresultqtunused2 o19))

(declare-const o20 Bool)

;; "H"
(assert (= o20 (ite (<= usf2 o19) true false)))
...
;; "H"
(assert (= o21 (ite (<= 1 usf2) true false)))
...
;; "H"
(assert (= andbqtresultqtunused4 (and o21 o20)))
           ...
           (=>
             (= (to_rep1
                  (rec__binary_trees__cell__position
                    (us_split_fields1
                      (select (rec__binary_trees__forest__c
                                f_old__split_fields) r2)))) 2)
             (= (oeq1
                  (model1 (us_repqtmk1 f_old__split_fields) r2)
                  (model1 (us_repqtmk1 f__split_fields) r2)) true))))
    true
    false))
...
(assert
  (forall ((r2 Int))
    (=>
      (and
        (<= 1 r2)
        (<= r2 (to_rep (rec__binary_trees__forest__s f_old__split_fields))))
      (=>
        (= (to_rep1
             (rec__binary_trees__cell__position
               (us_split_fields1
                 (select (rec__binary_trees__forest__c f_old__split_fields) r2)))) 2)
        (= (oeq1
             (model1 (us_repqtmk1 f_old__split_fields) r2)
             (model1 (us_repqtmk1 f__split_fields) r2)) true)))))
...
;; "temp___compl_4062"
(define-fun temp___compl_4062 () us_rep1
  (us_repqtmk1 f__split_fields))
...
;; "temp___4064"
(define-fun temp___4064 () us_rep1
  (us_repqtmk1 f__split_fields))
...
;; "Assert"
(assert (type_invariant temp___4064))

;; Goal "def'vc"
;; File "binary_trees.adb", line 1074, characters 0-0
(assert
  (not (= (valid_root temp___compl_4062 root) true)))
