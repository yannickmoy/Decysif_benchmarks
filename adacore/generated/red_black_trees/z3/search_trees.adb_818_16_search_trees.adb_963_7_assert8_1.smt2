...
;; "H"
(assert (= int__contentqtresultqtunused11 yl1))
...
(declare-const us_split_fields__contentqtresultqtunused70 us_split_fields4)

(declare-const us_repqtmkqtresultqtunused73 us_rep2)

(declare-const us_split_fieldsqtresultqtunused24 us_split_fields4)

(declare-const o29 (Array Int natural))

(declare-const rec__search_trees__search_tree__valuesqtresultqtunused3 (Array Int natural))
...
(declare-const us_repqtmkqtresultqtunused74 us_rep1)

(declare-const us_split_fields__contentqtresultqtunused72 us_split_fields4)

(declare-const us_repqtmkqtresultqtunused75 us_rep2)
...
(declare-const us_split_fields__contentqtresultqtunused73 us_split_fields4)

(declare-const us_repqtmkqtresultqtunused76 us_rep2)

(declare-const us_split_fieldsqtresultqtunused26 us_split_fields4)

(declare-const o31 (Array Int natural))

(declare-const rec__search_trees__search_tree__valuesqtresultqtunused4 (Array Int natural))
...
(declare-const us_split_fields__contentqtresultqtunused74 us_split_fields2)

(declare-const o32 us_rep1)

(declare-const us_repqtmkqtresultqtunused77 us_rep1)

(declare-const us_split_fields__contentqtresultqtunused75 us_split_fields4)

(declare-const us_repqtmkqtresultqtunused78 us_rep2)

(declare-const us_split_fieldsqtresultqtunused27 us_split_fields4)

(declare-const o33 us_rep1)

(declare-const rec__search_trees__search_tree__structqtresultqtunused9 us_rep1)

;; "H"
(assert
  (ite (= spark__branch1 true)
    (and
      (= us_split_fields__contentqtresultqtunused73 t__split_fields3)
      (and
        (= us_repqtmkqtresultqtunused76 (us_repqtmk2 t__split_fields3))
        (and
          (= us_split_fieldsqtresultqtunused26 t__split_fields3)
          (and
            (= o31 (rec__search_trees__search_tree__values t__split_fields3))
            (and
              (= rec__search_trees__search_tree__valuesqtresultqtunused4 
              o31)
              (and
                (= int__contentqtresultqtunused13 yl1)
                (and
                  (in_range4 yl1)
                  (and
                    ...
                    (and
                      ...
                      (and
                        ...
                        (and
                          (= o32 (us_repqtmk1 dummy_2__split_fields1))
                          (and
                            (= us_repqtmkqtresultqtunused77 o32)
                            (and
                              (= us_split_fields__contentqtresultqtunused75 
                              t__split_fields3)
                              (and
                                (= us_repqtmkqtresultqtunused78 (us_repqtmk2
                                                                  t__split_fields3))
                                (and
                                  (= us_split_fieldsqtresultqtunused27 
                                  t__split_fields3)
                                  (and
                                    (= o33 (rec__search_trees__search_tree__struct
                                             t__split_fields3))
                                    (and
                                      (= rec__search_trees__search_tree__structqtresultqtunused9 
                                      o33)
                                      (and
                                        (and
                                          (and
                                            (= (ordered_leafs o33 y1 o31) true)
                                            (= (ordered_leafs o33 yl1 o31) true))
                                          (= (correct_place
                                               o33
                                               (rec__tree_model__path_type__a
                                                 (us_split_fields7
                                                   (select (model1 o32 y1) 
                                                   yl1)))
                                               y1
                                               yl1
                                               o31) true))
                                        (= (get
                                             ...
                                             1) 0)))))))))))))))))))
    (and
      (= us_split_fields__contentqtresultqtunused70 t__split_fields3)
      (and
        (= us_repqtmkqtresultqtunused73 (us_repqtmk2 t__split_fields3))
        (and
          (= us_split_fieldsqtresultqtunused24 t__split_fields3)
          (and
            (= o29 (rec__search_trees__search_tree__values t__split_fields3))
            (and
              (= rec__search_trees__search_tree__valuesqtresultqtunused3 
              o29)
              (and
                (= int__contentqtresultqtunused12 y1)
                (and
                  (= us_split_fields__contentqtresultqtunused71 dummy_2__split_fields1)
                  (and
                    (= us_repqtmkqtresultqtunused74 (us_repqtmk1
                                                      dummy_2__split_fields1))
                    (and
                      (= us_split_fields__contentqtresultqtunused72 t__split_fields3)
                      (and
                        (= us_repqtmkqtresultqtunused75 (us_repqtmk2
                                                          t__split_fields3))
                        (and
                          (= us_split_fieldsqtresultqtunused25 t__split_fields3)
                          (and
                            (= o30 (rec__search_trees__search_tree__struct
                                     t__split_fields3))
                            (and
                              (= rec__search_trees__search_tree__structqtresultqtunused8 
                              o30)
                              (= (ordered_leafs o30 y1 o29) true))))))))))))))))
...
(define-fun o35 () us_rep1
  (us_repqtmk1 dummy_2__split_fields1))
...
;; "H"
(assert (= (ordered_leafs o36 x1 o34) true))
...
(declare-const us_repqtmkqtresultqtunused82 us_rep2)
...
(declare-const rec__search_trees__search_tree__rootqtresultqtunused6 extended_index_type)
...
(declare-const us_split_fields__contentqtresultqtunused81 us_split_fields2)

(declare-const us_repqtmkqtresultqtunused84 us_rep1)
...
(assert
  (=>
    (= spark__branch2 true)
    (and
      (= us_split_fields__contentqtresultqtunused79 t__split_fields3)
      (and
        (= us_repqtmkqtresultqtunused82 (us_repqtmk2 t__split_fields3))
        (and
          (= us_split_fieldsqtresultqtunused30 t__split_fields3)
          (and
            (= o37 (rec__search_trees__search_tree__values t__split_fields3))
            (and
              (= rec__search_trees__search_tree__valuesqtresultqtunused6 
              o37)
              (and
                (= us_split_fields__contentqtresultqtunused80 t__split_fields3)
                (and
                  (= us_repqtmkqtresultqtunused83 (us_repqtmk2
                                                    t__split_fields3))
                  (and
                    (= us_split_fieldsqtresultqtunused31 t__split_fields3)
                    (and
                      (= o38 (rec__search_trees__search_tree__root
                               t__split_fields3))
                      (and
                        (= rec__search_trees__search_tree__rootqtresultqtunused6 
                        o38)
                        (and
                          (= (to_rep1 o38) o39)
                          (and
                            (= to_repqtresultqtunused3 o39)
                            (and
                              (in_range4 o39)
                              (and
                                (= range_check_qtresultqtunused6 o39)
                                (and
                                  (= us_split_fields__contentqtresultqtunused81 
                                  dummy_2__split_fields1)
                                  (and
                                    (= us_repqtmkqtresultqtunused84 (us_repqtmk1
                                                                    dummy_2__split_fields1))
                                    (and
                                        ...
                                        (and
                                          ...
                                          (and
                                            ...
                                            (and
                                              ...
                                              o40)
                                              (= (ordered_leafs o40 o39 o37) true))))))))))))))))))))))))
...
(assert
  (= (rec__tree_model__path_type__k
       (us_split_fields7
         (let ((temp___529 (model1
                             (rec__search_trees__search_tree__struct
                               t__split_fields3)
                             yl1)))
           (select temp___529 j2)))) true))
...
(assert
  (not
  (< (to_rep
       (select (rec__search_trees__search_tree__values t__split_fields3) 
       j2)) (to_rep
              (select (rec__search_trees__search_tree__values
                        t__split_fields3) y1)))))
