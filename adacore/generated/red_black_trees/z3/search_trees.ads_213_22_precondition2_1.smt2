            ...
            (and
              ...
              (and
                ...
                (ite (not (= temp___1901 0))
                  ...
                  (and
                    (= o76 (distinct 1 0))
                    (= of_intqtresultqtunused2 o76)))))))))
    (= o76 false)))

(declare-const us_split_fields__contentqtresultqtunused110 us_split_fields4)

(declare-const temp___compl_1902 us_rep2)

(declare-const us_repqtmkqtresultqtunused117 us_rep2)

(declare-const temp___compl_1905 Int)

(declare-const temp___1910 Int)

(declare-const peekqtresultqtunused15 Int)

(declare-const range_check_qtresultqtunused15 Int)

(declare-const us_split_fields__contentqtresultqtunused111 us_split_fields4)

(declare-const temp___1913 us_rep2)

(declare-const us_repqtmkqtresultqtunused118 us_rep2)

(declare-const temp___1916 Int)

(declare-const peekqtresultqtunused16 Int)
...
(assert
  (ite (= o76 true)
    (and
      (= us_split_fields__contentqtresultqtunused110 t__split_fields6)
      (and
        (= temp___compl_1902 (us_repqtmk2 t__split_fields6))
        (and
          (= us_repqtmkqtresultqtunused117 temp___compl_1902)
          (and
            (= temp___compl_1905 i)
            (and
              (type_invariant temp___old_1903)
              (and
                (= temp___1910 (peek1 temp___old_1903 temp___compl_1905 1))
                (and
                  (and
                    (in_range2 temp___1910)
                    (= temp___1910 (peek
                                     (rec__search_trees__search_tree__struct
                                       t__split_fields)
                                     temp___compl_1905
                                     1)))
                  (and
                    (= peekqtresultqtunused15 temp___1910)
                    (and
                      (in_range4 temp___1910)
                      (and
                        (= range_check_qtresultqtunused15 temp___1910)
                        (and
                          (= us_split_fields__contentqtresultqtunused111 
                          t__split_fields6)
                          (and
                            (= temp___1913 (us_repqtmk2 t__split_fields6))
                            (and
                              (= us_repqtmkqtresultqtunused118 temp___1913)
                              (and
                                (type_invariant temp___1913)
                                (and
                                  (= temp___1916 (peek1
                                                   temp___compl_1902
                                                   temp___1910
                                  ...
                                  (and
                                    (and
                                      ...
                                      (= temp___1916 (peek
                                                       ...
                                                       0)))
                                    (and
                                      (= peekqtresultqtunused16 temp___1916)
                                      (and
                                        (= o55 (ite (= temp___1916 i)
                                                 true
                                                 false))
...
;; "j'unused"
(define-fun jqtunused6 () Int
  usf8)

;; "o"
(define-fun o77 () Bool
  (ite (<= usf8 100) true false))
...
;; "any'result'unused"
(define-fun anyqtresultqtunused9 () Int
  usf9)

;; "d'unused"
(define-fun dqtunused2 () Int
  usf9)

;; "o"
(define-fun o80 () Bool
  (ite (<= usf9 1) true false))
...
;; "__split_fields__content'result'unused"
(define-fun us_split_fields__contentqtresultqtunused112 () us_split_fields4
  t__split_fields6)

;; "temp___compl_1954"
(define-fun temp___compl_1954 () us_rep2
  (us_repqtmk2 t__split_fields6))

;; "__rep'mk'result'unused"
(define-fun us_repqtmkqtresultqtunused119 () us_rep2
  temp___compl_1954)

;; "__split_fields__content'result'unused"
(define-fun us_split_fields__contentqtresultqtunused113 () us_split_fields4
  t__split_fields6)

;; "temp___1955"
(define-fun temp___1955 () us_rep2
  (us_repqtmk2 t__split_fields6))

;; "__rep'mk'result'unused"
(define-fun us_repqtmkqtresultqtunused120 () us_rep2
  temp___1955)

;; "Assert"
(assert (type_invariant temp___1955))

;; "temp___1958"
(define-fun temp___1958 () (Array Int us_rep4)
  (model2 temp___compl_1954))

;; "H"
(assert (dynamic_invariant temp___1958 true false true true))
...
;; "o"
(define-fun o83 () us_rep4
  (select temp___1958 usf8))
...
;; "o"
(define-fun o84 () us_split_fields6
  (us_split_fields7 o83))

;; "__split_fields'result'unused"
(define-fun us_split_fieldsqtresultqtunused45 () us_split_fields6
  o84)

;; "o"
(define-fun o85 () Bool
  (rec__tree_model__path_type__k o84))
...
(declare-const temp___compl_1948 Int)

;; "H"
(assert (= temp___compl_1948 i))

;; "Assert"
(assert (type_invariant temp___old_1946))

(declare-const temp___1953 Int)

;; "H"
(assert (= temp___1953 (peek1 temp___old_1946 temp___compl_1948 1)))

;; "H"
(assert (in_range2 temp___1953))
...
(declare-const peekqtresultqtunused17 Int)

;; "H"
(assert (= peekqtresultqtunused17 temp___1953))

(declare-const infix_eqqtresultqtunused17 Bool)

;; "H"
(assert (= infix_eqqtresultqtunused17 (ite (= usf8 temp___1953) true false)))

(declare-const infix_eqqtresultqtunused18 Bool)

;; "H"
(assert
  (ite (not (= usf8 temp___1953))
    (= o86 true)
    (and
      (= o86 (ite (= usf9 1) true false))
      (= infix_eqqtresultqtunused18 o86))))

(declare-const o87 Bool)

(declare-const temp___compl_1934 Int)

;; "H"
(assert (= temp___compl_1934 i))

;; "Assert"
(assert (type_invariant temp___old_1932))

(declare-const temp___1938 Int)

;; "H"
(assert (= temp___1938 (parent1 temp___old_1932 temp___compl_1934)))

;; "H"
(assert (in_range2 temp___1938))
...
;; "H"
(assert (=> (= (size temp___old_1932) 0) (= temp___1938 0)))

(declare-const parentqtresultqtunused7 Int)

;; "H"
(assert (= parentqtresultqtunused7 temp___1938))

(declare-const infix_eqqtresultqtunused19 Bool)

;; "H"
(assert (= infix_eqqtresultqtunused19 (ite (= usf8 temp___1938) true false)))

(declare-const temp___compl_1941 Int)

(declare-const temp___1945 Int)

(declare-const positionqtresultqtunused6 Int)

(declare-const infix_eqqtresultqtunused20 Bool)

;; "H"
(assert
  (ite (not (= usf8 temp___1938))
    (= o87 true)
    (and
      (= temp___compl_1941 i)
      (and
        (type_invariant temp___old_1939)
        (and
          (= temp___1945 (position1 temp___old_1939 temp___compl_1941))
          (and
            (and
              (in_range5 temp___1945)
              (= temp___1945 (position
                               (rec__search_trees__search_tree__struct
                                 t__split_fields)
                               temp___compl_1941)))
            (and
              (= positionqtresultqtunused6 temp___1945)
              (and
                (= infix_eqqtresultqtunused20 (ite (= usf9 temp___1945)
                                                true
                                                false))
                (= o87 (ite (= usf9 temp___1945) false true))))))))))

;; "o"
(define-fun o88 () Bool
  (ite (= usf9 0) true false))
...
(define-fun infix_eqqtresultqtunused22 () Bool
  (ite (= usf8 i) true false))

;; "o"
(define-fun o89 () Bool
  (or (ite (= usf8 i) false true) o88))
...
;; "Assert"
(assert (type_invariant temp___old_1924))

;; "temp___1931"
(define-fun temp___1931 () Int
  (peek1 temp___old_1924 usf8 usf9))

;; "H"
(assert (in_range2 temp___1931))
...
;; "peek'result'unused"
(define-fun peekqtresultqtunused18 () Int
  temp___1931)

;; "__split_fields__content'result'unused"
(define-fun us_split_fields__contentqtresultqtunused114 () us_split_fields4
  t__split_fields6)

;; "temp___compl_1917"
(define-fun temp___compl_1917 () us_rep2
  (us_repqtmk2 t__split_fields6))

;; "__rep'mk'result'unused"
(define-fun us_repqtmkqtresultqtunused121 () us_rep2
  temp___compl_1917)

;; "__split_fields__content'result'unused"
(define-fun us_split_fields__contentqtresultqtunused115 () us_split_fields4
  t__split_fields6)

;; "temp___1920"
(define-fun temp___1920 () us_rep2
  (us_repqtmk2 t__split_fields6))

;; "__rep'mk'result'unused"
(define-fun us_repqtmkqtresultqtunused122 () us_rep2
  temp___1920)

;; "Assert"
(assert (type_invariant temp___1920))
...
(assert
  (not
  (= (rec__tree_model__path_type__k
       (us_split_fields7 (select (model2 temp___compl_1917) usf8))) true)))
