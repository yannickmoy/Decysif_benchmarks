...
;; "H"
(assert (= temp___30201 (model1 o129 o128)))
...
(assert
  (= (rec__tree_model__path_type__k
       (us_split_fields5 (select temp___30201 o128))) true))

;; "H"
(assert
  (= (last
       (rec__tree_model__path_type__a
         (us_split_fields5 (select temp___30201 o128)))) 0))
  ...
  (forall ((i2 Int))
    (=>
      ...
      (=>
        (not (= i2 o128))
        (ite (and
               (not (= (parent o129 i2) 0))
               (= (rec__tree_model__path_type__k
                    (us_split_fields5 (select temp___30201 (parent o129 i2)))) true))
          (= (rec__tree_model__path_type__k
  ...
  (forall ((i2 Int))
    (=>
      ...
      (ite (and
        ...
        (= (is_add
             (rec__tree_model__path_type__a
               (us_split_fields5 (select temp___30201 (parent o129 i2))))
             (position o129 i2)
             (rec__tree_model__path_type__a
               (us_split_fields5 (select temp___30201 i2)))) true)
        (= (last
...
;; "H"
(assert (= o130 (select temp___30201 i1)))

(declare-const getqtresultqtunused22 us_rep3)

;; "H"
(assert (= getqtresultqtunused22 o130))

(declare-const o131 us_split_fields4)

;; "H"
(assert (= o131 (us_split_fields5 o130)))

(declare-const us_split_fieldsqtresultqtunused22 us_split_fields4)

;; "H"
(assert (= us_split_fieldsqtresultqtunused22 o131))

(declare-const o132 Bool)

;; "H"
(assert (= o132 (rec__tree_model__path_type__k o131)))

(declare-const rec__tree_model__path_type__kqtresultqtunused12 Bool)

;; "H"
(assert (= rec__tree_model__path_type__kqtresultqtunused12 o132))
          ...
          (and
              ...
              (and
                (and
                  (and
                    (and
                      (= (rec__tree_model__path_type__k
                           (us_split_fields5 (select temp___30211 o134))) true)
                      (= (last
                           (rec__tree_model__path_type__a
                             (us_split_fields5 (select temp___30211 o134)))) 0))
                    (forall ((i2 Int))
                      (=>
                        (and (<= 1 i2) (<= i2 100))
                        (=>
                          (not (= i2 o134))
                          (ite (and
                                 (not (= (parent o135 i2) 0))
                                 (= (rec__tree_model__path_type__k
                                      (us_split_fields5
                                        (select temp___30211 (parent o135 i2)))) true))
                            (= (rec__tree_model__path_type__k
                    ...
                    (=>
                      ...
                      (ite (and
                        ...
                        (= (is_add
                             (rec__tree_model__path_type__a
                               (us_split_fields5
                                 (select temp___30211 (parent o135 i2))))
                             (position o135 i2)
                             (rec__tree_model__path_type__a
                               (us_split_fields5 (select temp___30211 i2)))) true)
                        (= (last
            ...
            (and
              ...
              (and
                ...
                (and
                  (= o136 (select temp___30211 j2))
                  (and
                    (= getqtresultqtunused23 o136)
                    (and
                      (= o137 (us_split_fields5 o136))
                      (and
                        (= us_split_fieldsqtresultqtunused23 o137)
                        (and
                          (= o133 (rec__tree_model__path_type__k o137))
...
(declare-const temp___30281 (Array Int us_rep3))

;; "H"
(assert (= temp___30281 (model1 o150 o149)))

;; "H"
(assert (dynamic_invariant temp___30281 true false true true))

;; "H"
(assert
  (= (rec__tree_model__path_type__k
       (us_split_fields5 (select temp___30281 o149))) true))

;; "H"
(assert
  (= (last
       (rec__tree_model__path_type__a
         (us_split_fields5 (select temp___30281 o149)))) 0))
  ...
  (forall ((i2 Int))
    (=>
      ...
      (=>
        (not (= i2 o149))
        (ite (and
               (not (= (parent o150 i2) 0))
               (= (rec__tree_model__path_type__k
                    (us_split_fields5 (select temp___30281 (parent o150 i2)))) true))
          (= (rec__tree_model__path_type__k
               (us_split_fields5 (select temp___30281 i2))) true)
          (not
            (= (rec__tree_model__path_type__k
                 (us_split_fields5 (select temp___30281 i2))) true)))))))
  ...
  (forall ((i2 Int))
    (=>
      ...
      (ite (and
        ...
        (= (is_add
             (rec__tree_model__path_type__a
               (us_split_fields5 (select temp___30281 (parent o150 i2))))
             (position o150 i2)
             (rec__tree_model__path_type__a
               (us_split_fields5 (select temp___30281 i2)))) true)
        (= (last
             (rec__tree_model__path_type__a
               (us_split_fields5 (select temp___30281 i2)))) 0)))))
        ...
        (forall ((j3 Int))
          (=>
            ...
            (=>
              (and
                (= (rec__tree_model__path_type__k
                     (us_split_fields5 (select temp___30281 j3))) true)
                (= (oeq
                     (rec__tree_model__path_type__a
                       (us_split_fields5 (select temp___30281 i2)))
                     (rec__tree_model__path_type__a
                       (us_split_fields5 (select temp___30281 j3)))) true))
              (= j3 i2))))))))
...
;; "H"
(assert (= modelqtresultqtunused26 temp___30281))

(declare-const int__contentqtresultqtunused34 Int)

;; "H"
(assert (= int__contentqtresultqtunused34 i1))

(declare-const o151 us_rep3)

;; "H"
(assert (= o151 (select temp___30281 i1)))

(declare-const getqtresultqtunused26 us_rep3)

;; "H"
(assert (= getqtresultqtunused26 o151))

(declare-const o152 us_split_fields4)

;; "H"
(assert (= o152 (us_split_fields5 o151)))

(declare-const us_split_fieldsqtresultqtunused26 us_split_fields4)

;; "H"
(assert (= us_split_fieldsqtresultqtunused26 o152))

(declare-const o153 Bool)

;; "H"
(assert (= o153 (rec__tree_model__path_type__k o152)))

(declare-const rec__tree_model__path_type__kqtresultqtunused14 Bool)

;; "H"
(assert (= rec__tree_model__path_type__kqtresultqtunused14 o153))
...
(declare-const temp___30291 (Array Int us_rep3))

(declare-const modelqtresultqtunused27 (Array Int us_rep3))

(declare-const int__contentqtresultqtunused35 Int)

(declare-const o157 us_rep3)

(declare-const getqtresultqtunused27 us_rep3)

(declare-const o158 us_split_fields4)

(declare-const us_split_fieldsqtresultqtunused27 us_split_fields4)

(declare-const rec__tree_model__path_type__kqtresultqtunused15 Bool)
  ...
  (ite (= o153 true)
    (and
      ...
      (and
        (= o156 f_old)
        (and
          (= temp___30291 (model1 o156 o155))
          (and
            (and
              (dynamic_invariant temp___30291 true false true true)
              (and
                (and
                  (and
                    (and
                      (= (rec__tree_model__path_type__k
                           (us_split_fields5 (select temp___30291 o155))) true)
                      (= (last
                           (rec__tree_model__path_type__a
                             (us_split_fields5 (select temp___30291 o155)))) 0))
                    (forall ((i2 Int))
                      (=>
                        (and (<= 1 i2) (<= i2 100))
                        (=>
                          (not (= i2 o155))
                          (ite (and
                                 (not (= (parent o156 i2) 0))
                                 (= (rec__tree_model__path_type__k
                                      (us_split_fields5
                                        (select temp___30291 (parent o156 i2)))) true))
                            (= (rec__tree_model__path_type__k
                                 (us_split_fields5 (select temp___30291 i2))) true)
                            (not
                              (= (rec__tree_model__path_type__k
                                   (us_split_fields5
                                     (select temp___30291 i2))) true)))))))
                  (forall ((i2 Int))
                    (=>
                      (and (<= 1 i2) (<= i2 100))
                      (ite (and
                        ...
                        (= (is_add
                             (rec__tree_model__path_type__a
                               (us_split_fields5
                                 (select temp___30291 (parent o156 i2))))
                             (position o156 i2)
                             (rec__tree_model__path_type__a
                               (us_split_fields5 (select temp___30291 i2)))) true)
                        (= (last
                             (rec__tree_model__path_type__a
                               (us_split_fields5 (select temp___30291 i2)))) 0)))))
                (forall ((i2 Int))
                  (=>
                    (and (<= 1 i2) (<= i2 100))
                    (=>
                        ...
                        (=>
                          ...
                          (=>
                            (and
                              (= (rec__tree_model__path_type__k
                                   (us_split_fields5
                                     (select temp___30291 j3))) true)
                              (= (oeq
                                   (rec__tree_model__path_type__a
                                     (us_split_fields5
                                       (select temp___30291 i2)))
                                   (rec__tree_model__path_type__a
                                     (us_split_fields5
                                       (select temp___30291 j3)))) true))
                            (= j3 i2)))))))))
            (and
              (= modelqtresultqtunused27 temp___30291)
              (and
                (= int__contentqtresultqtunused35 j2)
                (and
                  (= o157 (select temp___30291 j2))
                  (and
                    (= getqtresultqtunused27 o157)
                    (and
                      (= o158 (us_split_fields5 o157))
                      (and
                        (= us_split_fieldsqtresultqtunused27 o158)
                        (and
                          (= o154 (rec__tree_model__path_type__k o158))
                          (= rec__tree_model__path_type__kqtresultqtunused15 
                          o154))))))))))))
    (= o154 false)))
...
;; "H"
(assert (= spark__branchqtunused7 (bool__refqtmk spark__branch7)))

;; "H"
(assert (= spark__branch7 o154))
        ...
        (forall ((i2 Int))
          (=>
            ...
            (or
              (not
                (= (rec__tree_model__path_type__k
                     (us_split_fields5 (select (model1 o159 root) i2))) true))
              (not
                (= (rec__tree_model__path_type__k
                     (us_split_fields5 (select (model1 o159 v) i2))) true)))))
        (not
          (= (olt
               (rec__tree_model__path_type__a
                 (us_split_fields5 (select (model1 f root) i1)))
...
;; "H"
(assert (= int__contentqtresultqtunused36 j2))

(declare-const o160 Bool)

;; "H"
(assert (= o160 (ite (<= usf2 j2) true false)))

(declare-const infix_lseqqtresultqtunused8 Bool)

;; "H"
(assert (= infix_lseqqtresultqtunused8 o160))

(declare-const o161 Bool)

;; "H"
(assert (= o161 (ite (<= 1 usf2) true false)))

(declare-const infix_lseqqtresultqtunused9 Bool)

;; "H"
(assert (= infix_lseqqtresultqtunused9 o161))

(declare-const andbqtresultqtunused4 Bool)

;; "H"
(assert (= andbqtresultqtunused4 (and o161 o160)))
...
(assert
  (not (= (ordered_prefix (model1 f root) values i1 k) true)))
