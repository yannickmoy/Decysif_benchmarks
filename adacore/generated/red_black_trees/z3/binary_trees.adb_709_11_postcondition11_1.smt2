...
;; "H"
(assert (<= r2 (to_rep (rec__binary_trees__forest__s f__split_fields))))
...
(assert
  ...
  (= (oeq
       (rec__tree_model__path_type__a
         (us_split_fields5
           (select (model1 (us_repqtmk1 f_old__split_fields) r2) i)))
       (rec__tree_model__path_type__a
         (us_split_fields5
           (select (model1 (us_repqtmk1 f__split_fields) r2) i)))) true)))
