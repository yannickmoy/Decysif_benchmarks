...
;; "H"
(assert (= int__contentqtresultqtunused11 xr1))
...
(declare-const us_split_fields__contentqtresultqtunused76 us_split_fields4)

(declare-const us_repqtmkqtresultqtunused79 us_rep2)
...
(declare-const us_split_fields__contentqtresultqtunused77 us_split_fields2)

(declare-const us_repqtmkqtresultqtunused80 us_rep1)

(declare-const us_split_fields__contentqtresultqtunused78 us_split_fields4)
...
(declare-const us_split_fields__contentqtresultqtunused80 us_split_fields2)

(declare-const o35 us_rep1)

(declare-const us_repqtmkqtresultqtunused83 us_rep1)
  ...
  (ite (= spark__branch1 true)
    (and
      ...
      (and
        ...
        (and
          (= us_split_fieldsqtresultqtunused35 t__split_fields3)
          (and
            (= o34 (rec__search_trees__search_tree__values t__split_fields3))
            (and
              (= rec__search_trees__search_tree__valuesqtresultqtunused4 
              o34)
              (and
                (= int__contentqtresultqtunused13 xr1)
                (and
                  (in_range4 xr1)
                  (and
                    (= range_check_qtresultqtunused5 xr1)
                    (and
                      (= int__contentqtresultqtunused14 x1)
                      (and
                        (= us_split_fields__contentqtresultqtunused80 
                        dummy_2__split_fields1)
                        (and
                          (= o35 (us_repqtmk1 dummy_2__split_fields1))
                          (and
                            (= us_repqtmkqtresultqtunused83 o35)
                            (and
                              (= us_split_fields__contentqtresultqtunused81 
                              t__split_fields3)
                              (and
                                (= us_repqtmkqtresultqtunused84 (us_repqtmk2
                                                                  t__split_fields3))
                                (and
                                  (= us_split_fieldsqtresultqtunused36 
                                  t__split_fields3)
                                  (and
                                    (= o36 (rec__search_trees__search_tree__struct
                                             t__split_fields3))
                                    (and
                                      ...
                                      (and
                                        (and
                                          (and
                                            (= (ordered_leafs o36 x1 o34) true)
                                            (= (ordered_leafs o36 xr1 o34) true))
                                          (= (correct_place
                                               o36
                                               (rec__tree_model__path_type__a
                                                 (us_split_fields7
                                                   (select (model1 o35 x1) 
                                                   xr1)))
                                               x1
                                               xr1
                                               o34) true))
                                        (= (get
                                             ...
                                             1) 1)))))))))))))))))))
    (and
      (= us_split_fields__contentqtresultqtunused76 t__split_fields3)
      (and
        (= us_repqtmkqtresultqtunused79 (us_repqtmk2 t__split_fields3))
        (and
          (= us_split_fieldsqtresultqtunused33 t__split_fields3)
          (and
            (= o32 (rec__search_trees__search_tree__values t__split_fields3))
            (and
              (= rec__search_trees__search_tree__valuesqtresultqtunused3 
              o32)
              (and
                (= int__contentqtresultqtunused12 x1)
                (and
                  (= us_split_fields__contentqtresultqtunused77 dummy_2__split_fields1)
                  (and
                    (= us_repqtmkqtresultqtunused80 (us_repqtmk1
                                                      dummy_2__split_fields1))
                    (and
                      (= us_split_fields__contentqtresultqtunused78 t__split_fields3)
                      (and
                        (= us_repqtmkqtresultqtunused81 (us_repqtmk2
                                                          t__split_fields3))
                        (and
                          (= us_split_fieldsqtresultqtunused34 t__split_fields3)
                          (and
...
;; "H"
(assert (= (ordered_leafs o39 y1 o37) true))
...
(declare-const rec__search_trees__search_tree__rootqtresultqtunused5 extended_index_type)
...
(declare-const us_repqtmkqtresultqtunused90 us_rep1)
...
(assert
  (=>
    (= spark__branch2 true)
    (and
      (= us_split_fields__contentqtresultqtunused85 t__split_fields3)
      (and
        (= us_repqtmkqtresultqtunused88 (us_repqtmk2 t__split_fields3))
        (and
          (= us_split_fieldsqtresultqtunused39 t__split_fields3)
          (and
            (= o40 (rec__search_trees__search_tree__values t__split_fields3))
            (and
              (= rec__search_trees__search_tree__valuesqtresultqtunused6 
              o40)
              (and
                (= us_split_fields__contentqtresultqtunused86 t__split_fields3)
                (and
                  (= us_repqtmkqtresultqtunused89 (us_repqtmk2
                                                    t__split_fields3))
                  (and
                    (= us_split_fieldsqtresultqtunused40 t__split_fields3)
                    (and
                      (= o41 (rec__search_trees__search_tree__root
                               t__split_fields3))
                      (and
                        (= rec__search_trees__search_tree__rootqtresultqtunused5 
                        o41)
                        (and
                          (= (to_rep1 o41) o42)
                          (and
                            (= to_repqtresultqtunused2 o42)
                            (and
                              (in_range4 o42)
                              (and
                                (= range_check_qtresultqtunused6 o42)
                                (and
                                  (= us_split_fields__contentqtresultqtunused87 
                                  dummy_2__split_fields1)
                                  (and
                                    (= us_repqtmkqtresultqtunused90 (us_repqtmk1
                                                                    dummy_2__split_fields1))
                                    (and
                                        ...
                                        (and
                                          ...
                                          (and
                                            ...
                                            (and
                                              ...
                                              o43)
                                              (= (ordered_leafs o43 o42 o40) true))))))))))))))))))))))))
