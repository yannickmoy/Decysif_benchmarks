...
;; "H"
(assert (= int__contentqtresultqtunused ki))

(declare-const o Bool)

;; "H"
(assert (= o (ite (<= ki 100) true false)))
                  ...
                  (and
                    ...
                    (ite (= spark__branch true)
                      (and
                        (= o6 l)
                        (and
                          (= o7 (us_split_fields5 t))
                          (and
                            (= us_split_fieldsqtresultqtunused o7)
                            (and
                              (= o8 (rec__search_trees__search_tree__root o7))
                              (and
                                        ...
                                        (and
                                          ...
                                          (and
                                            ...
                                            (and
                                              ...
                                              t_old__split_fields)
                                              (and
                                                (= o10 (rec__search_trees__search_tree__struct
                                                         t_old__split_fields))
                                                (and
        ...
        (and
          ...
          (and
            (= usfqtunused (ite (forall ((i1 Int))
                             ...
                             false))
            (and
              (= anyqtresultqtunused (ite (forall ((i1 Int))
                                            (=>
                                              (and (<= 1 i1) (<= i1 ki))
                                              (forall ((j Int))
                                                (=>
              ...
              (and
                ...
                (and
                  ...
                  (and
                    (and (<= 1 ki1) (<= ki1 100))
                    (and
                      (= int__contentqtresultqtunused2 ki1)
                      (and
...
(assert
  ...
  (= (ordered_leafs
       ...
       (rec__search_trees__search_tree__values (us_split_fields5 t))) true)))
