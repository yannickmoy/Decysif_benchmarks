...
;; "__rep'mk'result'unused"
(define-fun us_repqtmkqtresultqtunused100 () us_rep2
  (us_repqtmk2 t__split_fields4))
...
;; "o"
(define-fun o56 () extended_index_type
...
;; "__split_fields__content'result'unused"
(define-fun us_split_fields__contentqtresultqtunused97 () us_split_fields2
  dummy_3__split_fields1)

;; "o"
(define-fun o58 () us_rep1
  (us_repqtmk1 dummy_3__split_fields1))

;; "__rep'mk'result'unused"
(define-fun us_repqtmkqtresultqtunused101 () us_rep1
  o58)

;; "__split_fields__content'result'unused"
(define-fun us_split_fields__contentqtresultqtunused98 () us_split_fields4
  t__split_fields4)
...
(assert
  (= (rec__tree_model__path_type__k
       (us_split_fields7 (select (model1 o59 o57) i1))) true))
...
(assert
  (not
  (= (rec__tree_model__path_type__k
       (us_split_fields7 (select (model1 o58 o57) i1))) true)))
