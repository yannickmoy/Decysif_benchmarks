...
(declare-const us_split_fieldsqtresultqtunused2 us_split_fields10)
    ...
    (and
      (and
        ...
        (and
          (= iqtunused usf)
          (and
            (= o24 (ite (<= usf 100) true false))
            (and
              (= infix_lseqqtresultqtunused2 o24)
              (and
                (= o25 (ite (<= 1 usf) true false))
                (and
              ...
              (and
                ...
                (and
                  (=>
                    ...
                    (to_rep
                      (rec__red_black_trees__black_count__count
                        (us_split_fields11 (select (nb_blacks t_old) y))))))
                  (and
                    (forall ((i Int))
                      (=>
                        (and (<= 1 i) (<= i 100))
                                  ...
                                  (=>
                                    (= (rec__tree_model__path_type__k
                                         (us_split_fields9
                                           (select (model1
                                                     (rec__red_black_trees__rbt__struct
                                                       (us_split_fields7 o18))) i))) true)
                                    (and
                                      (and
                                        (=
                                          (= (rec__red_black_trees__black_count__status
                                               (us_split_fields11
                                                 (select temp___1160 i))) true)
                                          (= (to_rep
                                               (rec__red_black_trees__black_count__count
                                                 (us_split_fields11
                                                   (select temp___1160 
                                             ...
                                             (rec__red_black_trees__black_count__count
                                               (us_split_fields11
                                                 ...
                                                 (peek
                                                   ...
                                                   0))))))))))))
                            (and
                              (= nb_blacksqtresultqtunused1 temp___1160)
                              (and
                                (= o19 (select temp___1160 x))
                                (and
                                  (= getqtresultqtunused1 o19)
                                  (and
                                    (= o20 (us_split_fields11 o19))
                                    (and
                                      (= us_split_fieldsqtresultqtunused3 
                                      o20)
                                      (and
                                        (= o21 (rec__red_black_trees__black_count__depth
                                                 o20))
                                        (and
                                               ...
                                               (rec__red_black_trees__black_count__count
                                                 (us_split_fields11
                                                   ...
                                                   (peek
                                                     ...
                                                     0))))))))))))
                              (and
                                (= nb_blacksqtresultqtunused temp___1165)
                                (and
                                  (= o9 x)
                                  (and
                                          ...
                                          (and
                                            ...
                                            (and
                                              ...
                                              (and
                                                ...
                                                o12)
                                                (and
                                                  (= o13 (select temp___1165 
                                                  o12))
                                                  (and
                                                    (= getqtresultqtunused 
                                                    o13)
                                                    (and
                                                      (= o14 (us_split_fields11
                                                               o13))
                                                      (and
                                                        (= us_split_fieldsqtresultqtunused2 
                                                        o14)
                                                        (and
                                                          (= o15 (rec__red_black_trees__black_count__depth
                                                                   o14))
                                                          (and
