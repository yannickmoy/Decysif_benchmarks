...
;; "o"
(define-fun o15 () us_split_fields4
  (us_split_fields5 t))
...
;; "o"
(define-fun o16 () extended_index_type
  (rec__search_trees__search_tree__root o15))
  ...
  (forall ((j Int))
    (=>
      ...
      (=>
        (and
          (= (rec__tree_model__path_type__k
               (us_split_fields7 (select (model1 o18 o17) j))) true)
          (= (olt
               (rec__tree_model__path_type__a
                 (us_split_fields7 (select (model1 o18 o17) o14)))
               (rec__tree_model__path_type__a
                 (us_split_fields7 (select (model1 o18 o17) j)))) true))
        (not
          (= (get
               (rec__tree_model__path_type__a
                 (us_split_fields7 (select (model1 o18 o17) j)))
               (+ (last
                    (rec__tree_model__path_type__a
                      (us_split_fields7 (select (model1 o18 o17) o14)))) 1)) 
          o13))))))
