                          ...
                          (and
                            ...
                            (and
                              ...
                              (and
                                ...
                                (and
                                  (= o58 (oeq1 temp___2527 temp___2533))
                                  (and
                                    (=
                                      (= o58 true)
                                      (and
...
;; "temp___compl_2545"
(define-fun temp___compl_2545 () Int
  i)

;; "Assert"
(assert (type_invariant temp___old_2543))

;; "temp___2550"
(define-fun temp___2550 () Int
  (peek1 temp___old_2543 temp___compl_2545 0))

;; "H"
(assert (in_range2 temp___2550))
...
;; "Assert"
(assert (type_invariant temp___old_2541))
...
(assert
  (not
  (= (rec__tree_model__path_type__k
       (us_split_fields7 (select (model2 temp___old_2541) temp___2550))) true)))
