...
;; "o"
(define-fun o16 () us_rep3
  t_old)

;; "temp___1165"
(define-fun temp___1165 () (Array Int us_rep6)
  (nb_blacks o16))
...
;; "nb_blacks'result'unused"
(define-fun nb_blacksqtresultqtunused1 () (Array Int us_rep6)
  temp___1165)
...
;; "o"
(define-fun o18 () us_split_fields6
  (us_split_fields7 t_old))

;; "__split_fields'result'unused"
(define-fun us_split_fieldsqtresultqtunused2 () us_split_fields6
  o18)

;; "o"
(define-fun o19 () us_rep2
  (rec__red_black_trees__rbt__struct o18))
...
(define-fun parentqtresultqtunused () Int
  o20)

;; "o"
(define-fun o21 () us_rep6
  (select temp___1165 o20))
...
;; "o"
(define-fun o22 () us_split_fields10
  (us_split_fields11 o21))

;; "__split_fields'result'unused"
(define-fun us_split_fieldsqtresultqtunused3 () us_split_fields10
  o22)

;; "o"
(define-fun o23 () extended_index_type
  (rec__red_black_trees__black_count__depth o22))

;; "rec__red_black_trees__black_count__depth'result'unused"
(define-fun rec__red_black_trees__black_count__depthqtresultqtunused1 
  () extended_index_type
  o23)
