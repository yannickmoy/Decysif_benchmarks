...
;; "H"
(assert (= o45 (select temp___3259 ki)))
        ...
        (and
          ...
          (and
            ...
            (and
              (in_range3 o54)
              (and
                (= range_check_qtresultqtunused1 o54)
                (and
                  ...
                  (and
                    ...
                    (and
                      ...
                      (and
                        ...
                        (and
                          (= temp___3271 (model1 temp___compl_3267 o54))
                          (and
                            (and
                              (dynamic_invariant
                                temp___3271
                                ...
                                (and
                                  (and
                                    (and
                                      (= (rec__tree_model__path_type__k
                                           (us_split_fields5
                                             (select temp___3271 o54))) true)
                                      (= (last
                                           (rec__tree_model__path_type__a
                                             (us_split_fields5
                                               (select temp___3271 o54)))) 0))
                                    (forall ((i Int))
                                      (=>
                                        (and (<= 1 i) (<= i 100))
                                        (=>
                            ...
                            (and
                              ...
                              (and
                                ...
                                (and
                                  (= o55 (select temp___3271 ki))
                                  (and
                                    (= getqtresultqtunused12 o55)
                                    (and
                                      (= o56 (us_split_fields5 o55))
                                      (and
...
;; "temp___3254"
(define-fun temp___3254 () (Array Int us_rep)
...
;; "o"
(define-fun o59 () position_type
  (rec__binary_trees__cell__position o58))
...
;; "temp___compl_3248"
(define-fun temp___compl_3248 () us_rep1
  (us_repqtmk1 f__split_fields))
...
;; "temp___compl_3249"
(define-fun temp___compl_3249 () Int
  root)
...
;; "temp___3250"
(define-fun temp___3250 () us_rep1
  (us_repqtmk1 f__split_fields))
...
;; "Assert"
(assert (type_invariant temp___3250))

;; "temp___3252"
(define-fun temp___3252 () (Array Int us_rep3)
  (model1 temp___compl_3248 temp___compl_3249))

;; "H"
(assert (dynamic_invariant temp___3252 true false true true))

;; "H"
(assert
  (= (rec__tree_model__path_type__k
       (us_split_fields5 (select temp___3252 temp___compl_3249))) true))

;; "H"
(assert
  (= (last
       (rec__tree_model__path_type__a
         (us_split_fields5 (select temp___3252 temp___compl_3249)))) 0))
...
(assert
  (forall ((i Int))
    (=>
      (and (<= 1 i) (<= i 100))
      (=>
        (not (= i temp___compl_3249))
        (ite (and
               (not (= (parent temp___compl_3248 i) 0))
               (= (rec__tree_model__path_type__k
                    (us_split_fields5
                      (select temp___3252 (parent temp___compl_3248 i)))) true))
          (= (rec__tree_model__path_type__k
               (us_split_fields5 (select temp___3252 i))) true)
          (not
            (= (rec__tree_model__path_type__k
                 (us_split_fields5 (select temp___3252 i))) true)))))))
    ...
    (=>
      ...
      (ite (and
        ...
        (= (is_add
             (rec__tree_model__path_type__a
               (us_split_fields5
                 (select temp___3252 (parent temp___compl_3248 i))))
             (position temp___compl_3248 i)
             (rec__tree_model__path_type__a
               (us_split_fields5 (select temp___3252 i)))) true)
        (= (last
             (rec__tree_model__path_type__a
               (us_split_fields5 (select temp___3252 i)))) 0)))))
        ...
        (forall ((j Int))
          (=>
            ...
            (=>
              (and
                (= (rec__tree_model__path_type__k
                     (us_split_fields5 (select temp___3252 j))) true)
                (= (oeq
                     (rec__tree_model__path_type__a
                       (us_split_fields5 (select temp___3252 i)))
                     (rec__tree_model__path_type__a
                       (us_split_fields5 (select temp___3252 j)))) true))
              (= j i))))))))
...
;; "o"
(define-fun o61 () us_rep3
  (select temp___3252 v))
...
;; "o"
(define-fun o62 () us_split_fields4
  (us_split_fields5 o61))
...
;; "temp___compl_3242"
(define-fun temp___compl_3242 () us_rep1
  (us_repqtmk1 f__split_fields))
...
;; "temp___compl_3243"
(define-fun temp___compl_3243 () Int
  root)
...
;; "temp___3244"
(define-fun temp___3244 () us_rep1
  (us_repqtmk1 f__split_fields))
...
;; "Assert"
(assert (type_invariant temp___3244))

;; "temp___3246"
(define-fun temp___3246 () (Array Int us_rep3)
  (model1 temp___compl_3242 temp___compl_3243))

;; "H"
(assert (dynamic_invariant temp___3246 true false true true))

;; "H"
(assert
  (= (rec__tree_model__path_type__k
       (us_split_fields5 (select temp___3246 temp___compl_3243))) true))

;; "H"
(assert
  (= (last
       (rec__tree_model__path_type__a
         (us_split_fields5 (select temp___3246 temp___compl_3243)))) 0))
...
(assert
  (forall ((i Int))
    (=>
      (and (<= 1 i) (<= i 100))
      (=>
        (not (= i temp___compl_3243))
        (ite (and
               (not (= (parent temp___compl_3242 i) 0))
               (= (rec__tree_model__path_type__k
                    (us_split_fields5
                      (select temp___3246 (parent temp___compl_3242 i)))) true))
          (= (rec__tree_model__path_type__k
               (us_split_fields5 (select temp___3246 i))) true)
          (not
            (= (rec__tree_model__path_type__k
                 (us_split_fields5 (select temp___3246 i))) true)))))))
    ...
    (=>
      ...
      (ite (and
        ...
        (= (is_add
             (rec__tree_model__path_type__a
               (us_split_fields5
                 (select temp___3246 (parent temp___compl_3242 i))))
             (position temp___compl_3242 i)
             (rec__tree_model__path_type__a
               (us_split_fields5 (select temp___3246 i)))) true)
        (= (last
             (rec__tree_model__path_type__a
               (us_split_fields5 (select temp___3246 i)))) 0)))))
        ...
        (forall ((j Int))
          (=>
            ...
            (=>
              (and
                (= (rec__tree_model__path_type__k
                     (us_split_fields5 (select temp___3246 j))) true)
                (= (oeq
                     (rec__tree_model__path_type__a
                       (us_split_fields5 (select temp___3246 i)))
                     (rec__tree_model__path_type__a
                       (us_split_fields5 (select temp___3246 j)))) true))
              (= j i))))))))
...
;; "o"
(define-fun o64 () us_rep3
  (select temp___3246 ki))
...
;; "o"
(define-fun o65 () us_split_fields4
  (us_split_fields5 o64))
...
;; "temp___compl_3236"
(define-fun temp___compl_3236 () us_rep1
  (us_repqtmk1 f_old__split_fields))
...
;; "temp___3238"
(define-fun temp___3238 () us_rep1
  (us_repqtmk1 f_old__split_fields))
...
;; "Assert"
(assert (type_invariant temp___3238))

;; "temp___3240"
(define-fun temp___3240 () (Array Int us_rep3)
  (model1 temp___compl_3236 o67))

;; "H"
(assert (dynamic_invariant temp___3240 true false true true))

;; "H"
(assert
  (= (rec__tree_model__path_type__k
       (us_split_fields5 (select temp___3240 o67))) true))

;; "H"
(assert
  (= (last
       (rec__tree_model__path_type__a
         (us_split_fields5 (select temp___3240 o67)))) 0))
  ...
  (forall ((i Int))
    (=>
      ...
      (=>
        (not (= i o67))
        (ite (and
               (not (= (parent temp___compl_3236 i) 0))
               (= (rec__tree_model__path_type__k
                    (us_split_fields5
                      (select temp___3240 (parent temp___compl_3236 i)))) true))
          (= (rec__tree_model__path_type__k
               (us_split_fields5 (select temp___3240 i))) true)
          (not
            (= (rec__tree_model__path_type__k
                 (us_split_fields5 (select temp___3240 i))) true)))))))
    ...
    (=>
      ...
      (ite (and
        ...
        (= (is_add
             (rec__tree_model__path_type__a
               (us_split_fields5
                 (select temp___3240 (parent temp___compl_3236 i))))
             (position temp___compl_3236 i)
             (rec__tree_model__path_type__a
               (us_split_fields5 (select temp___3240 i)))) true)
        (= (last
             (rec__tree_model__path_type__a
               (us_split_fields5 (select temp___3240 i)))) 0)))))
        ...
        (forall ((j Int))
          (=>
            ...
            (=>
              (and
                (= (rec__tree_model__path_type__k
                     (us_split_fields5 (select temp___3240 j))) true)
                (= (oeq
                     (rec__tree_model__path_type__a
                       (us_split_fields5 (select temp___3240 i)))
                     (rec__tree_model__path_type__a
                       (us_split_fields5 (select temp___3240 j)))) true))
              (= j i))))))))
...
;; "o"
(define-fun o68 () us_rep3
  (select temp___3240 ki))
...
;; "o"
(define-fun o69 () us_split_fields4
  (us_split_fields5 o68))
...
(define-fun o70 () us_rep2
  (rec__tree_model__path_type__a o69))
...
;; "temp___compl_3228"
(define-fun temp___compl_3228 () us_rep1
  (us_repqtmk1 f__split_fields))
...
;; "temp___compl_3229"
(define-fun temp___compl_3229 () Int
  root)
...
;; "temp___3230"
(define-fun temp___3230 () us_rep1
  (us_repqtmk1 f__split_fields))
...
;; "Assert"
(assert (type_invariant temp___3230))

;; "temp___3232"
(define-fun temp___3232 () (Array Int us_rep3)
  (model1 temp___compl_3228 temp___compl_3229))

;; "H"
(assert (dynamic_invariant temp___3232 true false true true))

;; "H"
(assert
  (= (rec__tree_model__path_type__k
       (us_split_fields5 (select temp___3232 temp___compl_3229))) true))

;; "H"
(assert
  (= (last
       (rec__tree_model__path_type__a
         (us_split_fields5 (select temp___3232 temp___compl_3229)))) 0))
...
(assert
  (forall ((i Int))
    (=>
      (and (<= 1 i) (<= i 100))
      (=>
        (not (= i temp___compl_3229))
        (ite (and
               (not (= (parent temp___compl_3228 i) 0))
               (= (rec__tree_model__path_type__k
                    (us_split_fields5
                      (select temp___3232 (parent temp___compl_3228 i)))) true))
          (= (rec__tree_model__path_type__k
               (us_split_fields5 (select temp___3232 i))) true)
          (not
            (= (rec__tree_model__path_type__k
                 (us_split_fields5 (select temp___3232 i))) true)))))))
    ...
    (=>
      ...
      (ite (and
        ...
        (= (is_add
             (rec__tree_model__path_type__a
               (us_split_fields5
                 (select temp___3232 (parent temp___compl_3228 i))))
             (position temp___compl_3228 i)
             (rec__tree_model__path_type__a
               (us_split_fields5 (select temp___3232 i)))) true)
        (= (last
             (rec__tree_model__path_type__a
               (us_split_fields5 (select temp___3232 i)))) 0)))))
        ...
        (forall ((j Int))
          (=>
            ...
            (=>
              (and
                (= (rec__tree_model__path_type__k
                     (us_split_fields5 (select temp___3232 j))) true)
                (= (oeq
                     (rec__tree_model__path_type__a
                       (us_split_fields5 (select temp___3232 i)))
                     (rec__tree_model__path_type__a
                       (us_split_fields5 (select temp___3232 j)))) true))
              (= j i))))))))
...
;; "temp___3234"
(define-fun temp___3234 () (Array Int us_rep)
  (rec__binary_trees__forest__c f__split_fields))
...
;; "o"
(define-fun o71 () us_rep
  (select temp___3234 ki))
...
;; "o"
(define-fun o72 () us_split_fields
  (us_split_fields1 o71))
...
;; "o"
(define-fun o73 () extended_index_type
  (rec__binary_trees__cell__parent o72))
...
;; "Assert"
(assert (and (<= 1 temp___3235) (<= temp___3235 100)))

;; "o"
(define-fun o74 () us_rep3
  (select temp___3232 temp___3235))
...
;; "o"
(define-fun o75 () us_split_fields4
  (us_split_fields5 o74))
...
;; "o"
(define-fun o76 () us_rep2
  (rec__tree_model__path_type__a o75))
...
;; "temp___compl_3220"
(define-fun temp___compl_3220 () us_rep1
  (us_repqtmk1 f_old__split_fields))
...
;; "temp___3222"
(define-fun temp___3222 () us_rep1
  (us_repqtmk1 f_old__split_fields))
...
;; "Assert"
(assert (type_invariant temp___3222))

;; "temp___3224"
(define-fun temp___3224 () (Array Int us_rep3)
  (model1 temp___compl_3220 o77))

;; "H"
(assert (dynamic_invariant temp___3224 true false true true))

;; "H"
(assert
  (= (rec__tree_model__path_type__k
       (us_split_fields5 (select temp___3224 o77))) true))

;; "H"
(assert
  (= (last
       (rec__tree_model__path_type__a
         (us_split_fields5 (select temp___3224 o77)))) 0))
  ...
  (forall ((i Int))
    (=>
      ...
      (=>
        (not (= i o77))
        (ite (and
               (not (= (parent temp___compl_3220 i) 0))
               (= (rec__tree_model__path_type__k
                    (us_split_fields5
                      (select temp___3224 (parent temp___compl_3220 i)))) true))
          (= (rec__tree_model__path_type__k
               (us_split_fields5 (select temp___3224 i))) true)
          (not
            (= (rec__tree_model__path_type__k
                 (us_split_fields5 (select temp___3224 i))) true)))))))
    ...
    (=>
      ...
      (ite (and
        ...
        (= (is_add
             (rec__tree_model__path_type__a
               (us_split_fields5
                 (select temp___3224 (parent temp___compl_3220 i))))
             (position temp___compl_3220 i)
             (rec__tree_model__path_type__a
               (us_split_fields5 (select temp___3224 i)))) true)
        (= (last
             (rec__tree_model__path_type__a
               (us_split_fields5 (select temp___3224 i)))) 0)))))
        ...
        (forall ((j Int))
          (=>
            ...
            (=>
              (and
                (= (rec__tree_model__path_type__k
                     (us_split_fields5 (select temp___3224 j))) true)
                (= (oeq
                     (rec__tree_model__path_type__a
                       (us_split_fields5 (select temp___3224 i)))
                     (rec__tree_model__path_type__a
                       (us_split_fields5 (select temp___3224 j)))) true))
              (= j i))))))))
...
;; "temp___3226"
(define-fun temp___3226 () (Array Int us_rep)
  (rec__binary_trees__forest__c f__split_fields))
...
;; "o"
(define-fun o78 () us_rep
  (select temp___3226 ki))
...
;; "o"
(define-fun o80 () extended_index_type
  (rec__binary_trees__cell__parent o79))
...
;; "Assert"
(assert (and (<= 1 temp___3227) (<= temp___3227 100)))

;; "o"
(define-fun o81 () us_rep3
  (select temp___3224 temp___3227))
...
;; "o"
(define-fun o82 () us_split_fields4
  (us_split_fields5 o81))
...
;; "o"
(define-fun o83 () us_rep2
  (rec__tree_model__path_type__a o82))
...
(assert
  (not (= (get o83 (- i (last o63))) (get o76 i))))
