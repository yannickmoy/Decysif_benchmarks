  ...
  (forall ((j Int))
    (=>
      ...
      (=>
        (and
          (= (rec__tree_model__path_type__k
               (us_split_fields7 (select (model1 o9 o8) j))) true)
          (= (olt
               (rec__tree_model__path_type__a
                 (us_split_fields7 (select (model1 o9 o8) o5)))
               (rec__tree_model__path_type__a
                 (us_split_fields7 (select (model1 o9 o8) j)))) true))
        (not
          (= (get
               (rec__tree_model__path_type__a
                 (us_split_fields7 (select (model1 o9 o8) j)))
               (+ (last
                    (rec__tree_model__path_type__a
                      (us_split_fields7 (select (model1 o9 o8) o5)))) 1)) 
          o4))))))
