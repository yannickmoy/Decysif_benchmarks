                      ...
                      (=>
                        ...
                        (=>
                          ...
                          (=>
                            ...
                            (forall ((res1 (Array Int us_rep6)))
                              (=>
                                (exists ((n Int))
                                  (and
                                    (= n 0)
                                    (ite (= (and (ite (<= 0 n) true false) 
                                      (ite (<= n 99)
                                        true
                                        false)) true)
                                      (exists ((res2 (Array Int us_rep6)) (n1 Int))
                                        (and
                                          (and
                                            (= (bool_eq
                                                 (select res2 0)
                                          ...
                                          (and
                                            ...
                                            (and
                                                ...
                                                (and
                                                  ...
                                                  (ite (= (and (ite (<= 1 i)
                                                    ...
                                                    (ite (<= i 100)
                                                      true
                                                      false)) true)
                                                    (exists ((res3 (Array Int us_rep6)) (i1 Int))
                                                      (and
                                                        (and
                                                          (= (bool_eq
                                                               (select res3 0)
                                                        ...
                                                        (and
                                                          (= (and (ite 
                                                                    ...
                                                                    (< temp___937 1)
                                                                    (<= i1 temp___937)))
                                                                    (= (select res3 temp___937) (select res2 temp___937)))))
                                                                    true
                                                                    false) 
                                                          (ite (and
                                                                 (<= 1 i1)
                                              ...
                                              (= n1 99)))))
                                      (= res1 res))))
                                (forall ((red_black_trees__nb_blacks__result (Array Int us_rep6)))
                                  (=>
                                    (= red_black_trees__nb_blacks__result res1)
                                    (forall ((i Int))
                                      (=>
                                        (and (<= 1 i) (<= i 100))
                                        (=>
                                          ...
                                          (=>
                                            (= (to_rep
                                                 (rec__red_black_trees__black_count__count
                                                   (us_split_fields11
                                                     (select red_black_trees__nb_blacks__result 
                                                     (peek
                                                       (rec__red_black_trees__rbt__struct
                                                         (us_split_fields7 t))
                                                       i
                                            ...
                                            (= (rec__red_black_trees__black_count__status
                                                 (us_split_fields11
                                                   (select red_black_trees__nb_blacks__result i))) true))))))))))))))))))))))))
