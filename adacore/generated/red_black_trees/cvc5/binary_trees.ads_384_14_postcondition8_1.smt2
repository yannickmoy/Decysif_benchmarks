...
(assert
  (not
  (forall ((f__split_fields us_split_fields2) (root Int))
    (=>
      ...
      (=>
        ...
        (=>
          ...
          (=>
            ...
            (=>
              (type_invariant (us_repqtmk1 f__split_fields))
              (let ((temp___1974 (size (us_repqtmk1 f__split_fields))))
                (=>
                  (and
                    (in_range temp___1974)
                    (= temp___1974 (to_rep
                                     (rec__binary_trees__forest__s
                                       f__split_fields))))
                        ...
                        (forall ((o Int))
                          (=>
                            ...
                            (let ((o1 (+ o 1)))
                              (=>
                                (in_range o1)
                                (forall ((o2 extended_index_type))
                                  (=>
                                    (= (to_rep o2) o1)
                                    (forall ((f__split_fields1 us_split_fields2))
                                      (=>
                                        (= f__split_fields1 (us_split_fieldsqtmk1
                                                              o2
                                                              (rec__binary_trees__forest__c
                                                                f__split_fields)))
                                        (forall ((o3 Int))
