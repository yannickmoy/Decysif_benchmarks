...
;; Goal "def'vc"
;; File "search_trees.adb", line 583, characters 0-0
(assert
  (not
  (=>
      ...
      (=>
        ...
        (=>
          (and
            (and
              (and
                (= (valid_root f1 root) true)
                (= (valid_root f2 root) true))
              (= (ordered_leafs f2 root values) true))
            (= (oeq1 (model1 f2 root) (model1 f1 root)) true))
          (=>
            (forall ((i Int))
              (=>
                (and (<= 1 i) (<= i 100))
                    ...
                    (=>
                      (and
                        (and
                          ...
                          (= (rec__tree_model__path_type__k
                               (us_split_fields5 (select (model1 f1 root) j))) true))
                        (= (olt
                             (rec__tree_model__path_type__a
                      ...
                      (and
                        ...
                        (= (get
                             (rec__tree_model__path_type__a
                               (us_split_fields5 (select (model1 f1 root) j)))
                             (+ (last
                                  (rec__tree_model__path_type__a
                                    (us_split_fields5
                                      (select (model1 f1 root) i)))) 1)) 
                        (get
                          (rec__tree_model__path_type__a
                            (us_split_fields5 (select (model1 f2 root) j)))
                          (+ (last
                               (rec__tree_model__path_type__a
                                 (us_split_fields5
                                   (select (model1 f2 root) i)))) 1)))))))))
            (=>
              (forall ((i Int))
                (=>
                  (and (<= 1 i) (<= i 100))
                    ...
                    (=>
                      ...
                      (=>
                        ...
                        (ite (= (get
                                  (rec__tree_model__path_type__a
                                    (us_split_fields5
                                      (select (model1 f1 root) j)))
                                  (+ (last
                                       (rec__tree_model__path_type__a
                                         (us_split_fields5
                                           (select (model1 f1 root) i)))) 1)) 0)
                          (< (to_rep (select values j)) (to_rep
                                                          (select values i)))
                          (< (to_rep (select values i)) (to_rep
                                                          (select values j)))))))))
              (= (ordered_leafs f1 root values) true)))))))))
