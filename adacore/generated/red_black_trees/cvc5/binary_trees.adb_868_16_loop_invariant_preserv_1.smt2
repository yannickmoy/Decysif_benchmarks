...
(assert
  (not
  (forall ((spark__branch Bool) (f__split_fields us_split_fields2) (f_old__split_fields us_split_fields2))
    (=>
      (in_range3 root)
      (=>
        (in_range v)
                    ...
                    (=>
                      ...
                      (forall ((spark__branch1 Bool))
                        (=>
                          ...
                          (forall ((binary_trees__plug__prove_post__L_17__R266b__assume Int))
                            (=>
                              (= (to_rep
                                   (rec__binary_trees__forest__s
                                     f_old__split_fields)) binary_trees__plug__prove_post__L_17__R266b__assume)
                              (=>
                                (= binary_trees__plug__prove_post__L_17__R266b__assume 
                                r266b)
                                (=>
                                  (in_range r266b)
                                  (let ((temp___3454 r266b))
                                    (forall ((r Int))
                                      (=>
                                        (= r 1)
                                        (=>
