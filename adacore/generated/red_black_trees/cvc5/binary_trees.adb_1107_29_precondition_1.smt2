              ...
              (forall ((n Int))
                (=>
                  ...
                  (=>
                    ...
                    (forall ((usf Int))
                      (=>
                        (= (and (ite (<= 1 usf) true false) (ite (<= usf 100)
                                                              true
                                                              false)) true)
                        (forall ((o Bool))
                          (=>
                            (let ((temp___compl_4023 (us_repqtmk1
                                                       f__split_fields)))
                              (and
                                (type_invariant
                                  (us_repqtmk1 f__split_fields))
                                (let ((temp___4027 (model1
                                                     temp___compl_4023
                                                     root)))
                                  (and
                                    (and
                                        ...
                                        (and
                                          (and
                                            (and
                                              (= (rec__tree_model__path_type__k
                                                   (us_split_fields5
                                                     (select temp___4027 root))) true)
                                              (= (last
                                                   (rec__tree_model__path_type__a
                                                     (us_split_fields5
                                                       (select temp___4027 root)))) 0))
                                            (forall ((i Int))
                                              (=>
                                                (and (<= 1 i) (<= i 100))
                                                (=>
                                                ...
                                                (=>
                                                  ...
                                                  (=>
                                                    (and
                                                      (= (rec__tree_model__path_type__k
                                                           (us_split_fields5
                                                             (select temp___4027 j))) true)
                                                      (= (oeq
                                                           (rec__tree_model__path_type__a
                                                             (us_split_fields5
                                                               (select temp___4027 i)))
                                                           (rec__tree_model__path_type__a
                                                             (us_split_fields5
                                                               (select temp___4027 j)))) true))
                                                    (= j i)))))))))
                                    (ite (= (rec__tree_model__path_type__k
                                              (us_split_fields5
                                                (select temp___4027 usf))) true)
                                      (= o (ite (= usf root) false true))
                                      (= o false))))))
                            (=>
                              (= o true)
                              (=>
