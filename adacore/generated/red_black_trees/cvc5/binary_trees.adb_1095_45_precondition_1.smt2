...
(assert
  (not
  (forall ((f__split_fields us_split_fields2) (root Int) (f_old__split_fields us_split_fields2))
    (=>
      (dynamic_invariant1
              ...
              (=>
                (exists ((n Int))
                  (and
                    (= n 0)
                    (=>
                      (= (and (ite (<= 0 n) true false) (ite (<= n 100)
                                                          true
                                                          false)) true)
                      (exists ((n1 Int))
                        (and
                                          ...
                                          (us_split_fields5
                                            (select (model1
                                                      (us_repqtmk1
                                                        f__split_fields)
                                                      root) j))))))))
                          (and (and (<= 0 n1) (<= n1 100)) (= n1 100)))))))
                (forall ((binary_trees__init__prove_post__L_22__R310b__assume Int))
                  (=>
                    (= (to_rep
                         (rec__binary_trees__forest__s f_old__split_fields)) binary_trees__init__prove_post__L_22__R310b__assume)
                    (=>
                      ...
                      (=>
                        (in_range r310b)
                        (=>
                          (let ((temp___4034 r310b))
                            (exists ((r Int))
                              (and
                                (= r 1)
                                (=>
                                  (= (and (ite (<= 1 r) true false) (ite (<= r temp___4034)
                                                                    true
                                                                    false)) true)
