                              ...
                              (exists ((o1 Int))
                                (and
                                  (= (to_rep
                                       (rec__red_black_trees__black_count__depth
                                         (us_split_fields11
                                           (select temp___1076 except)))) o1)
                                  (exists ((spark__branch Bool))
                                    (and
                                      (= spark__branch (ite (= o1 n1)
                                                         true
                                                         false))
                                      (=>
                                        (= spark__branch true)
