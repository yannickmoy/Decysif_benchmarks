...
;; "complex_trajectory_overflow__compute_distance__old_speed__assume'unused"
(define-fun complex_trajectory_overflow__compute_distance__old_speed__assumeqtunused 
  () Float64
  speed)
...
;; "complex_trajectory_overflow__compute_distance__delta_speed__assume"
(define-fun complex_trajectory_overflow__compute_distance__delta_speed__assume 
  () Float64
  (fp.add RNE drag o1))
...
;; "complex_trajectory_overflow__compute_distance__n_bv__assume"
(define-fun complex_trajectory_overflow__compute_distance__n_bv__assume 
  () (_ BitVec 16)
  ((_ int2bv 16) n))
...
;; "Assume"
(assert (= complex_trajectory_overflow__compute_distance__n_bv__assume n_bv))
...
;; "t__content'result'unused"
(define-fun t__contentqtresultqtunused3 () Float64
  average1)
