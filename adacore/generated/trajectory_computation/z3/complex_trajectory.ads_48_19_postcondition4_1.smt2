...
;; "t__content'result'unused"
(define-fun t__contentqtresultqtunused2 () Float64
  speed1)

;; "o"
(define-fun o3 () Float64
  (fp.add RNE old_speed speed1))
...
;; "o"
(define-fun o4 () Float64
  (fp.div RNE o3 (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000)))

;; "div_rne_'result'unused"
(define-fun div_rne_qtresultqtunused () Float64
  o4)

(declare-const average1 Float64)

;; "average'unused"
(define-fun averageqtunused () t__ref
  (t__refqtmk average1))
...
(declare-const t__contentqtresultqtunused3 Float64)

;; "H"
(assert (= t__contentqtresultqtunused3 speed1))

(declare-const o5 Bool)

;; "H"
(assert (= o5 (ite (fp.leq old_speed speed1) true false)))

(declare-const leqtresultqtunused Bool)

;; "H"
(assert (= leqtresultqtunused o5))
...
;; "t__content'result'unused"
(define-fun t__contentqtresultqtunused4 () Float64
  average1)

;; "o"
(define-fun o6 () Float64
  (fp.mul RNE average1 (fp #b0 #b01111111001 #b0001000100010001000100010001000100010001000100010001)))

;; "mul_rne'result'unused"
(define-fun mul_rneqtresultqtunused2 () Float64
  o6)

;; "t__content'result'unused"
(define-fun t__contentqtresultqtunused5 () Float64
  distance)

;; "o"
(define-fun o7 () Float64
  (fp.add RNE distance o6))
...
;; "distance'unused"
(define-fun distanceqtunused1 () t__ref
  (t__refqtmk distance1))
...
(assert
  ...
  (of_int
    RNE
    (+ n 1))) (fp.neg (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000))) (fp #b0 #b01111111110 #b0000000000000000000000000000000000000000000000000000)) (fp.mul RNE (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) 
  (of_int
    RNE
    n)) (fp.neg (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000))) (fp #b0 #b01111111110 #b0000000000000000000000000000000000000000000000000000))) (fp.mul RNE (fp.mul RNE (fp.mul RNE 
  (of_int
    RNE
    (+ n 1)) (of_int RNE (+ n 2))) (fp.neg (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000))) (fp #b0 #b01111111110 #b0000000000000000000000000000000000000000000000000000))))
...
(assert
  ...
  (of_int
    RNE
    (+ n 1))) bound) (fp #b0 #b01111111110 #b0000000000000000000000000000000000000000000000000000)) (fp.mul RNE (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) 
  (of_int
    RNE
    n)) bound) (fp #b0 #b01111111110 #b0000000000000000000000000000000000000000000000000000))) (fp.mul RNE (fp.mul RNE (fp.mul RNE 
  (of_int
    RNE
    (+ n 1)) (of_int RNE (+ n 2))) bound) (fp #b0 #b01111111110 #b0000000000000000000000000000000000000000000000000000))))
...
(assert
  (not
  (fp.leq distance1 (fp.mul RNE (fp.mul RNE (fp.mul RNE (of_int RNE (+ n 1)) 
  (of_int
    RNE
    (+ (+ n 1) 1))) bound) (fp #b0 #b01111111110 #b0000000000000000000000000000000000000000000000000000)))))
