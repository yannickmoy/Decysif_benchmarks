...
;; "med'unused"
(define-fun medqtunused9 () int__ref
  (int__refqtmk med9))
...
;; "right'unused"
(define-fun rightqtunused10 () int__ref
  (int__refqtmk right10))

;; "left'unused"
(define-fun leftqtunused10 () int__ref
  (int__refqtmk left10))

;; "spark__branch'unused"
(define-fun spark__branchqtunused17 () bool__ref
  (bool__refqtmk spark__branch17))

(declare-const int__contentqtresultqtunused64 Int)

;; "H"
(assert (= int__contentqtresultqtunused64 med9))

(declare-const o96 integer)

;; "H"
(assert (= o96 (select a med9)))

(declare-const getqtresultqtunused18 integer)

;; "H"
(assert (= getqtresultqtunused18 o96))

(declare-const o97 Int)

;; "Ensures"
(assert (= (to_rep o96) o97))

(declare-const to_repqtresultqtunused18 Int)

;; "H"
(assert (= to_repqtresultqtunused18 o97))

(declare-const o98 Bool)

;; "H"
(assert (= o98 (ite (< o97 i) true false)))

(declare-const infix_lsqtresultqtunused9 Bool)

;; "H"
(assert (= infix_lsqtresultqtunused9 o98))

(declare-const spark__branch18 Bool)

(declare-const spark__branchqtunused18 bool__ref)

;; "H"
(assert (= spark__branchqtunused18 (bool__refqtmk spark__branch18)))

;; "H"
(assert (= spark__branch18 o98))

(declare-const bool__contentqtresultqtunused17 Bool)

;; "H"
(assert (= bool__contentqtresultqtunused17 spark__branch18))

(declare-const int__contentqtresultqtunused65 Int)

(declare-const o99 integer)

(declare-const getqtresultqtunused19 integer)
...
(declare-const infix_gtqtresultqtunused9 Bool)
...
(assert
  (ite (= spark__branch18 true)
    (and
      (and
        (and
          (= int__contentqtresultqtunused67 med9)
          (and
            (= o103 (+ med9 1))
            (and
              (= infix_plqtresultqtunused17 o103)
              (and
                (in_range1 o103)
                (and (= range_check_qtresultqtunused26 o103) (= left10 o103))))))
        (= spark__branch17 spark__branch18))
      (= right10 right9))
    (and
      (and
        (= int__contentqtresultqtunused65 med9)
        (and
          (= o99 (select a med9))
          (and
            (= getqtresultqtunused19 o99)
            (and
              (= (to_rep o99) o100)
              (and
                (= to_repqtresultqtunused19 o100)
                (and
                  (= o101 (ite (< i o100) true false))
                  (and
                    (= infix_gtqtresultqtunused9 o101)
                    (and
                      (= spark__branch17 o101)
                      (and
                        (= bool__contentqtresultqtunused18 spark__branch17)
                        (and
                          (= spark__branch17 true)
                          (and
                            (= int__contentqtresultqtunused66 med9)
                            (and
                              (= o102 (- med9 1))
                              (and
                                (= infix_mnqtresultqtunused17 o102)
                                (and
                                  (in_range1 o102)
                                  (and
