      ...
      (=>
        ...
        (=>
          (and
            (bvult x #x000F4240)
            (or
              (fp.eq state (fp #b0 #b00000000 #b00000000000000000000000))
              (and
                (fp.leq (fp #b0 #b10000010 #b01000000000000000000000) state)
                (fp.leq state (fp.mul RNE ((_ to_fp_unsigned 8 24) RNE 
