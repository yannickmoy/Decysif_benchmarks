...
(declare-datatypes ()
  ((us_t (us_tqtmk (elts (Array Int small_int))(rt t)))))
...
(declare-const temp___868 (Array Int small_int))
...
;; "H"
(assert (= (select temp___868 1) rliteral))

;; "H"
(assert (= (select temp___868 2) rliteral1))

;; "H"
(assert (= (select temp___868 3) rliteral2))

;; "H"
(assert (= (select temp___868 4) rliteral3))

;; "H"
(assert (= (select temp___868 5) rliteral4))

;; "H"
(assert (= (select temp___868 6) rliteral5))

;; "H"
(assert (= (select temp___868 7) rliteral6))

;; "H"
(assert (= (select temp___868 8) rliteral))

;; "H"
(assert (= (select temp___868 9) rliteral))

;; "H"
(assert (= temp___868 (temp_____aggregate_def_864 1 2 3 4 5 6 7 1 1)))

;; "temp_____aggregate_def_864'result'unused"
(define-fun temp_____aggregate_def_864qtresultqtunused () (Array Int small_int)
  temp___868)

;; "o"
(define-fun o () us_t
  (of_array temp___868 1 9))
