...
;; "H"
(assert (= o68 (us_repqtmk2 m__pointer_value1)))

(declare-const map__contentqtresultqtunused16 us_rep2)

;; "H"
(assert (= map__contentqtresultqtunused16 o68))

(declare-const o69 us_main_type)

;; "H"
(assert (= o69 (us_close o68)))

(declare-const us_closeqtresultqtunused17 us_main_type)

;; "H"
(assert (= us_closeqtresultqtunused17 o69))

(declare-const bool__contentqtresultqtunused28 Bool)

;; "H"
(assert (= bool__contentqtresultqtunused28 m__rec__is_moved__))

(declare-const o70 us_rep)

;; "H"
(assert (= o70 (us_repqtmk m__is_null_pointer m__rec__is_moved__ o69)))

(declare-const us_repqtmkqtresultqtunused19 us_rep)

;; "H"
(assert (= us_repqtmkqtresultqtunused19 o70))

(declare-const o71 Bool)

;; "H"
(assert (= o71 (model_contains o70 o67)))
...
(assert
  (=
    (= o71 true)
    (and
      (not (= (bool_eq o70 us_null_pointer1) true))
      (= (has_element (rec__my_map__map_acc__pointer_value o70) o67) true))))

(declare-const model_containsqtresultqtunused1 Bool)

;; "H"
(assert (= model_containsqtresultqtunused1 o71))
...
(declare-const model_valueqtresultqtunused Int)
...
(assert
  (ite (= o71 true)
    (and
      (= o73 k)
      (and
        (= o74 (us_repqtmk2 m__pointer_value1))
        (and
          (= map__contentqtresultqtunused17 o74)
          (and
            (= o75 (us_close o74))
            (and
              (= us_closeqtresultqtunused18 o75)
              (and
                (= bool__contentqtresultqtunused29 m__rec__is_moved__)
                (and
                  (= o76 (us_repqtmk
                           m__is_null_pointer
                           m__rec__is_moved__
                           o75))
                  (and
                    (= us_repqtmkqtresultqtunused20 o76)
                    (and
                      (= o77 (model_value o76 o73))
                      (and
                        (and
                          (in_range o77)
                          (= o77 (ite (= (to_rep1
                                   ...
                                   (model_value
                                     ...
                                     o73))))
                        (and
                          (= model_valueqtresultqtunused o77)
                          (and
                            (= o72 (ite (= o77 v) true false))
                            (= infix_eqqtresultqtunused1 o72)))))))))))))
    (= o72 false)))

(declare-const old_mqtunused us_rep)

(declare-const usf1 Bool)

(declare-const anyqtresultqtunused1 Bool)

(declare-const temp___359 us_rep2)
...
(assert
  (ite (= o72 true)
    (and
      (= old_mqtunused temp___old_361)
      (and
        (and
          (= temp___359 (rec__my_map__map_acc__pointer_value temp___old_361))
          (and
            (= rec__my_map__map_acc__pointer_value_qtresultqtunused1 
            temp___359)
            (and
              (= anyqtresultqtunused2 usf2)
              (and
                (= kqtunused usf2)
                (and
                  (= o78 (has_element temp___359 usf2))
                  (and
                    (= has_element_no_rec_wrapperqtresultqtunused o78)
                    (and
                      (= usf3 (ite (in_range1 usf2) true false))
                      (and
                        (= anyqtresultqtunused3 usf3)
                        (= andbqtresultqtunused (and usf3 o78))))))))))
        (and
          (= usf1 (ite (forall ((k1 Int))
                         (=>
                           (and
                             (in_range1 k1)
                             (= (has_element
                    ...
                    true
                    false))
          (and (= anyqtresultqtunused1 usf1) (= o66 usf1)))))
    (= o66 false)))
...
;; "old_m'unused"
(define-fun old_mqtunused1 () us_rep
  temp___old_364)
...
(assert
  (not
  (or
    (= (rec__my_map__map_acc__is_null_pointer temp___old_364) true)
    (= (rec__my_map__map_acc__is_moved temp___old_364) true))))
