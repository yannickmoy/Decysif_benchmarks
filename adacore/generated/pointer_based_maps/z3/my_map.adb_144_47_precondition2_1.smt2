...
(declare-const temp___339 us_rep2)

;; "H"
(assert
  (= temp___339 (rec__my_map__map_acc__pointer_value x__borrowed_at_end)))

(declare-const rec__my_map__map_acc__pointer_value_qtresultqtunused5 us_rep2)

;; "H"
(assert (= rec__my_map__map_acc__pointer_value_qtresultqtunused5 temp___339))
...
;; "H"
(assert (= anyqtresultqtunused11 usf8))
...
;; "H"
(assert (= o74 (has_element temp___339 usf8)))

(declare-const has_element_no_rec_wrapperqtresultqtunused3 Bool)

;; "H"
(assert (= has_element_no_rec_wrapperqtresultqtunused3 o74))

(declare-const usf9 Bool)

;; "H"
(assert (= usf9 (ite (in_range1 usf8) true false)))

(declare-const anyqtresultqtunused12 Bool)

;; "H"
(assert (= anyqtresultqtunused12 usf9))

(declare-const andbqtresultqtunused3 Bool)

;; "H"
(assert (= andbqtresultqtunused3 (and usf9 o74)))
...
;; "H"
(assert (= o75 (us_repqtmk2 x__pointer_value2)))

(declare-const map__contentqtresultqtunused17 us_rep2)

;; "H"
(assert (= map__contentqtresultqtunused17 o75))

(declare-const o76 us_main_type)

;; "H"
(assert (= o76 (us_close o75)))

(declare-const us_closeqtresultqtunused17 us_main_type)

;; "H"
(assert (= us_closeqtresultqtunused17 o76))

(declare-const bool__contentqtresultqtunused31 Bool)

;; "H"
(assert (= bool__contentqtresultqtunused31 x__rec__is_moved__2))

(declare-const bool__contentqtresultqtunused32 Bool)

;; "H"
(assert (= bool__contentqtresultqtunused32 x__is_null_pointer2))

(declare-const o77 us_rep)

;; "H"
(assert (= o77 (us_repqtmk x__is_null_pointer2 x__rec__is_moved__2 o76)))

(declare-const us_repqtmkqtresultqtunused17 us_rep)

;; "H"
(assert (= us_repqtmkqtresultqtunused17 o77))

(declare-const temp___335 us_rep2)

;; "H"
(assert (= temp___335 (rec__my_map__map_acc__pointer_value o77)))

(declare-const rec__my_map__map_acc__pointer_value_qtresultqtunused6 us_rep2)

;; "H"
(assert (= rec__my_map__map_acc__pointer_value_qtresultqtunused6 temp___335))
...
;; "H"
(assert (= anyqtresultqtunused14 usf10))
...
;; "H"
(assert (= o78 (has_element temp___335 usf10)))

(declare-const has_element_no_rec_wrapperqtresultqtunused4 Bool)

;; "H"
(assert (= has_element_no_rec_wrapperqtresultqtunused4 o78))

(declare-const usf11 Bool)

;; "H"
(assert (= usf11 (ite (in_range1 usf10) true false)))

(declare-const anyqtresultqtunused15 Bool)

;; "H"
(assert (= anyqtresultqtunused15 usf11))

(declare-const andbqtresultqtunused4 Bool)

;; "H"
(assert (= andbqtresultqtunused4 (and usf11 o78)))
...
;; "any'result'unused"
(define-fun anyqtresultqtunused16 () Bool
  (ite (forall ((k1 Int))
         (=>
           (and
             (in_range1 k1)
...
;; "H"
(assert (= o79 (us_repqtmk2 r__pointer_value2)))

(declare-const map__contentqtresultqtunused18 us_rep2)

;; "H"
(assert (= map__contentqtresultqtunused18 o79))

(declare-const o80 us_main_type)

;; "H"
(assert (= o80 (us_close o79)))

(declare-const us_closeqtresultqtunused18 us_main_type)

;; "H"
(assert (= us_closeqtresultqtunused18 o80))

(declare-const bool__contentqtresultqtunused33 Bool)

;; "H"
(assert (= bool__contentqtresultqtunused33 r__rec__is_moved__))

(declare-const bool__contentqtresultqtunused34 Bool)

;; "H"
(assert (= bool__contentqtresultqtunused34 r__is_null_pointer2))

(declare-const o81 us_rep)

;; "H"
(assert (= o81 (us_repqtmk r__is_null_pointer2 r__rec__is_moved__ o80)))

(declare-const us_repqtmkqtresultqtunused18 us_rep)

;; "H"
(assert (= us_repqtmkqtresultqtunused18 o81))

(declare-const o82 Bool)

;; "H"
(assert (= o82 (bool_eq o81 us_null_pointer1)))

(declare-const bool_eqqtresultqtunused3 Bool)

;; "H"
(assert (= bool_eqqtresultqtunused3 o82))
...
;; "H"
(assert (= notbqtresultqtunused3 o83))
...
(declare-const o84 us_rep2)

(declare-const map__contentqtresultqtunused19 us_rep2)

(declare-const o85 us_main_type)

(declare-const us_closeqtresultqtunused19 us_main_type)
...
(declare-const temp___331 us_rep2)

(declare-const rec__my_map__map_acc__pointer_value_qtresultqtunused7 us_rep2)
...
(declare-const has_element_no_rec_wrapperqtresultqtunused5 Bool)

(declare-const usf13 Bool)
...
(assert
  (ite (= o83 true)
    (and
      (and
        (= o84 (us_repqtmk2 r__pointer_value2))
        (and
          (= map__contentqtresultqtunused19 o84)
          (and
            (= o85 (us_close o84))
            (and
              (= us_closeqtresultqtunused19 o85)
              (and
                (= bool__contentqtresultqtunused35 r__rec__is_moved__)
                (and
                  (= bool__contentqtresultqtunused36 r__is_null_pointer2)
                  (and
                    (= o86 (us_repqtmk
                             r__is_null_pointer2
                             r__rec__is_moved__
                             o85))
                    (and
                      (= us_repqtmkqtresultqtunused19 o86)
                      (and
                        (= temp___331 (rec__my_map__map_acc__pointer_value
                                        o86))
                        (and
                          (= rec__my_map__map_acc__pointer_value_qtresultqtunused7 
                          temp___331)
                          (and
                            (= anyqtresultqtunused18 usf12)
                            (and
                              (= kqtunused5 usf12)
                              (and
                                (= o87 (has_element temp___331 usf12))
                                (and
                                  (= has_element_no_rec_wrapperqtresultqtunused5 
                                  o87)
                                  (and
                                    (= usf13 (ite (in_range1 usf12)
                                               true
                                               false))
                                    (and
                                      (= anyqtresultqtunused19 usf13)
                                      (= andbqtresultqtunused5 (and usf13 
                                      o87))))))))))))))))))
      (and
        (= usfqtunused5 (ite (forall ((k1 Int))
                               (=>
                                 (and
                                   (in_range1 k1)
                                   (= (has_element
                          ...
                          true
                          false))
        (= anyqtresultqtunused17 (ite (forall ((k1 Int))
                                        (=>
                                          (and
                                            (in_range1 k1)
                                            (= (has_element
...
;; "H"
(assert (= o88 (us_repqtmk2 m_copy__pointer_value)))

(declare-const map__contentqtresultqtunused20 us_rep2)

;; "H"
(assert (= map__contentqtresultqtunused20 o88))

(declare-const o89 us_main_type)

;; "H"
(assert (= o89 (us_close o88)))

(declare-const us_closeqtresultqtunused20 us_main_type)

;; "H"
(assert (= us_closeqtresultqtunused20 o89))

(declare-const bool__contentqtresultqtunused37 Bool)

;; "H"
(assert (= bool__contentqtresultqtunused37 m_copy__rec__is_moved__))

(declare-const o90 us_rep)

;; "H"
(assert
  (= o90 (us_repqtmk m_copy__is_null_pointer m_copy__rec__is_moved__ o89)))

(declare-const us_repqtmkqtresultqtunused20 us_rep)

;; "H"
(assert (= us_repqtmkqtresultqtunused20 o90))

(declare-const temp___327 us_rep2)

;; "H"
(assert (= temp___327 (rec__my_map__map_acc__pointer_value o90)))

(declare-const rec__my_map__map_acc__pointer_value_qtresultqtunused8 us_rep2)

;; "H"
(assert (= rec__my_map__map_acc__pointer_value_qtresultqtunused8 temp___327))
...
;; "H"
(assert (= anyqtresultqtunused20 usf14))
...
;; "H"
(assert (= o91 (has_element temp___327 usf14)))

(declare-const has_element_no_rec_wrapperqtresultqtunused6 Bool)

;; "H"
(assert (= has_element_no_rec_wrapperqtresultqtunused6 o91))

(declare-const usf15 Bool)

;; "H"
(assert (= usf15 (ite (in_range1 usf14) true false)))

(declare-const anyqtresultqtunused21 Bool)

;; "H"
(assert (= anyqtresultqtunused21 usf15))

(declare-const andbqtresultqtunused6 Bool)

;; "H"
(assert (= andbqtresultqtunused6 (and usf15 o91)))
...
;; "any'result'unused"
(define-fun anyqtresultqtunused22 () Bool
  (ite (forall ((k1 Int))
         (=>
           (and
             (in_range1 k1)
...
;; "o"
(define-fun o92 () us_rep2
  (us_repqtmk2 m_copy__pointer_value))

;; "map__content'result'unused"
(define-fun map__contentqtresultqtunused21 () us_rep2
  o92)

;; "o"
(define-fun o93 () us_main_type
  (us_close o92))

;; "__close'result'unused"
(define-fun us_closeqtresultqtunused21 () us_main_type
  o93)
...
;; "o"
(define-fun o94 () us_rep
  (us_repqtmk m_copy__is_null_pointer m_copy__rec__is_moved__ o93))

;; "__rep'mk'result'unused"
(define-fun us_repqtmkqtresultqtunused21 () us_rep
  o94)

;; "temp___323"
(define-fun temp___323 () us_rep2
  (rec__my_map__map_acc__pointer_value o94))

;; "rec__my_map__map_acc__pointer_value_'result'unused"
(define-fun rec__my_map__map_acc__pointer_value_qtresultqtunused9 () us_rep2
  temp___323)

(declare-const usf16 Int)

;; "any'result'unused"
(define-fun anyqtresultqtunused23 () Int
  usf16)

;; "k'unused"
(define-fun kqtunused7 () Int
  usf16)

;; "o"
(define-fun o95 () Bool
  (has_element temp___323 usf16))

;; "has_element_no_rec_wrapper'result'unused"
(define-fun has_element_no_rec_wrapperqtresultqtunused7 () Bool
  o95)

;; "_f"
(define-fun usf17 () Bool
  (ite (in_range1 usf16) true false))

;; "any'result'unused"
(define-fun anyqtresultqtunused24 () Bool
  usf17)
...
;; "o"
(define-fun o97 () us_rep2
  (us_repqtmk2 r__pointer_value2))

;; "map__content'result'unused"
(define-fun map__contentqtresultqtunused22 () us_rep2
  o97)

;; "o"
(define-fun o98 () us_main_type
  (us_close o97))

;; "__close'result'unused"
(define-fun us_closeqtresultqtunused22 () us_main_type
  o98)
...
;; "bool__content'result'unused"
(define-fun bool__contentqtresultqtunused40 () Bool
  r__is_null_pointer2)

;; "o"
(define-fun o99 () us_rep
  (us_repqtmk r__is_null_pointer2 r__rec__is_moved__ o98))
...
;; "o"
(define-fun o100 () Bool
  (model_contains o99 usf16))
...
(assert
  (=
    (= o100 true)
    (and
      (not (= (bool_eq o99 us_null_pointer1) true))
      (= (has_element (rec__my_map__map_acc__pointer_value o99) usf16) true))))
...
;; "o"
(define-fun o101 () us_rep2
  (us_repqtmk2 x__pointer_value2))

;; "map__content'result'unused"
(define-fun map__contentqtresultqtunused23 () us_rep2
  o101)

;; "o"
(define-fun o102 () us_main_type
  (us_close o101))

;; "__close'result'unused"
(define-fun us_closeqtresultqtunused23 () us_main_type
  o102)

;; "bool__content'result'unused"
(define-fun bool__contentqtresultqtunused41 () Bool
  x__rec__is_moved__2)

;; "bool__content'result'unused"
(define-fun bool__contentqtresultqtunused42 () Bool
  x__is_null_pointer2)

;; "o"
(define-fun o103 () us_rep
  (us_repqtmk x__is_null_pointer2 x__rec__is_moved__2 o102))

;; "__rep'mk'result'unused"
(define-fun us_repqtmkqtresultqtunused23 () us_rep
  o103)

;; Goal "def'vc"
;; File "my_map.ads", line 42, characters 0-0
(assert
  (not (= (model_contains o103 usf16) true)))
