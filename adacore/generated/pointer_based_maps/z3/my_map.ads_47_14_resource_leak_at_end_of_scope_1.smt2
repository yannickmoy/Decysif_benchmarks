...
(declare-const o74 us_main_type)
...
(assert
  (ite (= o71 true)
    (and
      (= o72 k)
      (and
        (= o73 (us_repqtmk2 m__pointer_value1))
        (and
          (= map__contentqtresultqtunused17 o73)
          (and
            (= o74 (us_close o73))
            (and
              (= us_closeqtresultqtunused18 o74)
              (and
                ...
                (and
                  (= o75 (us_repqtmk
                           ...
                           o74))
                  (and
                    (= us_repqtmkqtresultqtunused20 o75)
                    (and
                      (= o76 (model_value o75 o72))
                      (and
                        (and
                          (in_range o76)
                          (= o76 (ite (= (to_rep1
                                   ...
                                   (model_value
                                     ...
                                     o72))))
                        (and
                          (= model_valueqtresultqtunused o76)
                          (and
                            (= o66 (ite (= o76 v) true false))
                            (= infix_eqqtresultqtunused1 o66)))))))))))))
    (= o66 false)))
...
;; "old_m'unused"
(define-fun old_mqtunused () us_rep
  temp___old_361)
...
(assert
  (not
  (or
    (= (rec__my_map__map_acc__is_null_pointer temp___old_361) true)
    (= (rec__my_map__map_acc__is_moved temp___old_361) true))))
