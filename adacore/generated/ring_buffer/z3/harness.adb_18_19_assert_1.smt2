...
;; "param__r__split_fields'unused"
(define-fun param__r__split_fieldsqtunused5 () us_split_fields__ref
  (us_split_fields__refqtmk r__split_fields6))
...
;; "h'unused"
(define-fun hqtunused3 () int__ref
  (int__refqtmk h3))

;; "r__split_fields'unused"
(define-fun r__split_fieldsqtunused7 () us_split_fields__ref
  (us_split_fields__refqtmk r__split_fields7))
...
(assert
  ...
  (to_rep2
    (rec__ring_buf__ring_buffer__length r__split_fields6)) 1)))

;; "H"
(assert
  (= (let ((temp___217 (us_repqtmk r__split_fields6))) (head temp___217)) 
  h3))

;; "H"
(assert
  (dynamic_invariant (us_repqtmk r__split_fields7) true true true true))
