...
;; "temp___802"
(define-fun temp___802 () (Array Int character)
  (to_array temp___801))
...
;; "Assert"
(assert
  (let ((temp___805 (to_string o 12)))
    (and (= (first temp___805) 1) (<= 0 (last temp___805)))))

;; "Assert"
(assert (<= (last temp___801) 1000))

;; Goal "def'vc"
;; File "configdata.ads", line 39, characters 0-0
(assert
  (not (<= 3 (length (to_string o 12)))))
