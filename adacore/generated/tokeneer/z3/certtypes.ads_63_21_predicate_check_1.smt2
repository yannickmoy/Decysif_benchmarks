...
;; "temp___358"
(define-fun temp___358 () (Array Int character)
  (to_array temp___357))
...
;; "Assert"
(assert
  (let ((temp___361 (to_string o 3)))
    (and (= (first temp___361) 1) (<= 0 (last temp___361)))))

;; "Assert"
(assert (<= (last temp___357) 1000))

;; Goal "def'vc"
;; File "certtypes.ads", line 62, characters 0-0
(assert
  (not (<= 2 (length (to_string o 3)))))
