...
(define-fun o58 () us_rep
  (rec__display__msgstrt__top o57))
...
;; "o"
(define-fun o60 () msgtextcount
  (rec__display__msglinet__len o59))
...
;; "temp___loop_entry_574"
(define-fun temp___loop_entry_574 () us_rep1
  c43b)
...
;; "temp___loop_entry_571'unused"
(define-fun temp___loop_entry_571qtunused () us_rep3
  (us_repqtmk3 result____split_fields))
...
;; "o"
(define-fun o64 () Bool
  (bool_eq2 c43b temp___loop_entry_574))
...
;; "o"
(define-fun o65 () us_split_fields2
  (us_split_fields3 c43b))
...
;; "o"
(define-fun o66 () us_rep
  (rec__display__msgstrt__top o65))

;; "rec__display__msgstrt__top'result'unused"
(define-fun rec__display__msgstrt__topqtresultqtunused2 () us_rep
  o66)

;; "o"
(define-fun o67 () us_split_fields
  (us_split_fields1 o66))
...
;; "o"
(define-fun o68 () msgtextcount
  (rec__display__msglinet__len o67))
...
(assert
  (not (= (bool_eq2 c43b temp___loop_entry_574) true)))
