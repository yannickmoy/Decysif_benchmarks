...
;; "temp___297"
(define-fun temp___297 () (Array Int character)
  (to_array temp___296))
...
;; "Assert"
(assert
  (let ((temp___299 (to_string o 2040)))
    (and (= (first temp___299) 1) (<= 0 (last temp___299)))))

;; Goal "def'vc"
;; File "tokenreader-interfac.ads", line 83, characters 0-0
(assert
  (not (<= (last temp___296) 1000)))
