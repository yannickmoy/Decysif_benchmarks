...
;; "temp___808"
(define-fun temp___808 () (Array Int character)
  (to_array temp___807))
...
;; "Assert"
(assert
  (let ((temp___810 (to_string o 2040)))
    (and (= (first temp___810) 1) (<= 0 (last temp___810)))))

;; Goal "def'vc"
;; File "configdata.ads", line 48, characters 0-0
(assert
  (not (<= (last temp___807) 12)))
