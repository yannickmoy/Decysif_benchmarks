...
;; "temp___272"
(define-fun temp___272 () (Array Int character)
  (to_array temp___271))
...
;; "Assert"
(assert
  (let ((temp___274 (to_string o 2040)))
    (and (= (first temp___274) 1) (<= 0 (last temp___274)))))

;; Goal "def'vc"
;; File "audittypes.ads", line 77, characters 0-0
(assert
  (not (<= (last temp___271) 20)))
