...
;; "temp___214"
(define-fun temp___214 () (Array Int character)
  (to_array temp___213))
...
;; "temp___216"
(define-fun temp___216 () us_t
  (to_string o 12))

;; Goal "def'vc"
;; File "stats.ads", line 29, characters 0-0
(assert
  (not (<= 0 (last temp___216))))
