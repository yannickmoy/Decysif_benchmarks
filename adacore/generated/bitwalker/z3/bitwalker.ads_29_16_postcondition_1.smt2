...
;; "Assert"
(assert
  (= (= flag true) (= (nth_bv r (bvsub #x000000000000003F left_bv)) true)))

(declare-const bitwalker__pokebit64__result (_ BitVec 64))

;; "bitwalker__pokebit64__result'unused"
(define-fun bitwalker__pokebit64__resultqtunused () t__ref
  (t__refqtmk bitwalker__pokebit64__result))

;; "H"
(assert (= bitwalker__pokebit64__result r))
...
;; "H"
(assert (= (nth bitwalker__pokebit64__result i) true))
