...
(assert
  (not
  (= (let ((temp___990 (let ((temp___986 (to_rep a__last)))
                         (let ((temp___984 (+ r 1)))
                           (of_array a temp___984 temp___986)))))
       (let ((temp___988 (let ((temp___982 (to_rep a__last)))
                           (let ((temp___980 (+ r 1)))
                             (of_array a2 temp___980 temp___982)))))
         (bool_eq
           (to_array temp___988)
           (first temp___988)
           (last temp___988)
