...
;; "H"
(assert
  (forall ((temp___958 Int) (temp___957 us_t))
    (occurrences__function_guard
      (occurrences temp___957 l temp___958)
      temp___957
      l
      temp___958)))
...
;; "H"
(assert
  (forall ((temp___963 Int) (temp___962 us_t))
    (occurrences__function_guard
      (occurrences temp___962 l temp___963)
      temp___962
      l
      temp___963)))
...
(assert
  ...
  (= (oeq
       (let ((temp___958 r))
         (let ((temp___957 (let ((temp___954 (of_array
                                               a2
                                               (to_rep a__first)
                                               (to_rep a__last))))
           ...
           (occurrences temp___957 l temp___958)))
       (let ((temp___963 r))
         (let ((temp___962 (let ((temp___959 (of_array
                                               a
                                               (to_rep a__first)
                                               (to_rep a__last))))
                             (of_array a (to_rep a__first) (to_rep a__last)))))
           (occurrences temp___962 l temp___963)))) true)))
