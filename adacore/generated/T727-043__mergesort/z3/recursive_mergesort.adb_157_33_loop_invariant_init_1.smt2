...
(assert
  (= (is_merge
       (let ((temp___733 (- (+ l lii1) 1)))
         (occurrences a_copy l temp___733))
       (let ((temp___736 (+ m rii1)))
         (let ((temp___735 (+ m 1)))
           (occurrences a_copy temp___735 temp___736)))
       (let ((temp___741 (- (+ l aii1) 1)))
  ...
  (= (let ((temp___728 (let ((temp___724 (- l 1)))
       ...
       (let ((temp___726 (let ((temp___721 (- l 1)))
                           (let ((temp___720 (to_rep a__first)))
                             (of_array a1 temp___720 temp___721)))))
         (bool_eq
           (to_array temp___726)
           (first temp___726)
           (last temp___726)
...
(assert
  (= (let ((temp___705 (let ((temp___701 (to_rep a__last)))
       ...
       (let ((temp___703 (let ((temp___698 (to_rep a__last)))
                           (let ((temp___696 (+ r 1)))
                             (of_array a1 temp___696 temp___698)))))
         (bool_eq
           (to_array temp___703)
           (first temp___703)
           (last temp___703)
...
(assert
  (= (is_sorted
       (let ((temp___681 (let ((temp___680 (- (+ l aii1) 1)))
                           (of_array a1 l temp___680))))
         (let ((temp___680 (- (+ l aii1) 1))) (of_array a1 l temp___680)))) true))

;; "LoopInvariant"
(assert
  (=>
    (< lii1 n1)
    (<= (to_rep (select a1 (- (+ l aii1) 1))) (to_rep
