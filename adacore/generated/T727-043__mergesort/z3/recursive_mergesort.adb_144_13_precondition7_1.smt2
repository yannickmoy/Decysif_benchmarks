...
;; "temp___632"
(define-fun temp___632 () (Array Int integer)
  (slide o34 o33 o32))
...
;; "temp___635"
(define-fun temp___635 () us_t
  (of_array temp___632 o36 o35))
...
;; "Assert"
(assert (and (<= (first a_copy) o44) (<= o44 (last a_copy))))

;; "o"
(define-fun o45 () (Array Int integer)
  (to_array a_copy))
...
;; "o"
(define-fun o51 () (Array Int integer)
  (store o50 o49 o48))
...
;; "o"
(define-fun o53 () (Array Int integer)
  (to_array o52))
...
;; "Ensures"
(assert (= (to_rep a_iterm__last) o60))
...
;; "Ensures"
(assert (= (to_rep a_iterm__first) o61))
...
;; "temp___644"
(define-fun temp___644 () us_t
  (of_array a_iterm1 o61 o60))
...
;; "temp___645"
(define-fun temp___645 () (Array Int integer)
  a_iterm1)
...
;; "temp___643"
(define-fun temp___643 () (Array Int integer)
  a1)
...
;; "H"
(assert
  (forall ((o70 Int) (o71 Int) (o72 us_t))
    (occurrences__function_guard (occurrences o72 o71 o70) o72 o71 o70)))
...
;; "H"
(assert (= (oeq (occurrences o69 o59 o58) (occurrences o64 o56 o55)) true))
...
;; "Assert"
(assert (and (<= (first a_copy) o71) (<= o71 (last a_copy))))
...
;; "temp___649"
(define-fun temp___649 () (Array Int integer)
  a1)
...
;; "o"
(define-fun o82 () us_rep
  (occurrences o81 o76 o75))

;; "H"
(assert
  (forall ((o83 Int) (o84 us_t) (temp___330 Int))
    (occurrences__function_guard
      (occurrences o84 o83 temp___330)
      o84
      o83
      temp___330)))

;; "H"
(assert (occurrences__function_guard o82 o81 o76 o75))
...
(assert
  (or
    (< o75 o76)
    (and
      (<= (length o82) (+ (- o75 o76) 1))
      (forall ((k Int))
        (=>
          (and (in_range k) (= (has_key o82 k) true))
          (<= (get o82 k) (+ (- o75 o76) 1)))))))

;; "H"
(assert
  (ite (= (< o75 o76) true)
    (and (= (is_empty o82) true) (= (length o82) 0))
    (= (is_add
         (let ((temp___330 (- o75 1))) (occurrences o81 o76 temp___330))
         (to_rep (select temp___649 o75))
         o82) true)))
...
;; "temp___647"
(define-fun temp___647 () (Array Int integer)
  a1)
...
;; "o"
(define-fun o91 () us_rep
  (occurrences o90 o85 o84))

;; "H"
(assert
  (forall ((o92 Int) (o93 us_t) (temp___330 Int))
    (occurrences__function_guard
      (occurrences o93 o92 temp___330)
      o93
      o92
      temp___330)))

;; "H"
(assert (occurrences__function_guard o91 o90 o85 o84))
...
(assert
  (or
    (< o84 o85)
    (and
      (<= (length o91) (+ (- o84 o85) 1))
      (forall ((k Int))
        (=>
          (and (in_range k) (= (has_key o91 k) true))
          (<= (get o91 k) (+ (- o84 o85) 1)))))))

;; "H"
(assert
  (ite (= (< o84 o85) true)
    (and (= (is_empty o91) true) (= (length o91) 0))
    (= (is_add
         (let ((temp___330 (- o84 1))) (occurrences o90 o85 temp___330))
         (to_rep (select temp___647 o84))
         o91) true)))
...
(define-fun o96 () us_rep
  (occurrences o95 o94 o93))

;; "H"
(assert
  (forall ((o97 Int) (o98 us_t) (temp___330 Int))
    (occurrences__function_guard
      (occurrences o98 o97 temp___330)
      o98
      o97
      temp___330)))

;; "H"
(assert (occurrences__function_guard o96 o95 o94 o93))
...
(assert
  (or
    (< o93 o94)
    (and
      (<= (length o96) (+ (- o93 o94) 1))
      (forall ((k Int))
        (=>
          (and (in_range k) (= (has_key o96 k) true))
          (<= (get o96 k) (+ (- o93 o94) 1)))))))

;; "H"
(assert
  (ite (= (< o93 o94) true)
    (and (= (is_empty o96) true) (= (length o96) 0))
    (= (is_add
         (let ((temp___330 (- o93 1))) (occurrences o95 o94 temp___330))
         (to_rep (select (to_array o95) o93))
         o96) true)))
...
;; "H"
(assert (occurrences__function_guard o102 o101 o100 o99))
...
(assert
  (or
    (< o99 o100)
    (and
      (<= (length o102) (+ (- o99 o100) 1))
      (forall ((k Int))
        (=>
          (and (in_range k) (= (has_key o102 k) true))
          (<= (get o102 k) (+ (- o99 o100) 1)))))))

;; "H"
(assert
  (ite (= (< o99 o100) true)
    (and (= (is_empty o102) true) (= (length o102) 0))
    (= (is_add
         (let ((temp___330 (- o99 1))) (occurrences o101 o100 temp___330))
         (to_rep (select (to_array o101) o99))
         o102) true)))
...
;; "o"
(define-fun o106 () us_t
  a_copy)

;; "o"
(define-fun o107 () us_rep
  (occurrences o106 o105 o104))

;; "H"
(assert
  (forall ((o108 Int) (o109 us_t) (temp___330 Int))
    (occurrences__function_guard
      (occurrences o109 o108 temp___330)
      o109
      o108
      temp___330)))

;; "H"
(assert (occurrences__function_guard o107 o106 o105 o104))
...
(assert
  (or
    (< o104 o105)
    (and
      (<= (length o107) (+ (- o104 o105) 1))
      (forall ((k Int))
        (=>
          (and (in_range k) (= (has_key o107 k) true))
          (<= (get o107 k) (+ (- o104 o105) 1)))))))

;; "H"
(assert
  (ite (= (< o104 o105) true)
    (and (= (is_empty o107) true) (= (length o107) 0))
    (= (is_add
         (let ((temp___330 (- o104 1))) (occurrences o106 o105 temp___330))
         (to_rep (select (to_array o106) o104))
         o107) true)))
...
;; "H"
(assert (not (= (has_key o102 o74) true)))

;; Goal "def'vc"
;; File "recursive_mergesort.ads", line 92, characters 0-0
(assert
  (not (= (keys_included_except o96 o102 o74) true)))
