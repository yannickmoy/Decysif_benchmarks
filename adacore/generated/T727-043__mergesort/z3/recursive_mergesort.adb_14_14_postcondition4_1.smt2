...
;; "recursive_mergesort__prove_cut__variant"
(define-fun recursive_mergesort__prove_cut__variant () Int
  r)
...
(assert
  (forall ((temp___compl_991 us_t) (temp___compl_992 Int) (temp___compl_993 Int))
    (occurrences__function_guard
      (occurrences temp___compl_991 temp___compl_992 temp___compl_993)
      temp___compl_991
      temp___compl_992
      temp___compl_993)))
...
;; "H"
(assert (= infix_eqqtresultqtunused (ite (= m r) true false)))
...
;; "H"
(assert (= spark__branch (ite (= m r) false true)))
...
(declare-const temp___compl_991 us_t)

(declare-const temp___compl_992 Int)

(declare-const temp___compl_993 Int)
      ...
      (and
        ...
        (and
          ...
          (and
            (= o (- r 1))
            (and
              (= infix_mnqtresultqtunused o)
              (and
                (in_range1 o)
                (and
                  (= range_check_qtresultqtunused o)
                  (= (is_merge
                       (occurrences
                         temp___compl_991
                         temp___compl_992
...
(define-fun temp___328 () us_rep
  (let ((temp___1001 r)) (occurrences a l temp___1001)))
...
(assert
  (forall ((temp___996 Int))
    (occurrences__function_guard (occurrences a l temp___996) a l temp___996)))
...
(assert
  (not
    (and
      (= (has_key (let ((temp___996 m)) (occurrences a l temp___996)) k) true)
      (= (has_key
           (let ((temp___999 r))
             (let ((temp___998 (+ m 1)))
               (occurrences a temp___998 temp___999)))
...
(assert
  (not
  (= (get (let ((temp___1001 r)) (occurrences a l temp___1001)) k) (get
                                                                    (let ((temp___996 
                                                                    m))
                                                                    (occurrences
                                                                    a
