      ...
      (forall ((temp___627 (Array Int integer_32)))
        (=>
          ...
          (=>
            ...
            (=>
              (in_range4 v)
              (forall ((integer32_parsing__print_int_32__result us_t))
                (=>
                  (forall ((o us_t))
                    (valid_int_32__function_guard (valid_int_32 o) o))
                  (=>
                    (forall ((o us_t))
                      (valid_int__function_guard (valid_int o) o))
                    (=>
                      (exists ((temp___567 (Array Int character)))
                        (and
                          (and
                            (forall ((temp___566 Int))
                              (! (=>
                                   ...
                                   (=>
                                     (in_range3 48)
                                     (= (to_rep
                                          (select temp___567 temp___566)) 48))) :pattern ((select temp___567 temp___566)) ))
                            (= temp___567 (integer32_parsing__print_int_32__res__aggregate_def
                                            48)))
                          (exists ((res (Array Int character)))
                            (and
                              (= res temp___567)
                              (exists ((x Int))
                                (and
                                              ...
                                              (and
                                                ...
                                                (ite (= spark__branch true)
                                                  ...
                                                  (of_array
                                                    ...
                                                    1
                                                    1))
                                                  (exists ((res1 (Array Int character)) (top1 Int))
                                                    (and
                                                      (exists ((i Int))
                                                        (and
                                                          (= i 1)
                                                        ...
                                                        (and
                                                          ...
                                                          (exists ((first2 Int))
                                                            (and
                                                              (= first2 o)
                                                              (exists 
                                                                ((spark__branch1 Bool) (res2 (Array Int character)) (top2 Int))
                                                                (and
                                                                  (and
                                                                    (= spark__branch1 
                                                                    (ite (< 
                                                                  ...
                                                                  (and
                                                                    ...
                                                                    (= integer32_parsing__print_int_32__result 
                                                                    res0)))))))))))))))))))))))))))))))))))))))))))
                      (= (length integer32_parsing__print_int_32__result) 
                      (length1
                        v))))))))))))))
