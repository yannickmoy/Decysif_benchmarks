...
;; "Assert"
(assert (= x2 (__cdiv v (to_rep2 (select tens (+ i1 1))))))

;; "Assert"
(assert
  (= (char_to_int (to_rep (select res2 (- 12 i1)))) (abs (__cmod (__cdiv 
  v (to_rep2 (select tens i1))) 10))))

;; "Assert"
(assert
  (=>
    (= (__cdiv v (to_rep2 (select tens (+ i1 1)))) (__cdiv 2147483647 
    (to_rep2
      (select tens i1))))
    (<= (to_rep (select res2 (- 12 i1))) (to_rep (select last32 (- 11 i1))))))
...
;; "Assert"
(assert (and (<= 1 temp___579) (<= temp___579 10)))

;; "o"
(define-fun o15 () integer_32
  (select tens temp___579))

;; "get'result'unused"
(define-fun getqtresultqtunused1 () integer_32
  o15)
