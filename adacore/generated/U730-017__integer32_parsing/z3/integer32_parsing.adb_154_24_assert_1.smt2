...
;; "H"
(assert (= lastqtresultqtunused6 o20))

(declare-const infix_lseqqtresultqtunused2 Bool)

;; "H"
(assert (= infix_lseqqtresultqtunused2 (ite (<= firstz1 o20) true false)))
          ...
          (and
            ...
            (and
              ...
              (and
                ...
                (and
                  (= o19 (ite (= o22 9) true false))
                  (= infix_eqqtresultqtunused1 o19))))))))
    (= o19 false)))
...
;; "Assert"
(assert (= (is_less_than_max s1 is_pos first1) true))

;; Goal "def'vc"
;; File "integer32_parsing.ads", line 31, characters 0-0
(assert
  (not (= (is_less_than_max s2 is_pos first2) true)))
