...
;; "Assert"
(assert (and (<= 1 temp___502) (<= temp___502 10)))

;; "o"
(define-fun o36 () integer_32
  (select tens temp___502))
...
;; "Assert"
(assert (and (<= 1 temp___501) (<= temp___501 10)))

;; "o"
(define-fun o40 () integer_32
  (select tens temp___501))
