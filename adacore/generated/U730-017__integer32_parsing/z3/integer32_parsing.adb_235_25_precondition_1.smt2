...
;; "abs'result'unused"
(define-fun absqtresultqtunused2 () Int
  o55)
...
;; "Assert"
(assert (and (<= (first s) o57) (<= o57 (last s))))

;; "o"
(define-fun o58 () (Array Int character)
  (to_array s))

;; "to_array'result'unused"
(define-fun to_arrayqtresultqtunused5 () (Array Int character)
  o58)

;; "o"
(define-fun o59 () character
  (select o58 o57))

;; "get'result'unused"
(define-fun getqtresultqtunused5 () character
  o59)
