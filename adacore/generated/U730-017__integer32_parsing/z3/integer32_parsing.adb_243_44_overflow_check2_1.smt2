...
;; "Assert"
(assert (ite (= is_pos true) (<= 0 v3) (<= v3 0)))
...
(assert
  (= (* (ite (= is_pos true) 1 (- 1)) (char_to_int
                                        (to_rep
                                          (select (to_array s) (+ (- 
                                          i3 1) first2))))) (__cmod v3 10)))

;; "Assert"
(assert
  (= (char_to_int (to_rep (select (to_array s) (+ (- i3 1) first2)))) (abs (__cmod 
  v3 10))))

;; "Assert"
(assert (= (is_integer_32 s firstz (+ (- i3 1) first2) v3) true))
...
;; "Assert"
(assert (and (<= 1 temp___544) (<= temp___544 10)))

;; "o"
(define-fun o58 () integer_32
  (select tens temp___544))

;; "get'result'unused"
(define-fun getqtresultqtunused5 () integer_32
  o58)
...
;; "Assert"
(assert (and (<= 1 temp___543) (<= temp___543 10)))

;; "o"
(define-fun o62 () integer_32
  (select tens temp___543))

;; "get'result'unused"
(define-fun getqtresultqtunused6 () integer_32
  o62)
