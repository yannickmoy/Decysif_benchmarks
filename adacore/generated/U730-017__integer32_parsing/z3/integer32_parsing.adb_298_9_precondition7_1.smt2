...
;; "Assert"
(assert (= (is_integer_32 (of_array res3 1 11) first2 11 v) true))
...
(define-fun integer32_parsing__print_int_32__B_7__last__assume () Int
  (- 11 top3))
...
;; "Assume"
(assert (= integer32_parsing__print_int_32__B_7__last__assume last1))
...
(assert
  (=>
    (<= o20 11)
    (and (and (<= 1 o20) (<= o20 11)) (and (<= 1 11) (<= 11 11)))))
...
;; "o"
(define-fun o21 () (Array Int character)
  res3)
...
;; "o"
(define-fun o23 () (Array Int character)
  o21)
...
;; "temp___611"
(define-fun temp___611 () (Array Int character)
  (slide o23 o22 1))
...
;; "Assert"
(assert
  (ite (<= o20 11) (and (<= 1 last1) (= (- 11 o20) (- last1 1))) (< last1 1)))

;; "integer32_parsing__print_int_32__B_7__res0__assume"
(define-fun integer32_parsing__print_int_32__B_7__res0__assume () us_t
  (of_array temp___611 1 last1))
...
;; "Assume"
(assert (= integer32_parsing__print_int_32__B_7__res0__assume res0))

;; "Assume"
(assert (dynamic_invariant res0 true false true true last1))

;; "temp___601"
(define-fun temp___601 () (Array Int character)
  (to_array res0))
...
(assert
  (=>
    (<= o27 11)
    (and (and (<= 1 o27) (<= o27 11)) (and (<= 1 11) (<= 11 11)))))
...
;; "o"
(define-fun o28 () (Array Int character)
  res3)
...
;; "temp___600"
(define-fun temp___600 () (Array Int character)
  o28)
...
;; "H"
(assert
  (forall ((o32 us_t)) (valid_int_32__function_guard (valid_int_32 o32) o32)))

;; "H"
(assert (= (valid_int_32 o26) true))
...
;; "temp___606"
(define-fun temp___606 () (Array Int character)
  (to_array res0))
...
(assert
  (=>
    (<= o36 11)
    (and (and (<= 1 o36) (<= o36 11)) (and (<= 1 11) (<= 11 11)))))
...
;; "o"
(define-fun o37 () (Array Int character)
  res3)

;; "slice'result'unused"
(define-fun sliceqtresultqtunused2 () (Array Int character)
  o37)

;; "temp___604"
(define-fun temp___604 () us_t
  (of_array o37 o36 11))
...
;; "temp___605"
(define-fun temp___605 () (Array Int character)
  o37)
...
;; "is_pos"
(define-fun is_pos () Bool
  (not (= (to_rep (select temp___605 o39)) 45)))

;; "first"
(define-fun first3 () Int
  (ite (= is_pos true) o39 (+ o39 1)))

;; Goal "def'vc"
;; File "integer32_parsing.ads", line 65, characters 0-0
(assert
  (not (= (is_integer_32 o40 first3 o38 o32) true)))
