...
;; "H"
(assert (= o17 (ite (<= i2 10) true false)))
...
;; "H"
(assert (= o18 (ite (<= 1 i2) true false)))
...
;; "H"
(assert (= andbqtresultqtunused1 o19))

(declare-const temp___loop_entry_505qtunused Int)
...
(declare-const resqtunused2 int__ref)
...
(declare-const char_to_intqtresultqtunused Int)
...
(assert
  (ite (= o19 true)
    (and
      (= temp___loop_entry_505qtunused res)
      (and
        (= int__contentqtresultqtunused7 res)
        (and
          (= iqtunused3 (int__refqtmk i3))
          (and
            (= resqtunused2 (int__refqtmk res2))
            (and
              (= (and (ite (in_range3 res2) true false) (ite (and
                                                               (<= 1 
                                                               i3)
                                                               (<= i3 10))
                                                          true
                    ...
                    (and
                      ...
                      (and
                        ...
                        (and
                          (in_range o21)
                          (and
                            (= range_check_qtresultqtunused6 o21)
                            (and
                              (and (<= (first s) o21) (<= o21 (last s)))
                              (and
                                (= o22 (to_array s))
                                (and
                                  (= to_arrayqtresultqtunused1 o22)
                                  (and
                                    (= o23 (select o22 o21))
                                    (and
...
(declare-const integer32_parsing__parse_int_32__result Int)

;; "integer32_parsing__parse_int_32__result'unused"
(define-fun integer32_parsing__parse_int_32__resultqtunused () int__ref
  (int__refqtmk integer32_parsing__parse_int_32__result))

;; "H"
(assert (= integer32_parsing__parse_int_32__result res1))

;; "result'unused"
(define-fun resultqtunused () Int
  integer32_parsing__parse_int_32__result)
...
;; "is_pos"
(define-fun is_pos1 () Bool
  (not (= (to_rep (select (to_array s) (first s))) 45)))

;; "first"
(define-fun first2 () Int
  (ite (= is_pos1 true) (first s) (+ (first s) 1)))
...
(assert
  ...
  (= (is_integer_32
       ...
       first2
       (last s)
       integer32_parsing__parse_int_32__result) true)))
