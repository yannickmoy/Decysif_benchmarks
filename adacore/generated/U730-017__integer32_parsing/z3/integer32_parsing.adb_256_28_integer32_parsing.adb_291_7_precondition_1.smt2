...
(assert
  (or
    (< 1 first1)
    (= (is_less_than_max (of_array res3 1 11) (>= v 0) first1) true)))
...
;; "Assert"
(assert (and (<= 1 temp___591) (<= temp___591 10)))

;; "o"
(define-fun o20 () integer_32
  (select tens temp___591))
...
;; "rem_'result'unused"
(define-fun rem_qtresultqtunused1 () Int
  o23)
...
;; "abs'result'unused"
(define-fun absqtresultqtunused1 () Int
  o24)
