...
;; "temp___old_351"
(define-fun temp___old_351 () Int
  (page_length standard_output))

;; "Ensures"
(assert (in_range4 temp___old_351))
...
;; "temp___old_352"
(define-fun temp___old_352 () Int
  (line_length standard_output))

;; "Ensures"
(assert (in_range4 temp___old_352))
...
;; "temp___old_353"
(define-fun temp___old_353 () us_t
  (form standard_output))

;; "Ensures"
(assert (dynamic_invariant temp___old_353 true false true true))
...
;; Goal "def'vc"
;; File "spark-text_io-unbounded_io.ads", line 78, characters 0-0
(assert
