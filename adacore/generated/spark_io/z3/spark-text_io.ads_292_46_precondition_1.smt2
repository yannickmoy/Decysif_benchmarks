...
;; "temp___old_718"
(define-fun temp___old_718 () Int
  (line_length standard_output))

;; "Ensures"
(assert (in_range3 temp___old_718))
...
;; "temp___old_719"
(define-fun temp___old_719 () us_t
  (form standard_output))

;; "Ensures"
(assert (dynamic_invariant temp___old_719 true false true true))
...
;; Goal "def'vc"
;; File "spark-text_io.ads", line 286, characters 0-0
(assert
