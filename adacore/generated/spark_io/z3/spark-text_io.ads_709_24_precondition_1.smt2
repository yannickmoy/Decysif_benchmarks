...
;; "temp___old_831"
(define-fun temp___old_831 () Int
  (page_length standard_output))

;; "Ensures"
(assert (in_range4 temp___old_831))
...
;; "temp___old_832"
(define-fun temp___old_832 () Int
  (line_length standard_output))

;; "Ensures"
(assert (in_range4 temp___old_832))
...
;; "temp___old_833"
(define-fun temp___old_833 () us_t
  (form standard_output))

;; "Ensures"
(assert (dynamic_invariant temp___old_833 true false true true))
