...
;; "temp___old_710"
(define-fun temp___old_710 () Int
  (page_length standard_output))

;; "Ensures"
(assert (in_range3 temp___old_710))
...
;; "temp___old_711"
(define-fun temp___old_711 () us_t
  (form standard_output))

;; "Ensures"
(assert (dynamic_invariant temp___old_711 true false true true))
...
;; Goal "def'vc"
;; File "spark-text_io.ads", line 263, characters 0-0
(assert
