...
;; "temp___old_701"
(define-fun temp___old_701 () Int
  (page_length standard_output))

;; "Ensures"
(assert (in_range3 temp___old_701))
...
;; "temp___old_702"
(define-fun temp___old_702 () Int
  (line_length standard_output))

;; "Ensures"
(assert (in_range3 temp___old_702))
...
;; "temp___old_703"
(define-fun temp___old_703 () us_t
  (form standard_output))

;; "Ensures"
(assert (dynamic_invariant temp___old_703 true false true true))
...
;; Goal "def'vc"
;; File "spark-text_io.ads", line 236, characters 0-0
(assert
