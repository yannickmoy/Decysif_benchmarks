...
;; "temp___old_342"
(define-fun temp___old_342 () Int
  (page_length standard_output))

;; "Ensures"
(assert (in_range4 temp___old_342))
...
;; "temp___old_343"
(define-fun temp___old_343 () Int
  (line_length standard_output))

;; "Ensures"
(assert (in_range4 temp___old_343))
...
;; "temp___old_344"
(define-fun temp___old_344 () us_t
  (form standard_output))

;; "Ensures"
(assert (dynamic_invariant temp___old_344 true false true true))
