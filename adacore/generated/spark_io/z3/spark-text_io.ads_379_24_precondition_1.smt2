...
;; "temp___old_742"
(define-fun temp___old_742 () Int
  (page_length standard_output))

;; "Ensures"
(assert (in_range3 temp___old_742))
...
;; "temp___old_743"
(define-fun temp___old_743 () Int
  (line_length standard_output))

;; "Ensures"
(assert (in_range3 temp___old_743))
...
;; "temp___old_744"
(define-fun temp___old_744 () us_t
  (form standard_output))

;; "Ensures"
(assert (dynamic_invariant temp___old_744 true false true true))
...
;; Goal "def'vc"
;; File "spark-text_io.ads", line 374, characters 0-0
(assert
