...
;; "temp___old_727"
(define-fun temp___old_727 () Int
  (page_length standard_output))

;; "Ensures"
(assert (in_range3 temp___old_727))
...
;; "temp___old_728"
(define-fun temp___old_728 () Int
  (line_length standard_output))

;; "Ensures"
(assert (in_range3 temp___old_728))
...
;; "temp___old_729"
(define-fun temp___old_729 () us_t
  (form standard_output))

;; "Ensures"
(assert (dynamic_invariant temp___old_729 true false true true))
...
;; Goal "def'vc"
;; File "spark-text_io.ads", line 325, characters 0-0
(assert
