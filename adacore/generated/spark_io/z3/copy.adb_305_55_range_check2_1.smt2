...
(assert
  (forall ((us_void_param tuple0))
    (! (and
         (and
           (= (to_rep (select (temp___String_Literal_634 us_void_param) 1)) 65)
           (= (to_rep (select (temp___String_Literal_634 us_void_param) 2)) 110))
         (and
           (and
             (and
               (and
                 (and
                   (= (to_rep
                        (select (temp___String_Literal_634 us_void_param) 3)) 32)
                   (= (to_rep
                        (select (temp___String_Literal_634 us_void_param) 4)) 101))
                 (and
                   (= (to_rep
                        (select (temp___String_Literal_634 us_void_param) 5)) 114)
                   (= (to_rep
                        (select (temp___String_Literal_634 us_void_param) 6)) 114)))
               (and
                 (and
                   (= (to_rep
                        (select (temp___String_Literal_634 us_void_param) 7)) 111)
                   (= (to_rep
                        (select (temp___String_Literal_634 us_void_param) 8)) 114))
                 (= (to_rep
                      (select (temp___String_Literal_634 us_void_param) 9)) 32)))
             (and
               (and
                 (and
                   (= (to_rep
                        (select (temp___String_Literal_634 us_void_param) 10)) 104)
                   (= (to_rep
                        (select (temp___String_Literal_634 us_void_param) 11)) 97))
                 (and
                   (= (to_rep
                        (select (temp___String_Literal_634 us_void_param) 12)) 115)
                   (= (to_rep
                        (select (temp___String_Literal_634 us_void_param) 13)) 32)))
               (and
                 (and
                   (= (to_rep
                        (select (temp___String_Literal_634 us_void_param) 14)) 111)
                   (= (to_rep
                        (select (temp___String_Literal_634 us_void_param) 15)) 99))
                 (= (to_rep
                      (select (temp___String_Literal_634 us_void_param) 16)) 99))))
           (and
             (and
               (and
                 (and
                   (= (to_rep
                        (select (temp___String_Literal_634 us_void_param) 17)) 117)
                   (= (to_rep
                        (select (temp___String_Literal_634 us_void_param) 18)) 114))
                 (and
                   (= (to_rep
                        (select (temp___String_Literal_634 us_void_param) 19)) 101)
                   (= (to_rep
                        (select (temp___String_Literal_634 us_void_param) 20)) 100)))
               (and
                 (and
                   (= (to_rep
                        (select (temp___String_Literal_634 us_void_param) 21)) 32)
                   (= (to_rep
                        (select (temp___String_Literal_634 us_void_param) 22)) 114))
                 (= (to_rep
                      (select (temp___String_Literal_634 us_void_param) 23)) 101)))
             (and
               (and
                 (and
                   (= (to_rep
                        (select (temp___String_Literal_634 us_void_param) 24)) 97)
                   (= (to_rep
                        (select (temp___String_Literal_634 us_void_param) 25)) 100))
                 (= (to_rep
                      (select (temp___String_Literal_634 us_void_param) 26)) 105))
               (and
                 (and
                   (= (to_rep
                        (select (temp___String_Literal_634 us_void_param) 27)) 110)
                   (= (to_rep
                        (select (temp___String_Literal_634 us_void_param) 28)) 103))
                 (= (to_rep
                      (select (temp___String_Literal_634 us_void_param) 29)) 32)))))) :pattern (
    (temp___String_Literal_634
      us_void_param)) )))
...
;; "Ensures"
(assert (dynamic_invariant temp___636 true false true true))
...
;; "temp___635"
(define-fun temp___635 () (Array Int character)
  (temp___String_Literal_634 Tuple0))

;; "temp___String_Literal_634'result'unused"
(define-fun temp___String_Literal_634qtresultqtunused () (Array Int character)
  temp___635)
