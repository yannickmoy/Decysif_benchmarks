...
;; "Ensures"
(assert (in_range4 temp___old_783))
...
;; "temp___old_784"
(define-fun temp___old_784 () Int
  (line_length standard_output))

;; "Ensures"
(assert (in_range4 temp___old_784))
...
;; "temp___old_785"
(define-fun temp___old_785 () us_t
  (form standard_output))

;; "Ensures"
(assert (dynamic_invariant temp___old_785 true false true true))
