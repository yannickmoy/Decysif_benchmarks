...
;; "c268b'unused"
(define-fun c268bqtunused () int__ref
  (int__refqtmk c268b))

;; "c267b'unused"
(define-fun c267bqtunused () int__ref
  (int__refqtmk c267b))
...
;; "Ensures"
(assert (= (to_rep1 a__first) temp___899))
...
;; "Ensures"
(assert (= (to_rep1 a__last) temp___901))
...
;; "temp___old_893"
(define-fun temp___old_893 () us_t
  (of_array a o1 o))
...
;; "temp___loop_entry_862"
(define-fun temp___loop_entry_862 () us_t
  (of_array a o3 o2))
...
;; "temp___loop_entry_860'unused"
(define-fun temp___loop_entry_860qtunused () Int
  c268b)
...
;; "temp___loop_entry_859'unused"
(define-fun temp___loop_entry_859qtunused () Int
  c267b)
...
;; "temp___loop_entry_858'unused"
(define-fun temp___loop_entry_858qtunused () Int
  max)
...
;; "temp___loop_entry_857'unused"
(define-fun temp___loop_entry_857qtunused () Int
  k)
...
;; "temp___loop_entry_855"
(define-fun temp___loop_entry_855 () us_t
  (of_array a o5 o4))
...
(declare-const temp___846 us_t)

;; "H"
(assert (= temp___846 (of_array a o7 o6)))

(declare-const of_arrayqtresultqtunused3 us_t)

;; "H"
(assert (= of_arrayqtresultqtunused3 temp___846))
        ...
        (and
          ...
          (and
            ...
            (and
              ...
              (and
                (= temp___845 (of_array a o15 o14))
                (and
                  (= of_arrayqtresultqtunused4 temp___845)
                  (and
                    (and (<= o15 k) (<= k o14))
                    (and
...
;; "c267b'unused"
(define-fun c267bqtunused1 () int__ref
  (int__refqtmk c267b1))
...
;; "c268b'unused"
(define-fun c268bqtunused1 () int__ref
  (int__refqtmk c268b1))
...
;; "o"
(define-fun o28 () natural
  (rec__frame_condition__cell__max_left usq_))
...
;; "Assert"
(assert (and (<= o22 c267b1) (<= c267b1 o21)))
      ...
      (=>
        ...
        (forall ((j Int))
          (=>
            ...
            (<= (to_rep
                  (rec__frame_condition__cell__value
                    (us_split_fields1 (select a2 i)))) (get_max_right j a2))))))
    (forall ((i Int))
      (=>
        (and (<= k1 i) (<= i first1))
        (forall ((j Int))
          (=>
            ...
            (<= (to_rep
                  (rec__frame_condition__cell__value
                    (us_split_fields1 (select a2 j)))) (get_max_right i a2))))))))

;; "LoopInvariant"
(assert (= (frame_right (of_array a o3 o2) a2) true))
      ...
      (and
        (and
          (forall ((temp___856 Int))
            (=>
              (and
                (<= (to_rep1 a__first) temp___856)
                (<= temp___856 (to_rep1 a__last)))
              (and
                (= (rec__frame_condition__cell__value
                     (us_split_fields1 (select a2 temp___856))) (rec__frame_condition__cell__value
                                                                  (us_split_fields1
                                                                    (select 
                                                                    a temp___856))))
                (= (rec__frame_condition__cell__max_left
                     (us_split_fields1 (select a2 temp___856))) (rec__frame_condition__cell__max_left
                                                                  (us_split_fields1
                                                                    (select 
                                                                    a temp___856)))))))
          (in_range2 k1))
...
(declare-const temp___8461 us_t)

;; "H"
(assert (= temp___8461 (of_array a2 o46 o45)))

(declare-const of_arrayqtresultqtunused9 us_t)

;; "H"
(assert (= of_arrayqtresultqtunused9 temp___8461))
...
(declare-const temp___8451 us_t)
        ...
        (and
          ...
          (and
            ...
            (and
              ...
              (and
                (= temp___8451 (of_array a2 o54 o53))
                (and
                  (= of_arrayqtresultqtunused10 temp___8451)
                  (and
                    (and (<= o54 k2) (<= k2 o53))
                    (and
...
;; "c267b'unused"
(define-fun c267bqtunused2 () int__ref
  (int__refqtmk c267b3))
...
;; "c268b'unused"
(define-fun c268bqtunused2 () int__ref
  (int__refqtmk c268b3))
...
;; "Assert"
(assert (and (<= o61 c267b3) (<= c267b3 o60)))
