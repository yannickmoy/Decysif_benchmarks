...
(assert
  ...
  (=>
    ...
    (forall ((o (_ BitVec 64)))
      (=>
        (let ((temp___199 (bv2nat pos)))
          (ite (< temp___199 18446744073709551616)
            (= o (bvshl #x0000000000000001 ((_ int2bv 64) temp___199)))
            (= o #x0000000000000000)))
        (forall ((mask (_ BitVec 64)))
          (=>
            (= mask (bvnot o))
            (forall ((bitset__bit_clear__result (_ BitVec 64)))
              (=>
                (= bitset__bit_clear__result (bvand value mask))
                (=>
                  (bit_test__function_guard
