...
(assert
  (forall ((param__s us_rep))
    (! (= (= (is_empty param__s) true) (= (size param__s) 0)) :pattern (
    (is_empty
      param__s)) )))
  ...
  (forall ((param__s us_rep1))
    (! (=>
         ...
         (let ((result (last1 param__s)))
           (=> (last__function_guard result param__s) (in_range result)))) :pattern (
    (last1
      param__s)) )))
           ...
           (=>
             ...
             (and
               (and
                 ...
                 (= (length result) (size (to_base param__s))))
...
;; "temp___1063"
(define-fun temp___1063 () (Array Int element)
...
;; "temp___1064"
(define-fun temp___1064 () Int
  (last1 o))

;; "H"
(assert (last__function_guard temp___1064 o))

;; "H"
(assert (in_range temp___1064))

;; "H"
(assert
  (= temp___1064 (ite (not (= (wraps_around o) true))
                   (- (+ (to_rep3
                           (rec__stacks__buffer__first s__split_fields)) 
                   (to_rep
                     (rec__stacks__stack_root__length1 s__split_fields))) 1)
                   (- (- (+ (to_rep3
                              (rec__stacks__buffer__first s__split_fields)) 
                   (to_rep
                     (rec__stacks__stack_root__length1 s__split_fields))) 1) 100))))
...
;; "Assert"
(assert (and (<= 1 temp___1064) (<= temp___1064 100)))

;; "o"
(define-fun o1 () element
  (select temp___1063 temp___1064))

;; "get'result'unused"
(define-fun getqtresultqtunused () element
  o1)
...
;; "o"
(define-fun o5 () positive_less_than_max
  (rec__stacks__buffer__first s__split_fields))
...
;; "o"
(define-fun o10 () (Array Int element)
  (rec__stacks__stack_root__content1 s__split_fields))
...
(define-fun o11 () us_split_fields2
  (us_split_fieldsqtmk1 o10 o9 o5 o4))
...
;; "H"
(assert (= s__split_fields1 o11))

;; "H"
(assert
  (forall ((temp___1081 us_rep1))
    (get_model__function_guard (get_model temp___1081) temp___1081)))

;; "H"
(assert
  (forall ((temp___1077 us_rep1))
    (get_model__function_guard (get_model temp___1077) temp___1077)))

;; "H"
(assert
  (forall ((temp___1074 us_rep1))
    (get_model__function_guard (get_model temp___1074) temp___1074)))

;; "H"
(assert
  (forall ((temp___1072 us_rep1))
    (get_model__function_guard (get_model temp___1072) temp___1072)))

;; Goal "def'vc"
;; File "stacks.ads", line 73, characters 0-0
(assert
  (not
  (= (let ((temp___1087 (let ((temp___1083 (- (last
                                                (let ((temp___1081 (us_repqtmk1
                                                                    s__split_fields
                                                                    s__attr__tag)))
                                                  (get_model temp___1081))) 1)))
                          (let ((temp___1079 (first
                                               (let ((temp___1077 (us_repqtmk1
                                                                    s__split_fields
                                                                    s__attr__tag)))
                                                 (get_model temp___1077)))))
                            (of_array
                              (to_array
                                (let ((temp___1074 (us_repqtmk1
                                                     s__split_fields
                                                     s__attr__tag)))
                                  (get_model temp___1074)))
                              temp___1079
                              temp___1083)))))
       (let ((temp___1085 (let ((temp___1072 (us_repqtmk1
                                               s__split_fields1
                                               s__attr__tag)))
                            (get_model temp___1072))))
         (bool_eq
           (to_array temp___1085)
           (first temp___1085)
           (last temp___1085)
           (to_array temp___1087)
           (first temp___1087)
           (last temp___1087)))) true)))
