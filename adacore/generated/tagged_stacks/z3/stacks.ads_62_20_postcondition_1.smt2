...
(declare-datatypes ()
  ((ext__1 (ext__qtmk1 (rec__hidden_ext__1 us_private)))))
...
;; "attr__tag'result'unused"
(define-fun attr__tagqtresultqtunused () Int
  o)
...
;; "o"
(define-fun o1 () us_ext_type1
  (rec__ext__1 s__split_fields))

;; "rec__ext__'result'unused"
(define-fun rec__ext__qtresultqtunused () us_ext_type1
  o1)

;; "o"
(define-fun o2 () positive_less_than_max
  (rec__stacks__buffer__first s__split_fields))

;; "rec__stacks__buffer__first'result'unused"
(define-fun rec__stacks__buffer__firstqtresultqtunused () positive_less_than_max
  o2)
...
;; "o"
(define-fun o3 () less_than_max
  (rec__stacks__stack_root__length1 s__split_fields))

;; "rec__stacks__stack_root__length'result'unused"
(define-fun rec__stacks__stack_root__lengthqtresultqtunused () less_than_max
  o3)
...
(define-fun of_repqtresultqtunused () less_than_max
  o6)

;; "o"
(define-fun o7 () (Array Int element)
  (rec__stacks__stack_root__content1 s__split_fields))

;; "rec__stacks__stack_root__content'result'unused"
(define-fun rec__stacks__stack_root__contentqtresultqtunused () (Array Int element)
  o7)

;; "o"
(define-fun o8 () us_split_fields2
  (us_split_fieldsqtmk1 o7 o6 o2 o1))
...
;; "H"
(assert (= us_split_fields__contentqtresultqtunused2 s__split_fields1))

(declare-const us_repqtmkqtresultqtunused3 us_rep1)

;; "H"
(assert
  (= us_repqtmkqtresultqtunused3 (us_repqtmk1 s__split_fields1 s__attr__tag)))

(declare-const us_split_fieldsqtresultqtunused3 us_split_fields2)

;; "H"
(assert (= us_split_fieldsqtresultqtunused3 s__split_fields1))

(declare-const o9 positive_less_than_max)

;; "H"
(assert (= o9 (rec__stacks__buffer__first s__split_fields1)))

(declare-const rec__stacks__buffer__firstqtresultqtunused1 positive_less_than_max)

;; "H"
(assert (= rec__stacks__buffer__firstqtresultqtunused1 o9))

(declare-const o10 Int)

;; "Ensures"
(assert (= (to_rep3 o9) o10))

(declare-const to_repqtresultqtunused1 Int)

;; "H"
(assert (= to_repqtresultqtunused1 o10))
...
;; "H"
(assert (= infix_eqqtresultqtunused o11))
...
(declare-const attr__tagqtresultqtunused1 Int)

(declare-const usq_qtunused1 us_split_fields2)

(declare-const us_split_fieldsqtresultqtunused4 us_split_fields2)

(declare-const o13 us_ext_type1)

(declare-const rec__ext__qtresultqtunused1 us_ext_type1)
...
(declare-const o14 positive_less_than_max)

(declare-const rec__stacks__buffer__firstqtresultqtunused2 positive_less_than_max)
...
(declare-const o17 positive_less_than_max)

(declare-const of_repqtresultqtunused1 positive_less_than_max)

(declare-const o18 less_than_max)

(declare-const rec__stacks__stack_root__lengthqtresultqtunused1 less_than_max)

(declare-const o19 (Array Int element))

(declare-const rec__stacks__stack_root__contentqtresultqtunused1 (Array Int element))
...
(declare-const attr__tagqtresultqtunused2 Int)

(declare-const usq_qtunused2 us_split_fields2)

(declare-const us_split_fieldsqtresultqtunused7 us_split_fields2)

(declare-const o22 us_ext_type1)

(declare-const rec__ext__qtresultqtunused2 us_ext_type1)

(declare-const o23 less_than_max)

(declare-const rec__stacks__stack_root__lengthqtresultqtunused2 less_than_max)

(declare-const o24 (Array Int element))

(declare-const rec__stacks__stack_root__contentqtresultqtunused2 (Array Int element))
...
(assert
  (ite (= spark__branch true)
    (and
      (= us_split_fields__contentqtresultqtunused5 s__split_fields1)
      (and
        (= us_repqtmkqtresultqtunused7 (us_repqtmk1
                                         s__split_fields1
                                         s__attr__tag))
        (and
          (= o21 s__attr__tag)
          (and
            (= attr__tagqtresultqtunused2 o21)
            (and
              (= usq_qtunused2 s__split_fields1)
              (and
                (= us_split_fieldsqtresultqtunused7 s__split_fields1)
                (and
                  (= o22 (rec__ext__1 s__split_fields1))
                  (and
                    (= rec__ext__qtresultqtunused2 o22)
                    (and
                      (= o23 (rec__stacks__stack_root__length1
                               s__split_fields1))
                      (and
                        (= rec__stacks__stack_root__lengthqtresultqtunused2 
                        o23)
                        (and
                          (= o24 (rec__stacks__stack_root__content1
                                   s__split_fields1))
                          (and
                            (= rec__stacks__stack_root__contentqtresultqtunused2 
                            o24)
                            (and
                              (= o25 (us_split_fieldsqtmk1
                                       o24
                                       o23
                                       rliteral
                                       o22))
                              (and
                                ...
                                o25)
                                (and
                                  (= us_repqtmkqtresultqtunused8 (us_repqtmk1
                                                                   o25
                                                                   o21))
                                  (and
                                    (= us_split_fieldsqtresultqtunused8 
                                    o25)
                                    (= s__split_fields2 o25)))))))))))))))))
    (and
      (= us_split_fields__contentqtresultqtunused3 s__split_fields1)
      (and
        (= us_repqtmkqtresultqtunused4 (us_repqtmk1
                                         s__split_fields1
                                         s__attr__tag))
        (and
          (= o12 s__attr__tag)
          (and
            (= attr__tagqtresultqtunused1 o12)
            (and
              (= usq_qtunused1 s__split_fields1)
              (and
                (= us_split_fieldsqtresultqtunused4 s__split_fields1)
                (and
                  (= o13 (rec__ext__1 s__split_fields1))
                  (and
                    (= rec__ext__qtresultqtunused1 o13)
                    (and
                      (= us_split_fields__contentqtresultqtunused4 s__split_fields1)
                      (and
                        (= us_repqtmkqtresultqtunused5 (us_repqtmk1
                                                         s__split_fields1
                                                         s__attr__tag))
                        (and
                          (= us_split_fieldsqtresultqtunused5 s__split_fields1)
                          (and
                            (= o14 (rec__stacks__buffer__first
                                     s__split_fields1))
                            (and
                              (= rec__stacks__buffer__firstqtresultqtunused2 
                              o14)
                              (and
                                (= (to_rep3 o14) o15)
                                (and
                                  (= to_repqtresultqtunused2 o15)
                                  (and
                                    (= o16 (- o15 1))
                                    (and
                                      (= infix_mnqtresultqtunused o16)
                                      (and
                                        (in_range4 o16)
                                        (and
                                          ...
                                          (and
                                            ...
                                            (and
                                              ...
                                              o17)
                                              (and
                                                (= o18 (rec__stacks__stack_root__length1
                                                         s__split_fields1))
                                                (and
                                                  (= rec__stacks__stack_root__lengthqtresultqtunused1 
                                                  o18)
                                                  (and
                                                    (= o19 (rec__stacks__stack_root__content1
                                                             s__split_fields1))
                                                    (and
                                                      (= rec__stacks__stack_root__contentqtresultqtunused1 
                                                      o19)
                                                      (and
                                                        (= o20 (us_split_fieldsqtmk1
                                                                 o19
                                                                 o18
                                                                 o17
                                                                 o13))
...
;; "attr__tag'result'unused"
(define-fun attr__tagqtresultqtunused3 () Int
  o26)
...
;; "o"
(define-fun o27 () us_ext_type1
  (rec__ext__1 s__split_fields2))

;; "rec__ext__'result'unused"
(define-fun rec__ext__qtresultqtunused3 () us_ext_type1
  o27)

;; "o"
(define-fun o28 () positive_less_than_max
  (rec__stacks__buffer__first s__split_fields2))

;; "rec__stacks__buffer__first'result'unused"
(define-fun rec__stacks__buffer__firstqtresultqtunused3 () positive_less_than_max
  o28)

;; "o"
(define-fun o29 () less_than_max
  (rec__stacks__stack_root__length1 s__split_fields2))

;; "rec__stacks__stack_root__length'result'unused"
(define-fun rec__stacks__stack_root__lengthqtresultqtunused3 () less_than_max
  o29)
...
;; "temp___1011"
(define-fun temp___1011 () (Array Int element)
  (rec__stacks__stack_root__content1 s__split_fields2))

;; "rec__stacks__stack_root__content'result'unused"
(define-fun rec__stacks__stack_root__contentqtresultqtunused3 () (Array Int element)
  temp___1011)

(declare-const o30 element)

;; "Ensures"
(assert (= (to_rep1 o30) e))

;; "of_rep'result'unused"
(define-fun of_repqtresultqtunused2 () element
  o30)
...
;; "o"
(define-fun o31 () positive_less_than_max
  (rec__stacks__buffer__first s__split_fields2))

;; "rec__stacks__buffer__first'result'unused"
(define-fun rec__stacks__buffer__firstqtresultqtunused4 () positive_less_than_max
  o31)

(declare-const o32 Int)

;; "Ensures"
(assert (= (to_rep3 o31) o32))
...
;; "o"
(define-fun o33 () (Array Int element)
  (store temp___1011 o32 o30))

;; "set'result'unused"
(define-fun setqtresultqtunused () (Array Int element)
  o33)

;; "o"
(define-fun o34 () us_split_fields2
  (us_split_fieldsqtmk1 o33 o29 o28 o27))
...
;; "H"
(assert (= s__split_fields3 o34))

;; "H"
(assert
  (forall ((temp___1021 us_rep1))
    (get_model__function_guard (get_model temp___1021) temp___1021)))

;; "H"
(assert
  (forall ((temp___1019 us_rep1))
    (get_model__function_guard (get_model temp___1019) temp___1019)))

;; Goal "def'vc"
;; File "stacks.ads", line 60, characters 0-0
(assert
  (not
  (= (let ((temp___1026 (let ((temp___1022 (let ((temp___1021 (us_repqtmk1
                                                                s__split_fields
                                                                s__attr__tag)))
                          ...
                          (of_array
                            ...
                            (- (+ 1 (+ 1 (length
                                           (first temp___1022)
                                           (last temp___1022)))) 1)))))
       (let ((temp___1024 (let ((temp___1019 (us_repqtmk1
                                               s__split_fields3
                                               s__attr__tag)))
