...
;; "attr__tag'result'unused"
(define-fun attr__tagqtresultqtunused1 () Int
  o9)
...
;; "o"
(define-fun o10 () us_ext_type1
  (rec__ext__1 s__split_fields1))

;; "rec__ext__'result'unused"
(define-fun rec__ext__qtresultqtunused1 () us_ext_type1
  o10)

;; "o"
(define-fun o11 () positive_less_than_max
  (rec__stacks__buffer__first s__split_fields1))

;; "rec__stacks__buffer__first'result'unused"
(define-fun rec__stacks__buffer__firstqtresultqtunused1 () positive_less_than_max
  o11)

;; "o"
(define-fun o12 () less_than_max
  (rec__stacks__stack_root__length1 s__split_fields1))

;; "rec__stacks__stack_root__length'result'unused"
(define-fun rec__stacks__stack_root__lengthqtresultqtunused1 () less_than_max
  o12)
...
;; "temp___1107"
(define-fun temp___1107 () (Array Int element)
  (rec__stacks__stack_root__content1 s__split_fields1))

;; "rec__stacks__stack_root__content'result'unused"
(define-fun rec__stacks__stack_root__contentqtresultqtunused1 () (Array Int element)
  temp___1107)

(declare-const o13 element)

;; "Ensures"
(assert (= (to_rep1 o13) e))

;; "of_rep'result'unused"
(define-fun of_repqtresultqtunused1 () element
  o13)
...
;; "temp___1109"
(define-fun temp___1109 () Int
  (last1 o14))

;; "H"
(assert (last__function_guard temp___1109 o14))

;; "H"
(assert (in_range1 temp___1109))

;; "H"
(assert
  (= temp___1109 (ite (not (= (wraps_around o14) true))
                   (- (+ (to_rep3
                           (rec__stacks__buffer__first s__split_fields1)) 
                   (to_rep
                     (rec__stacks__stack_root__length1 s__split_fields1))) 1)
                   (- (- (+ (to_rep3
                              (rec__stacks__buffer__first s__split_fields1)) 
                   (to_rep
                     (rec__stacks__stack_root__length1 s__split_fields1))) 1) 100))))
...
;; "Assert"
(assert (and (<= 1 temp___1109) (<= temp___1109 100)))

;; "o"
(define-fun o15 () (Array Int element)
  (store temp___1107 temp___1109 o13))
...
;; "o"
(define-fun o16 () us_split_fields2
  (us_split_fieldsqtmk1 o15 o12 o11 o10))
...
;; Goal "def'vc"
;; File "stacks.ads", line 75, characters 0-0
(assert
  (not
  (= (let ((temp___1123 (let ((temp___1119 (let ((temp___1118 (us_repqtmk1
                                                                s__split_fields
                                                                s__attr__tag)))
                                             (get_model temp___1118))))
                          (ite (= (length1 temp___1119) 0)
                            (of_array (singleton1 (of_rep1 e) 1) 1 1)
                            (of_array
                              (concat_singleton_right
                                (to_array temp___1119)
                                (first temp___1119)
                                (last temp___1119)
                                (of_rep1 e))
                              (first temp___1119)
                              (- (+ (first temp___1119) (+ (length
                                                             (first
                                                               temp___1119)
                                                             (last
                                                               temp___1119)) 1)) 1))))))
       (let ((temp___1121 (let ((temp___1116 (us_repqtmk1
                                               s__split_fields2
                                               s__attr__tag)))
                            (get_model temp___1116))))
         (bool_eq
           (to_array temp___1121)
           (first temp___1121)
           (last temp___1121)
           (to_array temp___1123)
           (first temp___1123)
           (last temp___1123)))) true)))
