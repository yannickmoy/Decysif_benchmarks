                          ...
                          (forall ((o3 element))
                            (=>
                              ...
                              (let ((o4 (us_repqtmk1
                                          s__split_fields1
                                          s__attr__tag)))
                                (let ((temp___1109 (last1 o4)))
                                  (=>
                                    (and
                                      (last__function_guard temp___1109 o4)
                                      (and
                                        (in_range1 temp___1109)
                                        (= temp___1109 (ite (not
                                                              (= (wraps_around
                                                                   o4) true))
                                                         (- (+ (to_rep3
                                      ...
                                      (forall ((s__split_fields2 us_split_fields2))
                                        (=>
                                          (= s__split_fields2 (us_split_fieldsqtmk1
                                                                (store 
                                                                (rec__stacks__stack_root__content1
                                                                  s__split_fields1) temp___1109 o3)
                                                                (rec__stacks__stack_root__length1
                                                                  s__split_fields1)
                                                                (rec__stacks__buffer__first
                                                                  s__split_fields1)
                                            ...
                                            (=>
                                              (forall ((temp___1116 us_rep1))
                                                (get_model__function_guard
                                                  ...
                                                  temp___1116))
                                              (= (let ((temp___1123 (let ((temp___1119 
                                                                    (let ((temp___1118 
                                                                    (us_repqtmk1
                                                                    s__split_fields
                                                                    s__attr__tag)))
