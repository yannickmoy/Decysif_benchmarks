    ...
    (=>
      ...
      (=>
        ...
        (=>
          (not
            (= (is_empty
                 (to_base (us_repqtmk1 s__split_fields s__attr__tag))) true))
          (let ((o (us_repqtmk1 s__split_fields s__attr__tag)))
            (let ((temp___1064 (last1 o)))
              (=>
                (and
                  (last__function_guard temp___1064 o)
                  (and
                    (in_range temp___1064)
                    (= temp___1064 (ite (not (= (wraps_around o) true))
                                     (- (+ (to_rep3
                                             (rec__stacks__buffer__first
                                               s__split_fields)) (to_rep
                                                                   (rec__stacks__stack_root__length1
                                                                    s__split_fields))) 1)
                                     (- (- (+ (to_rep3
                                                (rec__stacks__buffer__first
                                                  s__split_fields)) (to_rep
                                                                    (rec__stacks__stack_root__length1
                                                                    s__split_fields))) 1) 100)))))
                (=>
                  (and (<= 1 temp___1064) (<= temp___1064 100))
                  (forall ((o1 Int))
                    (=>
                      (= (to_rep1
                           (select (rec__stacks__stack_root__content1
                                     s__split_fields) temp___1064)) o1)
                      (forall ((e1 Int))
                        (=>
                          (= e1 o1)
                          (forall ((o2 Int))
