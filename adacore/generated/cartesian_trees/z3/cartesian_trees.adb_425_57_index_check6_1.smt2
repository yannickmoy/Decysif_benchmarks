...
;; "Assert"
(assert (and (<= (first1 temp___1210) j4) (<= j4 (last1 temp___1210))))
...
;; "o"
(define-fun o202 () (Array Int us_rep)
...
;; "o"
(define-fun o204 () us_split_fields
  (us_split_fields1 o203))
...
;; "o"
(define-fun o205 () natural
  (rec__cartesian_trees__tree_cell__parent o204))
...
;; "Ensures"
(assert (= (to_rep o205) temp___1211))
