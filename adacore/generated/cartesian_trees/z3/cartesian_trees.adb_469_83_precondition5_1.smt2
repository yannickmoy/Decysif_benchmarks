...
;; "o"
(define-fun o166 () Bool
  (ite (<= usf1 o165) true false))
...
;; "o"
(define-fun o168 () Bool
  (ite (<= o167 usf1) true false))
...
;; "H"
(assert (= int__contentqtresultqtunused43 w2))

;; "Assert"
(assert (and (<= (first s) usf1) (<= usf1 (last s))))

(declare-const o171 (Array Int natural))

;; "H"
(assert (= o171 (to_array s)))

(declare-const to_arrayqtresultqtunused33 (Array Int natural))

;; "H"
(assert (= to_arrayqtresultqtunused33 o171))

(declare-const o172 natural)

;; "H"
(assert (= o172 (select o171 usf1)))

(declare-const getqtresultqtunused25 natural)

;; "H"
(assert (= getqtresultqtunused25 o172))

(declare-const o173 Int)

;; "Ensures"
(assert (= (to_rep o172) o173))

(declare-const to_repqtresultqtunused21 Int)

;; "H"
(assert (= to_repqtresultqtunused21 o173))

(declare-const infix_lseqqtresultqtunused12 Bool)

;; "H"
(assert (= infix_lseqqtresultqtunused12 (ite (<= o173 w2) true false)))
...
(declare-const o174 (Array Int us_rep))
          ...
          (and
            ...
            (and
              ...
              (and
                ...
                (and
                  (= int__contentqtresultqtunused44 i2)
                  (and
                    (= o174 (to_array1 temp___1274))
                    (and
                      (= to_arrayqtresultqtunused34 o174)
                      (and
                        (= o175 (select o174 i2))
                        (and
                          (= getqtresultqtunused26 o175)
                          (and
                            (= o176 (us_split_fields1 o175))
                            (and
                              (= us_split_fieldsqtresultqtunused39 o176)
                              (and
                                (= o177 (rec__cartesian_trees__tree_cell__right
                                          o176))
                                (and
                                  ...
                                  (and
                                    (= (to_rep o177) o178)
                                    (and
                                      (= to_repqtresultqtunused22 o178)
                                      (and
                                        (= infix_eqqtresultqtunused8 
                                        (ite (= o178 0)
                                          true
                                          false))
                                        (= o170 (ite (= o178 0) false true))))))))))))))))))))
    (= o170 false)))
...
;; "o"
(define-fun o179 () (Array Int us_rep)
...
;; "o"
(define-fun o181 () us_split_fields
  (us_split_fields1 o180))
...
;; "o"
(define-fun o182 () natural
  (rec__cartesian_trees__tree_cell__right o181))
