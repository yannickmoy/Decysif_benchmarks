...
;; "o"
(define-fun o173 () (Array Int us_rep)
  (to_array1 temp___12591))
...
;; "o"
(define-fun o175 () us_split_fields
  (us_split_fields1 o174))
...
;; "o"
(define-fun o176 () natural
  (rec__cartesian_trees__tree_cell__right o175))
...
;; "temp___1258"
(define-fun temp___12581 () us_t1
  (rec__cartesian_trees__tree__cells1 t__split_fields1))

;; "rec__cartesian_trees__tree__cells'result'unused"
(define-fun rec__cartesian_trees__tree__cellsqtresultqtunused20 () us_t1
  temp___12581)
...
;; "o"
(define-fun o178 () (Array Int us_rep)
  (to_array1 temp___12581))

;; "to_array'result'unused"
(define-fun to_arrayqtresultqtunused34 () (Array Int us_rep)
  o178)

;; "o"
(define-fun o179 () us_rep
  (select o178 i2))

;; "get'result'unused"
(define-fun getqtresultqtunused26 () us_rep
  o179)

;; "o"
(define-fun o180 () us_split_fields
  (us_split_fields1 o179))

;; "__split_fields'result'unused"
(define-fun us_split_fieldsqtresultqtunused41 () us_split_fields
  o180)

;; "o"
(define-fun o181 () natural
  (rec__cartesian_trees__tree_cell__right o180))

;; "rec__cartesian_trees__tree_cell__right'result'unused"
(define-fun rec__cartesian_trees__tree_cell__rightqtresultqtunused9 () natural
  o181)
...
;; "temp___1256"
(define-fun temp___12561 () us_t1
  (rec__cartesian_trees__tree__cells1 t__split_fields1))

;; "rec__cartesian_trees__tree__cells'result'unused"
(define-fun rec__cartesian_trees__tree__cellsqtresultqtunused21 () us_t1
  temp___12561)

;; "temp___1257"
(define-fun temp___12571 () (Array Int us_rep)
  (to_array1 temp___12561))

;; "to_array'result'unused"
(define-fun to_arrayqtresultqtunused35 () (Array Int us_rep)
  temp___12571)
...
;; "o"
(define-fun o186 () Bool
  (belongs_to o185 o182 j4))
...
(define-fun belongs_toqtresultqtunused1 () Bool
  o186)
...
;; "o"
(define-fun o187 () (Array Int natural)
  (to_array s))

;; "to_array'result'unused"
(define-fun to_arrayqtresultqtunused36 () (Array Int natural)
  o187)

;; "o"
(define-fun o188 () natural
  (select o187 j4))

;; "get'result'unused"
(define-fun getqtresultqtunused27 () natural
  o188)
...
;; "o"
(define-fun o190 () Bool
  (ite (= o189 w4) true false))
...
;; "o"
(define-fun o192 () Bool
  (and o191 (ite (= j4 o177) false true)))
...
;; "temp___1192"
(define-fun temp___11921 () us_t1
  (rec__cartesian_trees__tree__cells1 t__split_fields1))

;; "rec__cartesian_trees__tree__cells'result'unused"
(define-fun rec__cartesian_trees__tree__cellsqtresultqtunused22 () us_t1
  temp___11921)

;; "Assert"
(assert (and (<= (first1 temp___11921) i2) (<= i2 (last1 temp___11921))))
...
;; "o"
(define-fun o193 () (Array Int us_rep)
  (to_array1 temp___11921))

;; "to_array'result'unused"
(define-fun to_arrayqtresultqtunused37 () (Array Int us_rep)
  o193)
...
;; "get'result'unused"
(define-fun getqtresultqtunused28 () us_rep
  o194)

;; "o"
(define-fun o195 () us_split_fields
  (us_split_fields1 o194))
...
;; "o"
(define-fun o196 () natural
  (rec__cartesian_trees__tree_cell__right o195))

;; "rec__cartesian_trees__tree_cell__right'result'unused"
(define-fun rec__cartesian_trees__tree_cell__rightqtresultqtunused10 
  () natural
  o196)
...
;; "temp___1190"
(define-fun temp___11901 () us_t1
  (rec__cartesian_trees__tree__cells1 t__split_fields1))

;; "rec__cartesian_trees__tree__cells'result'unused"
(define-fun rec__cartesian_trees__tree__cellsqtresultqtunused23 () us_t1
  temp___11901)

;; "temp___1191"
(define-fun temp___11911 () (Array Int us_rep)
  (to_array1 temp___11901))

;; "to_array'result'unused"
(define-fun to_arrayqtresultqtunused38 () (Array Int us_rep)
  temp___11911)
  ...
  (or
    ...
    (and
      (not
        (= (to_rep
             (rec__cartesian_trees__tree_cell__parent
               (us_split_fields1 (select (to_array1 o200) j4)))) 0))
      (= (belongs_to
           o200
           o197
           (to_rep
             (rec__cartesian_trees__tree_cell__parent
               (us_split_fields1 (select (to_array1 o200) j4))))) true))))
...
;; "o"
(define-fun o202 () Bool
  (ite (<= usf2 o201) true false))
...
;; "H"
(assert (= int__contentqtresultqtunused55 w4))
...
;; "H"
(assert (= infix_mnqtresultqtunused o207))

;; "Assert"
(assert (and (<= (first s) usf2) (<= usf2 (last s))))

(declare-const o208 (Array Int natural))

;; "H"
(assert (= o208 (to_array s)))

(declare-const to_arrayqtresultqtunused39 (Array Int natural))

;; "H"
(assert (= to_arrayqtresultqtunused39 o208))

(declare-const o209 natural)

;; "H"
(assert (= o209 (select o208 usf2)))

(declare-const getqtresultqtunused29 natural)

;; "H"
(assert (= getqtresultqtunused29 o209))

(declare-const o210 Int)

;; "Ensures"
(assert (= (to_rep o209) o210))

(declare-const to_repqtresultqtunused25 Int)

;; "H"
(assert (= to_repqtresultqtunused25 o210))

(declare-const infix_lseqqtresultqtunused16 Bool)

;; "H"
(assert (= infix_lseqqtresultqtunused16 (ite (<= o210 o207) true false)))
...
(assert
  (ite (<= o210 o207)
    (and
      (= us_split_fields__contentqtresultqtunused29 t__split_fields1)
      (and
        (= us_repqtmkqtresultqtunused38 (us_repqtmk2
                                          t__split_discrs
                                          t__split_fields1))
        (and
          (= us_split_fieldsqtresultqtunused46 t__split_fields1)
          (and
            ...
            (and
              ...
              (and
                ...
                (and
                  (= int__contentqtresultqtunused56 i2)
                  (and
                    (= o211 (to_array1 temp___1213))
                    (and
                      (= to_arrayqtresultqtunused40 o211)
                      (and
                        (= o212 (select o211 i2))
                        (and
                          (= getqtresultqtunused30 o212)
                          (and
                            (= o213 (us_split_fields1 o212))
                            (and
                              (= us_split_fieldsqtresultqtunused47 o213)
                              (and
                                (= o214 (rec__cartesian_trees__tree_cell__right
                                          o213))
                                (and
                                  ...
                                  (and
                                    (= (to_rep o214) o215)
                                    (and
                                      (= to_repqtresultqtunused26 o215)
                                      (and
                                        (= infix_eqqtresultqtunused11 
                                        (ite (= o215 0)
                                          true
                                          false))
                                        (= o206 (ite (= o215 0) false true))))))))))))))))))))
    (= o206 false)))
...
;; "rec__cartesian_trees__tree__cells'result'unused"
(define-fun rec__cartesian_trees__tree__cellsqtresultqtunused25 () us_t1
  temp___1216)
...
;; "o"
(define-fun o216 () (Array Int us_rep)
  (to_array1 temp___1216))

;; "to_array'result'unused"
(define-fun to_arrayqtresultqtunused41 () (Array Int us_rep)
  o216)

;; "o"
(define-fun o217 () us_rep
  (select o216 i2))
...
;; "o"
(define-fun o219 () natural
  (rec__cartesian_trees__tree_cell__right o218))
...
;; "rec__cartesian_trees__tree__cells'result'unused"
(define-fun rec__cartesian_trees__tree__cellsqtresultqtunused26 () us_t1
  temp___1214)
