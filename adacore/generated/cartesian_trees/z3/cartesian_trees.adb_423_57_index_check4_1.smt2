...
;; "o"
(define-fun o166 () (Array Int us_rep)
...
;; "o"
(define-fun o168 () us_split_fields
  (us_split_fields1 o167))
...
;; "o"
(define-fun o169 () natural
  (rec__cartesian_trees__tree_cell__right o168))
...
;; "o"
(define-fun o171 () (Array Int us_rep)
...
;; "o"
(define-fun o173 () us_split_fields
  (us_split_fields1 o172))
...
;; "o"
(define-fun o174 () natural
  (rec__cartesian_trees__tree_cell__right o173))
...
;; "o"
(define-fun o180 () (Array Int natural)
  (to_array s))
...
;; "o"
(define-fun o183 () Bool
  (ite (= o182 w2) true false))
...
;; "o"
(define-fun o185 () Bool
  (and o184 (ite (= j4 o170) false true)))
...
;; "o"
(define-fun o186 () (Array Int us_rep)
...
;; "o"
(define-fun o188 () us_split_fields
  (us_split_fields1 o187))
...
;; "o"
(define-fun o189 () natural
  (rec__cartesian_trees__tree_cell__right o188))
  ...
  (or
    ...
    (and
      (not
        (= (to_rep
             (rec__cartesian_trees__tree_cell__parent
               (us_split_fields1 (select (to_array1 o193) j4)))) 0))
      (= (belongs_to
           o193
           o190
           (to_rep
             (rec__cartesian_trees__tree_cell__parent
               (us_split_fields1 (select (to_array1 o193) j4))))) true))))
...
;; "o"
(define-fun o194 () (Array Int natural)
  (to_array s))

;; "to_array'result'unused"
(define-fun to_arrayqtresultqtunused39 () (Array Int natural)
  o194)

;; "o"
(define-fun o195 () natural
  (select o194 j4))

;; "get'result'unused"
(define-fun getqtresultqtunused29 () natural
  o195)
...
;; "Assert"
(assert (and (<= (first1 temp___1199) j4) (<= j4 (last1 temp___1199))))
...
;; "o"
(define-fun o197 () (Array Int us_rep)
...
;; "o"
(define-fun o199 () us_split_fields
  (us_split_fields1 o198))
...
;; "o"
(define-fun o200 () natural
  (rec__cartesian_trees__tree_cell__parent o199))
...
;; "Ensures"
(assert (= (to_rep o200) temp___1200))
