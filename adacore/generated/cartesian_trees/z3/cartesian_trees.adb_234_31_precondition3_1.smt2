...
;; "Assert"
(assert (and (<= (first1 temp___844) i1) (<= i1 (last1 temp___844))))
...
(assert
  (and
    (= (valid_tree_cell
         (let ((temp___850 (rec__cartesian_trees__tree__cells
                             (us_split_fields3 (to_base temp___848)))))
           (rec__cartesian_trees__tree__cells
             (us_split_fields3 (to_base temp___848))))) true)
    (or
      (= (to_rep
           (rec__cartesian_trees__tree__root
             (us_split_fields3 (to_base temp___848)))) 0)
      (let ((temp___853 (to_rep
                          (rec__cartesian_trees__tree__root
                            (us_split_fields3 (to_base temp___848))))))
        (and
          (<= 1 temp___853)
          (<= temp___853 (to_rep
                           (rec__cartesian_trees__tree__size
                             (us_split_discrs1 (to_base temp___848))))))))))
...
;; "o"
(define-fun o57 () natural
  (rec__cartesian_trees__tree_cell__right usq_1))

;; "rec__cartesian_trees__tree_cell__right'result'unused"
(define-fun rec__cartesian_trees__tree_cell__rightqtresultqtunused1 () natural
  o57)
...
(assert
  (and
    (<= (first1 temp___859) temp___861)
    (<= temp___861 (last1 temp___859))))

;; "o"
(define-fun o63 () (Array Int us_rep)
  (to_array1 temp___859))
...
(assert
  (and
    (= (valid_tree_cell
         (let ((temp___866 (rec__cartesian_trees__tree__cells
                             (us_split_fields3 (to_base temp___864)))))
           (rec__cartesian_trees__tree__cells
             (us_split_fields3 (to_base temp___864))))) true)
    (or
      (= (to_rep
           (rec__cartesian_trees__tree__root
             (us_split_fields3 (to_base temp___864)))) 0)
      (let ((temp___869 (to_rep
        ...
        (and
          ...
          (<= temp___869 (to_rep
                           (rec__cartesian_trees__tree__size
                             (us_split_discrs1 (to_base temp___864))))))))))
...
;; "Assert"
(assert (< i1 (to_rep (select (to_array right) i1))))
...
;; "o"
(define-fun o69 () (Array Int natural)
  (to_array right))

;; "to_array'result'unused"
(define-fun to_arrayqtresultqtunused16 () (Array Int natural)
  o69)

;; "o"
(define-fun o70 () natural
  (select o69 i1))

;; "get'result'unused"
(define-fun getqtresultqtunused13 () natural
  o70)

(declare-const o71 Int)

;; "Ensures"
(assert (= (to_rep o70) o71))
...
(define-fun us_repqtmkqtresultqtunused12 () us_rep2
  (us_repqtmk2 t__split_discrs t__split_fields3))
...
;; "temp___874"
(define-fun temp___874 () us_t1
  (rec__cartesian_trees__tree__cells1 t__split_fields3))

;; "rec__cartesian_trees__tree__cells'result'unused"
(define-fun rec__cartesian_trees__tree__cellsqtresultqtunused5 () us_t1
  temp___874)

;; "temp___875"
(define-fun temp___875 () (Array Int us_rep)
  (to_array1 temp___874))

;; "to_array'result'unused"
(define-fun to_arrayqtresultqtunused17 () (Array Int us_rep)
  temp___875)
