...
;; "o"
(define-fun o201 () (Array Int natural)
  (to_array s))
...
;; "o"
(define-fun o204 () (Array Int us_rep)
...
;; "o"
(define-fun o207 () natural
  (rec__cartesian_trees__tree_cell__parent o206))
...
;; "Ensures"
(assert (= (to_rep o207) temp___1200))
