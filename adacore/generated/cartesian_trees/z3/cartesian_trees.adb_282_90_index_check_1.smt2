...
;; "Assert"
(assert (and (<= (first1 temp___1014) usf) (<= usf (last1 temp___1014))))

;; "o"
(define-fun o113 () (Array Int us_rep)
  (to_array1 temp___1014))
...
;; "Ensures"
(assert (= (to_rep o120) temp___1013))
