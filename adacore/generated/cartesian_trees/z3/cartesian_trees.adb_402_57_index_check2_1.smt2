...
;; "Assert"
(assert (and (<= (first1 temp___1174) i2) (<= i2 (last1 temp___1174))))
...
;; "o"
(define-fun o115 () (Array Int us_rep)
...
;; "o"
(define-fun o118 () natural
  (rec__cartesian_trees__tree_cell__right o117))
...
;; "Ensures"
(assert (= (to_rep o118) temp___1175))
