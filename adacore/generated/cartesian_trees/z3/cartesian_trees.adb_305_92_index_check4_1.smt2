...
(assert
  (= (well_formed
       (let ((temp___1030 (rec__cartesian_trees__tree__cells1
                            t__split_fields1)))
         (rec__cartesian_trees__tree__cells1 t__split_fields1))
       i4) true))
...
;; "Assert"
(assert (and (<= (first1 temp___1041) i4) (<= i4 (last1 temp___1041))))
...
(define-fun o180 () natural
  (rec__cartesian_trees__tree_cell__left o179))
...
;; "Ensures"
(assert (= (to_rep o180) temp___1042))
