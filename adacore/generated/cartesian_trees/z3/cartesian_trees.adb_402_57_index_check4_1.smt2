...
(assert
  (= (well_formed
       (let ((temp___1171 (rec__cartesian_trees__tree__cells1
                            t__split_fields1)))
         (rec__cartesian_trees__tree__cells1 t__split_fields1))
       i4) true))
...
;; "Assert"
(assert (and (<= (first1 temp___1174) i4) (<= i4 (last1 temp___1174))))
...
;; "o"
(define-fun o177 () (Array Int us_rep)
  (to_array1 temp___1174))
...
;; "o"
(define-fun o179 () us_split_fields
  (us_split_fields1 o178))
...
;; "o"
(define-fun o180 () natural
  (rec__cartesian_trees__tree_cell__right o179))
...
;; "Ensures"
(assert (= (to_rep o180) temp___1175))
...
(assert
  (not (<= temp___1175 (last1 temp___1173))))
