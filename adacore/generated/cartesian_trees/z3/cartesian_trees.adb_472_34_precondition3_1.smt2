...
;; "H"
(assert (= wqtunused3 (int__refqtmk w3)))
...
;; "H"
(assert (= int__contentqtresultqtunused25 w3))

(declare-const o115 Bool)

;; "H"
(assert (= o115 (ite (<= w3 2147483647) true false)))

(declare-const infix_lseqqtresultqtunused4 Bool)

;; "H"
(assert (= infix_lseqqtresultqtunused4 o115))

(declare-const int__contentqtresultqtunused26 Int)

;; "H"
(assert (= int__contentqtresultqtunused26 w3))

(declare-const o116 Bool)

;; "H"
(assert (= o116 (ite (<= 0 w3) true false)))

(declare-const infix_lseqqtresultqtunused5 Bool)

;; "H"
(assert (= infix_lseqqtresultqtunused5 o116))

(declare-const o117 Bool)

;; "H"
(assert (= o117 (and o116 o115)))

(declare-const andbqtresultqtunused3 Bool)

;; "H"
(assert (= andbqtresultqtunused3 o117))
        ...
        (and
          ...
          (and
            ...
            (and
              (= temp___1189 (last s))
              (and
                (= lastqtresultqtunused4 temp___1189)
                (and
                  (= jqtunused3 (int__refqtmk j4))
                  (and
                    (= j4 temp___1188)
                    (and
                      (= int__contentqtresultqtunused28 j4)
                      (and
                        (= o122 (ite (<= j4 temp___1189) true false))
                        (and
                          (= infix_lseqqtresultqtunused8 o122)
                          (and
                            (= int__contentqtresultqtunused29 j4)
                            (and
                              (= o123 (ite (<= temp___1188 j4) true false))
                              (and
                                (= infix_lseqqtresultqtunused9 o123)
                                (and
                                  (= o124 (and o123 o122))
                                  (and
                                    (= andbqtresultqtunused5 o124)
                                    (ite (= o124 true)
                                      (and
          ...
          (and
            ...
            (and
              ...
              (and
                (= o118 (last s))
                (and
                  (= lastqtresultqtunused3 o118)
                  (and
                    (= o119 (ite (<= usf o118) true false))
                    (and
                      (= infix_lseqqtresultqtunused6 o119)
                      (and
                        (= o120 (first s))
                        (and
                          (= firstqtresultqtunused3 o120)
                          (and
                            (= o121 (ite (<= o120 usf) true false))
                            (and
                              (= infix_lseqqtresultqtunused7 o121)
                              (= andbqtresultqtunused4 (and o121 o119))))))))))))
          (and
                ...
                (forall ((k Int))
                  (=>
                    ...
                    (=>
                      ...
                      (< i2 k))))
                (and
                  (and (<= 0 w2) (<= w2 2147483647))
                  (and
                    (= int__contentqtresultqtunused27 w2)
                    (and
                      (= infix_eqqtresultqtunused5 (ite (= w2 2147483647)
                                                     true
                                                     false))
                      (= w2 2147483647))))))))))
    (and (and (= spark__branch4 spark__branch3) (= w2 w3)) (= j2 j1))))
