...
;; "Assert"
(assert (and (<= (first1 temp___1205) j4) (<= j4 (last1 temp___1205))))
...
;; "o"
(define-fun o206 () (Array Int us_rep)
...
;; "o"
(define-fun o208 () us_split_fields
  (us_split_fields1 o207))
...
;; "o"
(define-fun o209 () natural
  (rec__cartesian_trees__tree_cell__right o208))
