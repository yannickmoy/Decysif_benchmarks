...
;; "o"
(define-fun o163 () Bool
  (ite (<= usf j2) true false))
...
;; "H"
(assert (= int__contentqtresultqtunused42 w2))

;; "Assert"
(assert (and (<= (first s) usf) (<= usf (last s))))

(declare-const o167 (Array Int natural))

;; "H"
(assert (= o167 (to_array s)))

(declare-const to_arrayqtresultqtunused33 (Array Int natural))

;; "H"
(assert (= to_arrayqtresultqtunused33 o167))

(declare-const o168 natural)

;; "H"
(assert (= o168 (select o167 usf)))

(declare-const getqtresultqtunused25 natural)

;; "H"
(assert (= getqtresultqtunused25 o168))
...
;; "H"
(assert (= to_repqtresultqtunused21 o169))

(declare-const infix_eqqtresultqtunused7 Bool)

;; "H"
(assert (= infix_eqqtresultqtunused7 (ite (= o169 w2) true false)))
...
(declare-const o170 (Array Int us_rep))
          ...
          (and
            ...
            (and
              ...
              (and
                ...
                (and
                  (= int__contentqtresultqtunused43 i2)
                  (and
                    (= o170 (to_array1 temp___1261))
                    (and
                      (= to_arrayqtresultqtunused34 o170)
                      (and
                        (= o171 (select o170 i2))
                        (and
                          (= getqtresultqtunused26 o171)
                          (and
                            (= o172 (us_split_fields1 o171))
                            (and
                              (= us_split_fieldsqtresultqtunused39 o172)
                              (and
                                (= o173 (rec__cartesian_trees__tree_cell__right
                                          o172))
                                (and
                                  ...
                                  (and
                                    (= (to_rep o173) o174)
                                    (and
                                      (= to_repqtresultqtunused22 o174)
                                      (and
                                        (= infix_eqqtresultqtunused8 
                                        (ite (= o174 0)
                                          true
                                          false))
                                        (= o166 (ite (= o174 0) false true))))))))))))))))))))
    (= o166 false)))
...
;; "o"
(define-fun o175 () (Array Int us_rep)
...
;; "o"
(define-fun o178 () natural
  (rec__cartesian_trees__tree_cell__right o177))
