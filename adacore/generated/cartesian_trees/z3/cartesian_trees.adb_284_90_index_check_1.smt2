...
;; "min"
(declare-fun min (us_t) Int)

;; "min__function_guard"
(declare-fun min__function_guard (Int
  us_t) Bool)
  ...
  (forall ((param__s us_t))
    (! (=>
         (and
           (dynamic_invariant param__s true false true true)
           (< 0 (length param__s)))
         (let ((result (min param__s)))
           (=>
             (min__function_guard result param__s)
             (and
               (and
                 (and
                 ...
                 (forall ((temp___324 Int))
                   (=>
                     (and
                       (<= (first param__s) temp___324)
                       (<= temp___324 (last param__s)))
                     (<= (to_rep (select (to_array param__s) result)) 
                     (to_rep
                       (select (to_array param__s) temp___324))))))
               (in_range2 result))))) :pattern ((min param__s)) )))
...
;; "H"
(assert (min__function_guard (min s) s))
       ...
       (rec__cartesian_trees__tree_cell__parent
         (us_split_fields1
           (select (to_array1
                     (rec__cartesian_trees__tree__cells1 t__split_fields1)) 
           (to_rep
             (rec__cartesian_trees__tree__root1 t__split_fields1)))))) 0))
...
(assert
  (forall ((x Int))
    (=>
      (and
        (<= 1 x)
        (<= x (last1 (rec__cartesian_trees__tree__cells1 t__split_fields1))))
      (=>
        (= (to_rep
             (rec__cartesian_trees__tree_cell__parent
               (us_split_fields1
...
;; "o"
(define-fun o111 () natural
  (rec__cartesian_trees__tree__root1 t__split_fields1))

;; "rec__cartesian_trees__tree__root'result'unused"
(define-fun rec__cartesian_trees__tree__rootqtresultqtunused4 () natural
  o111)

(declare-const o112 Int)

;; "Ensures"
(assert (= (to_rep o111) o112))
...
;; "Assert"
(assert (and (<= (first1 temp___1021) usf) (<= usf (last1 temp___1021))))

;; "o"
(define-fun o113 () (Array Int us_rep)
  (to_array1 temp___1021))
...
;; "o"
(define-fun o115 () us_split_fields
  (us_split_fields1 o114))
...
;; "o"
(define-fun o116 () natural
  (rec__cartesian_trees__tree_cell__parent o115))
...
(define-fun o119 () Bool
  (and o118 (ite (= usf o112) false true)))
...
;; "o"
(define-fun o120 () natural
  (rec__cartesian_trees__tree__root1 t__split_fields1))

;; "rec__cartesian_trees__tree__root'result'unused"
(define-fun rec__cartesian_trees__tree__rootqtresultqtunused5 () natural
  o120)

(declare-const temp___1020 Int)

;; "Ensures"
(assert (= (to_rep o120) temp___1020))
