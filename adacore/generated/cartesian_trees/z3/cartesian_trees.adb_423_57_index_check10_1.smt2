...
;; "o"
(define-fun o183 () (Array Int us_rep)
...
;; "o"
(define-fun o185 () us_split_fields
  (us_split_fields1 o184))
...
;; "o"
(define-fun o186 () natural
  (rec__cartesian_trees__tree_cell__right o185))
...
;; "o"
(define-fun o188 () (Array Int us_rep)
...
;; "o"
(define-fun o189 () us_rep
  (select o188 i4))

;; "get'result'unused"
(define-fun getqtresultqtunused27 () us_rep
  o189)

;; "o"
(define-fun o190 () us_split_fields
  (us_split_fields1 o189))

;; "__split_fields'result'unused"
(define-fun us_split_fieldsqtresultqtunused43 () us_split_fields
  o190)

;; "o"
(define-fun o191 () natural
  (rec__cartesian_trees__tree_cell__right o190))
...
;; "to_array'result'unused"
(define-fun to_arrayqtresultqtunused36 () (Array Int us_rep)
  temp___12571)
...
;; "o"
(define-fun o197 () (Array Int natural)
  (to_array s))

;; "to_array'result'unused"
(define-fun to_arrayqtresultqtunused37 () (Array Int natural)
  o197)

;; "o"
(define-fun o198 () natural
  (select o197 j5))

;; "get'result'unused"
(define-fun getqtresultqtunused28 () natural
  o198)
...
;; "o"
(define-fun o200 () Bool
  (ite (= o199 w4) true false))
...
(define-fun o202 () Bool
  (and o201 (ite (= j5 o187) false true)))
...
;; "Assert"
(assert (and (<= (first1 temp___11921) i4) (<= i4 (last1 temp___11921))))
...
;; "o"
(define-fun o203 () (Array Int us_rep)
...
;; "o"
(define-fun o204 () us_rep
  (select o203 i4))

;; "get'result'unused"
(define-fun getqtresultqtunused29 () us_rep
  o204)

;; "o"
(define-fun o205 () us_split_fields
  (us_split_fields1 o204))

;; "__split_fields'result'unused"
(define-fun us_split_fieldsqtresultqtunused46 () us_split_fields
  o205)

;; "o"
(define-fun o206 () natural
  (rec__cartesian_trees__tree_cell__right o205))

;; "rec__cartesian_trees__tree_cell__right'result'unused"
(define-fun rec__cartesian_trees__tree_cell__rightqtresultqtunused11 
  () natural
  o206)
...
;; "rec__cartesian_trees__tree__cells'result'unused"
(define-fun rec__cartesian_trees__tree__cellsqtresultqtunused24 () us_t1
  temp___11901)
...
;; "to_array'result'unused"
(define-fun to_arrayqtresultqtunused39 () (Array Int us_rep)
  temp___11911)
  ...
  (or
    ...
    (and
      (not
        (= (to_rep
             (rec__cartesian_trees__tree_cell__parent
               (us_split_fields1 (select (to_array1 o210) j5)))) 0))
      (= (belongs_to
           o210
           o207
           (to_rep
             (rec__cartesian_trees__tree_cell__parent
               (us_split_fields1 (select (to_array1 o210) j5))))) true))))
...
;; "o"
(define-fun o211 () (Array Int natural)
  (to_array s))

;; "to_array'result'unused"
(define-fun to_arrayqtresultqtunused40 () (Array Int natural)
  o211)

;; "o"
(define-fun o212 () natural
  (select o211 j5))

;; "get'result'unused"
(define-fun getqtresultqtunused30 () natural
  o212)

(declare-const o213 Int)

;; "Ensures"
(assert (= (to_rep o212) o213))
...
;; "Assert"
(assert (and (<= (first1 temp___1199) j5) (<= j5 (last1 temp___1199))))
...
;; "o"
(define-fun o214 () (Array Int us_rep)
...
;; "o"
(define-fun o216 () us_split_fields
  (us_split_fields1 o215))
...
;; "o"
(define-fun o217 () natural
  (rec__cartesian_trees__tree_cell__parent o216))

;; "rec__cartesian_trees__tree_cell__parent'result'unused"
(define-fun rec__cartesian_trees__tree_cell__parentqtresultqtunused3 
  () natural
  o217)
...
;; "Ensures"
(assert (= (to_rep o217) temp___1200))
