...
(assert
  (or
    (= (to_rep (select (to_array right) i1)) 0)
    (and
      (< 0 (to_rep (select (to_array left) i1)))
      (< (to_rep (select (to_array s) (to_rep (select (to_array right) i1)))) 
      (to_rep
        (select (to_array s) (to_rep (select (to_array left) i1))))))))
