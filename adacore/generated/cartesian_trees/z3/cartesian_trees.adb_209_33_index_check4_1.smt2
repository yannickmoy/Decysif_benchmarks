...
;; "temp___982"
(define-fun temp___982 () us_t1
  (rec__cartesian_trees__tree__cells1 t__split_fields2))

;; "rec__cartesian_trees__tree__cells'result'unused"
(define-fun rec__cartesian_trees__tree__cellsqtresultqtunused11 () us_t1
  temp___982)

;; "temp___983"
(define-fun temp___983 () (Array Int us_rep)
  (to_array1 temp___982))

;; "to_array'result'unused"
(define-fun to_arrayqtresultqtunused24 () (Array Int us_rep)
  temp___983)
...
;; "temp___inv_981"
(define-fun temp___inv_981 () Bool
  (is_heap o114 o111))
...
(assert
  (=
    ...
    (forall ((x Int))
      (=>
        (and (<= (first1 o114) x) (<= x (last1 o114)))
        (=>
          (not
            (= (to_rep
                 (rec__cartesian_trees__tree_cell__parent
                   (us_split_fields1 (select (to_array1 o114) x)))) 0))
          (< (to_rep
               (select (to_array o111) (to_rep
                                         (rec__cartesian_trees__tree_cell__parent
                                           (us_split_fields1
                                             (select (to_array1 o114) x)))))) 
          (to_rep
            (select (to_array o111) x))))))))

;; "is_heap'result'unused"
(define-fun is_heapqtresultqtunused () Bool
  temp___inv_981)

(declare-const us_split_fields__contentqtresultqtunused17 us_split_fields4)

;; "H"
(assert (= us_split_fields__contentqtresultqtunused17 t__split_fields2))
...
;; "H"
(assert (= us_split_fieldsqtresultqtunused25 t__split_fields2))

(declare-const o115 natural)

;; "H"
(assert (= o115 (rec__cartesian_trees__tree__root1 t__split_fields2)))

(declare-const rec__cartesian_trees__tree__rootqtresultqtunused4 natural)

;; "H"
(assert (= rec__cartesian_trees__tree__rootqtresultqtunused4 o115))
...
;; "H"
(assert (= to_repqtresultqtunused14 o116))

(declare-const infix_eqqtresultqtunused4 Bool)

;; "H"
(assert (= infix_eqqtresultqtunused4 (ite (= o116 0) true false)))
...
(declare-const o117 natural)

(declare-const rec__cartesian_trees__tree__rootqtresultqtunused5 natural)
...
(declare-const temp___976 us_t1)
...
(declare-const rec__cartesian_trees__tree__rootqtresultqtunused6 natural)
...
(declare-const rec__cartesian_trees__tree__rootqtresultqtunused7 natural)

(declare-const temp___975 Int)

(declare-const to_repqtresultqtunused18 Int)

(declare-const o130 (Array Int natural))

(declare-const to_arrayqtresultqtunused26 (Array Int natural))

(declare-const o131 natural)

(declare-const getqtresultqtunused19 natural)
...
(declare-const rec__cartesian_trees__tree__rootqtresultqtunused8 natural)
...
(declare-const getqtresultqtunused20 natural)
        ...
        (and
          ...
          (and
            ...
            (and
              (= o140 (- i2 1))
              (and
                (= infix_mnqtresultqtunused1 o140)
                (and
                  (in_range o140)
                  (and
                    (= range_check_qtresultqtunused6 o140)
                    (and
                      (= o141 (ite (<= usf o140) true false))
                      (and
                        (= infix_lseqqtresultqtunused4 o141)
                        (and
                          (= o142 (ite (<= 1 usf) true false))
                          (and
                            (= infix_lseqqtresultqtunused5 o142)
                            (= andbqtresultqtunused5 (and o142 o141)))))))))))))
      (and
        ...
        (= anyqtresultqtunused (ite (forall ((k Int))
                                      (=>
                                        ...
                                        (or
                                          (not
                                            (= (to_rep
                                                 (select (to_array right) k)) 0))
                                          (not
                                            (= (to_rep
                                                 (select (to_array left) k)) 0)))))
                                 true
                                 false))))
    (and
      (= us_split_fields__contentqtresultqtunused18 t__split_fields2)
      (and
        (= us_repqtmkqtresultqtunused27 (us_repqtmk2
                                          t__split_discrs
                                          t__split_fields2))
        (and
          (= us_split_fieldsqtresultqtunused26 t__split_fields2)
          (and
            (= o117 (rec__cartesian_trees__tree__root1 t__split_fields2))
            (and
              (= rec__cartesian_trees__tree__rootqtresultqtunused5 o117)
              (and
                (= (to_rep o117) temp___973)
                (and
                  (= to_repqtresultqtunused15 temp___973)
                  (and
                    (= int__contentqtresultqtunused23 i2)
                    (and
                      (= o118 (- i2 1))
                      (and
                        (= infix_mnqtresultqtunused o118)
                        (and
                          (in_range o118)
                          (and
                            (= range_check_qtresultqtunused5 o118)
                            (and
                              (= o119 (ite (<= temp___973 o118) true false))
                              (and
                                (= infix_lseqqtresultqtunused2 o119)
                                (and
                                  (= o120 (ite (<= 1 temp___973) true false))
                                  (and
                                    (= infix_lseqqtresultqtunused3 o120)
                                    (and
                                      (= o121 (and o120 o119))
                                      (and
                                        (= andbqtresultqtunused2 o121)
                                        (=>
                                          (= o121 true)
                                          (and
                                            ...
                                            (and
                                              ...
                                              (and
                                                ...
                                                t__split_fields2)
                                                (and
                                                  (= temp___976 (rec__cartesian_trees__tree__cells1
                                                                  t__split_fields2))
                                                  (and
                                                    ...
                                                    (and
                                                      ...
                                                      (and
                                                        ...
                                                        (and
                                                          ...
                                                          t__split_fields2)
                                                          (and
                                                            (= o122 (rec__cartesian_trees__tree__root1
                                                                    t__split_fields2))
                                                            (and
                                                              (= rec__cartesian_trees__tree__rootqtresultqtunused6 
                                                              o122)
                                                              (and
                                                                (= (to_rep
                                                                    o122) 
                                                                ...
                                                                (and
                                                                  ...
                                                                  (and
                                                                    ...
                                                                    (and
                                                                    (= 
                                                                    rec__cartesian_trees__tree__rootqtresultqtunused7 
                                                                    o129)
                                                                    (and
                                                                    (= 
                                                                    (to_rep
                                                                    ...
                                                                    (and
                                                                    (= 
                                                                    rec__cartesian_trees__tree__rootqtresultqtunused8 
                                                                    o134)
                                                                    (and
                                                                    (= 
                                                                    (to_rep
...
;; "H"
(assert (= lastqtresultqtunused4 o143))

(declare-const o144 Bool)

;; "H"
(assert (= o144 (ite (<= usf1 o143) true false)))

(declare-const infix_lseqqtresultqtunused6 Bool)

;; "H"
(assert (= infix_lseqqtresultqtunused6 o144))
...
;; "H"
(assert (= o145 (ite (<= i2 usf1) true false)))

(declare-const infix_lseqqtresultqtunused7 Bool)

;; "H"
(assert (= infix_lseqqtresultqtunused7 o145))

(declare-const andbqtresultqtunused6 Bool)

;; "H"
(assert (= andbqtresultqtunused6 (and o145 o144)))
...
;; "o"
(define-fun o147 () Bool
  (ite (<= usf2 o146) true false))
...
;; "Assert"
(assert (and (<= (first left) usf2) (<= usf2 (last left))))

;; "o"
(define-fun o150 () (Array Int natural)
  (to_array left))

;; "to_array'result'unused"
(define-fun to_arrayqtresultqtunused28 () (Array Int natural)
  o150)

;; "o"
(define-fun o151 () natural
  (select o150 usf2))

;; "get'result'unused"
(define-fun getqtresultqtunused21 () natural
  o151)

(declare-const o152 Int)

;; "Ensures"
(assert (= (to_rep o151) o152))
...
;; "Assert"
(assert (and (<= (first right) usf2) (<= usf2 (last right))))

;; "o"
(define-fun o154 () (Array Int natural)
  (to_array right))

;; "to_array'result'unused"
(define-fun to_arrayqtresultqtunused29 () (Array Int natural)
  o154)

;; "o"
(define-fun o155 () natural
  (select o154 usf2))

;; "get'result'unused"
(define-fun getqtresultqtunused22 () natural
  o155)
...
;; "o"
(define-fun o157 () Bool
  (ite (= o156 0) true false))
...
(declare-const o160 (Array Int natural))

;; "H"
(assert (= o160 (to_array left)))

(declare-const to_arrayqtresultqtunused30 (Array Int natural))

;; "H"
(assert (= to_arrayqtresultqtunused30 o160))

(declare-const o161 natural)

;; "H"
(assert (= o161 (select o160 usf2)))

(declare-const getqtresultqtunused23 natural)

;; "H"
(assert (= getqtresultqtunused23 o161))

(declare-const o162 Int)

;; "Ensures"
(assert (= (to_rep o161) o162))

(declare-const to_repqtresultqtunused24 Int)

;; "H"
(assert (= to_repqtresultqtunused24 o162))

(declare-const infix_eqqtresultqtunused10 Bool)

;; "H"
(assert (= infix_eqqtresultqtunused10 (ite (= o162 0) true false)))

(declare-const o163 (Array Int natural))

(declare-const to_arrayqtresultqtunused31 (Array Int natural))

(declare-const o164 natural)

(declare-const getqtresultqtunused24 natural)
...
(declare-const o166 (Array Int natural))

(declare-const to_arrayqtresultqtunused32 (Array Int natural))
...
(declare-const to_arrayqtresultqtunused34 (Array Int natural))
...
(declare-const o173 (Array Int natural))

(declare-const to_arrayqtresultqtunused35 (Array Int natural))
...
(assert
  (ite (= o162 0)
    (= o159 true)
    (and
      (and (<= (first right) usf2) (<= usf2 (last right)))
      (and
        (= o163 (to_array right))
        (and
          (= to_arrayqtresultqtunused31 o163)
          (and
            (= o164 (select o163 usf2))
            (and
              (= getqtresultqtunused24 o164)
              (and
                (= (to_rep o164) o165)
                (and
                  (= to_repqtresultqtunused25 o165)
                  (and
                    (= infix_gtqtresultqtunused2 (ite (< 0 o165) true false))
                    (ite (< 0 o165)
                      (and
                        (and (<= (first left) usf2) (<= usf2 (last left)))
                        (and
                          (= o166 (to_array left))
                          (and
                            (= to_arrayqtresultqtunused32 o166)
                            (and
                              (= o167 (select o166 usf2))
                              (and
                                (= getqtresultqtunused25 o167)
                                (and
                                  (= (to_rep o167) temp___956)
                                  (and
                                    (= to_repqtresultqtunused26 temp___956)
                                    (and
                                      (and
                                        (<= (first s) temp___956)
                                        (<= temp___956 (last s)))
...
;; "temp___953"
(define-fun temp___953 () us_t1
  (rec__cartesian_trees__tree__cells1 t__split_fields2))

;; "rec__cartesian_trees__tree__cells'result'unused"
(define-fun rec__cartesian_trees__tree__cellsqtresultqtunused13 () us_t1
  temp___953)
...
;; "o"
(define-fun o176 () (Array Int natural)
  (to_array left))
...
(assert
  (and
    (<= (first1 temp___953) temp___954)
    (<= temp___954 (last1 temp___953))))

;; "o"
(define-fun o178 () (Array Int us_rep)
  (to_array1 temp___953))
...
;; "__split_fields'result'unused"
(define-fun us_split_fieldsqtresultqtunused33 () us_split_fields
  o180)
...
;; "o"
(define-fun o184 () (Array Int natural)
  (to_array left))

;; "to_array'result'unused"
(define-fun to_arrayqtresultqtunused38 () (Array Int natural)
  o184)

;; "o"
(define-fun o185 () natural
  (select o184 usf2))

;; "get'result'unused"
(define-fun getqtresultqtunused31 () natural
  o185)

(declare-const o186 Int)

;; "Ensures"
(assert (= (to_rep o185) o186))
...
;; "temp___952"
(define-fun temp___952 () us_t1
  (rec__cartesian_trees__tree__cells1 t__split_fields2))

;; "rec__cartesian_trees__tree__cells'result'unused"
(define-fun rec__cartesian_trees__tree__cellsqtresultqtunused14 () us_t1
  temp___952)

;; Goal "def'vc"
;; File "cartesian_trees.ads", line 113, characters 0-0
(assert
  (not (<= usf2 (last1 temp___952))))
