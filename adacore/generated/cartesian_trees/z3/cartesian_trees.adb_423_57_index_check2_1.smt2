...
;; "o"
(define-fun o121 () (Array Int us_rep)
  (to_array1 temp___1259))
...
(define-fun o124 () natural
  (rec__cartesian_trees__tree_cell__right o123))

;; "rec__cartesian_trees__tree_cell__right'result'unused"
(define-fun rec__cartesian_trees__tree_cell__rightqtresultqtunused4 () natural
  o124)
...
;; "temp___1258"
(define-fun temp___1258 () us_t1
  (rec__cartesian_trees__tree__cells1 t__split_fields1))

;; "rec__cartesian_trees__tree__cells'result'unused"
(define-fun rec__cartesian_trees__tree__cellsqtresultqtunused12 () us_t1
  temp___1258)
...
;; "o"
(define-fun o126 () (Array Int us_rep)
  (to_array1 temp___1258))

;; "to_array'result'unused"
(define-fun to_arrayqtresultqtunused25 () (Array Int us_rep)
  o126)
...
;; "get'result'unused"
(define-fun getqtresultqtunused20 () us_rep
  o127)

;; "o"
(define-fun o128 () us_split_fields
  (us_split_fields1 o127))
...
;; "o"
(define-fun o129 () natural
  (rec__cartesian_trees__tree_cell__right o128))

;; "rec__cartesian_trees__tree_cell__right'result'unused"
(define-fun rec__cartesian_trees__tree_cell__rightqtresultqtunused5 () natural
  o129)
...
;; "temp___1257"
(define-fun temp___1257 () (Array Int us_rep)
  (to_array1 temp___1256))

;; "to_array'result'unused"
(define-fun to_arrayqtresultqtunused26 () (Array Int us_rep)
  temp___1257)
...
(define-fun belongs_toqtresultqtunused () Bool
  o134)
...
;; "o"
(define-fun o135 () (Array Int natural)
  (to_array s))

;; "to_array'result'unused"
(define-fun to_arrayqtresultqtunused27 () (Array Int natural)
  o135)

;; "o"
(define-fun o136 () natural
  (select o135 j2))
...
(define-fun o140 () Bool
  (and o139 (ite (= j2 o125) false true)))
...
;; "Assert"
(assert (and (<= (first1 temp___1192) i2) (<= i2 (last1 temp___1192))))
...
;; "o"
(define-fun o141 () (Array Int us_rep)
  (to_array1 temp___1192))

;; "to_array'result'unused"
(define-fun to_arrayqtresultqtunused28 () (Array Int us_rep)
  o141)

;; "o"
(define-fun o142 () us_rep
  (select o141 i2))

;; "get'result'unused"
(define-fun getqtresultqtunused22 () us_rep
  o142)

;; "o"
(define-fun o143 () us_split_fields
  (us_split_fields1 o142))
...
;; "o"
(define-fun o144 () natural
  (rec__cartesian_trees__tree_cell__right o143))

;; "rec__cartesian_trees__tree_cell__right'result'unused"
(define-fun rec__cartesian_trees__tree_cell__rightqtresultqtunused6 () natural
  o144)

(declare-const o145 Int)

;; "Ensures"
(assert (= (to_rep o144) o145))
...
;; "temp___1190"
(define-fun temp___1190 () us_t1
  (rec__cartesian_trees__tree__cells1 t__split_fields1))

;; "rec__cartesian_trees__tree__cells'result'unused"
(define-fun rec__cartesian_trees__tree__cellsqtresultqtunused15 () us_t1
  temp___1190)

;; "temp___1191"
(define-fun temp___1191 () (Array Int us_rep)
  (to_array1 temp___1190))

;; "to_array'result'unused"
(define-fun to_arrayqtresultqtunused29 () (Array Int us_rep)
  temp___1191)
  ...
  (or
    ...
    (and
      (not
        (= (to_rep
             (rec__cartesian_trees__tree_cell__parent
               (us_split_fields1 (select (to_array1 o148) j2)))) 0))
      (= (belongs_to
           o148
           o145
           (to_rep
             (rec__cartesian_trees__tree_cell__parent
               (us_split_fields1 (select (to_array1 o148) j2))))) true))))
...
;; "o"
(define-fun o149 () (Array Int natural)
  (to_array s))
...
;; "rec__cartesian_trees__tree__cells'result'unused"
(define-fun rec__cartesian_trees__tree__cellsqtresultqtunused16 () us_t1
  temp___1199)

;; "Assert"
(assert (and (<= (first1 temp___1199) j2) (<= j2 (last1 temp___1199))))
...
;; "o"
(define-fun o152 () (Array Int us_rep)
  (to_array1 temp___1199))

;; "to_array'result'unused"
(define-fun to_arrayqtresultqtunused31 () (Array Int us_rep)
  o152)

;; "o"
(define-fun o153 () us_rep
  (select o152 j2))
...
;; "o"
(define-fun o154 () us_split_fields
  (us_split_fields1 o153))

;; "__split_fields'result'unused"
(define-fun us_split_fieldsqtresultqtunused34 () us_split_fields
  o154)

;; "o"
(define-fun o155 () natural
  (rec__cartesian_trees__tree_cell__parent o154))

;; "rec__cartesian_trees__tree_cell__parent'result'unused"
(define-fun rec__cartesian_trees__tree_cell__parentqtresultqtunused2 
  () natural
  o155)
...
;; "Ensures"
(assert (= (to_rep o155) temp___1200))
