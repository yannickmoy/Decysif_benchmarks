...
;; "H"
(assert (= temp___1026 (first s)))

(declare-const firstqtresultqtunused2 Int)

;; "H"
(assert (= firstqtresultqtunused2 temp___1026))

(declare-const temp___1027 Int)

;; "H"
(assert (= temp___1027 (last s)))

(declare-const lastqtresultqtunused2 Int)

;; "H"
(assert (= lastqtresultqtunused2 temp___1027))
...
;; "H"
(assert (= o107 (ite (<= i2 temp___1027) true false)))
...
;; "H"
(assert (= o108 (ite (<= temp___1026 i2) true false)))
            ...
            (and
              ...
              (and
                ...
                (and
                  ...
                  (and
                    (= temp___1149 (rec__cartesian_trees__tree__cells1
                                     t__split_fields1))
                    (and
                      ...
                      (and
                        (and
                          (<= (first1 temp___1149) i2)
                          (<= i2 (last1 temp___1149)))
                        (and
                          (= int__contentqtresultqtunused26 i2)
                          (and
                            (= o112 (to_array1 temp___1149))
                            (and
                                ...
                                (and
                                  ...
                                  (and
                                    ...
                                    (and
                                      ...
                                      o114)
                                      (and
                                        (= o115 (rec__cartesian_trees__tree_cell__left
                                                  o114))
                                        (and
                                          (= rec__cartesian_trees__tree_cell__leftqtresultqtunused3 
                                          o115)
                                          (and
                                            (= (to_rep o115) o116)
                                            (and
...
;; "temp___1162"
(define-fun temp___1162 () (Array Int us_rep)
  (to_array1 temp___1161))
