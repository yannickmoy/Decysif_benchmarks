...
(assert
  (and
    (<= (first1 temp___950) temp___951)
    (<= temp___951 (last1 temp___950))))

;; "o"
(define-fun o178 () (Array Int us_rep)
  (to_array1 temp___950))
...
(define-fun o181 () natural
  (rec__cartesian_trees__tree_cell__left o180))

;; "rec__cartesian_trees__tree_cell__left'result'unused"
(define-fun rec__cartesian_trees__tree_cell__leftqtresultqtunused3 () natural
  o181)
