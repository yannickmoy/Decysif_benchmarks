...
;; "Assert"
(assert (and (<= (first1 temp___12551) j4) (<= j4 (last1 temp___12551))))
...
;; "o"
(define-fun o201 () (Array Int us_rep)
  (to_array1 temp___12551))
...
;; "o"
(define-fun o203 () us_split_fields
  (us_split_fields1 o202))

;; "__split_fields'result'unused"
(define-fun us_split_fieldsqtresultqtunused47 () us_split_fields
  o203)

;; "o"
(define-fun o204 () natural
  (rec__cartesian_trees__tree_cell__parent o203))
  ...
  (= (to_rep
       (rec__cartesian_trees__tree_cell__parent
         (us_split_fields1
           (select (to_array1
                     (rec__cartesian_trees__tree__cells1 t__split_fields1)) 
           j4)))) (to_rep (select (to_array right) j4))))
...
;; "Assert"
(assert (and (<= (first1 temp___12511) i2) (<= i2 (last1 temp___12511))))
...
;; "o"
(define-fun o207 () (Array Int us_rep)
  (to_array1 temp___12511))

;; "to_array'result'unused"
(define-fun to_arrayqtresultqtunused40 () (Array Int us_rep)
  o207)

;; "o"
(define-fun o208 () us_rep
  (select o207 i2))

;; "get'result'unused"
(define-fun getqtresultqtunused30 () us_rep
  o208)

;; "o"
(define-fun o209 () us_split_fields
  (us_split_fields1 o208))
...
;; "o"
(define-fun o210 () natural
  (rec__cartesian_trees__tree_cell__right o209))
...
;; "temp___1250"
(define-fun temp___12501 () (Array Int us_rep)
  (to_array1 temp___12491))
