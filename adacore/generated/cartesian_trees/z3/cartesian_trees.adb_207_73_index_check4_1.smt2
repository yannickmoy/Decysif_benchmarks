...
;; "o"
(define-fun o159 () (Array Int natural)
  (to_array left))

;; "to_array'result'unused"
(define-fun to_arrayqtresultqtunused30 () (Array Int natural)
  o159)

;; "o"
(define-fun o160 () natural
  (select o159 usf2))

;; "get'result'unused"
(define-fun getqtresultqtunused23 () natural
  o160)
...
;; "o"
(define-fun o162 () (Array Int natural)
  (to_array right))

;; "to_array'result'unused"
(define-fun to_arrayqtresultqtunused31 () (Array Int natural)
  o162)

;; "o"
(define-fun o163 () natural
  (select o162 usf2))

;; "get'result'unused"
(define-fun getqtresultqtunused24 () natural
  o163)

(declare-const o164 Int)

;; "Ensures"
(assert (= (to_rep o163) o164))
...
;; "o"
(define-fun o165 () (Array Int natural)
  (to_array left))

;; "to_array'result'unused"
(define-fun to_arrayqtresultqtunused32 () (Array Int natural)
  o165)

;; "o"
(define-fun o166 () natural
  (select o165 usf2))

;; "get'result'unused"
(define-fun getqtresultqtunused25 () natural
  o166)

(declare-const temp___956 Int)

;; "Ensures"
(assert (= (to_rep o166) temp___956))
...
;; "Assert"
(assert (and (<= (first s) temp___956) (<= temp___956 (last s))))

;; "o"
(define-fun o167 () (Array Int natural)
  (to_array s))

;; "to_array'result'unused"
(define-fun to_arrayqtresultqtunused33 () (Array Int natural)
  o167)

;; "o"
(define-fun o168 () natural
  (select o167 temp___956))

;; "get'result'unused"
(define-fun getqtresultqtunused26 () natural
  o168)
...
;; "o"
(define-fun o170 () (Array Int natural)
  (to_array right))

;; "to_array'result'unused"
(define-fun to_arrayqtresultqtunused34 () (Array Int natural)
  o170)

;; "o"
(define-fun o171 () natural
  (select o170 usf2))
