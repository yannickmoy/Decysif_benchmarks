...
;; "o"
(define-fun o34 () Bool
  (has_sub_range_in_prefix o33 i2 o32))
...
(assert
  (=
    ...
    (exists ((j Int))
      (and
        (and (<= (first o33) j) (<= j i2))
        (= (equal_subrange o33 j o32) true)))))

;; "has_sub_range_in_prefix'result'unused"
(define-fun has_sub_range_in_prefixqtresultqtunused1 () Bool
  o34)

;; "loop_var_new___15010'unused"
(define-fun loop_var_new___15010qtunused () Int
  i2)
...
(assert
  (not (not (= (has_sub_range_in_prefix a i2 b) true))))
