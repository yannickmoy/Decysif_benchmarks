      ...
      (forall ((v Int))
        (=>
          (and
            (<= (max
                  0
                  (+ (- value (abs (- value test_prime_and_coprime_numbers__p__nearest_prime_number__result))) 1)) v)
            (<= v value))
          (not (= (is_prime v) true))))
      (forall ((v Int))
        (=>
...
(assert
  (not
  (= (is_prime
       test_prime_and_coprime_numbers__p__nearest_prime_number__result) true)))
