...
;; "H"
(assert (= o28 (mod1 v2 c169b)))

(declare-const mod_qtresultqtunused2 Int)

;; "H"
(assert (= mod_qtresultqtunused2 o28))

(declare-const o29 Bool)

;; "H"
(assert (= o29 (ite (= o28 0) true false)))

(declare-const infix_eqqtresultqtunused2 Bool)

;; "H"
(assert (= infix_eqqtresultqtunused2 o29))
...
(declare-const sqtunused2 int__ref)
...
(declare-const rqtunused2 int__ref)
...
(declare-const dd2 Int)

(declare-const ddqtunused2 int__ref)
...
(declare-const ds2 Int)

(declare-const dsqtunused2 int__ref)
...
(assert
  (=>
    ...
    (and
      (= o30 c169b)
      (and
        (= o31 (smallest_divisor o30))
        (and
          (and
            (smallest_divisor__function_guard o31 o30)
            (and
              (in_range1 o31)
              (and
                (and (<= 2 o31) (<= o31 (- o30 1)))
                (= o30 (* o31 (__cdiv o30 o31))))))
          (and
            (= smallest_divisorqtresultqtunused1 o31)
            (and
              (= sqtunused2 (int__refqtmk s2))
              (and
                (= s2 o31)
                (and
                  (in_range1 s2)
                  (and
                    (= int__contentqtresultqtunused20 s2)
                    (and
                      (= int__contentqtresultqtunused21 v2)
                      (and
                        (= o32 (__cdiv v2 s2))
                        (and
                          (= div_qtresultqtunused3 o32)
                          (and
                            (in_range1 o32)
                            (and
                              (= range_check_qtresultqtunused6 o32)
                              (and
...
;; "Assert"
(assert (=> (= (mod1 v2 c169b) 0) (= (mod1 v2 (smallest_divisor c169b)) 0)))
...
;; "H"
(assert (= wqtunused1 usf2))

(declare-const int__contentqtresultqtunused26 Int)

;; "H"
(assert (= int__contentqtresultqtunused26 v2))

(declare-const o36 Bool)

;; "H"
(assert (= o36 (ite (<= usf2 v2) true false)))

(declare-const infix_lseqqtresultqtunused8 Bool)

;; "H"
(assert (= infix_lseqqtresultqtunused8 o36))
...
;; "H"
(assert (= range_check_qtresultqtunused10 o37))

(declare-const o38 Bool)

;; "H"
(assert (= o38 (ite (<= o37 usf2) true false)))

(declare-const infix_lseqqtresultqtunused9 Bool)

;; "H"
(assert (= infix_lseqqtresultqtunused9 o38))

(declare-const andbqtresultqtunused4 Bool)

;; "H"
(assert (= andbqtresultqtunused4 (and o38 o36)))
...
(assert
  (not (= (mod1 w (smallest_divisor c169b)) 0)))
