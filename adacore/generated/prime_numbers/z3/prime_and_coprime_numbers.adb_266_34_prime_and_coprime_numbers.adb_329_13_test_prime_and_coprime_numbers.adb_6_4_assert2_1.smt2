...
;; "o"
(define-fun o44 () Int
  (smallest_divisor o43))

;; "H"
(assert (smallest_divisor__function_guard o44 o43))
...
;; "H"
(assert (= o43 (* o44 (__cdiv o43 o44))))

;; "smallest_divisor'result'unused"
(define-fun smallest_divisorqtresultqtunused2 () Int
  o44)

(declare-const d4 Int)

;; "d'unused"
(define-fun dqtunused4 () int__ref
  (int__refqtmk d4))
...
;; "Assert"
(assert (and (<= 2 d4) (<= d4 (- c169b 1))))

;; "Assert"
(assert (not (= (mod1 v4 d4) 0)))

;; Goal "def'vc"
;; File "prime_and_coprime_numbers.adb", line 201, characters 0-0
(assert
  (not (not (= (mod1 v4 c169b) 0))))
