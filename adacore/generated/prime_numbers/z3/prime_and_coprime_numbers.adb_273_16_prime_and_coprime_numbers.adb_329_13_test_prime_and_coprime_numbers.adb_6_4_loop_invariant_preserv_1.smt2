...
;; "H"
(assert (= anyqtresultqtunused9 usf6))
...
(declare-const smallest_divisorqtresultqtunused2 Int)

(declare-const d4 Int)

(declare-const dqtunused4 int__ref)
...
(assert
  (=>
    ...
    (and
      (= o43 c169b)
      (and
        (= o44 (smallest_divisor o43))
        (and
          (and
            (smallest_divisor__function_guard o44 o43)
            (and
              (in_range1 o44)
              (and
                (and (<= 2 o44) (<= o44 (- o43 1)))
                (= o43 (* o44 (__cdiv o43 o44))))))
          (and
            (= smallest_divisorqtresultqtunused2 o44)
            (and
              (= dqtunused4 (int__refqtmk d4))
              (and
                (= d4 o44)
                (and
                  (in_range1 d4)
...
(assert
  (=>
    (forall ((div1 Int))
      (=> (and (<= 2 div1) (<= div1 (- c169b 1))) (not (= (mod1 v4 div1) 0))))
    (not (= (mod1 v4 c169b) 0))))
...
;; "H"
(assert (= anyqtresultqtunused10 usf7))

(declare-const wqtunused2 Int)

;; "H"
(assert (= wqtunused2 usf7))

(declare-const int__contentqtresultqtunused23 Int)

;; "H"
(assert (= int__contentqtresultqtunused23 v4))

(declare-const o45 Bool)

;; "H"
(assert (= o45 (ite (<= usf7 v4) true false)))

(declare-const infix_lseqqtresultqtunused16 Bool)

;; "H"
(assert (= infix_lseqqtresultqtunused16 o45))
...
;; "H"
(assert (= infix_plqtresultqtunused5 o46))
...
;; "H"
(assert (= range_check_qtresultqtunused8 o46))

(declare-const o47 Bool)

;; "H"
(assert (= o47 (ite (<= o46 usf7) true false)))

(declare-const infix_lseqqtresultqtunused17 Bool)

;; "H"
(assert (= infix_lseqqtresultqtunused17 o47))

(declare-const andbqtresultqtunused8 Bool)

;; "H"
(assert (= andbqtresultqtunused8 (and o47 o45)))
...
(assert
  (forall ((div1 Int))
    (=> (and (<= 2 div1) (<= div1 (- c169b 1))) (not (= (mod1 w div1) 0)))))

;; Goal "def'vc"
;; File "prime_and_coprime_numbers.adb", line 201, characters 0-0
(assert
  (not (not (= (mod1 w c169b) 0))))
