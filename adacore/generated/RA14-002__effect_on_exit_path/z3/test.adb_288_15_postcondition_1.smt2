...
(declare-const temp___index_587 Int)

;; "H"
(assert (<= 0 temp___index_587))

;; "H"
(assert (<= temp___index_587 4))
...
(assert
  ...
  (= (bool_eq2
       ...
       (ite (= temp___index_587 task_id)
         (us_repqtmk1
           (let ((usq_qtunused (us_split_fields3
                                 (select os_task_mbx_rw task_id))))
             (us_split_fieldsqtmk1
               (of_rep
                 (let ((temp___591 (bvadd (to_rep
                                            (rec__test__os_mbx_t__head
                                              (us_split_fields3
                                                (select os_task_mbx_rw 
                                                task_id)))) #x01)))
               ...
               (of_rep1
                 (bvsub (to_rep1
                          (rec__test__os_mbx_t__count
                            (us_split_fields3
                              (select os_task_mbx_rw task_id)))) #x01))
               (temp_____aggregate_def_419
                 (rec__test__os_mbx_t__mbx_array
                   (us_split_fields3 (select os_task_mbx_rw task_id)))
                 (let ((temp___596 (bvsub (os_mbx_get_mbx_head
                                            task_id
                                            os_task_mbx_rw4) #x01)))
