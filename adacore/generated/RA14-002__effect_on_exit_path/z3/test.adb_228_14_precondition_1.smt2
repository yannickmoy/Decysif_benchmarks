...
(assert
  (forall ((temp___533 Int))
    (=>
      (and (<= 0 temp___533) (<= temp___533 4))
      (dynamic_invariant
        (select os_task_mbx_rw temp___533)
        true
        false
        true
        true))))
...
;; "H"
(assert (= o2 (os_mbx_is_empty o1 os_task_mbx_rw)))
...
(assert
  (=
    ...
    (= (to_rep1
         (rec__test__os_mbx_t__count
           (us_split_fields3 (select os_task_mbx_rw o1)))) #x00)))

(declare-const os_mbx_is_emptyqtresultqtunused Bool)

;; "H"
(assert (= os_mbx_is_emptyqtresultqtunused o2))
...
(assert
  (ite (not (= o2 true))
    (and
      (= o3 (os_ghost_mbx_are_well_formed os_task_mbx_rw))
      (and
        (=
          (= o3 true)
          (forall ((task_id1 Int))
        ...
        (= os_ghost_mbx_are_well_formedqtresultqtunused o3)))
    (= o3 false)))
...
(assert
  (ite (= o3 true)
    (and
      (= o4 task_id)
      (and
        (= o5 (os_mbx_get_mbx_count o4 os_task_mbx_rw))
        (and
          (and
            (in_range1 o5)
            (= o5 (to_rep1
          ...
          (and
            (= os_mbx_get_mbx_countqtresultqtunused o5)
            (and
              (= o (ite (bvult index o5) true false))
              (= ultqtresultqtunused o))))))
    (= o false)))
          ...
          (rec__test__os_mbx_entry_t__sender_id
            (us_split_fields1
              (select (rec__test__os_mbx_t__mbx_array
                        (us_split_fields3 (select os_task_mbx_rw o7))) 
              (oadd
                (os_mbx_get_mbx_head o7 os_task_mbx_rw)
                o6))))))))
