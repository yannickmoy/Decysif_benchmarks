          ...
          (forall ((o Bool))
            (=>
              (exists ((o1 Bool))
                (and
                  (let ((o2 task_id))
                    (let ((o3 (os_mbx_is_empty o2 os_task_mbx_rw)))
                      (and
                        (=
                          (= o3 true)
                          (= (to_rep1
                               (rec__test__os_mbx_t__count
                                 (us_split_fields3
                                   (select os_task_mbx_rw o2)))) #x00))
                        (ite (not (= o3 true))
                          (and
                            (= o1 (os_ghost_mbx_are_well_formed
                                    os_task_mbx_rw))
                            (=
                              (= o1 true)
                              (forall ((task_id1 Int))
                    ...
                    (let ((o2 task_id))
                      (let ((o3 (os_mbx_get_mbx_count o2 os_task_mbx_rw)))
                        (and
                          ...
                          (= o (ite (bvult index o3) true false)))))
                    (= o false))))
              (=>
                (= o true)
                (let ((o1 task_id))
                          ...
                          (rec__test__os_mbx_entry_t__sender_id
                            (us_split_fields1
                              (select (rec__test__os_mbx_t__mbx_array
                                        (us_split_fields3
                                          (select os_task_mbx_rw o1))) 
                              (oadd
                                (os_mbx_get_mbx_head o1 os_task_mbx_rw)
                                index))))))))))))))))
