...
(assert
  (not
  (forall ((os_task_mbx_rw (Array Int us_rep1)) (status Int) (mbx_entry__split_fields us_split_fields) (os_task_list_rw (Array Int us_rep2)) (os_task_current Int))
    (=>
                      ...
                      (forall ((mbx_entry__split_fields2 us_split_fields))
                        (=>
                          ...
                          (forall ((os_task_mbx_rw1 (Array Int us_rep1)))
                            (=>
                              (forall ((os_task_mbx_rw2 (Array Int us_rep1)) (iterator (_ BitVec 8)) (o Int))
                                (os_mbx_get_mbx_entry_sender__function_guard
                                  (os_mbx_get_mbx_entry_sender
                                    o
                                    iterator
                                                        ...
                                                        (let ((temp___468 
                                                          ...
                                                          (exists ((iterator (_ BitVec 8)))
                                                            (and
                                                              (= iterator #x00)
                                                              (ite (= (and 
                                                                (ite (bvule #x00 iterator)
                                                                  true
                                                                  false) 
                                                                (ite (bvule iterator temp___468)
                                                                  true
                                                                  false)) true)
                                                                (let ((o4 
                                                                  current))
                                                                  (and
                                                                    ...
                                                                    os_task_mbx_rw) true))))
                                                                    (exists 
                                                                    ((os_task_mbx_rw2 (Array Int us_rep1)) (status2 Int) (mbx_entry__split_fields3 us_split_fields) (iterator1 (_ BitVec 8)))
                                                                    (and
                                                                    (and
                                                                    (= 
                                                                    (os_ghost_mbx_are_well_formed
                                                                    ...
                                                                    (and
                                                                    (= status2 status1)
                                                                    (= os_task_mbx_rw2 os_task_mbx_rw))
                                                                    ...
                                                                    o7
                                                                    iterator1
                                                                    os_task_mbx_rw2) (select 
                                                                    (rec__test__os_mbx_t__mbx_array
                                                                    (us_split_fields3
                                                                    (select os_task_mbx_rw2 o7))) 
                                                                    (oadd
                                                                    (os_mbx_get_mbx_head
                                                                    o7
                                                                    os_task_mbx_rw2)
                                                                    ...
                                                                    (= 
                                                                    (bool_eq2
                                                                    (select os_task_mbx_rw1 temp___index_411)
                                                                    (ite (= temp___index_411 o8)
                                                                    (us_repqtmk1
                                                                    (let ((usq_qtunused 
                                                                    (us_split_fields3
                                                                    (select os_task_mbx_rw2 o8))))
                                                                    (us_split_fieldsqtmk1
                                                                    (of_rep
                                                                    ...
                                                                    rliteral
                                                                    rliteral1))))))
                                                                    (select os_task_mbx_rw2 temp___index_411))) true)))
                                                                    (forall 
                                                                    ((temp___426 Int))
                                                                    (=>
                                                                    (and
                                                                    ...
                                                                    (<= temp___426 4))
                                                                    (dynamic_invariant
                                                                    (select os_task_mbx_rw1 temp___426)
                                                                    true
                                                                    false
                                                                    true
                                                                    true))))))))
                                                                    (and
                                                                    (= iterator1 temp___468)
                                                                    (= os_task_mbx_rw1 os_task_mbx_rw2)))))))))))))))
                                                                (= os_task_mbx_rw1 os_task_mbx_rw)))))))))))))))))
                                (forall ((task_id Int))
                                  (=>
                                    (and (<= 0 task_id) (<= task_id 4))
