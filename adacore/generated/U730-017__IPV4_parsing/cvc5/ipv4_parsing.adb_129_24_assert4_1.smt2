                ...
                (forall ((i Int))
                  (=>
                    ...
                    (=>
                      (in_range1 first1)
                      (let ((o s))
                        (forall ((byte (_ BitVec 8)) (error Bool) (param__first Int))
                          (=>
                            (forall ((o1 us_t))
                              (find_first_dot__function_guard
                                (find_first_dot o1 first1)
                                o1
                                first1))
                            (=>
                              (forall ((o1 us_t))
                                (find_first_dot__function_guard
                                  ...
                                  first1))
                              (=>
                                (forall ((o1 us_t) (temp___339 Int))
                                  (is_byte_10__function_guard
                                    (is_byte_10 o1 first1 temp___339 byte)
                                    o1
                                    first1
                                    temp___339
                                    byte))
                                        ...
                                        (=
                                          ...
                                          (not
                                            (= (valid_byte_10
                                                 o
                                                 first1
                                                 (- (find_first_dot o first1) 1)) true))))
                                      (=>
                                        (not (= error true))
                                        (and
                                          (= param__first (find_first_dot
                                                            o
                                                            first1))
                                      ...
                                      (=>
                                        ...
                                        (=>
                                          ...
                                          (forall ((v1 (_ BitVec 32)))
                                            (=>
                                              (= v1 (bvor (bvshl v ((_ int2bv 32) 8)) ((_ zero_extend 24) byte)))
                                              (=>
                                                (not (= i 4))
                                                (let ((o1 (+ first2 1)))
                                                  (=>
                                                              ...
                                                              (let ((o2 
                                                                ...
                                                                (forall 
                                                                  ...
                                                                  (=>
                                                                    ...
                                                                    ((v2 (_ BitVec 32)))
                                                                    (=>
                                                                    (= v2 (bvor (bvshl v1 ((_ int2bv 32) 8)) ((_ zero_extend 24) byte1)))
                                                                    (=>
                                                                    (not
                                                                    (= i1 4))
                                                                    (let ((o3 (+ first4 1)))
