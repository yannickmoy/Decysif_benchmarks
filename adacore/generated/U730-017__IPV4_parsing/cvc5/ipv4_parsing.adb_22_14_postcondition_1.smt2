...
;; Goal "def'vc"
;; File "ipv4_parsing.adb", line 18, characters 0-0
(assert
  (not
  (=>
              ...
              (and
                (and
                  (and
                    ...
                    (and (<= (first s) last1) (<= last1 (last s))))
                  (= (is_byte_10 s first1 last1 v1) true))
                (= (is_byte_10 s first1 last1 v2) true))
              (= v1 v2)))))))))
