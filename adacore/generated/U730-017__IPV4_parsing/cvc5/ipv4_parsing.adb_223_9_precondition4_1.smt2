                                                              ...
                                                              (let ((temp___576 (select ds1 2)))
                                                                (=>
                                                                  ...
                                                                  (forall 
                                                                    ...
                                                                    res__first) o10)
                                                                    (=>
                                                                    (bvuge ((_ extract 7 0) (bvlshr o2 ((_ int2bv 32) 24))) #x0A)
                                                                    (= 
                                                                    (to_rep1
                                                                    (select 
                                                                    (to_array
                                                                    (let ((temp___436qtunused 
                                                                    (let ((temp___435 (- o8 1)))
                                                                    (let ((temp___434 o10))
                                                                    (of_array
                                                                    res
                                                                    ...
                                                                    temp___435))))) 1))) 
                                                                    (char_of_byte_10
                                                                    (bvurem (bvudiv ((_ extract 7 0) (bvlshr o2 ((_ int2bv 32) 24))) #x0A) #x0A))))))))))))))))))))))))))))))))))))))))))))))))))))))
