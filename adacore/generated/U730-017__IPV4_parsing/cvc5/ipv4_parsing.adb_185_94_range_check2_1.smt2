                        ...
                        (and
                            ...
                            (and
                              ...
                              (ite (= o4 true)
                                (and
                                  ...
                                  (exists ((o5 Int))
                                    (and
                                      (= (to_rep (select (to_array s) d2)) o5)
                          ...
                          (ite (= o3 true)
                            (and
                              ...
                              (exists ((o4 Int))
                                (and
                                  (= (to_rep (select (to_array s) d3)) o4)
                                  (= o2 (ite (= o4 46) true false)))))
                            (= o2 false))))
                      (ite (= o2 true)
                        (let ((o3 ((_ extract 7 0) (bvlshr v ((_ int2bv 32) 24)))))
                          (let ((temp___764 (- d1 1)))
                              ...
                              (and
                                ...
                                (let ((o4 (to_array s)))
                                  (let ((o5 (of_array
                                              ...
                                              temp___764)))
                                    (and
                                      (= o1 (is_smallest_byte_10 o5 o3))
                                      (=
                                        (= o1 true)
                                        (and
                                          (and
                                            (and
                                              (= (length o5) (ite (bvuge o3 #x64)
                                                               3
                                                               (ite (bvuge o3 #x0A)
                                                                 2
                                                                 1)))
                                              (= (to_rep
                                                   (select o4 temp___764)) 
                                              (char_of_byte_10
                                                (bvurem o3 #x0A))))
                                            (=>
                                              (bvuge o3 #x0A)
                                              (= (to_rep
                                                   (select o4 (- temp___764 1))) 
                                              (char_of_byte_10
                                                (bvurem (bvudiv o3 #x0A) #x0A)))))
                                          (=>
                                            (bvuge o3 #x64)
                                            (= (to_rep
                                                 (select o4 temp___763)) 
                                            (char_of_byte_10
                                              (bvudiv o3 #x64)))))))))))))
                        (= o1 false))))
                  (ite (= o1 true)
                    (let ((o2 ((_ extract 7 0) (bvand (bvlshr v ((_ int2bv 32) 16)) #x000000FF))))
                      (let ((temp___768 (- d2 1)))
                        (let ((o3 (+ d1 1)))
                          (and
                            (in_range o3)
                              ...
                              (=>
                                ...
                                (and
                                  ...
                                  (and
                                    ...
                                    (<= temp___768 (last s)))))
                              (let ((o4 (to_array s)))
                                (let ((o5 (of_array o4 o3 temp___768)))
                                  (and
                                          ...
                                          (and
                                            (= (length o5) (ite (bvuge o2 #x64)
                                                             ...
                                                             (ite (bvuge o2 #x0A)
                                                               ...
                                                               1)))
                                            (= (to_rep
                                                 (select o4 temp___768)) 
                                            (char_of_byte_10
                                              (bvurem o2 #x0A))))
                                          (=>
                                            (bvuge o2 #x0A)
                                            (= (to_rep
                                                 (select o4 (- temp___768 1))) 
                                            (char_of_byte_10
