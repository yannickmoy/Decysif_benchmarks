...
(assert
  (forall ((temp___275 (_ BitVec 8)) (temp___274 Int) (temp___273 Int))
    (is_byte_10__function_guard
      (is_byte_10 s temp___273 temp___274 temp___275)
      s
      temp___273
      temp___274
      temp___275)))
...
(assert
  (not
  (= (let ((temp___275 ((_ extract 7 0) (bvand (bvlshr ipv4_parsing__parse_ipv4__2__result ((_ int2bv 32) 8)) #x000000FF))))
       (let ((temp___274 (- d3 1)))
         (let ((temp___273 (+ d2 1)))
           (is_byte_10 s temp___273 temp___274 temp___275)))) true)))
