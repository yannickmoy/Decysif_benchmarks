...
;; "o"
(define-fun o17 () Bool
  (is_byte_10 o16 o15 o14 o13))

;; "H"
(assert (is_byte_10__function_guard o17 o16 o15 o14 o13))
...
(assert
  (=
    ...
    (and
      (and
        (and
          (and (<= (- o14 2) o15) (<= o15 o14))
          (= (char_of_byte_10 (bvurem o13 #x0A)) (to_rep
                                                   (select (to_array o16) 
                                                   o14))))
        (= (char_of_byte_10 (bvurem (bvudiv o13 #x0A) #x0A)) (ite (< 
                                                               o15 o14)
                                                               (to_rep
                                                                 (select 
                                                                 (to_array
                                                                 ...
                                                                 o14 1)))
                                                               48)))
      (= (char_of_byte_10 (bvudiv o13 #x64)) (ite (< o15 (- o14 1))
                                               (to_rep
                                                 (select (to_array o16) (- 
                                                 o14 2)))
                                               48)))))
...
;; "H"
(assert (=> (= o17 true) (= (valid_byte_10 o16 o15 o14) true)))

;; "is_byte_10'result'unused"
(define-fun is_byte_10qtresultqtunused () Bool
  o17)
