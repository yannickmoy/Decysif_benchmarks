...
(assert
  (forall ((temp___285 Int))
    (find_first_dot__function_guard
      (find_first_dot ipv4_parsing__print_ipv4__result temp___285)
      ipv4_parsing__print_ipv4__result
      temp___285)))

;; "d1"
(define-fun d1 () Int
  (let ((temp___285 (first ipv4_parsing__print_ipv4__result)))
    (find_first_dot ipv4_parsing__print_ipv4__result temp___285)))
...
(assert
  (forall ((temp___283 Int))
    (find_first_dot__function_guard
      (find_first_dot ipv4_parsing__print_ipv4__result temp___283)
      ipv4_parsing__print_ipv4__result
      temp___283)))
...
(assert
  (forall ((temp___281 Int))
    (find_first_dot__function_guard
      (find_first_dot ipv4_parsing__print_ipv4__result temp___281)
      ipv4_parsing__print_ipv4__result
      temp___281)))
...
(assert
  (not
  (= (let ((temp___279 ((_ extract 7 0) (bvand v #x000000FF))))
       (let ((temp___278 (last ipv4_parsing__print_ipv4__result)))
         (let ((temp___277 (+ d3 1)))
           (is_byte_10
             ipv4_parsing__print_ipv4__result
             temp___277
