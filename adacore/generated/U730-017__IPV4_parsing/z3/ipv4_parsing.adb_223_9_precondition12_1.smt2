...
;; "H"
(assert
  (bvuge ((_ extract 7 0) (bvand (bvlshr o7 ((_ int2bv 32) 8)) #x000000FF)) #x0A))
  ...
  (= (to_rep1
       ...
       (last
         (let ((temp___444 (let ((temp___443 (- o10 1)))
           ...
           (let ((temp___443 (- o10 1)))
             (let ((temp___442 (+ o13 1)))
               (of_array temp___569 temp___442 temp___443))))) 1))) (char_of_byte_10
                                                                    (bvurem (bvudiv ((_ extract 7 0) (bvand (bvlshr 
                                                                    o7 ((_ int2bv 32) 8)) #x000000FF)) #x0A) #x0A)))))
