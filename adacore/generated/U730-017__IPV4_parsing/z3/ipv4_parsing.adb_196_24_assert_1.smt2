...
(assert
  (and
    (and
      (and
        (and
            ...
            (and
              (and
                (and
                  (and
                    (and
                      (and (< (last s) 2147483647) (< 0 (length s)))
          ...
          (= (is_smallest_byte_10
               (let ((temp___781 (let ((temp___780 (- d1 1)))
        ...
        (= (is_smallest_byte_10
             (let ((temp___785 (let ((temp___784 (- d2 1)))
                                 (let ((temp___783 (+ d1 1)))
                                   (of_array
                                     (to_array s)
                                     temp___783
      ...
      (= (is_smallest_byte_10
           (let ((temp___789 (let ((temp___788 (- d3 1)))
                               (let ((temp___787 (+ d2 1)))
                                 (of_array
                                   (to_array s)
                                   temp___787
    ...
    (= (is_smallest_byte_10
         (let ((temp___793 (let ((temp___792 (last s)))
                             (let ((temp___791 (+ d3 1)))
...
;; "Assert"
(assert (= d1 (let ((temp___742 (first s))) (find_first_dot s temp___742))))
...
;; "Assert"
(assert (= d2 (let ((temp___744 (+ d1 1))) (find_first_dot s temp___744))))
...
;; "Assert"
(assert (= d3 (let ((temp___746 (+ d2 1))) (find_first_dot s temp___746))))
...
;; "Assert"
(assert
  (= (let ((temp___750 ((_ extract 7 0) (bvlshr v ((_ int2bv 32) 24)))))
       (let ((temp___749 (- d1 1)))
...
(assert
  (forall ((temp___754 (_ BitVec 8)) (temp___753 Int) (temp___752 Int))
    (is_byte_10__function_guard
      (is_byte_10 s temp___752 temp___753 temp___754)
      s
      temp___752
      temp___753
      temp___754)))
...
;; "Assert"
(assert
  (= (let ((temp___754 ((_ extract 7 0) (bvand (bvlshr v ((_ int2bv 32) 16)) #x000000FF))))
       (let ((temp___753 (- d2 1)))
         (let ((temp___752 (+ d1 1)))
           (is_byte_10 s temp___752 temp___753 temp___754)))) true))

;; "H"
(assert
  (forall ((temp___758 (_ BitVec 8)) (temp___757 Int) (temp___756 Int))
    (is_byte_10__function_guard
      (is_byte_10 s temp___756 temp___757 temp___758)
      s
      temp___756
      temp___757
      temp___758)))
...
;; "Assert"
(assert
  (= (let ((temp___758 ((_ extract 7 0) (bvand (bvlshr v ((_ int2bv 32) 8)) #x000000FF))))
       (let ((temp___757 (- d3 1)))
         (let ((temp___756 (+ d2 1)))
...
;; "H"
(assert
  (forall ((temp___762 (_ BitVec 8)) (temp___761 Int) (temp___760 Int))
    (is_byte_10__function_guard
      (is_byte_10 s temp___760 temp___761 temp___762)
      s
      temp___760
      temp___761
      temp___762)))
...
(assert
  (not
  (= (let ((temp___762 ((_ extract 7 0) (bvand v #x000000FF))))
       (let ((temp___761 (last s)))
         (let ((temp___760 (+ d3 1)))
           (is_byte_10 s temp___760 temp___761 temp___762)))) true)))
