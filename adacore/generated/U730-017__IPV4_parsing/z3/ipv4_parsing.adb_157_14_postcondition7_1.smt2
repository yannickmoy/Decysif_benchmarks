...
(assert
  (and
    (and
      ...
      (and (<= (to_rep1 s__first) last2) (<= last2 (to_rep1 s__last))))
                        ...
                        (and
                          ...
                          (exists ((o10 character))
                            (and
                              (= (to_rep o10) o9)
                              (and
                                (and (<= o7 last2) (<= last2 o6))
                                (exists ((s2 (Array Int character__init_wrapper)))
                                  (and
                                    (= s2 (to_array1
                                            (us_tqtmk1
                                              (store s last2 (character__init_wrapperqtmk
                                                               o10
                                                               true))
                                              (rt1 (of_array1 s o7 o6)))))
                                    (let ((o11 (- last2 1)))
                                      (and
                                        (in_range1 o11)
                                        (exists ((last4 Int))
  ...
  (= (to_rep
       (select (to_array
                 (let ((temp___727 (let ((temp___725 (+ last3 1)))
                                     (of_array1 s1 temp___725 last2))))
                   (of_array
                     (convert (to_array1 temp___727))
                     (first temp___727)
                     (last1 temp___727)))) (- (last
                                                (let ((temp___727 (let ((temp___725 (+ 
                                                                    last3 1)))
                                                                    (of_array1
                                                                    s1
                                                                    temp___725
