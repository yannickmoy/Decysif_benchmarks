...
;; "H"
(assert
  (bvuge ((_ extract 7 0) (bvand (bvlshr o7 ((_ int2bv 32) 16)) #x000000FF)) #x0A))
...
(assert
  ...
  (= (to_rep1
       (select (to_array
                 (let ((temp___440 (let ((temp___439 (- o13 1)))
                                     (let ((temp___438 (+ o16 1)))
                                       (of_array
                                         temp___569
                                         temp___438
                                         temp___439)))))
                   (let ((temp___439 (- o13 1)))
                     (let ((temp___438 (+ o16 1)))
                       (of_array temp___569 temp___438 temp___439))))) (- 
       (last
         (let ((temp___440 (let ((temp___439 (- o13 1)))
                             (let ((temp___438 (+ o16 1)))
                               (of_array temp___569 temp___438 temp___439)))))
           (let ((temp___439 (- o13 1)))
             (let ((temp___438 (+ o16 1)))
               (of_array temp___569 temp___438 temp___439))))) 1))) (char_of_byte_10
                                                                    (bvurem (bvudiv ((_ extract 7 0) (bvand (bvlshr 
                                                                    o7 ((_ int2bv 32) 16)) #x000000FF)) #x0A) #x0A)))))
