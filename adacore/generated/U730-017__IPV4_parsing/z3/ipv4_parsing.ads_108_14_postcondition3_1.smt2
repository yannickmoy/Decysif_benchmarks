...
;; "H"
(assert
  (forall ((first1 Int) (o us_t))
    (find_first_dot__function_guard (find_first_dot o first1) o first1)))
...
;; "H"
(assert
  (forall ((first1 Int) (o us_t) (byte1 (_ BitVec 8)) (temp___339 Int))
    (is_byte_10__function_guard
      (is_byte_10 o first1 temp___339 byte1)
      o
      first1
      temp___339
      byte1)))
...
(declare-const firstqtunused int__ref)

;; "H"
(assert (= firstqtunused (int__refqtmk first1)))
...
(declare-const vqtunused1 t__ref1)

;; "H"
(assert (= vqtunused1 (t__refqtmk1 v2)))
...
(assert
  (ite (= spark__branch true)
    (and
      (and
        (= o3 (distinct 1 0))
        (and (= of_intqtresultqtunused o3) (= error1 o3)))
      (= v1 v2))
    (or
      (exists ((i Int))
        (and
          ...
          (and
            (in_range1 first1)
            (let ((o4 s))
              (exists ((error2 Bool) (byte1 (_ BitVec 8)) (param__first Int))
                (and
                  (and
                    (and
                      (and
                        ...
                        (=
                          ...
                          (not
                            (= (valid_byte_10
                                 o4
                                 first1
                                 (- (find_first_dot o4 first1) 1)) true))))
                      (=>
                        (not (= error2 true))
                        (and
                          (= param__first (find_first_dot o4 first1))
                          (= (let ((temp___339 (- param__first 1)))
                               (is_byte_10 o4 first1 temp___339 byte1)) true))))
                                                  ...
                                                  (exists ((i1 Int))
                                                    (and
                                                      ...
                                                      (and
                                                        (in_range1 first3)
                                                        (let ((o7 s))
                                                          (exists ((error3 Bool) (byte2 (_ BitVec 8)) (param__first1 Int))
                                                            (and
                                                              (and
                                                                (and
                                                                  (and
                                                              ...
                                                              (and
                                                                ...
                                                                (exists 
                                                                  ...
                                                                  (and
                                                                    ...
                                                                    s))
                                                                    (exists 
                                                                    ((error4 Bool) (byte3 (_ BitVec 8)) (param__first2 Int))
                                                                    (and
                                                                    (and
                                                                    (and
                                                                    (and
                                                                    ...
                                                                    ((v5 (_ BitVec 32)))
                                                                    (and
                                                                    (= v5 (bvor (bvshl v4 ((_ int2bv 32) 8)) ((_ zero_extend 24) byte3)))
                                                                    (let ((o11 (+ 
                                                                    (last
                                                                    s) 1)))
                                                                    (and
                                                                    ...
                                                                    s))
                                                                    (exists 
                                                                    ((byte4 (_ BitVec 8)) (param__first3 Int))
                                                                    (and
                                                                    (and
                                                                    (and
                                                                    (and
                                                                    ...
                                                                    (and
                                                                    (= 
                                                                    v1 (bvor (bvshl v5 ((_ int2bv 32) 8)) ((_ zero_extend 24) byte4)))
                                                                    (let ((o14 (+ 
                                                                    (last
                                                                    s) 1)))
                                                                    (and
                                                              ...
                                                              (and
                                                                ...
                                                                (exists 
                                                                  ...
                                                                  (and
                                                                    ...
                                                                    s))
                                                                    (exists 
                                                                    ((error5 Bool) (byte4 (_ BitVec 8)) (param__first3 Int))
                                                                    (and
                                                                    (and
                                                                    (and
                                                                    (and
...
;; Goal "def'vc"
;; File "ipv4_parsing.ads", line 106, characters 0-0
(assert
  (not
  (= (let ((temp___267 ((_ extract 7 0) (bvlshr v1 ((_ int2bv 32) 24)))))
       (let ((temp___266 (- d1 1)))
