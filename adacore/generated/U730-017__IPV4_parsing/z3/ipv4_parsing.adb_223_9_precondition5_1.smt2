...
;; "H"
(assert (bvuge ((_ extract 7 0) (bvlshr o7 ((_ int2bv 32) 24))) #x64))
  ...
  (= (to_rep1
       ...
       (first
         (let ((temp___436 (let ((temp___435 (- o16 1)))
           ...
           (let ((temp___435 (- o16 1)))
             (let ((temp___434 o20))
               (of_array temp___569 temp___434 temp___435))))))) (char_of_byte_10
                                                                   (bvudiv ((_ extract 7 0) (bvlshr 
                                                                   o7 ((_ int2bv 32) 24))) #x64)))))
