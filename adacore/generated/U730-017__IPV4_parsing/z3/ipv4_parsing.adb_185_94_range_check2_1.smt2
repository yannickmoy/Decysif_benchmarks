...
(assert
  (ite (= o31 true)
    (and
      (= o40 ((_ int2bv 32) 16))
      (and
        (= of_intqtresultqtunused1 o40)
        (and
          (= o41 (bvlshr v o40))
          (and
            (= lsr_bvqtresultqtunused1 o41)
            (and
              (= o42 (bvand o41 #x000000FF))
              (and
                (= bw_andqtresultqtunused o42)
                (and
                  (= toBigqtresultqtunused2 ((_ zero_extend 24) #xFF))
                  (and
                    (= toBigqtresultqtunused3 ((_ zero_extend 24) #x00))
                    (and
                      (= range_check_qtresultqtunused3 o42)
                      (and
                        (= o43 ((_ extract 7 0) o42))
                        (and
                          (= toSmallqtresultqtunused1 o43)
                          (and
                            (= temp___768 (- d2 1))
                            (and
