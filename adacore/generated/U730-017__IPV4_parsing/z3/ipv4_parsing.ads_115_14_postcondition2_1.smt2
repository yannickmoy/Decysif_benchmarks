...
(assert
  (forall ((temp___271 (_ BitVec 8)) (temp___270 Int) (temp___269 Int))
    (is_byte_10__function_guard
      (is_byte_10 s temp___269 temp___270 temp___271)
      s
      temp___269
      temp___270
      temp___271)))
...
(assert
  (not
  (= (let ((temp___271 ((_ extract 7 0) (bvand (bvlshr ipv4_parsing__parse_ipv4__2__result ((_ int2bv 32) 16)) #x000000FF))))
       (let ((temp___270 (- d2 1)))
         (let ((temp___269 (+ d1 1)))
           (is_byte_10 s temp___269 temp___270 temp___271)))) true)))
