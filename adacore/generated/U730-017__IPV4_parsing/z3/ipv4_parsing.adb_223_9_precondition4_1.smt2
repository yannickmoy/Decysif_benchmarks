...
;; "H"
(assert (bvuge ((_ extract 7 0) (bvlshr o7 ((_ int2bv 32) 24))) #x0A))
...
(assert
  ...
  (= (to_rep1
       (select (to_array
                 (let ((temp___436 (let ((temp___435 (- o16 1)))
                                     (let ((temp___434 o20))
                                       (of_array
                                         temp___569
                                         temp___434
                                         temp___435)))))
                   (let ((temp___435 (- o16 1)))
                     (let ((temp___434 o20))
                       (of_array temp___569 temp___434 temp___435))))) (- 
       (last
         (let ((temp___436 (let ((temp___435 (- o16 1)))
                             (let ((temp___434 o20))
                               (of_array temp___569 temp___434 temp___435)))))
           (let ((temp___435 (- o16 1)))
             (let ((temp___434 o20))
               (of_array temp___569 temp___434 temp___435))))) 1))) (char_of_byte_10
                                                                    (bvurem (bvudiv ((_ extract 7 0) (bvlshr 
                                                                    o7 ((_ int2bv 32) 24))) #x0A) #x0A)))))
