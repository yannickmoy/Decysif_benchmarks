...
;; "H"
(assert (bvuge ((_ extract 7 0) (bvand o7 #x000000FF)) #x0A))
...
(assert
  ...
  (= (to_rep1
       (select (to_array
                 (let ((temp___448 (let ((temp___447 o19))
                                     (let ((temp___446 (+ o10 1)))
                                       (of_array
                                         temp___569
                                         temp___446
                                         temp___447)))))
                   (let ((temp___447 o19))
                     (let ((temp___446 (+ o10 1)))
                       (of_array temp___569 temp___446 temp___447))))) (- 
       (last
         (let ((temp___448 (let ((temp___447 o19))
                             (let ((temp___446 (+ o10 1)))
                               (of_array temp___569 temp___446 temp___447)))))
           (let ((temp___447 o19))
             (let ((temp___446 (+ o10 1)))
               (of_array temp___569 temp___446 temp___447))))) 1))) (char_of_byte_10
                                                                    (bvurem (bvudiv ((_ extract 7 0) (bvand 
                                                                    o7 #x000000FF)) #x0A) #x0A)))))
