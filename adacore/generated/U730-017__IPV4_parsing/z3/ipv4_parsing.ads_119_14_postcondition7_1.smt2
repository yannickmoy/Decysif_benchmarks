...
(define-fun less_than_byte_max_10 ((param__s us_t) (param__first Int) (param__last Int)) Bool
  (or (< (to_rep1 (select (to_array param__s) param__first)) 50) (and (= 
  (to_rep1
    (select (to_array param__s) param__first)) 50) (or (< (to_rep1
                                                            (select (to_array
                                                                    param__s) (+ param__first 1))) 53) (and (= 
  (to_rep1
    (select (to_array param__s) (+ param__first 1))) 53) (< (to_rep1
                                                              (select 
                                                              (to_array
             ...
             (and
               ...
               (forall ((i Int))
                 (=>
                   ...
                   (in_range4 (to_rep1 (select (to_array param__s) i))))))
             (=>
               (= (- param__last param__first) 2)
                 ...
                 (and
                   (and
                     ...
                     (=>
                       ...
                       (= (to_rep1 (select (to_array param__s) result)) 46)))
                   (forall ((k Int))
                     (=>
                       (and (<= param__first k) (<= k (- result 1)))
                       (not (= (to_rep1 (select (to_array param__s) k)) 46)))))
                   ...
                   (and
                     ...
                     (and
                       ...
                       (=
                         ...
                         (let ((d1 (let ((temp___285 (first param__s)))
                                     (find_first_dot param__s temp___285))))
                           (let ((d2 (let ((temp___283 (+ d1 1)))
                                       (find_first_dot param__s temp___283))))
                             (let ((d3 (let ((temp___281 (+ d2 1)))
                                         (find_first_dot param__s temp___281))))
                               (and
                                 (and
                                   (and
...
;; "H"
(assert (= (valid_ipv4 o21) true))

;; "H"
(assert (= (is_ipv4 o21 o7) true))
...
;; "map__content'result'unused"
(define-fun map__contentqtresultqtunused5 () (Array Int character)
  res)

;; "temp___582"
(define-fun temp___582 () us_t
  (of_array res o23 o22))
...
;; "temp___583"
(define-fun temp___583 () (Array Int character)
  res)
...
;; "o"
(define-fun o26 () us_t
  (of_array temp___583 o25 o24))

;; "of_array'result'unused"
(define-fun of_arrayqtresultqtunused5 () us_t
  o26)

(declare-const ipv4_parsing__print_ipv4__result us_t)

;; "ipv4_parsing__print_ipv4__result'unused"
(define-fun ipv4_parsing__print_ipv4__resultqtunused () string____ref
  (string____refqtmk ipv4_parsing__print_ipv4__result))

;; "H"
(assert (= ipv4_parsing__print_ipv4__result o26))

;; "result'unused"
(define-fun resultqtunused () us_t
  ipv4_parsing__print_ipv4__result)
...
(assert
  (forall ((temp___233 Int))
    (find_first_dot__function_guard
      (find_first_dot ipv4_parsing__print_ipv4__result temp___233)
      ipv4_parsing__print_ipv4__result
      temp___233)))

;; "d1"
(define-fun d1 () Int
  (let ((temp___233 (first ipv4_parsing__print_ipv4__result)))
    (find_first_dot ipv4_parsing__print_ipv4__result temp___233)))
...
(assert
  (forall ((temp___231 Int))
    (find_first_dot__function_guard
      (find_first_dot ipv4_parsing__print_ipv4__result temp___231)
      ipv4_parsing__print_ipv4__result
      temp___231)))

;; "d2"
(define-fun d2 () Int
  (ite (= d1 (+ (last ipv4_parsing__print_ipv4__result) 1))
    (+ (last ipv4_parsing__print_ipv4__result) 1)
    (let ((temp___231 (+ d1 1)))
      (find_first_dot ipv4_parsing__print_ipv4__result temp___231))))
...
(assert
  (forall ((temp___229 Int))
    (find_first_dot__function_guard
      (find_first_dot ipv4_parsing__print_ipv4__result temp___229)
      ipv4_parsing__print_ipv4__result
      temp___229)))

;; "d3"
(define-fun d3 () Int
  (ite (= d2 (+ (last ipv4_parsing__print_ipv4__result) 1))
    (+ (last ipv4_parsing__print_ipv4__result) 1)
    (let ((temp___229 (+ d2 1)))
      (find_first_dot ipv4_parsing__print_ipv4__result temp___229))))
...
(assert
  (not
  (= (valid_byte_10 ipv4_parsing__print_ipv4__result (+ d1 1) (- d2 1)) true)))
