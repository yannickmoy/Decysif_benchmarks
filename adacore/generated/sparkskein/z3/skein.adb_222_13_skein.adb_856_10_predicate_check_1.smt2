...
;; "range_check_'result'unused"
(define-fun range_check_qtresultqtunused10 () (_ BitVec 64)
  o211)

;; "o"
(define-fun o214 () (_ BitVec 8)
  ((_ extract 7 0) o211))

;; "toSmall'result'unused"
(define-fun toSmallqtresultqtunused8 () (_ BitVec 8)
  o214)

(declare-const o215 byte)

;; "Ensures"
(assert (= (to_rep6 o215) o214))
...
;; "temp___1251"
(define-fun temp___1251 () (_ BitVec 64)
  (bvadd c266b n5))
...
;; "Assert"
(assert (and (bvule o202 temp___1251) (bvule temp___1251 o201)))
...
(define-fun o217 () (Array (_ BitVec 64) byte)
  (store o216 temp___1251 o215))

;; "set'result'unused"
(define-fun setqtresultqtunused9 () (Array (_ BitVec 64) byte)
  o217)

;; "temp___1252"
(define-fun temp___1252 () us_t
  (us_tqtmk o217 o203))
...
(assert
  (not (bvult (last temp___1252) #xFFFFFFFFFFFFFFFF)))
