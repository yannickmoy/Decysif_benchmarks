...
(declare-datatypes ()
  ((us_t1 (us_tqtmk1 (elts1 (Array (_ BitVec 64) byte))(rt1 t1)))))
...
;; "dynamic_invariant"
(define-fun dynamic_invariant1 ((temp___expr_363 us_t1) (temp___is_init_359 Bool) (temp___skip_constant_360 Bool) (temp___do_toplevel_361 Bool) (temp___do_typ_inv_362 Bool)) Bool
  (and
    (=>
    ...
    (=>
      ...
      (=>
        ...
        (bvult (last1 temp___expr_363) #xFFFFFFFFFFFFFFFF)))))
...
;; Goal "def'vc"
;; File "skein.ads", line 223, characters 0-0
(assert
  (not (uint_in_range o)))
