...
;; "H"
(assert (= o195 (ite (bvuge c269b #x0000000000000001) true false)))

(declare-const ugeqtresultqtunused1 Bool)

;; "H"
(assert (= ugeqtresultqtunused1 o195))
...
(declare-const map__contentqtresultqtunused5 (Array (_ BitVec 64) byte))

(declare-const temp___loop_entry_1256qtunused us_t)
...
(declare-const nqtunused4 t__ref)

(declare-const hashqtunused3 map__ref1)
...
(declare-const map__contentqtresultqtunused6 (Array (_ BitVec 64) byte))

(declare-const temp___1249 us_t)

(declare-const of_arrayqtresultqtunused7 us_t)

(declare-const o203 t)
...
(declare-const bw_andqtresultqtunused8 (_ BitVec 64))

(declare-const o205 (_ BitVec 64))
...
(declare-const temp___1247 (Array (_ BitVec 64) u64))
...
(declare-const temp___1248 (_ BitVec 64))

(declare-const udiv_qtresultqtunused2 (_ BitVec 64))
...
(declare-const lsr_bvqtresultqtunused7 (_ BitVec 64))

(declare-const o211 (_ BitVec 64))

(declare-const bw_andqtresultqtunused9 (_ BitVec 64))

(declare-const toBigqtresultqtunused16 (_ BitVec 64))

(declare-const toBigqtresultqtunused17 (_ BitVec 64))

(declare-const range_check_qtresultqtunused10 (_ BitVec 64))

(declare-const o212 (_ BitVec 8))

(declare-const toSmallqtresultqtunused8 (_ BitVec 8))

(declare-const o213 byte)

(declare-const of_repqtresultqtunused15 byte)

(declare-const t__contentqtresultqtunused20 (_ BitVec 64))

(declare-const temp___1251 (_ BitVec 64))

(declare-const addqtresultqtunused2 (_ BitVec 64))

(declare-const o214 (Array (_ BitVec 64) byte))

(declare-const to_arrayqtresultqtunused3 (Array (_ BitVec 64) byte))

(declare-const o215 (Array (_ BitVec 64) byte))

(declare-const setqtresultqtunused9 (Array (_ BitVec 64) byte))

(declare-const temp___1252 us_t)
...
(assert
  (=>
    (= spark__branch2 true)
    (and
      (= temp___1245 (bvsub c269b #x0000000000000001))
      (and
        (= subqtresultqtunused2 temp___1245)
        (and
          (= nqtunused3 (t__refqtmk n4))
          (and
            (= n4 #x0000000000000000)
            (and
              (= t__contentqtresultqtunused16 n4)
              (and
                (= o196 (ite (bvule n4 temp___1245) true false))
                (and
                  (= uleqtresultqtunused4 o196)
                  (and
                    (= t__contentqtresultqtunused17 n4)
                    (and
                      (= o197 (ite (bvule #x0000000000000000 n4) true false))
                      (and
                        (= uleqtresultqtunused5 o197)
                        (and
                          (= o198 (and o197 o196))
                          (and
                            (= andbqtresultqtunused2 o198)
                            (=>
                              (= o198 true)
                              (and
                                (= (to_rep7 hash__last) o199)
                                (and
                                  (= to_repqtresultqtunused15 o199)
                                  (and
                                    (= (to_rep7 hash__first) o200)
                                    (and
                                      (= to_repqtresultqtunused16 o200)
                                      (and
                                        (= map__contentqtresultqtunused5 
                                        hash2)
                                        (and
                                          (= temp___loop_entry_1256qtunused 
                                          (of_array
                                            hash2
                                            o200
                                            o199))
                                          (and
                                            ...
                                            (of_array
                                              ...
                                              o199))
                                            (and
                                              (= nqtunused4 (t__refqtmk n5))
                                              (and
                                                (= hashqtunused3 (map__refqtmk1
                                                                   hash3))
                                                (and
                                                  (= (and (ite true
                                                            true
                                                              ...
                                                              (and
                                                                ...
                                                                (and
                                                                  ...
                                                                  (and
                                                                    ...
                                                                    (= 
                                                                    temp___1248 (bvudiv 
                                                                    n5 #x0000000000000008))
                                                                    (and
                                                                    (= 
                                                                    udiv_qtresultqtunused2 
                                                                    temp___1248)
                                                                    (and
                                                                    (and
                                                                    (bvule #x0000000000000000 
                                                                    ...
                                                                    (and
                                                                    (= 
                                                                    lsr_bvqtresultqtunused7 
                                                                    o210)
                                                                    (and
                                                                    (= 
                                                                    o211 (bvand 
                                                                    o210 #x00000000000000FF))
                                                                    (and
                                                                    (= 
                                                                    ...
                                                                    (and
                                                                    (= 
                                                                    toBigqtresultqtunused16 ((_ zero_extend 56) #xFF))
                                                                    (and
                                                                    (= 
                                                                    toBigqtresultqtunused17 ((_ zero_extend 56) #x00))
                                                                    (and
                                                                    (= 
...
;; "_q 'unused"
(define-fun usq_qtunused13 () us_split_fields4
  local_ctx__split_fields18)
...
;; "o"
(define-fun o216 () (Array (_ BitVec 64) byte)
  (rec__skein__skein_512_context__b local_ctx__split_fields18))

;; "rec__skein__skein_512_context__b'result'unused"
(define-fun rec__skein__skein_512_context__bqtresultqtunused14 () (Array (_ BitVec 64) byte)
  o216)
...
;; "o"
(define-fun o217 () us_rep1
  (rec__skein__skein_512_context__h local_ctx__split_fields18))

;; "rec__skein__skein_512_context__h'result'unused"
(define-fun rec__skein__skein_512_context__hqtresultqtunused20 () us_rep1
  o217)

;; "o"
(define-fun o218 () us_split_fields4
  (us_split_fieldsqtmk2 o217 x1 o216))

;; "__split_fields'mk'result'unused"
(define-fun us_split_fieldsqtmkqtresultqtunused18 () us_split_fields4
  o218)
...
;; "local_ctx__split_fields'unused"
(define-fun local_ctx__split_fieldsqtunused19 () us_split_fields__ref
  (us_split_fields__refqtmk local_ctx__split_fields19))

;; "H"
(assert (= local_ctx__split_fields19 o218))
...
;; "eq'result'unused"
(define-fun eqqtresultqtunused3 () Bool
  (ite (= blocks_done1 temp___1177) true false))

;; "H"
(assert (not (= blocks_done1 temp___1177)))
...
(define-fun addqtresultqtunused3 () (_ BitVec 64)
  (bvadd blocks_done1 #x0000000000000001))

;; "__split_fields__content'result'unused"
(define-fun us_split_fields__contentqtresultqtunused42 () us_split_fields4
  local_ctx__split_fields19)

;; "__rep'mk'result'unused"
(define-fun us_repqtmkqtresultqtunused61 () us_rep2
  (us_repqtmk2 local_ctx__split_fields19))
...
;; "o"
(define-fun o219 () us_rep1
  (rec__skein__skein_512_context__h local_ctx__split_fields19))

;; "rec__skein__skein_512_context__h'result'unused"
(define-fun rec__skein__skein_512_context__hqtresultqtunused21 () us_rep1
  o219)

;; "o"
(define-fun o220 () us_split_fields2
  (us_split_fields3 o219))

;; "__split_fields'result'unused"
(define-fun us_split_fieldsqtresultqtunused65 () us_split_fields2
  o220)

;; "o"
(define-fun o221 () hash_bit_length
  (rec__skein__context_header__hash_bit_len o220))

;; "rec__skein__context_header__hash_bit_len'result'unused"
(define-fun rec__skein__context_header__hash_bit_lenqtresultqtunused6 
  () hash_bit_length
  o221)
...
;; "eq'result'unused"
(define-fun eqqtresultqtunused4 () Bool
  (ite (= o222 temp___loop_entry_1270) true false))
