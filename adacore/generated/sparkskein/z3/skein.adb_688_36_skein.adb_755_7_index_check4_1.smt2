...
;; "Assert"
(assert (and (bvule (first msg) src5) (bvule src5 (last msg))))
...
;; "o"
(define-fun o80 () (Array (_ BitVec 64) byte)
  (to_array msg))
...
;; "dst'unused"
(define-fun dstqtunused5 () t__ref
  (t__refqtmk dst6))

;; "src'unused"
(define-fun srcqtunused5 () t__ref
  (t__refqtmk src6))

;; "ctx__split_fields'unused"
(define-fun ctx__split_fieldsqtunused7 () us_split_fields__ref
  (us_split_fields__refqtmk ctx__split_fields8))

;; "loop_var___37735'unused"
(define-fun loop_var___37735qtunused () (_ BitVec 64)
  dst6)
...
(assert
  (and
    (and
      (in_range5 dst6)
      (dynamic_invariant
        (us_repqtmk2 ctx__split_fields8)
        true
        true
        true
        true))
    (and
      (= (rec__skein__skein_512_context__h ctx__split_fields8) (rec__skein__skein_512_context__h
                                                                 ctx__split_fields1))
      (= (rec__skein__skein_512_context__x ctx__split_fields8) (rec__skein__skein_512_context__x
                                                                 ctx__split_fields1)))))
...
;; "o"
(define-fun o88 () Bool
  (ite (bvuge src6 final_src3) true false))

;; "uge'result'unused"
(define-fun ugeqtresultqtunused2 () Bool
  o88)
...
;; "o"
(define-fun o89 () Bool
  (ite (bvuge dst6 final_dst3) true false))

;; "uge'result'unused"
(define-fun ugeqtresultqtunused3 () Bool
  o89)
...
;; "dst'unused"
(define-fun dstqtunused6 () t__ref
  (t__refqtmk dst7))
...
;; "src'unused"
(define-fun srcqtunused6 () t__ref
  (t__refqtmk src7))
...
;; "temp___1077"
(define-fun temp___10771 () (Array (_ BitVec 64) byte)
  (rec__skein__skein_512_context__b ctx__split_fields8))
