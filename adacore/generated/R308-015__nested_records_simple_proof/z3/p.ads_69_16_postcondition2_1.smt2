...
(assert
  (= (bool_eq
       (rec__p__type_4__field_0 (us_split_fields5 o))
       (create_type_1 Tuple0)) true))

;; "H"
(assert
  (= (bool_eq
       (rec__p__type_4__field_1 (us_split_fields5 o))
       (create_type_1 Tuple0)) true))

;; "H"
(assert
  (= (bool_eq1
       (rec__p__type_4__field_2 (us_split_fields5 o))
       (create_type_2 Tuple0)) true))

;; "H"
(assert
  (= (bool_eq1
       (rec__p__type_4__field_3 (us_split_fields5 o))
       (create_type_2 Tuple0)) true))
...
(assert
  (= (bool_eq
       (rec__p__type_4__field_0 (us_split_fields5 o1))
       (create_type_1 Tuple0)) true))

;; "H"
(assert
  (= (bool_eq
       (rec__p__type_4__field_1 (us_split_fields5 o1))
       (create_type_1 Tuple0)) true))

;; "H"
(assert
  (= (bool_eq1
       (rec__p__type_4__field_2 (us_split_fields5 o1))
       (create_type_2 Tuple0)) true))

;; "H"
(assert
  (= (bool_eq1
       (rec__p__type_4__field_3 (us_split_fields5 o1))
       (create_type_2 Tuple0)) true))
...
(assert
  (= (bool_eq
       (rec__p__type_2__field_0 (us_split_fields3 o2))
       (create_type_1 Tuple0)) true))

;; "H"
(assert
  (= (bool_eq
       (rec__p__type_2__field_1 (us_split_fields3 o2))
       (create_type_1 Tuple0)) true))

;; "H"
(assert
  (= (bool_eq
       (rec__p__type_2__field_2 (us_split_fields3 o2))
       (create_type_1 Tuple0)) true))

;; "H"
(assert
  (= (bool_eq
       (rec__p__type_2__field_3 (us_split_fields3 o2))
       (create_type_1 Tuple0)) true))

;; "H"
(assert
  (= (bool_eq
       (rec__p__type_2__field_4 (us_split_fields3 o2))
       (create_type_1 Tuple0)) true))
...
(assert
  (= (bool_eq
       (rec__p__type_4__field_0 (us_split_fields5 o3))
       (create_type_1 Tuple0)) true))

;; "H"
(assert
  (= (bool_eq
       (rec__p__type_4__field_1 (us_split_fields5 o3))
       (create_type_1 Tuple0)) true))

;; "H"
(assert
  (= (bool_eq1
       (rec__p__type_4__field_2 (us_split_fields5 o3))
       (create_type_2 Tuple0)) true))

;; "H"
(assert
  (= (bool_eq1
       (rec__p__type_4__field_3 (us_split_fields5 o3))
       (create_type_2 Tuple0)) true))

;; "create_type_4'result'unused"
(define-fun create_type_4qtresultqtunused2 () us_rep2
  o3)

;; "o"
(define-fun o4 () us_split_fields6
  (us_split_fieldsqtmk3 rliteral o3 o2 o1 o))
...
;; "p__create_type_5__result'unused"
(define-fun p__create_type_5__resultqtunused () type_5__ref
  (type_5__refqtmk (us_repqtmk3 p__create_type_5__result)))

;; "H"
(assert (= p__create_type_5__result o4))

;; "result'unused"
(define-fun resultqtunused () us_rep3
  (us_repqtmk3 p__create_type_5__result))

;; "type_5__content'result'unused"
(define-fun type_5__contentqtresultqtunused () us_rep3
  (us_repqtmk3 p__create_type_5__result))
...
(assert
  (not
  (= (bool_eq2
       (rec__p__type_5__field_1 p__create_type_5__result)
