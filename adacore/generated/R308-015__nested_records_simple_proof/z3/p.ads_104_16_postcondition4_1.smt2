...
;; "bool_eq"
(define-fun bool_eq4 ((a us_rep4) (b us_rep4)) Bool
  (ite (and
         (= (bool_eq
...
;; "create_type_6__function_guard"
(declare-fun create_type_6__function_guard (us_rep4
  tuple0) Bool)
...
;; "to_rep"
(define-fun to_rep2 ((x type_7)) Int
  (type_7qtint x))
...
(declare-datatypes ()
  ((type_8__ref (type_8__refqtmk (type_8__content us_rep5)))))
                 ...
                 (=>
                   ...
                   (and
                     (and
                       (and
                         (= (bool_eq
                              (rec__p__type_6__field_0
                                (us_split_fields9 result))
                              (create_type_1 Tuple0)) true)
                         (= (bool_eq3
                              (rec__p__type_6__field_1
                                (us_split_fields9 result))
                              (create_type_5 Tuple0)) true))
                       (= (bool_eq1
                            (rec__p__type_6__field_2
                              (us_split_fields9 result))
                            (create_type_2 Tuple0)) true))
                     (= (bool_eq3
                          (rec__p__type_6__field_3 (us_split_fields9 result))
                          (create_type_5 Tuple0)) true)))))))) :pattern (
    (create_type_6
      us_void_param)) )))
...
;; "o"
(define-fun o3 () us_rep4
  (create_type_6 Tuple0))
...
;; "H"
(assert (create_type_6__function_guard o3 Tuple0))
...
(assert
  (= (bool_eq
       (rec__p__type_6__field_0 (us_split_fields9 o3))
       (create_type_1 Tuple0)) true))

;; "H"
(assert
  (= (bool_eq3
       (rec__p__type_6__field_1 (us_split_fields9 o3))
       (create_type_5 Tuple0)) true))

;; "H"
(assert
  (= (bool_eq1
       (rec__p__type_6__field_2 (us_split_fields9 o3))
       (create_type_2 Tuple0)) true))

;; "H"
(assert
  (= (bool_eq3
       (rec__p__type_6__field_3 (us_split_fields9 o3))
       (create_type_5 Tuple0)) true))

;; "create_type_6'result'unused"
(define-fun create_type_6qtresultqtunused () us_rep4
  o3)

;; "o"
(define-fun o4 () us_rep2
  (create_type_4 Tuple0))
...
;; "H"
(assert (create_type_4__function_guard o4 Tuple0))
...
(assert
  (= (bool_eq
       (rec__p__type_4__field_0 (us_split_fields5 o4))
       (create_type_1 Tuple0)) true))

;; "H"
(assert
  (= (bool_eq
       (rec__p__type_4__field_1 (us_split_fields5 o4))
       (create_type_1 Tuple0)) true))

;; "H"
(assert
  (= (bool_eq1
       (rec__p__type_4__field_2 (us_split_fields5 o4))
       (create_type_2 Tuple0)) true))

;; "H"
(assert
  (= (bool_eq1
       (rec__p__type_4__field_3 (us_split_fields5 o4))
       (create_type_2 Tuple0)) true))

;; "create_type_4'result'unused"
(define-fun create_type_4qtresultqtunused () us_rep2
  o4)
...
;; "H"
(assert (create_type_5__function_guard o5 Tuple0))

;; "H"
(assert true)

;; "H"
(assert (= (to_rep1 (rec__p__type_5__field_0 (us_split_fields7 o5))) 0))

;; "H"
(assert
  (= (bool_eq2
       (rec__p__type_5__field_1 (us_split_fields7 o5))
       (create_type_4 Tuple0)) true))

;; "H"
(assert
  (= (bool_eq1
       (rec__p__type_5__field_2 (us_split_fields7 o5))
       (create_type_2 Tuple0)) true))

;; "H"
(assert
  (= (bool_eq2
       (rec__p__type_5__field_3 (us_split_fields7 o5))
       (create_type_4 Tuple0)) true))

;; "H"
(assert
  (= (bool_eq2
       (rec__p__type_5__field_4 (us_split_fields7 o5))
       (create_type_4 Tuple0)) true))

;; "create_type_5'result'unused"
(define-fun create_type_5qtresultqtunused2 () us_rep3
  o5)
...
;; "H"
(assert (create_type_4__function_guard o6 Tuple0))
...
(assert
  (= (bool_eq
       (rec__p__type_4__field_0 (us_split_fields5 o6))
       (create_type_1 Tuple0)) true))

;; "H"
(assert
  (= (bool_eq
       (rec__p__type_4__field_1 (us_split_fields5 o6))
       (create_type_1 Tuple0)) true))

;; "H"
(assert
  (= (bool_eq1
       (rec__p__type_4__field_2 (us_split_fields5 o6))
       (create_type_2 Tuple0)) true))

;; "H"
(assert
  (= (bool_eq1
       (rec__p__type_4__field_3 (us_split_fields5 o6))
       (create_type_2 Tuple0)) true))

;; "create_type_4'result'unused"
(define-fun create_type_4qtresultqtunused1 () us_rep2
  o6)

;; "o"
(define-fun o7 () us_split_fields10
  (us_split_fieldsqtmk5 o6 o5 o4 o3 o2 rliteral o1 o))
...
(define-fun us_repqtmkqtresultqtunused () us_rep5
  (us_repqtmk5 o7))

(declare-const p__create_type_8__result us_split_fields10)

;; "p__create_type_8__result'unused"
(define-fun p__create_type_8__resultqtunused () type_8__ref
  (type_8__refqtmk (us_repqtmk5 p__create_type_8__result)))

;; "H"
(assert (= p__create_type_8__result o7))

;; "result'unused"
(define-fun resultqtunused () us_rep5
  (us_repqtmk5 p__create_type_8__result))

;; "type_8__content'result'unused"
(define-fun type_8__contentqtresultqtunused () us_rep5
  (us_repqtmk5 p__create_type_8__result))

;; "H"
(assert (create_type_6__function_guard (create_type_6 Tuple0) Tuple0))
...
(assert
  (not
  (= (bool_eq4
       (rec__p__type_8__field_3 p__create_type_8__result)
       (create_type_6 Tuple0)) true)))
