                    ...
                    (=>
                      ...
                      (=>
                        ...
                        (=>
                          ...
                          (=>
                            (and
                              (create_type_2__function_guard o1 Tuple0)
                              (and
                                (and
                                  (and
                                    (and
                                                    ...
                                                    (= (to_rep
                                                         (rec__p__type_1__field_5
                                                           (us_split_fields1
                                                             o3))) 0))
                                                  (= (to_rep
                                                       (rec__p__type_1__field_6
                                                         (us_split_fields1
                                                           o3))) 0))
                                                (= (to_rep
                                                     (rec__p__type_1__field_7
                                                       (us_split_fields1 o3))) 0)))
                                            (forall ((p__create_type_6__result us_split_fields8))
                                              (=>
                                                (= p__create_type_6__result 
                                                (us_split_fieldsqtmk4
                                                  o3
                                                  o2
                                                  o1
