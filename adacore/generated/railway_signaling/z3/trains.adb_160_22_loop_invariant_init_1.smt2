    ...
    (=>
      ...
      (and
        (=>
          ...
          (= (to_rep5 (select track_signals2 j)) 2))
        (=>
          (= (to_rep5 (select track_signals1 j)) 1)
          (= (to_rep5 (select track_signals2 j)) 1))))))
...
;; "H"
(assert (not (= (get_previous_track (select trains1 train1) id1) 0)))

;; "temp___707"
(define-fun temp___707 () Int
  (to_rep5
    (select track_signals2 (get_previous_track (select trains1 train1) id1))))
