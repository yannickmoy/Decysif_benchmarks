...
;; "H"
(assert (not (= (get_previous_track new_position id) 0)))

;; "temp___687"
(define-fun temp___687 () Int
  (to_rep5
    (select track_signals (get_previous_track (select trains train) id))))

;; Goal "def'vc"
;; File "trains.ads", line 217, characters 0-0
(assert
  (not (or (= temp___687 1) (= temp___687 2))))
