...
;; "o"
(define-fun o3 () (Array Int us_rep1)
    ...
    (=>
      ...
      (forall ((id Int))
        (=>
          (and (<= 1 id) (<= id 3))
          (=>
            (not (= (get_previous_track (select trains1 train1) id) 0))
...
;; "temp___664"
(define-fun temp___664 () Int
  (to_rep5
    (select track_signals (get_other_previous_track
                            (select trains1 train1)
                            id))))
...
(assert
  (not (or (= temp___664 1) (= temp___664 2))))
