...
;; "H"
(assert (= o23 (ite (<= id 3) true false)))

(declare-const infix_lseqqtresultqtunused Bool)

;; "H"
(assert (= infix_lseqqtresultqtunused o23))
...
;; "H"
(assert (= o24 (ite (<= 1 id) true false)))

(declare-const infix_lseqqtresultqtunused1 Bool)

;; "H"
(assert (= infix_lseqqtresultqtunused1 o24))

(declare-const o25 Bool)

;; "H"
(assert (= o25 (and o24 o23)))

(declare-const andbqtresultqtunused Bool)

;; "H"
(assert (= andbqtresultqtunused o25))
...
(assert
  (ite (= o25 true)
    (and
      (= temp___loop_entry_710qtunused track_signals1)
      (and
        (= map__contentqtresultqtunused5 track_signals1)
        (and
          (= temp___loop_entry_709qtunused track_signals1)
          (and
            (= map__contentqtresultqtunused6 track_signals1)
            (and
              (= temp___loop_entry_696qtunused track_signals1)
              (and
                (= map__contentqtresultqtunused7 track_signals1)
                (and
                  (= temp___loop_entry_694qtunused prev)
                  (and
                    ...
                    (and
                      ...
                      (and
                        (= o26 new_position)
                        (and
                          (= o27 (get_other_previous_track o26 id))
                          (and
                            (and
                              (in_range2 o27)
                              (= o27 (ite (= (to_rep2
                            ...
                            (and
                              ...
                              (and
                                ...
                                (and
                                  (= prev1 o27)
                                  (and
                                    (= track_signalsqtunused3 (map__refqtmk1
                                                                track_signals3))
                                    (and
                                      (= spark__branchqtunused4 (bool__refqtmk
                                                                  spark__branch4))
                                      (and
                                        (and
                                          (and
...
;; "Assert"
(assert
  (= (occupied_tracks_on_red cur_num_trains trains1 track_signals2) true))
