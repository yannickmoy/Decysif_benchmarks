...
;; "o"
(define-fun o6 () (Array Int us_rep1)
...
;; "o"
(define-fun o9 () track_id
  (rec__trains__train_position__track_end o8))

;; "rec__trains__train_position__track_end'result'unused"
(define-fun rec__trains__train_position__track_endqtresultqtunused () track_id
  o9)

(declare-const o10 Int)

;; "Ensures"
(assert (= (to_rep4 o9) o10))
...
;; "map__content'result'unused"
(define-fun map__contentqtresultqtunused2 () (Array Int signal)
  track_signals)

;; "o"
(define-fun o11 () (Array Int signal)
  (store track_signals o10 o7))
...
;; "track_signals"
(define-fun track_signals2 () map__ref1
  (map__refqtmk1 track_signals1))

;; "H"
(assert (= track_signals1 o11))
...
;; "H"
(assert (= idqtunused (int__refqtmk id)))
...
;; "H"
(assert (= int__contentqtresultqtunused id))

(declare-const o12 Bool)

;; "H"
(assert (= o12 (ite (<= id 3) true false)))

(declare-const infix_lseqqtresultqtunused Bool)

;; "H"
(assert (= infix_lseqqtresultqtunused o12))

(declare-const int__contentqtresultqtunused1 Int)

;; "H"
(assert (= int__contentqtresultqtunused1 id))

(declare-const o13 Bool)

;; "H"
(assert (= o13 (ite (<= 1 id) true false)))

(declare-const infix_lseqqtresultqtunused1 Bool)

;; "H"
(assert (= infix_lseqqtresultqtunused1 o13))
...
(assert
  (ite (= o14 true)
    (and
      (= temp___loop_entry_676qtunused track_signals1)
      (and
        (= map__contentqtresultqtunused3 track_signals1)
        (and
          (= temp___loop_entry_675qtunused track_signals1)
          (and
            (= map__contentqtresultqtunused4 track_signals1)
            (and
              (= temp___loop_entry_673qtunused track_signals1)
              (and
                (= map__contentqtresultqtunused5 track_signals1)
                (and
                  (= temp___loop_entry_671qtunused prev)
                  (and
                    (= int__contentqtresultqtunused2 prev)
                    (and
                      (= int__contentqtresultqtunused3 id)
                      (and
                        (= o15 cur_position)
                        (and
                          (= o16 (get_previous_track o15 id))
                          (and
                            (and
                              (in_range2 o16)
                              (= o16 (to_rep2
                                       (select (select previous_tracks 
                                       (to_rep1
                                         (rec__trains__track__from
                                           (us_split_fields1
                                             (select tracks (to_rep4
                                       ...
                                       id))))
                            (and
                              (= get_previous_trackqtresultqtunused o16)
                              (and
                                (= prevqtunused1 (int__refqtmk prev1))
                                (and
                                  (= prev1 o16)
                                  (and
                                    (= track_signalsqtunused2 (map__refqtmk1
                                                                track_signals4))
                                    (and
                                                          ...
                                                          (forall ((other_track Int))
                                                            (=>
                                                              ...
                                                              (=>
                                                                ...
                                                                (to_rep5
                                                                  (select 
                                                                  track_signals1 other_track)))))))))))
                                                (= track_signals4 track_signals1)))))
                                        (and
                                          (and
...
;; "Assert"
(assert
  (= (occupied_tracks_on_red cur_num_trains trains1 track_signals3) true))
...
;; "H"
(assert (not (= (get_previous_track (select trains1 train1) id2) 0)))

;; "temp___352"
(define-fun temp___352 () Int
  (to_rep5
    (select track_signals3 (get_previous_track (select trains1 train1) id2))))

;; Goal "def'vc"
;; File "trains.ads", line 217, characters 0-0
(assert
  (not (or (= temp___352 1) (= temp___352 2))))
