...
(declare-datatypes ((map__ref 0))
  (((map__refqtmk (map__content (Array Int signal))))))
                                                        ...
                                                        (=>
                                                          (= (to_rep4
                                                               (rec__trains__train_position__track_end
                                                                 (us_split_fields3
                                                                   cur_position))) o7)
                                                          (forall ((track_signals1 (Array Int signal)))
                                                            (=>
                                                              (= track_signals1 (store track_signals o7 o6))
                                                              (=>
                                                                (= (no_track_precedes_itself
                                                                    Tuple0) true)
                                                                (=>
                                                                  ...
                                                                  (=>
                                                                    ...
                                                                    (= 
                                                                    (to_rep5
                                                                    (select track_signals1 prev1)) o11)
                                                                    (= o10 
                                                                    (ite (= o11 1)
                                                                    true
                                                                    false)))))
