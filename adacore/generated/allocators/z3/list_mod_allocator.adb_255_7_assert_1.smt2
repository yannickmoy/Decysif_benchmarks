...
;; "H"
(assert (= o15 (us_split_fields3 r158b)))

(declare-const us_split_fieldsqtresultqtunused1 us_split_fields2)

;; "H"
(assert (= us_split_fieldsqtresultqtunused1 o15))

(declare-const o16 us_rep1)

;; "H"
(assert (= o16 (rec__list_mod_allocator__m__t__available o15)))

(declare-const rec__list_mod_allocator__m__t__availableqtresultqtunused us_rep1)

;; "H"
(assert (= rec__list_mod_allocator__m__t__availableqtresultqtunused o16))

(declare-const list_mod_allocator__B159b__L_5__R160b__assume Int)

;; "H"
(assert (= list_mod_allocator__B159b__L_5__R160b__assume (last o16)))
...
;; "H"
(assert
  (= lastqtresultqtunused list_mod_allocator__B159b__L_5__R160b__assume))
...
;; "H"
(assert (= int__contentqtresultqtunused8 i))

(declare-const o17 Bool)

;; "H"
(assert (= o17 (ite (<= i temp___509) true false)))

(declare-const infix_lseqqtresultqtunused4 Bool)

;; "H"
(assert (= infix_lseqqtresultqtunused4 o17))
...
;; "H"
(assert (= o18 (ite (<= 1 i) true false)))

(declare-const infix_lseqqtresultqtunused5 Bool)

;; "H"
(assert (= infix_lseqqtresultqtunused5 o18))
...
;; "H"
(assert (= andbqtresultqtunused2 o19))
      ...
      (and
        ...
        (and
          ...
          (and
            ...
            (and
              (= o20 (ite (<= usf1 i) true false))
              (and
                (= infix_lseqqtresultqtunused6 o20)
                (and
                  (= o21 (ite (<= 1 usf1) true false))
                  (and
                    (= infix_lseqqtresultqtunused7 o21)
                    (= andbqtresultqtunused3 (and o21 o20)))))))))
      (and
          ...
          (and
            ...
            (and
              ...
              (and
                (and (<= 1 i1) (<= i1 r160b))
                (and
                  (= int__contentqtresultqtunused10 i1)
                  (and
                    (= infix_eqqtresultqtunused1 (ite (= i1 temp___509)
                                                   true
                                                   false))
                    (= i1 temp___509)))))))))))
         ...
         (us_split_fields1
           (select data1 (get
                           ...
                           (last
                             (rec__list_mod_allocator__m__t__available
                               (us_split_fields3
                                 (model1 data1 first_available))))))))) 0))
...
(assert
  ...
  (= (contains
       (rec__list_mod_allocator__m__t__available
         (us_split_fields3 (model1 data1 first_available)))
       r2) true)))
