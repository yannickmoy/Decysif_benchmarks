...
;; "o"
(define-fun o26 () us_rep3
  (model1 data1 first_available1))

;; "H"
(assert (model__function_guard o26 data1 first_available1))

;; "H"
(assert true)

;; "H"
(assert (= (model_is_well_formed o26 data1 first_available1) true))

;; "model'result'unused"
(define-fun modelqtresultqtunused6 () us_rep3
  o26)
...
;; "o"
(define-fun o28 () us_rep1
  (rec__list_mod_allocator__m__t__available o27))
...
;; "o"
(define-fun o30 () Bool
  (is_prepend temp___old_718 o29 o28))
...
(assert
  (=
    ...
    (and
      (and
        (and
          (< (last temp___old_718) 2147483647)
          (= (length o28) (+ (length temp___old_718) 1)))
        (= (get o28 1) o29))
      (= (range_shifted temp___old_718 o28 1 (last temp___old_718) 1) true))))

;; "is_prepend'result'unused"
(define-fun is_prependqtresultqtunused () Bool
  o30)
