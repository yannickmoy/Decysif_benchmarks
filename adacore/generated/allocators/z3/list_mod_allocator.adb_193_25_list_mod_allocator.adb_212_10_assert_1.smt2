...
;; "H"
(assert (= o19 (ite (<= i temp___684) true false)))

(declare-const infix_lseqqtresultqtunused Bool)

;; "H"
(assert (= infix_lseqqtresultqtunused o19))
...
;; "H"
(assert (= o20 (ite (<= 1 i) true false)))

(declare-const infix_lseqqtresultqtunused1 Bool)

;; "H"
(assert (= infix_lseqqtresultqtunused1 o20))

(declare-const o21 Bool)

;; "H"
(assert (= o21 (and o20 o19)))

(declare-const andbqtresultqtunused Bool)

;; "H"
(assert (= andbqtresultqtunused o21))
  ...
  (=>
    ...
    (and
      ...
      (and
        (= o22 (+ i 1))
        (and
          (= infix_plqtresultqtunused o22)
          (and
            (in_range o22)
            (and
              (= range_check_qtresultqtunused o22)
              (and
                (= o23 (last ma))
                (and
                  (in_range3 o23)
                  (and
                    (= lastqtresultqtunused1 o23)
                    (and
                      (= infix_gteqqtresultqtunused (ite (<= o22 o23)
                                                      true
                                                      false))
                      (and
...
(define-fun o25 () us_rep1
  (rec__list_mod_allocator__m__t__available o24))
