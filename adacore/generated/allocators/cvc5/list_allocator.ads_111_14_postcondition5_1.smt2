...
(assert
  (not
  (forall ((data (Array Int us_rep)) (model__split_fields us_split_fields2) (first_available Int))
    (=>
      ...
      (=>
        ...
        (=>
          ...
          (let ((temp___654 (contains
                              (rec__list_allocator__m__t__allocated
                                model__split_fields)
                              res)))
            (forall ((data1 (Array Int us_rep)) (model__split_fields1 us_split_fields2) (first_available1 Int))
              (=>
                (exists ((o Bool))
                  (and
                    (ite (not (= res 0))
                      (and
                        ...
                        (exists ((o1 Int))
                          (and
                            (= (to_rep1
                                 (rec__list_allocator__cell__stat
                                   (us_split_fields1 (select data res)))) o1)
                            (= o (ite (= o1 1) true false)))))
                      (= o false))
                              ...
                              (exists ((o2 status))
                                (and
                                  ...
                                  (and
                                    (and (<= 1 res) (<= res 10000))
                                    (and
                                      (= data1 (store data res (us_repqtmk
                                                                 (us_split_fieldsqtmk
                                                                   o2
                                                                   o1))))
                                      (and
                                        ...
                                        (let ((o3 res))
                                          (let ((o4 (rec__list_allocator__m__t__allocated
                                                      model__split_fields)))
                                            (let ((o5 (remove o4 o3)))
                                              (and
                                                (and
                                                ...
                                                (exists ((model__split_fields2 us_split_fields2))
                                                  (and
                                                    ...
                                                    (us_split_fieldsqtmk1
                                                      ...
                                                      o5))
                                                    (let ((o6 res))
                                                      (let ((o7 (rec__list_allocator__m__t__available
                                                                  model__split_fields2)))
                                                        (let ((o8 (add
                                                                    o7
                                                                    1
