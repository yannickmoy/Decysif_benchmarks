...
(assert
  ...
  (=>
    (= 0 no_resource)
    (=>
      (in_range no_resource)
      (=>
        (= (distinct 1 0) enable_handling_of_equivalence)
        (forall ((o status))
          (=>
            (= (to_rep1 o) 0)
            (let ((o1 (us_repqtmk (us_split_fieldsqtmk o rliteral))))
              (forall ((temp___521 (Array Int us_rep)))
                (=>
                  (and
                    (forall ((temp___520 Int))
                      (! (=>
                           (and (<= 1 temp___520) (<= temp___520 10000))
                           (= (select temp___521 temp___520) o1)) :pattern ((select temp___521 temp___520)) ))
                    (= temp___521 (list_mod_allocator__data__aggregate_def
                                    o1)))
                  (forall ((data (Array Int us_rep)))
                    (=>
                      (= data temp___521)
                      (forall ((first_available Int))
                        (=>
                          (= first_available 1)
                          (=>
                            ...
                            (forall ((data1 (Array Int us_rep)))
                              (=>
                                (exists ((r Int))
                                  (and
                                    (= r 1)
                                    (ite (= (and (ite (<= 1 r) true false) 
                                      (ite (<= r 10000)
                                        true
                                        false)) true)
                                      (exists ((spark__branch Bool) (data2 (Array Int us_rep)))
                                        (and
                                          (and
                                            (= spark__branch (ite (< r 10000)
                                                               true
                                                               false))
                                          ...
                                          (exists ((r1 Int))
                                            (and
                                              ...
                                              (and
                                                               ...
                                                               (=>
                                                                 ...
                                                                 (ite 
                                                                   (or
                                                                    ...
                                                                    (< temp___504 1)
                                                                    (< r1 temp___504)))
                                                                   (= (select data1 temp___504) (select data temp___504))
                                                                   (= 
                                                                   (rec__list_mod_allocator__cell__stat
                                                                    (us_split_fields1
                                                ...
                                                (= r1 10000))))))
                                      (= data1 data))))
                                (let ((list_mod_allocator__R158b__assume 
                                  (model1
                                    data1
                                    first_available)))
                                  (=>
