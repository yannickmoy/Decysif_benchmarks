              ...
              (=>
                ...
                (=>
                  (model__function_guard
                    ...
                    data
                    first_available)
                  (let ((temp___result_724 (model1 data first_available)))
                    (=>
                      (model__function_guard
                        temp___result_724
                        data
                        first_available)
                      (let ((temp___old_718 (rec__list_mod_allocator__m__t__available
                                              (us_split_fields3
                                                temp___result_724))))
                                  ...
                                  (=>
                                    (= (contains
                                         (rec__list_mod_allocator__m__t__allocated
                                           (us_split_fields3 o))
                                         res) true)
                                    (let ((o2 (model1 data1 first_available1)))
                                      (=>
                                        (and
                                          (model__function_guard
                                            o2
                                          ...
                                          (= (model_is_well_formed
                                               ...
                                               data1
                                               first_available1) true))
                                        (let ((o3 (rec__list_mod_allocator__m__t__available
                                                    (us_split_fields3 o2))))
                                          (let ((o4 res))
                                            (let ((o5 (is_prepend
                                                        temp___old_718
